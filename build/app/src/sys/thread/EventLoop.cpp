...
HX_LOCAL_STACK_FRAME(_hx_pos_4e54de61f45d3f7e_42_repeat,"sys.thread.EventLoop","repeat",0xe060da0e,"sys.thread.EventLoop.repeat","/opt/homebrew/lib/haxe/std/sys/thread/EventLoop.hx",42,0x83aee35b)
HX_LOCAL_STACK_FRAME(_hx_pos_4e54de61f45d3f7e_86_cancel,"sys.thread.EventLoop","cancel",0x9218302d,"sys.thread.EventLoop.cancel","/opt/homebrew/lib/haxe/std/sys/thread/EventLoop.hx",86,0x83aee35b)
HX_LOCAL_STACK_FRAME(_hx_pos_4e54de61f45d3f7e_119_run,"sys.thread.EventLoop","run",0xafe446b8,"sys.thread.EventLoop.run","/opt/homebrew/lib/haxe/std/sys/thread/EventLoop.hx",119,0x83aee35b)
...
bool EventLoop_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::sys::thread::_EventLoop::RegularEvent EventLoop_obj::repeat( ::Dynamic event,int intervalMs){
            	HX_GC_STACKFRAME(&_hx_pos_4e54de61f45d3f7e_42_repeat)
...
void EventLoop_obj::cancel( ::sys::thread::_EventLoop::RegularEvent eventHandler){
            	HX_STACKFRAME(&_hx_pos_4e54de61f45d3f7e_86_cancel)
...
void EventLoop_obj::run( ::Dynamic event){
            	HX_STACKFRAME(&_hx_pos_4e54de61f45d3f7e_119_run)
