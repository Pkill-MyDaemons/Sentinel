...
HX_LOCAL_STACK_FRAME(_hx_pos_3b5960fab4234575_551_registerBehaviours,"haxe.ui.containers.dialogs.Dialog","registerBehaviours",0xd64b78d2,"haxe.ui.containers.dialogs.Dialog.registerBehaviours","haxe/ui/macros/Macros.hx",551,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_8282b85acad398e5_700_cloneComponent,"haxe.ui.containers.dialogs.Dialog","cloneComponent",0xa86e8a19,"haxe.ui.containers.dialogs.Dialog.cloneComponent","haxe/ui/macros/helpers/ClassBuilder.hx",700,0x8cdaad7b)
HX_LOCAL_STACK_FRAME(_hx_pos_3b5960fab4234575_521_self,"haxe.ui.containers.dialogs.Dialog","self",0xcd0d8ac5,"haxe.ui.containers.dialogs.Dialog.self","haxe/ui/macros/Macros.hx",521,0x27866361)
namespace haxe{
namespace ui{
...
HXDLIN(  75)			if (_gthis->closable) {
HXLINE(  75)				if ((event->action != HX_("actionCancel",d0,49,2f,fe))) {
...
HXLINE(  74)		::haxe::ui::actions::ActionManager_obj::get_instance()->registerEvent(::haxe::ui::events::ActionEvent_obj::ACTION_START, ::Dynamic(new _hx_Closure_0(_gthis)),null());
            	}
...
bool Dialog_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x1e1df847) {
		if (inClassId<=(int)0x13d76ae7) {
			...
			return inClassId==(int)0x1e1df847;
		}
	} else {
...
void Dialog_obj::registerBehaviours(){
            	HX_STACKFRAME(&_hx_pos_3b5960fab4234575_551_registerBehaviours)
HXDLIN( 551)		this->super::registerBehaviours();
            	}


 ::haxe::ui::backend::ComponentBase Dialog_obj::cloneComponent(){
            	HX_STACKFRAME(&_hx_pos_8282b85acad398e5_700_cloneComponent)
HXLINE( 469)		 ::haxe::ui::containers::dialogs::Dialog c = ( ( ::haxe::ui::containers::dialogs::Dialog)(this->super::cloneComponent()) );
HXLINE( 484)		{
...
HXLINE( 493)		return c;
 ...
 ::haxe::ui::backend::ComponentBase Dialog_obj::self(){
            	HX_GC_STACKFRAME(&_hx_pos_3b5960fab4234575_521_self)
HXDLIN( 521)		return  ::haxe::ui::containers::dialogs::Dialog_obj::__alloc( HX_CTX );
            	}
