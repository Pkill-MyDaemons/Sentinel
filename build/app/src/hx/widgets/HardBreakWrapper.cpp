...
HXLINE(  13)			 wxString str = wxString::FromUTF8(text.utf8_str());
HXLINE(  14)			::cpp::Pointer<  wxHardBreakWrapper > _hx_tmp = ::cpp::Pointer_obj::fromRaw((new wxHardBreakWrapper(::hx::widgets::Window_obj::toRaw(win),str,maxWidth)));
...
bool HardBreakWrapper_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x393c5a1e;
}
...
static ::hx::StorageInfo HardBreakWrapper_obj_sMemberStorageInfo[] = {
	{::hx::fsUnknown /* ::cpp::Pointer<  wxHardBreakWrapper > */ ,(int)offsetof(HardBreakWrapper_obj,_ref),HX_("_ref",54,1e,22,3f)},
	{::hx::fsString,(int)offsetof(HardBreakWrapper_obj,wrapped),HX_("wrapped",45,d5,64,0d)},
	{ ::hx::fsUnknown, 0, null()}
};
...
{
	HardBreakWrapper_obj _hx_dummy;
	HardBreakWrapper_obj::_hx_vtable = *(void **)&_hx_dummy;
	::hx::Static(__mClass) = new ::hx::Class_obj();
	__mClass->mName = HX_("hx.widgets.HardBreakWrapper",3c,42,9a,b3);
