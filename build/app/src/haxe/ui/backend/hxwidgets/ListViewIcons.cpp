...
bool ListViewIcons_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x12687932;
}
...
HXLINE(  11)			 ::hx::widgets::ListView window = ( ( ::hx::widgets::ListView)(listView->get_window()) );
...
static ::hx::StaticInfo ListViewIcons_obj_sStaticStorageInfo[] = {
	{::hx::fsObject /*  ::haxe::ui::backend::hxwidgets::IconMap */ ,(void *) &ListViewIcons_obj::_map,HX_("_map",9d,4f,1e,3f)},
	{ ::hx::fsUnknown, 0, null()}
};
#endif
...
{
	ListViewIcons_obj _hx_dummy;
	ListViewIcons_obj::_hx_vtable = *(void **)&_hx_dummy;
	::hx::Static(__mClass) = new ::hx::Class_obj();
	__mClass->mName = HX_("haxe.ui.backend.hxwidgets.ListViewIcons",1c,eb,81,a9);
