...
class HXCPP_CLASS_ATTRIBUTES ChoiceDataSource_obj : public  ::haxe::ui::behaviours::DataBehaviour_obj
{
	public:
	...
	public:
		...
		::String __ToString() const { return HX_("ChoiceDataSource",86,79,3a,06); }
