...
bool AnimationEvent_obj::__GetStatic(const ::String &inName, Dynamic &outValue, ::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 3:
	...
	case 5:
		...
		if (HX_FIELD_EQ(inName,"FRAME") ) { outValue = ( FRAME ); return true; }
		break;
	case 6:
...
bool AnimationEvent_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 3:
		if (HX_FIELD_EQ(inName,"END") ) { END=ioValue.Cast< ::String >(); return true; }
		break;
	case 5:
		if (HX_FIELD_EQ(inName,"START") ) { START=ioValue.Cast< ::String >(); return true; }
		if (HX_FIELD_EQ(inName,"FRAME") ) { FRAME=ioValue.Cast< ::String >(); return true; }
		break;
	case 6:
		if (HX_FIELD_EQ(inName,"LOADED") ) { LOADED=ioValue.Cast< ::String >(); return true; }
	}
	return false;
}
...
void AnimationEvent_obj::__register()
{
	...
	__mClass->mGetStaticField = &AnimationEvent_obj::__GetStatic;
...
HXDLIN(   4)		LOADED = ::haxe::ui::events::_EventType::EventType_Impl__obj::name(HX_("animationloaded",09,52,d7,32));
            	}
{
            	HX_STACKFRAME(&_hx_pos_8a41f2c13e073b75_5_boot)
HXDLIN(   5)		START = ::haxe::ui::events::_EventType::EventType_Impl__obj::name(HX_("animationstart",de,96,01,01));
            	}
{
            	HX_STACKFRAME(&_hx_pos_8a41f2c13e073b75_6_boot)
HXDLIN(   6)		END = ::haxe::ui::events::_EventType::EventType_Impl__obj::name(HX_("animationend",57,4f,3c,aa));
            	}
{
            	HX_STACKFRAME(&_hx_pos_8a41f2c13e073b75_7_boot)
HXDLIN(   7)		FRAME = ::haxe::ui::events::_EventType::EventType_Impl__obj::name(HX_("animationframe",a9,9a,79,83));
            	}
}
