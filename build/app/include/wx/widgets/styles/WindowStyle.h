...
class HXCPP_CLASS_ATTRIBUTES WindowStyle_obj : public ::hx::Object
{
	...
	public:
		...
		inline static ::hx::ObjectPtr< WindowStyle_obj > __new() {
			::hx::ObjectPtr< WindowStyle_obj > __this = new WindowStyle_obj();
			__this->__construct();
			return __this;
		}

		inline static ::hx::ObjectPtr< WindowStyle_obj > __alloc(::hx::Ctx *_hx_ctx) {
		...
		::String __ToString() const { return HX_("WindowStyle",01,d3,22,59); }
