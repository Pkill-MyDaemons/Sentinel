...
bool AppEvent_obj::__GetStatic(const ::String &inName, Dynamic &outValue, ::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 9:
		if (HX_FIELD_EQ(inName,"APP_READY") ) { outValue = ( APP_READY ); return true; }
		break;
	case 10:
		if (HX_FIELD_EQ(inName,"APP_CLOSED") ) { outValue = ( APP_CLOSED ); return true; }
		if (HX_FIELD_EQ(inName,"APP_EXITED") ) { outValue = ( APP_EXITED ); return true; }
		break;
	case 11:
		if (HX_FIELD_EQ(inName,"APP_STARTED") ) { outValue = ( APP_STARTED ); return true; }
	}
	return false;
}

bool AppEvent_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 9:
		if (HX_FIELD_EQ(inName,"APP_READY") ) { APP_READY=ioValue.Cast< ::String >(); return true; }
		break;
	case 10:
		if (HX_FIELD_EQ(inName,"APP_CLOSED") ) { APP_CLOSED=ioValue.Cast< ::String >(); return true; }
		if (HX_FIELD_EQ(inName,"APP_EXITED") ) { APP_EXITED=ioValue.Cast< ::String >(); return true; }
		break;
	case 11:
		if (HX_FIELD_EQ(inName,"APP_STARTED") ) { APP_STARTED=ioValue.Cast< ::String >(); return true; }
	}
	return false;
}
...
void AppEvent_obj::__register()
{
	...
	__mClass->mGetStaticField = &AppEvent_obj::__GetStatic;
	__mClass->mSetStaticField = &AppEvent_obj::__SetStatic;
...
HXDLIN(   4)		APP_READY = ::haxe::ui::events::_EventType::EventType_Impl__obj::name(HX_("appready",22,3c,34,8c));
            	}
{
            	HX_STACKFRAME(&_hx_pos_b4b702f57c3dca25_5_boot)
HXDLIN(   5)		APP_STARTED = ::haxe::ui::events::_EventType::EventType_Impl__obj::name(HX_("appstarted",c0,72,02,61));
            	}
{
            	HX_STACKFRAME(&_hx_pos_b4b702f57c3dca25_6_boot)
HXDLIN(   6)		APP_CLOSED = ::haxe::ui::events::_EventType::EventType_Impl__obj::name(HX_("appclosed",0d,55,40,33));
            	}
{
            	HX_STACKFRAME(&_hx_pos_b4b702f57c3dca25_7_boot)
HXDLIN(   7)		APP_EXITED = ::haxe::ui::events::_EventType::EventType_Impl__obj::name(HX_("appexited",5e,7e,cf,e4));
            	}
}
