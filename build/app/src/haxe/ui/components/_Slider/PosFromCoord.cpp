...
HX_DEFINE_STACK_FRAME(_hx_pos_3eca3fbb5b0782c9_366_new,"haxe.ui.components._Slider.PosFromCoord","new",0x27b7901d,"haxe.ui.components._Slider.PosFromCoord.new","haxe/ui/components/Slider.hx",366,0x55cb8456)
HX_LOCAL_STACK_FRAME(_hx_pos_3eca3fbb5b0782c9_367_call,"haxe.ui.components._Slider.PosFromCoord","call",0x919e1e41,"haxe.ui.components._Slider.PosFromCoord.call","haxe/ui/components/Slider.hx",367,0x55cb8456)
namespace haxe{
namespace ui{
...
void PosFromCoord_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_3eca3fbb5b0782c9_366_new)
HXDLIN( 366)		super::__construct(component);
            	}
...
bool PosFromCoord_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::haxe::ui::util::VariantType PosFromCoord_obj::call( ::Dynamic coord){
            	HX_STACKFRAME(&_hx_pos_3eca3fbb5b0782c9_367_call)
HXLINE( 368)		 ::haxe::ui::components::Range range = this->_component->findComponent(null(),::hx::ClassOf< ::haxe::ui::components::Range >(),null(),null()).StaticCast<  ::haxe::ui::components::Range >();
HXLINE( 369)		return ::haxe::ui::util::_Variant::Variant_Impl__obj::fromFloat(range->posFromCoord(( ( ::haxe::ui::geom::Point)(coord) )));
            	}
