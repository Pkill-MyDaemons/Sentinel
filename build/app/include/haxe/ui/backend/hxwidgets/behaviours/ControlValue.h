...
class HXCPP_CLASS_ATTRIBUTES ControlValue_obj : public  ::haxe::ui::behaviours::DataBehaviour_obj
{
	public:
	...
	public:
		...
		::String __ToString() const { return HX_("ControlValue",f4,7e,a3,be); }
