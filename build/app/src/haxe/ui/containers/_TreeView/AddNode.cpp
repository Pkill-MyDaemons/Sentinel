...
HX_DEFINE_STACK_FRAME(_hx_pos_9206068ed598c4d1_124_new,"haxe.ui.containers._TreeView.AddNode","new",0xd4426cbf,"haxe.ui.containers._TreeView.AddNode.new","haxe/ui/containers/TreeView.hx",124,0xc7a0e210)
HX_LOCAL_STACK_FRAME(_hx_pos_9206068ed598c4d1_125_call,"haxe.ui.containers._TreeView.AddNode","call",0xde944f5f,"haxe.ui.containers._TreeView.AddNode.call","haxe/ui/containers/TreeView.hx",125,0xc7a0e210)
namespace haxe{
namespace ui{
...
void AddNode_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_9206068ed598c4d1_124_new)
...
bool AddNode_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x1b766ccd) {
		return inClassId==(int)0x00000001 || inClassId==(int)0x1b766ccd;
	} else {
 ...
 ::haxe::ui::util::VariantType AddNode_obj::call( ::Dynamic param){
            	HX_GC_STACKFRAME(&_hx_pos_9206068ed598c4d1_125_call)
HXLINE( 126)		 ::haxe::ui::containers::TreeViewNode node =  ::haxe::ui::containers::TreeViewNode_obj::__alloc( HX_CTX );
HXLINE( 127)		node->set_data(param);
HXLINE( 128)		this->_component->addComponent(node);
HXLINE( 129)		return ::haxe::ui::util::_Variant::Variant_Impl__obj::fromComponent(node);
            	}
...
::hx::ObjectPtr< AddNode_obj > AddNode_obj::__alloc(::hx::Ctx *_hx_ctx, ::haxe::ui::core::Component component) {
	AddNode_obj *__this = (AddNode_obj*)(::hx::Ctx::alloc(_hx_ctx, sizeof(AddNode_obj), true, "haxe.ui.containers._TreeView.AddNode"));
...
void AddNode_obj::__register()
{
	...
	__mClass->mName = HX_("haxe.ui.containers._TreeView.AddNode",4d,a1,c7,6c);
