...
class HXCPP_CLASS_ATTRIBUTES DialogStyle_obj : public ::hx::Object
{
	...
	public:
		...
		inline static ::hx::ObjectPtr< DialogStyle_obj > __new() {
			::hx::ObjectPtr< DialogStyle_obj > __this = new DialogStyle_obj();
			__this->__construct();
			return __this;
		}

		inline static ::hx::ObjectPtr< DialogStyle_obj > __alloc(::hx::Ctx *_hx_ctx) {
		...
		::String __ToString() const { return HX_("DialogStyle",29,53,3c,76); }
