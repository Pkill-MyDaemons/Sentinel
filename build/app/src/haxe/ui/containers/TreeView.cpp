...
HX_LOCAL_STACK_FRAME(_hx_pos_e29e92d3fff25226_693_addNode,"haxe.ui.containers.TreeView","addNode",0x0a95c662,"haxe.ui.containers.TreeView.addNode","haxe/ui/macros/Macros.hx",693,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_e29e92d3fff25226_693_removeNode,"haxe.ui.containers.TreeView","removeNode",0x69855827,"haxe.ui.containers.TreeView.removeNode","haxe/ui/macros/Macros.hx",693,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_e29e92d3fff25226_685_clearNodes,"haxe.ui.containers.TreeView","clearNodes",0x18250b25,"haxe.ui.containers.TreeView.clearNodes","haxe/ui/macros/Macros.hx",685,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_e29e92d3fff25226_696_getNodesInternal,"haxe.ui.containers.TreeView","getNodesInternal",0xdf8f7899,"haxe.ui.containers.TreeView.getNodesInternal","haxe/ui/macros/Macros.hx",696,0x27866361)
...
HX_LOCAL_STACK_FRAME(_hx_pos_e29e92d3fff25226_204_registerComposite,"haxe.ui.containers.TreeView","registerComposite",0x9c243b83,"haxe.ui.containers.TreeView.registerComposite","haxe/ui/macros/Macros.hx",204,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_e29e92d3fff25226_550_registerBehaviours,"haxe.ui.containers.TreeView","registerBehaviours",0x868ee49a,"haxe.ui.containers.TreeView.registerBehaviours","haxe/ui/macros/Macros.hx",550,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_e29e92d3fff25226_590_get_selectedNode,"haxe.ui.containers.TreeView","get_selectedNode",0xe01df107,"haxe.ui.containers.TreeView.get_selectedNode","haxe/ui/macros/Macros.hx",590,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_e29e92d3fff25226_648_set_selectedNode,"haxe.ui.containers.TreeView","set_selectedNode",0x365fde7b,"haxe.ui.containers.TreeView.set_selectedNode","haxe/ui/macros/Macros.hx",648,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_44ba5fd4ba31efac_700_cloneComponent,"haxe.ui.containers.TreeView","cloneComponent",0x650e71e1,"haxe.ui.containers.TreeView.cloneComponent","haxe/ui/macros/helpers/ClassBuilder.hx",700,0x8cdaad7b)
HX_LOCAL_STACK_FRAME(_hx_pos_e29e92d3fff25226_521_self,"haxe.ui.containers.TreeView","self",0xc113688d,"haxe.ui.containers.TreeView.self","haxe/ui/macros/Macros.hx",521,0x27866361)
namespace haxe{
namespace ui{
...
bool TreeView_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x433ebabe) {
		...
		if (inClassId<=(int)0x606705f3) {
			return inClassId==(int)0x4ba87886 || inClassId==(int)0x606705f3;
		} else {
...
void *TreeView_obj::_hx_getInterface(int inHash) {
 ...
 ::haxe::ui::containers::TreeViewNode TreeView_obj::addNode( ::Dynamic data){
            	HX_STACKFRAME(&_hx_pos_e29e92d3fff25226_693_addNode)
...
HX_DEFINE_DYNAMIC_FUNC1(TreeView_obj,addNode,return )
 ...
 ::haxe::ui::containers::TreeViewNode TreeView_obj::removeNode( ::haxe::ui::containers::TreeViewNode node){
            	HX_STACKFRAME(&_hx_pos_e29e92d3fff25226_693_removeNode)
...
void TreeView_obj::clearNodes(){
            	HX_STACKFRAME(&_hx_pos_e29e92d3fff25226_685_clearNodes)
...
::Array< ::Dynamic> TreeView_obj::getNodesInternal(){
            	HX_STACKFRAME(&_hx_pos_e29e92d3fff25226_696_getNodesInternal)
...
void TreeView_obj::registerComposite(){
            	HX_STACKFRAME(&_hx_pos_e29e92d3fff25226_204_registerComposite)
HXLINE( 205)		this->super::registerComposite();
HXLINE( 213)		this->_internalEventsClass = ::hx::ClassOf< ::haxe::ui::containers::_TreeView::TreeViewEvents >();
HXLINE( 217)		this->_compositeBuilderClass = ::hx::ClassOf< ::haxe::ui::containers::_TreeView::TreeViewBuilder >();
            	}


void TreeView_obj::registerBehaviours(){
            	HX_STACKFRAME(&_hx_pos_e29e92d3fff25226_550_registerBehaviours)
HXLINE( 551)		this->super::registerBehaviours();
HXLINE( 667)		this->behaviours->_hx_register(HX_("selectedNode",fd,29,a4,d9),::hx::ClassOf< ::haxe::ui::containers::_TreeView::SelectedNode >(),null());
HXLINE( 706)		this->behaviours->_hx_register(HX_("addNode",c3,4c,47,85),::hx::ClassOf< ::haxe::ui::containers::_TreeView::AddNode >(),null());
HXDLIN( 706)		this->behaviours->_hx_register(HX_("removeNode",66,44,29,c6),::hx::ClassOf< ::haxe::ui::containers::_TreeView::RemoveNode >(),null());
HXDLIN( 706)		this->behaviours->_hx_register(HX_("clearNodes",64,f7,c8,74),::hx::ClassOf< ::haxe::ui::containers::_TreeView::ClearNodes >(),null());
HXDLIN( 706)		this->behaviours->_hx_register(HX_("getNodesInternal",18,9e,b4,dd),::hx::ClassOf< ::haxe::ui::containers::_TreeView::GetNodesInternal >(),null());
            	}


 ::haxe::ui::containers::TreeViewNode TreeView_obj::get_selectedNode(){
            	HX_STACKFRAME(&_hx_pos_e29e92d3fff25226_590_get_selectedNode)
HXLINE( 591)		if (::hx::IsNull( this->behaviours )) {
HXLINE( 592)			return null();
            		}
HXLINE( 594)		return ( ( ::haxe::ui::containers::TreeViewNode)(::haxe::ui::util::_Variant::Variant_Impl__obj::toComponent(this->behaviours->get(HX_("selectedNode",fd,29,a4,d9)))) );
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(TreeView_obj,get_selectedNode,return )
 ...
 ::haxe::ui::containers::TreeViewNode TreeView_obj::set_selectedNode( ::haxe::ui::containers::TreeViewNode value){
            	HX_GC_STACKFRAME(&_hx_pos_e29e92d3fff25226_648_set_selectedNode)
...
HXDLIN( 652)		_hx_tmp->set(HX_("selectedNode",fd,29,a4,d9),::haxe::ui::util::_Variant::Variant_Impl__obj::fromComponent(value));
HXLINE( 653)		this->dispatch( ::haxe::ui::events::UIEvent_obj::__alloc( HX_CTX ,::haxe::ui::events::UIEvent_obj::PROPERTY_CHANGE,null(),HX_("selectedNode",fd,29,a4,d9)),null());
...
HX_DEFINE_DYNAMIC_FUNC1(TreeView_obj,set_selectedNode,return )
 ...
 ::haxe::ui::backend::ComponentBase TreeView_obj::cloneComponent(){
            	HX_STACKFRAME(&_hx_pos_44ba5fd4ba31efac_700_cloneComponent)
HXLINE( 469)		 ::haxe::ui::containers::TreeView c = ( ( ::haxe::ui::containers::TreeView)(this->super::cloneComponent()) );
HXLINE( 484)		{
...
HXLINE( 493)		return c;
 ...
 ::haxe::ui::backend::ComponentBase TreeView_obj::self(){
            	HX_GC_STACKFRAME(&_hx_pos_e29e92d3fff25226_521_self)
HXDLIN( 521)		return  ::haxe::ui::containers::TreeView_obj::__alloc( HX_CTX );
            	}
