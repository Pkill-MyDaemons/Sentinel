...
HX_DEFINE_STACK_FRAME(_hx_pos_fd6ca2179b1d9915_34_new,"sys.ssl.Key","new",0xfc27226e,"sys.ssl.Key.new","/opt/homebrew/lib/haxe/std/cpp/_std/sys/ssl/Key.hx",34,0xb16c3cdb)
HX_LOCAL_STACK_FRAME(_hx_pos_ea753cc06cec8329_55___init__,"::sys::ssl::Key_obj","__init__",0x25088cc6,"::sys::ssl::Key_obj.__init__","/opt/homebrew/lib/haxe/std/cpp/_std/sys/ssl/Key.hx",55,0xb16c3cdb)
namespace sys{
namespace ssl{

void Key_obj::__construct( ::Dynamic k){
            	HX_STACKFRAME(&_hx_pos_fd6ca2179b1d9915_34_new)
...
void Key_obj::__init__(){
            	HX_STACKFRAME(&_hx_pos_ea753cc06cec8329_55___init__)
