...
HX_DEFINE_STACK_FRAME(_hx_pos_496de811a6a1176f_63_new,"haxe.ui.containers.menus._MenuItem.ExpandableBehaviour","new",0xb49a349a,"haxe.ui.containers.menus._MenuItem.ExpandableBehaviour.new","haxe/ui/containers/menus/MenuItem.hx",63,0x19b927e6)
HX_LOCAL_STACK_FRAME(_hx_pos_496de811a6a1176f_64_validateData,"haxe.ui.containers.menus._MenuItem.ExpandableBehaviour","validateData",0xd10f9a66,"haxe.ui.containers.menus._MenuItem.ExpandableBehaviour.validateData","haxe/ui/containers/menus/MenuItem.hx",64,0x19b927e6)
namespace haxe{
namespace ui{
...
void ExpandableBehaviour_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_496de811a6a1176f_63_new)
...
void ExpandableBehaviour_obj::validateData(){
            	HX_GC_STACKFRAME(&_hx_pos_496de811a6a1176f_64_validateData)
HXLINE(  65)		 ::haxe::ui::components::Image image = this->_component->findComponent(HX_("menuitem-expandable",6f,ce,0a,88),null(),null(),null()).StaticCast<  ::haxe::ui::components::Image >();
HXLINE(  66)		bool _hx_tmp;
HXDLIN(  66)		if (::hx::IsNull( image )) {
HXLINE(  66)			 ::haxe::ui::util::VariantType _hx_tmp1 = this->_value;
HXDLIN(  66)			_hx_tmp = ::haxe::ui::util::_Variant::Variant_Impl__obj::eq(_hx_tmp1,::haxe::ui::util::_Variant::Variant_Impl__obj::fromBool(true));
            		}
            		else {
HXLINE(  66)			_hx_tmp = false;
            		}
HXDLIN(  66)		if (_hx_tmp) {
HXLINE(  67)			image =  ::haxe::ui::components::Image_obj::__alloc( HX_CTX );
HXLINE(  68)			image->set_id(HX_("menuitem-expandable",6f,ce,0a,88));
HXLINE(  69)			image->set_styleNames(HX_("menuitem-expandable",6f,ce,0a,88));
HXLINE(  70)			image->set_scriptAccess(false);
HXLINE(  71)			this->_component->addComponent(image);
HXLINE(  72)			{
HXLINE(  72)				 ::haxe::ui::core::Component _this = this->_component;
HXDLIN(  72)				_this->invalidateComponent(HX_("style",31,a5,1d,84),false);
HXDLIN(  72)				_this->_style = null();
            			}
            		}
            		else {
HXLINE(  73)			 ::haxe::ui::util::VariantType _hx_tmp2 = this->_value;
HXDLIN(  73)			if (::haxe::ui::util::_Variant::Variant_Impl__obj::eq(_hx_tmp2,::haxe::ui::util::_Variant::Variant_Impl__obj::fromBool(false))) {
HXLINE(  74)				this->_component->removeComponent(image,null(),null());
            			}
            		}
            	}
