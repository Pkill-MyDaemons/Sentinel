...
bool ValidationEvent_obj::__GetStatic(const ::String &inName, Dynamic &outValue, ::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 4:
...
bool ValidationEvent_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 4:
		if (HX_FIELD_EQ(inName,"STOP") ) { STOP=ioValue.Cast< ::String >(); return true; }
		break;
	case 5:
...
void ValidationEvent_obj::__register()
{
	...
	__mClass->mGetStaticField = &ValidationEvent_obj::__GetStatic;
	__mClass->mSetStaticField = &ValidationEvent_obj::__SetStatic;
...
HXDLIN(   4)		START = ::haxe::ui::events::_EventType::EventType_Impl__obj::name(HX_("validationstart",89,79,aa,99));
            	}
{
            	HX_STACKFRAME(&_hx_pos_fdc593fdf9f65bf1_5_boot)
HXDLIN(   5)		STOP = ::haxe::ui::events::_EventType::EventType_Impl__obj::name(HX_("validationstop",bb,0c,96,c9));
            	}
}
