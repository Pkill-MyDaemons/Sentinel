...
HXLINE(  78)				 ::haxe::ui::events::SortEvent sortEvent =  ::haxe::ui::events::SortEvent_obj::__alloc( HX_CTX ,::haxe::ui::events::SortEvent_obj::SORT_CHANGED,null(),null());
HXLINE(  79)				sortEvent->direction = _gthis->_column->get_sortDirection();
HXLINE(  80)				_gthis->_column->dispatch(sortEvent,null());
            			}
            		}
...
HXLINE(  75)		this->_column->registerEvent(::haxe::ui::events::MouseEvent_obj::CLICK,this->onColumnClick_dyn(),null());
HXLINE(  76)		this->_column->registerEvent(::haxe::ui::events::UIEvent_obj::READY, ::Dynamic(new _hx_Closure_0(_gthis)),null());
            	}
...
HXLINE(  98)		::Array< ::Dynamic> components = this->_column->findComponentsUnderPoint(event->screenX,event->screenY,::hx::ClassOf< ::haxe::ui::core::InteractiveComponent >());
HXLINE(  99)		components->remove(this->_column);
HXLINE( 100)		if ((components->length != 0)) {
HXLINE( 101)			return;
            		}
HXLINE( 104)		if (::hx::IsNull( this->_column->get_sortDirection() )) {
HXLINE( 105)			this->_column->set_sortDirection(HX_("asc",31,ff,49,00));
            		}
            		else {
HXLINE( 106)			if ((this->_column->get_sortDirection() == HX_("asc",31,ff,49,00))) {
HXLINE( 107)				this->_column->set_sortDirection(HX_("desc",51,5e,66,42));
            			}
            			else {
HXLINE( 108)				if ((this->_column->get_sortDirection() == HX_("desc",51,5e,66,42))) {
HXLINE( 109)					this->_column->set_sortDirection(HX_("asc",31,ff,49,00));
            				}
            			}
            		}
HXLINE( 112)		 ::haxe::ui::events::SortEvent sortEvent =  ::haxe::ui::events::SortEvent_obj::__alloc( HX_CTX ,::haxe::ui::events::SortEvent_obj::SORT_CHANGED,null(),null());
HXLINE( 113)		sortEvent->direction = this->_column->get_sortDirection();
HXLINE( 114)		this->_column->dispatch(sortEvent,null());
            	}
