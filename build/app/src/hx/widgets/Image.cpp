...
HX_LOCAL_STACK_FRAME(_hx_pos_aa9e72e6297a3354_120_destroy,"hx.widgets.Image","destroy",0x5989606a,"hx.widgets.Image.destroy","hx/widgets/Image.hx",120,0x548f18a2)
HX_LOCAL_STACK_FRAME(_hx_pos_aa9e72e6297a3354_130_get_width,"hx.widgets.Image","get_width",0xf0d701cd,"hx.widgets.Image.get_width","hx/widgets/Image.hx",130,0x548f18a2)
HX_LOCAL_STACK_FRAME(_hx_pos_aa9e72e6297a3354_135_get_height,"hx.widgets.Image","get_height",0x819a0a40,"hx.widgets.Image.get_height","hx/widgets/Image.hx",135,0x548f18a2)
HX_LOCAL_STACK_FRAME(_hx_pos_aa9e72e6297a3354_138_scale,"hx.widgets.Image","scale",0x96b145fa,"hx.widgets.Image.scale","hx/widgets/Image.hx",138,0x548f18a2)
HX_LOCAL_STACK_FRAME(_hx_pos_aa9e72e6297a3354_150_get_hasAlpha,"hx.widgets.Image","get_hasAlpha",0x1e84fc3d,"hx.widgets.Image.get_hasAlpha","hx/widgets/Image.hx",150,0x548f18a2)
HX_LOCAL_STACK_FRAME(_hx_pos_aa9e72e6297a3354_154_addAlphaChannel,"hx.widgets.Image","addAlphaChannel",0xb820d836,"hx.widgets.Image.addAlphaChannel","hx/widgets/Image.hx",154,0x548f18a2)
HX_LOCAL_STACK_FRAME(_hx_pos_aa9e72e6297a3354_158_get_imageData,"hx.widgets.Image","get_imageData",0x374b266c,"hx.widgets.Image.get_imageData","hx/widgets/Image.hx",158,0x548f18a2)
HX_LOCAL_STACK_FRAME(_hx_pos_aa9e72e6297a3354_175_get_imageRef,"hx.widgets.Image","get_imageRef",0xf4cf4751,"hx.widgets.Image.get_imageRef","hx/widgets/Image.hx",175,0x548f18a2)
namespace hx{
namespace widgets{
...
HXLINE( 112)				_hx_tmp1 = ::hx::IsNotNull( height );
            			}
            			else {
HXLINE( 112)				_hx_tmp1 = false;
            			}
HXDLIN( 112)			if (_hx_tmp1) {
HXLINE( 113)				::cpp::Pointer<  wxImage > _hx_tmp2 = ::cpp::Pointer_obj::fromRaw((new wxImage(( (int)(width) ),( (int)(height) ))));
HXDLIN( 113)				this->_ref = _hx_tmp2->reinterpret();
            			}
            		}
...
bool Image_obj::destroy(){
            	HX_STACKFRAME(&_hx_pos_aa9e72e6297a3354_120_destroy)
HXLINE( 121)		this->get_imageRef()->ptr->Destroy();
HXLINE( 122)		return this->super::destroy();
            	}


int Image_obj::get_width(){
            	HX_STACKFRAME(&_hx_pos_aa9e72e6297a3354_130_get_width)
HXDLIN( 130)		return this->get_imageRef()->ptr->GetWidth();
            	}
...
int Image_obj::get_height(){
            	HX_STACKFRAME(&_hx_pos_aa9e72e6297a3354_135_get_height)
HXDLIN( 135)		return this->get_imageRef()->ptr->GetHeight();
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(Image_obj,get_height,return )
 ...
 ::hx::widgets::Image Image_obj::scale(int width,int height){
            	HX_GC_STACKFRAME(&_hx_pos_aa9e72e6297a3354_138_scale)
HXLINE( 139)		 wxImage r = this->get_imageRef()->ptr->Scale(width,height);
HXLINE( 140)		int width1 = r.GetWidth();
HXDLIN( 140)		::cpp::Pointer<  wxImage > copy = ::cpp::Pointer_obj::fromRaw((new wxImage(width1,r.GetHeight())));
HXLINE( 141)		copy->ptr->Paste(r,0,0);
HXLINE( 142)		 ::hx::widgets::Image image =  ::hx::widgets::Image_obj::__alloc( HX_CTX ,null(),null(),null(),null());
HXLINE( 143)		image->_ref = copy->reinterpret();
HXLINE( 144)		r.Destroy();
HXLINE( 145)		return image;
            	}
...
bool Image_obj::get_hasAlpha(){
            	HX_STACKFRAME(&_hx_pos_aa9e72e6297a3354_150_get_hasAlpha)
HXDLIN( 150)		return this->get_imageRef()->ptr->HasAlpha();
            	}
...
void Image_obj::addAlphaChannel(){
            	HX_STACKFRAME(&_hx_pos_aa9e72e6297a3354_154_addAlphaChannel)
HXDLIN( 154)		this->get_imageRef()->ptr->SetAlpha(null());
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(Image_obj,addAlphaChannel,(void))
 ...
 ::hx::widgets::ImageData Image_obj::get_imageData(){
            	HX_GC_STACKFRAME(&_hx_pos_aa9e72e6297a3354_158_get_imageData)
HXLINE( 159)		unsigned char* rawPointerData = this->get_imageRef()->ptr->GetData();
HXLINE( 160)		::cpp::Pointer< unsigned char > data = ::cpp::Pointer_obj::fromRaw(rawPointerData);
HXLINE( 161)		unsigned char* rawPointerAlpha = this->get_imageRef()->ptr->GetAlpha();
HXLINE( 162)		::cpp::Pointer< unsigned char > alpha = null();
HXLINE( 163)		if (::hx::IsNotNull( rawPointerAlpha )) {
HXLINE( 164)			alpha = ::cpp::Pointer_obj::fromRaw(rawPointerAlpha);
            		}
HXLINE( 166)		 ::hx::widgets::ImageData wrapper =  ::hx::widgets::ImageData_obj::__alloc( HX_CTX ,::hx::ObjectPtr<OBJ_>(this),data,alpha);
HXLINE( 167)		return wrapper;
            	}
...
::cpp::Pointer<  wxImage > Image_obj::get_imageRef(){
            	HX_STACKFRAME(&_hx_pos_aa9e72e6297a3354_175_get_imageRef)
HXDLIN( 175)		return this->_ref->reinterpret();
            	}
