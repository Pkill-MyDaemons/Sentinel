...
class HXCPP_CLASS_ATTRIBUTES FrameStyle_obj : public ::hx::Object
{
	...
	public:
		...
		inline static ::hx::ObjectPtr< FrameStyle_obj > __new() {
			::hx::ObjectPtr< FrameStyle_obj > __this = new FrameStyle_obj();
			__this->__construct();
			return __this;
		}

		inline static ::hx::ObjectPtr< FrameStyle_obj > __alloc(::hx::Ctx *_hx_ctx) {
		...
		::String __ToString() const { return HX_("FrameStyle",e4,dd,f4,5d); }
