...
HXLINE(  12)			 wxString str = wxString::FromUTF8(title.utf8_str());
HXLINE(  13)			 wxStaticBox * _hx_tmp = this->get_staticBoxRef()->ptr;
HXDLIN(  13)			(*(_hx_tmp)).Create(::hx::widgets::Window_obj::toRaw(parent),id,str);
            		}
...
bool StaticBox_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x467ba226) {
		...
		return inClassId==(int)0x52737bde || inClassId==(int)0x5d92cb6f;
	}
}
...
{
	outFields->push(HX_("staticBoxRef",56,f3,77,86));
	super::__GetFields(outFields);
};

#ifdef HXCPP_SCRIPTABLE
static ::hx::StorageInfo StaticBox_obj_sMemberStorageInfo[] = {
	{::hx::fsUnknown /* ::cpp::Pointer<  wxStaticBox > */ ,(int)offsetof(StaticBox_obj,staticBoxRef),HX_("staticBoxRef",56,f3,77,86)},
	{ ::hx::fsUnknown, 0, null()}
};
...
static ::String StaticBox_obj_sMemberFields[] = {
	HX_("staticBoxRef",56,f3,77,86),
	HX_("get_staticBoxRef",df,df,16,8b),
	::String(null()) };
...
{
	StaticBox_obj _hx_dummy;
	StaticBox_obj::_hx_vtable = *(void **)&_hx_dummy;
	::hx::Static(__mClass) = new ::hx::Class_obj();
	__mClass->mName = HX_("hx.widgets.StaticBox",00,bc,f0,46);
