...
class HXCPP_CLASS_ATTRIBUTES StyleParser_obj : public ::hx::Object
{
	...
	public:
		...
		inline static ::hx::ObjectPtr< StyleParser_obj > __new() {
			::hx::ObjectPtr< StyleParser_obj > __this = new StyleParser_obj();
			__this->__construct();
			return __this;
		}

		inline static ::hx::ObjectPtr< StyleParser_obj > __alloc(::hx::Ctx *_hx_ctx) {
		...
		::String __ToString() const { return HX_("StyleParser",d0,c8,52,49); }
