...
HX_DEFINE_STACK_FRAME(_hx_pos_2dd7f304f28a6472_338_new,"haxe.ui.containers._ScrollView.VScrollPos","new",0xe5f5ddca,"haxe.ui.containers._ScrollView.VScrollPos.new","haxe/ui/containers/ScrollView.hx",338,0x01b76681)
HX_LOCAL_STACK_FRAME(_hx_pos_2dd7f304f28a6472_343_get,"haxe.ui.containers._ScrollView.VScrollPos","get",0xe5f08e00,"haxe.ui.containers._ScrollView.VScrollPos.get","haxe/ui/containers/ScrollView.hx",343,0x01b76681)
HX_LOCAL_STACK_FRAME(_hx_pos_2dd7f304f28a6472_351_validateData,"haxe.ui.containers._ScrollView.VScrollPos","validateData",0x536d4b36,"haxe.ui.containers._ScrollView.VScrollPos.validateData","haxe/ui/containers/ScrollView.hx",351,0x01b76681)
namespace haxe{
namespace ui{
...
void VScrollPos_obj::__construct( ::haxe::ui::containers::ScrollView scrollview){
            	HX_STACKFRAME(&_hx_pos_2dd7f304f28a6472_338_new)
HXLINE( 339)		super::__construct(scrollview);
HXLINE( 340)		this->_scrollview = scrollview;
            	}
...
bool VScrollPos_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::haxe::ui::util::VariantType VScrollPos_obj::get(){
            	HX_STACKFRAME(&_hx_pos_2dd7f304f28a6472_343_get)
...
HXLINE( 345)		if (::hx::IsNull( vscroll )) {
HXLINE( 346)			return ::haxe::ui::util::_Variant::Variant_Impl__obj::fromInt(0);
            		}
HXLINE( 348)		return ::haxe::ui::util::_Variant::Variant_Impl__obj::fromFloat(vscroll->get_pos());
            	}


void VScrollPos_obj::validateData(){
            	HX_STACKFRAME(&_hx_pos_2dd7f304f28a6472_351_validateData)
HXLINE( 352)		 ::haxe::ui::components::VerticalScroll vscroll = this->_scrollview->findComponent(null(),::hx::ClassOf< ::haxe::ui::components::VerticalScroll >(),false,null()).StaticCast<  ::haxe::ui::components::VerticalScroll >();
HXLINE( 353)		if ((this->_scrollview->get_virtual() == true)) {
HXLINE( 354)			if (::hx::IsNull( vscroll )) {
HXLINE( 355)				vscroll = ::hx::TCast<  ::haxe::ui::containers::ScrollViewBuilder >::cast(this->_scrollview->_compositeBuilder)->createVScroll();
            			}
HXLINE( 357)			if (::hx::IsNotNull( vscroll )) {
HXLINE( 358)				vscroll->set_pos(( (Float)(::haxe::ui::util::_Variant::Variant_Impl__obj::toFloat(this->_value)) ));
            			}
            		}
            		else {
HXLINE( 361)			if (::hx::IsNotNull( vscroll )) {
HXLINE( 362)				vscroll->set_pos(( (Float)(::haxe::ui::util::_Variant::Variant_Impl__obj::toFloat(this->_value)) ));
            			}
            		}
            	}
