...
class HXCPP_CLASS_ATTRIBUTES ToolTipManager_obj : public ::hx::Object
{
	...
	public:
		...
		static  ::haxe::ui::geom::Rectangle calcRect;
		 ::haxe::ui::events::MouseEvent _lastMouseEvent;
		 ::haxe::ds::ObjectMap _toolTipOptions;
		::Array< ::Dynamic> _toolTipRegions;
		 ::Dynamic registerTooltipRegion( ::Dynamic options);
		::Dynamic registerTooltipRegion_dyn();

		void unregisterTooltipRegion( ::Dynamic options);
		::Dynamic unregisterTooltipRegion_dyn();
		...
		::Dynamic updateTooltipRenderer_dyn();
		 ...
		 ::Dynamic _currentRegion;
		void onScreenMouseMoveRegion( ::haxe::ui::events::MouseEvent event);
		::Dynamic onScreenMouseMoveRegion_dyn();
		...
		void showToolTipAt(Float left,Float top, ::Dynamic options);
		::Dynamic showToolTipAt_dyn();

		void showToolTipForComponent( ::haxe::ui::core::Component component);
		::Dynamic showToolTipForComponent_dyn();

		void showToolTipForRegion( ::Dynamic region);
		::Dynamic showToolTipForRegion_dyn();

		void positionToolTip( ::Dynamic left, ::Dynamic top);
