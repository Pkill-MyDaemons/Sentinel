...
HXLINE( 139)		if (!(button->hasEvent(::haxe::ui::events::MouseEvent_obj::CLICK,this->onInc_dyn()))) {
HXLINE( 140)			button->registerEvent(::haxe::ui::events::MouseEvent_obj::CLICK,this->onInc_dyn(),null());
            		}
...
HXLINE( 144)		if (!(button1->hasEvent(::haxe::ui::events::MouseEvent_obj::CLICK,this->onDeinc_dyn()))) {
HXLINE( 145)			button1->registerEvent(::haxe::ui::events::MouseEvent_obj::CLICK,this->onDeinc_dyn(),null());
            		}
            	}
...
HXLINE( 151)		button->unregisterEvent(::haxe::ui::events::MouseEvent_obj::CLICK,this->onInc_dyn());
...
HXLINE( 154)		button1->unregisterEvent(::haxe::ui::events::MouseEvent_obj::CLICK,this->onDeinc_dyn());
            	}
