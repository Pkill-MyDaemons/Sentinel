...
HXDLIN(  40)				return ::Std_obj::string(s7);
            			...
            			break;
            			case (int)8: {
HXLINE(  41)				 ::hx::widgets::Bitmap s8 = this1->_hx_getObject(0).StaticCast<  ::hx::widgets::Bitmap >();
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Variant_Impl__obj,get_isComponent,return )
 ...
 ::haxe::ui::util::VariantType Variant_Impl__obj::fromImageData( ::hx::widgets::Bitmap s){
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Variant_Impl__obj,fromImageData,return )
 ...
 ::hx::widgets::Bitmap Variant_Impl__obj::toImageData( ::haxe::ui::util::VariantType this1){
...
HXLINE( 230)			 ::hx::widgets::Bitmap s = this1->_hx_getObject(0).StaticCast<  ::hx::widgets::Bitmap >();
HXDLIN( 230)			return s;
            		}
            		else {
...
HXLINE( 238)			 ::hx::widgets::Bitmap _g = this1->_hx_getObject(0).StaticCast<  ::hx::widgets::Bitmap >();
...
HXLINE( 481)				unstringable2 = ::Std_obj::isOfType(r,::hx::ClassOf< ::hx::widgets::Bitmap >());
            			}
            			else {
...
HXLINE( 514)								if (::Std_obj::isOfType(r,::hx::ClassOf< ::hx::widgets::Bitmap >())) {
HXLINE( 515)									v = ::haxe::ui::util::_Variant::Variant_Impl__obj::fromImageData(::hx::TCast<  ::hx::widgets::Bitmap >::cast(r));
            								}
            								else {
HXLINE( 520)									v = r;
            								}
...
HXLINE( 529)			_hx_tmp2 = ::Std_obj::isOfType(s,::hx::ClassOf< ::hx::widgets::Bitmap >());
            		}
            		else {
...
HXDLIN( 557)					d = y7;
            				...
            				break;
            				case (int)8: {
HXLINE( 558)					 ::hx::widgets::Bitmap y8 = v->_hx_getObject(0).StaticCast<  ::hx::widgets::Bitmap >();
HXDLIN( 558)					d = y8;
            				}
            				break;
            			}
