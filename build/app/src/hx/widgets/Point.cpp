...
bool Point_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x390b3c15;
}
...
HXLINE(  30)			::hx::widgets::Point_obj::defaultPosition = ::cpp::Pointer_obj::fromRaw((new wxPoint(-1,-1)));
            		}
...
static ::hx::StorageInfo Point_obj_sMemberStorageInfo[] = {
	{::hx::fsInt,(int)offsetof(Point_obj,x),HX_("x",78,00,00,00)},
	{::hx::fsInt,(int)offsetof(Point_obj,y),HX_("y",79,00,00,00)},
	{ ::hx::fsUnknown, 0, null()}
};
static ::hx::StaticInfo Point_obj_sStaticStorageInfo[] = {
	{::hx::fsUnknown /* ::cpp::Pointer<  wxPoint > */ ,(void *) &Point_obj::defaultPosition,HX_("defaultPosition",8a,5e,08,f4)},
	{ ::hx::fsUnknown, 0, null()}
};
#endif
...
void Point_obj::__register()
{
	...
	__mClass->mName = HX_("hx.widgets.Point",d3,38,e5,65);
