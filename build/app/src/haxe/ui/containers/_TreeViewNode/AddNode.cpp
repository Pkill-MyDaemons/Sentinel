...
HXLINE( 159)		node->set_data(param);
HXLINE( 160)		this->_component->addComponent(node);
HXLINE( 161)		return ::haxe::ui::util::_Variant::Variant_Impl__obj::fromComponent(node);
            	}
