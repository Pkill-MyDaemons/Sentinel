...
bool SizerFlag_Impl__obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x52d06e31;
}
...
static ::hx::StaticInfo SizerFlag_Impl__obj_sStaticStorageInfo[] = {
	{::hx::fsInt,(void *) &SizerFlag_Impl__obj::NONE,HX_("NONE",b8,da,ca,33)},
	{ ::hx::fsUnknown, 0, null()}
};
#endif
...
{
	SizerFlag_Impl__obj _hx_dummy;
	SizerFlag_Impl__obj::_hx_vtable = *(void **)&_hx_dummy;
	::hx::Static(__mClass) = new ::hx::Class_obj();
	__mClass->mName = HX_("wx.widgets._SizerFlag.SizerFlag_Impl_",39,b3,44,24);
