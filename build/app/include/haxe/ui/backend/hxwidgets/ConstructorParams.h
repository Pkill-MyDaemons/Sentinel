...
class HXCPP_CLASS_ATTRIBUTES ConstructorParams_obj : public ::hx::Object
{
	...
	public:
		...
		inline static ::hx::ObjectPtr< ConstructorParams_obj > __new() {
			::hx::ObjectPtr< ConstructorParams_obj > __this = new ConstructorParams_obj();
			__this->__construct();
			return __this;
		}

		inline static ::hx::ObjectPtr< ConstructorParams_obj > __alloc(::hx::Ctx *_hx_ctx) {
		...
		::String __ToString() const { return HX_("ConstructorParams",c0,53,79,49); }
