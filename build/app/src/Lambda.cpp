...
HX_LOCAL_STACK_FRAME(_hx_pos_481ea690991ca6c5_125_exists,"Lambda","exists",0x65091043,"Lambda.exists","/opt/homebrew/lib/haxe/std/Lambda.hx",125,0x26e244ef)
HX_LOCAL_STACK_FRAME(_hx_pos_481ea690991ca6c5_255_find,"Lambda","find",0x9b838ae0,"Lambda.find","/opt/homebrew/lib/haxe/std/Lambda.hx",255,0x26e244ef)
...
bool Lambda_obj::exists( ::Dynamic it, ::Dynamic f){
            	HX_STACKFRAME(&_hx_pos_481ea690991ca6c5_125_exists)
HXLINE( 126)		{
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(Lambda_obj,exists,return )
 ...
 ::Dynamic Lambda_obj::find( ::Dynamic it, ::Dynamic f){
            	HX_STACKFRAME(&_hx_pos_481ea690991ca6c5_255_find)
HXLINE( 256)		{
