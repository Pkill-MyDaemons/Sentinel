...
HX_DEFINE_STACK_FRAME(_hx_pos_166ed83c9d65a965_9_new,"haxe.ui.backend.hxwidgets.handlers.ChoiceHandler","new",0xcba5b311,"haxe.ui.backend.hxwidgets.handlers.ChoiceHandler.new","haxe/ui/backend/hxwidgets/handlers/ChoiceHandler.hx",9,0xafddf15e)
HX_LOCAL_STACK_FRAME(_hx_pos_166ed83c9d65a965_11_link,"haxe.ui.backend.hxwidgets.handlers.ChoiceHandler","link",0x64079029,"haxe.ui.backend.hxwidgets.handlers.ChoiceHandler.link","haxe/ui/backend/hxwidgets/handlers/ChoiceHandler.hx",11,0xafddf15e)
HX_LOCAL_STACK_FRAME(_hx_pos_166ed83c9d65a965_15_unlink,"haxe.ui.backend.hxwidgets.handlers.ChoiceHandler","unlink",0x9a0e40c2,"haxe.ui.backend.hxwidgets.handlers.ChoiceHandler.unlink","haxe/ui/backend/hxwidgets/handlers/ChoiceHandler.hx",15,0xafddf15e)
HX_LOCAL_STACK_FRAME(_hx_pos_166ed83c9d65a965_18___onChangeEvent,"haxe.ui.backend.hxwidgets.handlers.ChoiceHandler","__onChangeEvent",0xafda6ebc,"haxe.ui.backend.hxwidgets.handlers.ChoiceHandler.__onChangeEvent","haxe/ui/backend/hxwidgets/handlers/ChoiceHandler.hx",18,0xafddf15e)
namespace haxe{
namespace ui{
namespace backend{
namespace hxwidgets{
...
void ChoiceHandler_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_166ed83c9d65a965_9_new)
...
void ChoiceHandler_obj::link(){
            	HX_STACKFRAME(&_hx_pos_166ed83c9d65a965_11_link)
HXDLIN(  11)		this->_component->get_window()->bind(::wx::widgets::EventType_obj::CHOICE,this->_hx___onChangeEvent_dyn(),null());
            	}


void ChoiceHandler_obj::unlink(){
            	HX_STACKFRAME(&_hx_pos_166ed83c9d65a965_15_unlink)
HXDLIN(  15)		this->_component->get_window()->unbind(::wx::widgets::EventType_obj::CHOICE,this->_hx___onChangeEvent_dyn(),null());
            	}


void ChoiceHandler_obj::_hx___onChangeEvent( ::hx::widgets::Event event){
            	HX_STACKFRAME(&_hx_pos_166ed83c9d65a965_18___onChangeEvent)
HXLINE(  19)		 ::hx::widgets::Choice choice = ::hx::TCast<  ::hx::widgets::Choice >::cast(this->_component->get_window());
HXLINE(  20)		 ::haxe::ui::components::DropDown dropdown = ::hx::TCast<  ::haxe::ui::components::DropDown >::cast(this->_component);
HXLINE(  21)		dropdown->set(HX_("hasSelection",92,dd,6c,1b),true);
HXLINE(  22)		dropdown->set_selectedIndex(choice->get_selection());
            	}
