...
HX_DEFINE_STACK_FRAME(_hx_pos_e5af7442d9de1b88_258_new,"haxe.ui.components._Slider.PosBehaviour","new",0x2201ee6f,"haxe.ui.components._Slider.PosBehaviour.new","haxe/ui/components/Slider.hx",258,0x55cb8456)
HX_LOCAL_STACK_FRAME(_hx_pos_e5af7442d9de1b88_268_set,"haxe.ui.components._Slider.PosBehaviour","set",0x2205b9b1,"haxe.ui.components._Slider.PosBehaviour.set","haxe/ui/components/Slider.hx",268,0x55cb8456)
HX_LOCAL_STACK_FRAME(_hx_pos_e5af7442d9de1b88_280_validateData,"haxe.ui.components._Slider.PosBehaviour","validateData",0xcd5e7df1,"haxe.ui.components._Slider.PosBehaviour.validateData","haxe/ui/components/Slider.hx",280,0x55cb8456)
namespace haxe{
namespace ui{
...
void PosBehaviour_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_e5af7442d9de1b88_258_new)
...
void PosBehaviour_obj::set( ::haxe::ui::util::VariantType value){
            	HX_STACKFRAME(&_hx_pos_e5af7442d9de1b88_268_set)
HXLINE( 269)		if ((this->_component->get_isReady() == false)) {
HXLINE( 270)			this->_value = value;
HXLINE( 271)			 ::haxe::ui::components::Slider _hx_tmp = ::hx::TCast<  ::haxe::ui::components::Slider >::cast(this->_component);
HXDLIN( 271)			_hx_tmp->set_end(( (Float)(::haxe::ui::util::_Variant::Variant_Impl__obj::toFloat(this->_value)) ));
HXLINE( 272)			this->invalidateData();
HXLINE( 273)			return;
            		}
HXLINE( 276)		this->super::set(value);
            	}


void PosBehaviour_obj::validateData(){
            	HX_STACKFRAME(&_hx_pos_e5af7442d9de1b88_280_validateData)
HXDLIN( 280)		 ::haxe::ui::components::Slider _hx_tmp = ::hx::TCast<  ::haxe::ui::components::Slider >::cast(this->_component);
HXDLIN( 280)		_hx_tmp->set_end(( (Float)(::haxe::ui::util::_Variant::Variant_Impl__obj::toFloat(this->_value)) ));
            	}
