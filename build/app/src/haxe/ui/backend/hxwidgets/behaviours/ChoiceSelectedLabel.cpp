...
HX_LOCAL_STACK_FRAME(_hx_pos_d60ace7699016b55_16_set,"haxe.ui.backend.hxwidgets.behaviours.ChoiceSelectedLabel","set",0x5aec274f,"haxe.ui.backend.hxwidgets.behaviours.ChoiceSelectedLabel.set","haxe/ui/backend/hxwidgets/behaviours/ChoiceSelectedLabel.hx",16,0xc6f980a2)
HX_LOCAL_STACK_FRAME(_hx_pos_d60ace7699016b55_24_update,"haxe.ui.backend.hxwidgets.behaviours.ChoiceSelectedLabel","update",0x53f3c47c,"haxe.ui.backend.hxwidgets.behaviours.ChoiceSelectedLabel.update","haxe/ui/backend/hxwidgets/behaviours/ChoiceSelectedLabel.hx",24,0xc6f980a2)
HX_LOCAL_STACK_FRAME(_hx_pos_d60ace7699016b55_29_validateData,"haxe.ui.backend.hxwidgets.behaviours.ChoiceSelectedLabel","validateData",0xaab86c93,"haxe.ui.backend.hxwidgets.behaviours.ChoiceSelectedLabel.validateData","haxe/ui/backend/hxwidgets/behaviours/ChoiceSelectedLabel.hx",29,0xc6f980a2)
namespace haxe{
namespace ui{
namespace backend{
namespace hxwidgets{
...
HXLINE(  10)			return this->_value;
            		}
HXLINE(  12)		 ::hx::widgets::Choice choice = ::hx::TCast<  ::hx::widgets::Choice >::cast(this->_component->get_window());
HXLINE(  13)		return ::haxe::ui::util::_Variant::Variant_Impl__obj::fromString(choice->get_selectedString());
            	}


void ChoiceSelectedLabel_obj::set( ::haxe::ui::util::VariantType value){
            	HX_STACKFRAME(&_hx_pos_d60ace7699016b55_16_set)
HXLINE(  17)		if (::hx::IsNull( this->_component->get_window() )) {
HXLINE(  18)			this->_value = value;
HXLINE(  19)			return;
            		}
HXLINE(  21)		this->super::set(value);
            	}


void ChoiceSelectedLabel_obj::update(){
            	HX_STACKFRAME(&_hx_pos_d60ace7699016b55_24_update)
HXLINE(  25)		this->super::update();
HXLINE(  26)		this->set(this->_value);
            	}


void ChoiceSelectedLabel_obj::validateData(){
            	HX_STACKFRAME(&_hx_pos_d60ace7699016b55_29_validateData)
HXLINE(  30)		this->super::validateData();
HXLINE(  31)		 ::hx::widgets::Choice choice = ::hx::TCast<  ::hx::widgets::Choice >::cast(this->_component->get_window());
HXLINE(  32)		choice->set_selectedString(::haxe::ui::util::_Variant::Variant_Impl__obj::toString(this->_value));
            	}
