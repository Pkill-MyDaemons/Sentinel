...
HX_LOCAL_STACK_FRAME(_hx_pos_3d6dc08a9819def0_19_postClone,"haxe.ui.backend.EventImpl","postClone",0xe4aa023d,"haxe.ui.backend.EventImpl.postClone","haxe/ui/backend/EventImpl.hx",19,0x6e4513d1)
namespace haxe{
namespace ui{
namespace backend{
...
HXLINE(  13)			this->_originalEvent->skip(false);
HXLINE(  14)			this->_originalEvent->stopPropagation();
            		}
            	}


void EventImpl_obj::postClone( ::haxe::ui::events::UIEvent event){
            	HX_STACKFRAME(&_hx_pos_3d6dc08a9819def0_19_postClone)
HXDLIN(  19)		event->_originalEvent = this->_originalEvent;
            	}
...
::hx::Val EventImpl_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 14:
		if (HX_FIELD_EQ(inName,"_originalEvent") ) { _originalEvent=inValue.Cast<  ::hx::widgets::Event >(); return inValue; }
	}
...
static ::hx::StorageInfo EventImpl_obj_sMemberStorageInfo[] = {
	{::hx::fsObject /*  ::hx::widgets::Event */ ,(int)offsetof(EventImpl_obj,_originalEvent),HX_("_originalEvent",4a,ae,07,0f)},
	{ ::hx::fsUnknown, 0, null()}
};
