...
HXLINE(  12)				::cpp::Pointer<  wxString > str = ::cpp::Pointer_obj::fromRaw((new wxString(value.utf8_str())));
...
HXLINE(  16)				::cpp::Pointer<  wxString > str1 = ::cpp::Pointer_obj::fromRaw((new wxString(HX_("",00,00,00,00).utf8_str())));
HXLINE(  17)				 wxComboBox * _hx_tmp5 = this->get_comboBoxRef()->ptr;
HXDLIN(  17)				 wxWindow* _hx_tmp6 = ::hx::widgets::Window_obj::toRaw(parent);
HXDLIN(  17)				 wxString & _hx_tmp7 = str1->get_ref();
HXDLIN(  17)				 wxPoint & _hx_tmp8 = ::hx::widgets::Point_obj::get_defaultPosition()->get_ref();
HXDLIN(  17)				 wxSize & _hx_tmp9 = ::hx::widgets::Size_obj::get_defaultSize()->get_ref();
HXDLIN(  17)				(*(_hx_tmp5)).Create(_hx_tmp6,id,_hx_tmp7,_hx_tmp8,_hx_tmp9,0,null(),style);
...
HXLINE(  29)		::cpp::Pointer<  wxString > s = ::cpp::Pointer_obj::fromRaw((new wxString(string.utf8_str())));
...
HXLINE(  39)		::cpp::Pointer<  wxString > s = ::cpp::Pointer_obj::fromRaw((new wxString(string.utf8_str())));
