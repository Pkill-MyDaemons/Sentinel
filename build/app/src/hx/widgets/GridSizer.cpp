...
{
	GridSizer_obj _hx_dummy;
	GridSizer_obj::_hx_vtable = *(void **)&_hx_dummy;
	::hx::Static(__mClass) = new ::hx::Class_obj();
	__mClass->mName = HX_("hx.widgets.GridSizer",ee,d5,81,31);
