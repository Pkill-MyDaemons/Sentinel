...
class HXCPP_CLASS_ATTRIBUTES DropDown_obj : public  ::haxe::ui::components::Button_obj
{
	...
	public:
		...
		void selectItemBy( ::Dynamic fn,::hx::Null< bool >  allowUnselection);
		::Dynamic selectItemBy_dyn();
		...
		::String get_dropdownHorizontalPosition();
		::Dynamic get_dropdownHorizontalPosition_dyn();

		::String set_dropdownHorizontalPosition(::String value);
		::Dynamic set_dropdownHorizontalPosition_dyn();

		::String get_dropdownVerticalPosition();
		::Dynamic get_dropdownVerticalPosition_dyn();

		::String set_dropdownVerticalPosition(::String value);
		::Dynamic set_dropdownVerticalPosition_dyn();
		...
		bool get_dropDownOpen();
		::Dynamic get_dropDownOpen_dyn();

		bool set_dropDownOpen(bool value);
		::Dynamic set_dropDownOpen_dyn();
