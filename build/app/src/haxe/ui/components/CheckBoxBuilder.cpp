...
HX_DEFINE_STACK_FRAME(_hx_pos_277687b33c7f0cbf_233_new,"haxe.ui.components.CheckBoxBuilder","new",0xa70b7344,"haxe.ui.components.CheckBoxBuilder.new","haxe/ui/components/CheckBox.hx",233,0xaeb3e5d4)
HX_LOCAL_STACK_FRAME(_hx_pos_277687b33c7f0cbf_240_create,"haxe.ui.components.CheckBoxBuilder","create",0x4cfdaa98,"haxe.ui.components.CheckBoxBuilder.create","haxe/ui/components/CheckBox.hx",240,0xaeb3e5d4)
...
HX_LOCAL_STACK_FRAME(_hx_pos_277687b33c7f0cbf_256_get_cssName,"haxe.ui.components.CheckBoxBuilder","get_cssName",0x59ea46a9,"haxe.ui.components.CheckBoxBuilder.get_cssName","haxe/ui/components/CheckBox.hx",256,0xaeb3e5d4)
namespace haxe{
namespace ui{
namespace components{

void CheckBoxBuilder_obj::__construct( ::haxe::ui::components::CheckBox checkbox){
            	HX_STACKFRAME(&_hx_pos_277687b33c7f0cbf_233_new)
HXLINE( 234)		super::__construct(checkbox);
HXLINE( 235)		this->_checkbox = checkbox;
HXLINE( 236)		this->_checkbox->set_allowFocus(false);
            	}
...
void CheckBoxBuilder_obj::create(){
            	HX_GC_STACKFRAME(&_hx_pos_277687b33c7f0cbf_240_create)
HXDLIN( 240)		if (::hx::IsNull( this->_checkbox->findComponent(null(),::hx::ClassOf< ::haxe::ui::components::CheckBoxValue >(),null(),null()).StaticCast<  ::haxe::ui::components::CheckBoxValue >() )) {
HXLINE( 241)			 ::haxe::ui::components::CheckBoxValue value =  ::haxe::ui::components::CheckBoxValue_obj::__alloc( HX_CTX );
HXLINE( 242)			value->set_id(((HX_("",00,00,00,00) + this->_checkbox->get_cssName()) + HX_("-value",24,bc,c7,2f)));
HXLINE( 243)			value->addClass(((HX_("",00,00,00,00) + this->_checkbox->get_cssName()) + HX_("-value",24,bc,c7,2f)),null(),null());
HXLINE( 244)			value->set_scriptAccess(false);
HXLINE( 245)			this->_checkbox->addComponent(value);
            		}
            	}
...
::String CheckBoxBuilder_obj::get_cssName(){
            	HX_STACKFRAME(&_hx_pos_277687b33c7f0cbf_256_get_cssName)
HXDLIN( 256)		return HX_("checkbox",43,d2,f5,ac);
            	}
