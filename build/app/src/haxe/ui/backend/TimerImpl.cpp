...
HX_DEFINE_STACK_FRAME(_hx_pos_886b5ec6758f91cf_23_new,"haxe.ui.backend.TimerImpl","new",0x5c2f026b,"haxe.ui.backend.TimerImpl.new","haxe/ui/backend/TimerImpl.hx",23,0xe2a33786)
HX_LOCAL_STACK_FRAME(_hx_pos_886b5ec6758f91cf_60_onTimer,"haxe.ui.backend.TimerImpl","onTimer",0xea37f1b1,"haxe.ui.backend.TimerImpl.onTimer","haxe/ui/backend/TimerImpl.hx",60,0xe2a33786)
HX_LOCAL_STACK_FRAME(_hx_pos_886b5ec6758f91cf_70_stop,"haxe.ui.backend.TimerImpl","stop",0x504c8797,"haxe.ui.backend.TimerImpl.stop","haxe/ui/backend/TimerImpl.hx",70,0xe2a33786)
HX_LOCAL_STACK_FRAME(_hx_pos_886b5ec6758f91cf_47_processDeferredTimers,"haxe.ui.backend.TimerImpl","processDeferredTimers",0xdf77ad27,"haxe.ui.backend.TimerImpl.processDeferredTimers","haxe/ui/backend/TimerImpl.hx",47,0xe2a33786)
HX_LOCAL_STACK_FRAME(_hx_pos_886b5ec6758f91cf_21_boot,"haxe.ui.backend.TimerImpl","boot",0x450c1bc7,"haxe.ui.backend.TimerImpl.boot","haxe/ui/backend/TimerImpl.hx",21,0xe2a33786)
namespace haxe{
namespace ui{
namespace backend{

void TimerImpl_obj::__construct(int delay, ::Dynamic callback){
            	HX_GC_STACKFRAME(&_hx_pos_886b5ec6758f91cf_23_new)
HXLINE(  24)		bool _hx_tmp;
HXDLIN(  24)		if (::hx::IsNotNull( ::haxe::ui::core::Screen_obj::get_instance()->get_options() )) {
HXLINE(  24)			_hx_tmp = ::hx::IsNull( ::haxe::ui::core::Screen_obj::get_instance()->get_options()->__Field(HX_("frame",2d,78,83,06),::hx::paccDynamic) );
            		}
            		else {
HXLINE(  24)			_hx_tmp = true;
            		}
HXDLIN(  24)		if (_hx_tmp) {
HXLINE(  27)			if (::hx::IsNull( ::haxe::ui::backend::TimerImpl_obj::_deferredTimers )) {
HXLINE(  28)				::haxe::ui::backend::TimerImpl_obj::_deferredTimers = ::Array_obj< ::Dynamic>::__new(0);
            			}
HXLINE(  30)			::haxe::ui::backend::TimerImpl_obj::_deferredTimers->push( ::Dynamic(::hx::Anon_obj::Create(2)
            				->setFixed(0,HX_("delay",83,d7,26,d7),delay)
            				->setFixed(1,HX_("callback",c5,99,06,7f),callback)));
HXLINE(  34)			return;
            		}
HXLINE(  37)		bool _hx_tmp1;
HXDLIN(  37)		if (!(::haxe::ui::backend::hxwidgets::Platform_obj::get_isWindows())) {
HXLINE(  37)			_hx_tmp1 = (delay == 0);
            		}
            		else {
...
HXLINE(  40)		 ::hx::widgets::Frame frame = ( ( ::hx::widgets::Frame)(::haxe::ui::core::Screen_obj::get_instance()->get_options()->__Field(HX_("frame",2d,78,83,06),::hx::paccDynamic)) );
HXLINE(  41)		this->_callback = callback;
HXLINE(  42)		frame->bind(::wx::widgets::EventType_obj::TIMER,this->onTimer_dyn(),null());
HXLINE(  43)		this->_timer =  ::hx::widgets::Timer_obj::__alloc( HX_CTX ,frame,delay,false,::haxe::ui::backend::TimerImpl_obj::_nextTimerId);
HXLINE(  44)		::haxe::ui::backend::TimerImpl_obj::_nextTimerId++;
            	}
...
void TimerImpl_obj::onTimer( ::hx::widgets::Event e){
            	HX_STACKFRAME(&_hx_pos_886b5ec6758f91cf_60_onTimer)
HXLINE(  61)		 ::hx::widgets::TimerEvent timerEvent = e->convertTo(::hx::ClassOf< ::hx::widgets::TimerEvent >()).StaticCast<  ::hx::widgets::TimerEvent >();
HXLINE(  62)		 ::hx::widgets::Timer timer = timerEvent->get_timer();
HXLINE(  63)		int _hx_tmp = timer->get_id();
HXDLIN(  63)		if ((_hx_tmp == this->_timer->get_id())) {
HXLINE(  64)			if (::hx::IsNotNull( this->_callback )) {
HXLINE(  65)				this->_callback();
            			}
            		}
            	}
...
void TimerImpl_obj::stop(){
            	HX_STACKFRAME(&_hx_pos_886b5ec6758f91cf_70_stop)
HXLINE(  71)		this->_callback = null();
HXLINE(  72)		 ::hx::widgets::Frame frame = ( ( ::hx::widgets::Frame)(::haxe::ui::core::Screen_obj::get_instance()->get_options()->__Field(HX_("frame",2d,78,83,06),::hx::paccDynamic)) );
HXLINE(  73)		frame->unbind(::wx::widgets::EventType_obj::TIMER,this->onTimer_dyn(),null());
HXLINE(  74)		if (::hx::IsNotNull( this->_timer )) {
HXLINE(  75)			this->_timer->stop();
HXLINE(  76)			this->_timer->destroy();
HXLINE(  77)			this->_timer = null();
            		}
            	}
...
int TimerImpl_obj::_nextTimerId;

void TimerImpl_obj::processDeferredTimers(){
            	HX_STACKFRAME(&_hx_pos_886b5ec6758f91cf_47_processDeferredTimers)
HXLINE(  48)		if (::hx::IsNull( ::haxe::ui::backend::TimerImpl_obj::_deferredTimers )) {
HXLINE(  49)			return;
            		}
HXLINE(  52)		{
HXLINE(  52)			int _g = 0;
HXDLIN(  52)			::Array< ::Dynamic> _g1 = ::haxe::ui::backend::TimerImpl_obj::_deferredTimers;
HXDLIN(  52)			while((_g < _g1->length)){
HXLINE(  52)				 ::Dynamic d = _g1->__get(_g);
HXDLIN(  52)				_g = (_g + 1);
HXLINE(  53)				::haxe::ui::util::Timer_obj::delay(d->__Field(HX_("callback",c5,99,06,7f),::hx::paccDynamic),( (int)(d->__Field(HX_("delay",83,d7,26,d7),::hx::paccDynamic)) ));
            			}
            		}
HXLINE(  56)		::haxe::ui::backend::TimerImpl_obj::_deferredTimers = ::Array_obj< ::Dynamic>::__new(0);
HXLINE(  57)		::haxe::ui::backend::TimerImpl_obj::_deferredTimers = null();
            	}
...
bool TimerImpl_obj::__GetStatic(const ::String &inName, Dynamic &outValue, ::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 12:
		if (HX_FIELD_EQ(inName,"_nextTimerId") ) { outValue = ( _nextTimerId ); return true; }
		break;
	case 15:
...
bool TimerImpl_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 12:
		if (HX_FIELD_EQ(inName,"_nextTimerId") ) { _nextTimerId=ioValue.Cast< int >(); return true; }
		break;
	case 15:
...
static ::hx::StaticInfo TimerImpl_obj_sStaticStorageInfo[] = {
	...
	{::hx::fsInt,(void *) &TimerImpl_obj::_nextTimerId,HX_("_nextTimerId",4e,60,4c,15)},
	{ ::hx::fsUnknown, 0, null()}
};
#endif
...
static void TimerImpl_obj_sMarkStatics(HX_MARK_PARAMS) {
	...
	HX_MARK_MEMBER_NAME(TimerImpl_obj::_nextTimerId,"_nextTimerId");
};
...
static void TimerImpl_obj_sVisitStatics(HX_VISIT_PARAMS) {
	...
	HX_VISIT_MEMBER_NAME(TimerImpl_obj::_nextTimerId,"_nextTimerId");
};
...
{
{
            	HX_STACKFRAME(&_hx_pos_886b5ec6758f91cf_21_boot)
HXDLIN(  21)		_nextTimerId = 1;
            	}
}
