...
HXLINE(  16)				attribList = ( (::cpp::Pointer< int >)(::cpp::Pointer_obj::arrayElem(options,0)) )->rawCast();
            			}
            			else {
...
bool GLCanvas_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x2045b63e) {
		if (inClassId<=(int)0x12ebd618) {
			return inClassId==(int)0x00000001 || inClassId==(int)0x12ebd618;
		} else {
...
HXLINE(  23)		 wxString str = wxString::FromUTF8(colour.utf8_str());
HXLINE(  24)		return this->get_canvasRef()->ptr->SetColour(str);
            	}
...
{
	outFields->push(HX_("canvasRef",5b,d3,ee,71));
	super::__GetFields(outFields);
};

#ifdef HXCPP_SCRIPTABLE
static ::hx::StorageInfo GLCanvas_obj_sMemberStorageInfo[] = {
	{::hx::fsUnknown /* ::cpp::Pointer<  wxGLCanvas > */ ,(int)offsetof(GLCanvas_obj,canvasRef),HX_("canvasRef",5b,d3,ee,71)},
	{ ::hx::fsUnknown, 0, null()}
};
...
static ::String GLCanvas_obj_sMemberFields[] = {
	HX_("setColour",8e,3d,2e,26),
	HX_("setCurrent",b7,c0,c2,1e),
	HX_("canvasRef",5b,d3,ee,71),
	HX_("get_canvasRef",32,a7,52,33),
	::String(null()) };
...
{
	GLCanvas_obj _hx_dummy;
	GLCanvas_obj::_hx_vtable = *(void **)&_hx_dummy;
	::hx::Static(__mClass) = new ::hx::Class_obj();
	__mClass->mName = HX_("hx.widgets.GLCanvas",1a,e4,0d,c3);
