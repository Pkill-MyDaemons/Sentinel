...
HXLINE( 223)			_hx_tmp1 = ::haxe::ui::util::_Variant::Variant_Impl__obj::get_isNull(this->_value);
            		}
            		else {
HXLINE( 223)			_hx_tmp1 = true;
            		}
HXDLIN( 223)		if (!(_hx_tmp1)) {
HXLINE( 223)			 ::haxe::ui::util::VariantType _hx_tmp2 = this->_value;
HXDLIN( 223)			_hx_tmp = ::haxe::ui::util::_Variant::Variant_Impl__obj::eq(_hx_tmp2,::haxe::ui::util::_Variant::Variant_Impl__obj::fromString(HX_("",00,00,00,00)));
            		}
            		else {
...
HXLINE( 229)			_hx_tmp3 = ::Std_obj::isOfType(::haxe::ui::util::_Variant::Variant_Impl__obj::toComponent(this->_value),::hx::ClassOf< ::haxe::ui::components::Canvas >());
            		}
            		else {
...
HXLINE( 240)				::String _hx_tmp5 = existingCanvas->get_id();
HXDLIN( 240)				_hx_tmp4 = (_hx_tmp5 == canvas->get_id());
            			}
            			else {
...
HXLINE( 256)				_hx_tmp6 = ::Std_obj::isOfType(::haxe::ui::util::_Variant::Variant_Impl__obj::toComponent(this->_value),::hx::ClassOf< ::haxe::ui::components::Image >());
            			}
            			else {
...
HXLINE( 268)						 ::haxe::ui::components::Image subImage = _gthis->_component->findComponent(null(),::hx::ClassOf< ::haxe::ui::components::Image >(),null(),null()).StaticCast<  ::haxe::ui::components::Image >();
HXLINE( 269)						if (::hx::IsNotNull( subImage )) {
HXLINE( 270)							_gthis->_component->removeComponent(subImage,false,false);
            						}
HXLINE( 273)						 ::haxe::ui::components::Image image = ::hx::TCast<  ::haxe::ui::components::Image >::cast(_gthis->_component);
HXLINE( 274)						if (::hx::IsNull( image )) {
HXLINE( 275)							return;
            						}
HXLINE( 277)						 ::haxe::ui::core::ImageDisplay display = image->getImageDisplay();
HXLINE( 278)						if (::hx::IsNotNull( display )) {
HXLINE( 279)							if (::hx::IsNotNull( imageInfo->__Field(HX_("loader",13,48,6f,58),::hx::paccDynamic) )) {
HXLINE( 280)								( ( ::haxe::ui::loaders::image::ImageLoaderBase)(imageInfo->__Field(HX_("loader",13,48,6f,58),::hx::paccDynamic)) )->postProcess(_gthis->_value,image);
HXLINE( 281)								imageInfo->__SetField(HX_("loader",13,48,6f,58),null(),::hx::paccDynamic);
            							}
HXLINE( 283)							display->set_imageInfo(imageInfo);
HXLINE( 284)							image->set_originalWidth(( (Float)(imageInfo->__Field(HX_("width",06,b6,62,ca),::hx::paccDynamic)) ));
HXLINE( 285)							image->set_originalHeight(( (Float)(imageInfo->__Field(HX_("height",e7,07,4c,02),::hx::paccDynamic)) ));
HXLINE( 286)							bool _hx_tmp1;
HXDLIN( 286)							if ((image->autoSize() == true)) {
HXLINE( 286)								_hx_tmp1 = ::hx::IsNotNull( image->get_parentComponent() );
            							}
            							else {
HXLINE( 286)								_hx_tmp1 = false;
            							}
HXDLIN( 286)							if (_hx_tmp1) {
HXLINE( 287)								 ::haxe::ui::core::Component _this = image->get_parentComponent();
HXDLIN( 287)								bool _hx_tmp2;
HXDLIN( 287)								if (::hx::IsNotNull( _this->_layout )) {
HXLINE( 287)									_hx_tmp2 = (_this->_layoutLocked == true);
            								}
            								else {
HXLINE( 287)									_hx_tmp2 = true;
            								}
HXDLIN( 287)								if (!(_hx_tmp2)) {
HXLINE( 287)									_this->invalidateComponent(HX_("layout",aa,ae,b8,58),false);
            								}
            							}
HXLINE( 289)							image->invalidateComponent(null(),null());
HXLINE( 290)							display->validateComponent();
HXLINE( 292)							 ::haxe::ui::events::UIEvent event =  ::haxe::ui::events::UIEvent_obj::__alloc( HX_CTX ,::haxe::ui::events::UIEvent_obj::CHANGE,null(),null());
HXLINE( 293)							image->dispatch(event,null());
            						}
            					}
            				}
