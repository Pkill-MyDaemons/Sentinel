...
HXLINE(  29)		::cpp::Pointer<  wxString > k = ::cpp::Pointer_obj::fromRaw((new wxString(key.utf8_str())));
HXLINE(  30)		::cpp::Pointer<  wxString > v = ::cpp::Pointer_obj::fromRaw((new wxString(value.utf8_str())));
HXLINE(  31)		{
...
HXLINE(  37)		::cpp::Pointer<  wxString > k = ::cpp::Pointer_obj::fromRaw((new wxString(key.utf8_str())));
