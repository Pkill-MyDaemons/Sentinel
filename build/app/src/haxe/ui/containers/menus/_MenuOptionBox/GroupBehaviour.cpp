...
HX_DEFINE_STACK_FRAME(_hx_pos_8171369b78303cea_25_new,"haxe.ui.containers.menus._MenuOptionBox.GroupBehaviour","new",0xe1234fe2,"haxe.ui.containers.menus._MenuOptionBox.GroupBehaviour.new","haxe/ui/containers/menus/MenuOptionBox.hx",25,0x896244ad)
HX_LOCAL_STACK_FRAME(_hx_pos_8171369b78303cea_26_validateData,"haxe.ui.containers.menus._MenuOptionBox.GroupBehaviour","validateData",0x3afcd61e,"haxe.ui.containers.menus._MenuOptionBox.GroupBehaviour.validateData","haxe/ui/containers/menus/MenuOptionBox.hx",26,0x896244ad)
namespace haxe{
namespace ui{
...
void GroupBehaviour_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_8171369b78303cea_25_new)
HXDLIN(  25)		super::__construct(component);
            	}
...
void GroupBehaviour_obj::validateData(){
            	HX_GC_STACKFRAME(&_hx_pos_8171369b78303cea_26_validateData)
HXLINE(  27)		 ::haxe::ui::components::OptionBox optionbox = this->_component->findComponent(null(),::hx::ClassOf< ::haxe::ui::components::OptionBox >(),false,null()).StaticCast<  ::haxe::ui::components::OptionBox >();
HXLINE(  28)		if (::hx::IsNull( optionbox )) {
HXLINE(  29)			optionbox =  ::haxe::ui::components::OptionBox_obj::__alloc( HX_CTX );
HXLINE(  30)			optionbox->set_styleNames(HX_("menuitem-optionbox",9b,0c,7d,bf));
HXLINE(  31)			optionbox->set_scriptAccess(false);
HXLINE(  32)			this->_component->addComponent(optionbox);
            		}
HXLINE(  35)		optionbox->set_componentGroup(::haxe::ui::util::_Variant::Variant_Impl__obj::toString(this->_value));
            	}
