...
bool ScrollBarStyle_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x694464d7;
}
...
static ::hx::StaticInfo ScrollBarStyle_obj_sStaticStorageInfo[] = {
	{::hx::fsInt,(void *) &ScrollBarStyle_obj::HORIZONTAL,HX_("HORIZONTAL",e4,70,cd,07)},
	{::hx::fsInt,(void *) &ScrollBarStyle_obj::VERTICAL,HX_("VERTICAL",76,4c,9b,c3)},
	{ ::hx::fsUnknown, 0, null()}
};
#endif
...
{
	ScrollBarStyle_obj _hx_dummy;
	ScrollBarStyle_obj::_hx_vtable = *(void **)&_hx_dummy;
	::hx::Static(__mClass) = new ::hx::Class_obj();
	__mClass->mName = HX_("wx.widgets.styles.ScrollBarStyle",eb,0d,2e,7e);
