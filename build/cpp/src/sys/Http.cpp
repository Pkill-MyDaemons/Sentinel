...
HX_DEFINE_STACK_FRAME(_hx_pos_5babc877d3eba983_50_new,"sys.Http","new",0xa5e0041b,"sys.Http.new","/opt/homebrew/lib/haxe/std/sys/Http.hx",50,0xecb74ecc)
HX_LOCAL_STACK_FRAME(_hx_pos_5babc877d3eba983_62_request,"sys.Http","request",0xbb950c8a,"sys.Http.request","/opt/homebrew/lib/haxe/std/sys/Http.hx",62,0xecb74ecc)
HX_LOCAL_STACK_FRAME(_hx_pos_5babc877d3eba983_58_request,"sys.Http","request",0xbb950c8a,"sys.Http.request","/opt/homebrew/lib/haxe/std/sys/Http.hx",58,0xecb74ecc)
static const bool _hx_array_data_00b75aa9_3[] = {
	0,
};
HX_LOCAL_STACK_FRAME(_hx_pos_5babc877d3eba983_92_customRequest,"sys.Http","customRequest",0xecf59319,"sys.Http.customRequest","/opt/homebrew/lib/haxe/std/sys/Http.hx",92,0xecb74ecc)
...
HX_LOCAL_STACK_FRAME(_hx_pos_5babc877d3eba983_211_customRequest,"sys.Http","customRequest",0xecf59319,"sys.Http.customRequest","/opt/homebrew/lib/haxe/std/sys/Http.hx",211,0xecb74ecc)
HX_LOCAL_STACK_FRAME(_hx_pos_5babc877d3eba983_274_writeBody,"sys.Http","writeBody",0xc731a11c,"sys.Http.writeBody","/opt/homebrew/lib/haxe/std/sys/Http.hx",274,0xecb74ecc)
HX_LOCAL_STACK_FRAME(_hx_pos_5babc877d3eba983_299_readHttpResponse,"sys.Http","readHttpResponse",0xd67be204,"sys.Http.readHttpResponse","/opt/homebrew/lib/haxe/std/sys/Http.hx",299,0xecb74ecc)
HX_LOCAL_STACK_FRAME(_hx_pos_5babc877d3eba983_461_readChunk,"sys.Http","readChunk",0x940c4532,"sys.Http.readChunk","/opt/homebrew/lib/haxe/std/sys/Http.hx",461,0xecb74ecc)
HX_LOCAL_STACK_FRAME(_hx_pos_5babc877d3eba983_48_boot,"sys.Http","boot",0x763c9417,"sys.Http.boot","/opt/homebrew/lib/haxe/std/sys/Http.hx",48,0xecb74ecc)
namespace sys{

void Http_obj::__construct(::String url){
            	HX_STACKFRAME(&_hx_pos_5babc877d3eba983_50_new)
...
void Http_obj::request( ::Dynamic post){
            		...
            		void _hx_run(::String e){
            			HX_GC_STACKFRAME(&_hx_pos_5babc877d3eba983_62_request)
...
HXLINE(  67)			_gthis->onError(e);
            	...
            	HX_GC_STACKFRAME(&_hx_pos_5babc877d3eba983_58_request)
...
void Http_obj::customRequest(bool post, ::haxe::io::Output api, ::sys::net::Socket sock,::String method){
            	HX_GC_STACKFRAME(&_hx_pos_5babc877d3eba983_92_customRequest)
...
HXLINE( 112)				HX_STACK_DO_THROW(HX_("Https is only supported with -lib hxssl",e9,c3,05,32));
            			}
            			else {
...
HXDLIN( 211)				if (!(multipart)) {
            					...
            					bool _hx_run( ::Dynamic h){
            						HX_GC_STACKFRAME(&_hx_pos_5babc877d3eba983_211_customRequest)
...
void Http_obj::writeBody( ::haxe::io::BytesOutput body, ::haxe::io::Input fileInput,int fileSize,::String boundary, ::sys::net::Socket sock){
            	HX_STACKFRAME(&_hx_pos_5babc877d3eba983_274_writeBody)
...
void Http_obj::readHttpResponse( ::haxe::io::Output api, ::sys::net::Socket sock){
            	HX_GC_STACKFRAME(&_hx_pos_5babc877d3eba983_299_readHttpResponse)
...
bool Http_obj::readChunk( ::EReg chunk_re, ::haxe::io::Output api, ::haxe::io::Bytes buf,int len){
            	HX_GC_STACKFRAME(&_hx_pos_5babc877d3eba983_461_readChunk)
...
{
{
            	HX_STACKFRAME(&_hx_pos_5babc877d3eba983_48_boot)
