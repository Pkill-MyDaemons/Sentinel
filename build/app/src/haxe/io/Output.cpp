...
HX_LOCAL_STACK_FRAME(_hx_pos_10f2a46803650432_121_writeFullBytes,"haxe.io.Output","writeFullBytes",0xc2c420ea,"haxe.io.Output.writeFullBytes","/opt/homebrew/lib/haxe/std/haxe/io/Output.hx",121,0x14788955)
HX_LOCAL_STACK_FRAME(_hx_pos_10f2a46803650432_246_prepare,"haxe.io.Output","prepare",0xcd01ec7a,"haxe.io.Output.prepare","/opt/homebrew/lib/haxe/std/haxe/io/Output.hx",246,0x14788955)
HX_LOCAL_STACK_FRAME(_hx_pos_10f2a46803650432_278_writeString,"haxe.io.Output","writeString",0x97e1cb83,"haxe.io.Output.writeString","/opt/homebrew/lib/haxe/std/haxe/io/Output.hx",278,0x14788955)
namespace haxe{
namespace io{
...
void Output_obj::writeFullBytes( ::haxe::io::Bytes s,int pos,int len){
            	HX_STACKFRAME(&_hx_pos_10f2a46803650432_121_writeFullBytes)
...
void Output_obj::prepare(int nbytes){
            	HX_STACKFRAME(&_hx_pos_10f2a46803650432_246_prepare)
            	}
...
void Output_obj::writeString(::String s, ::haxe::io::Encoding encoding){
            	HX_STACKFRAME(&_hx_pos_10f2a46803650432_278_writeString)
