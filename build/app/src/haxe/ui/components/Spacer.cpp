...
HX_LOCAL_STACK_FRAME(_hx_pos_f5a54bb0734e13eb_551_registerBehaviours,"haxe.ui.components.Spacer","registerBehaviours",0xc78b40b5,"haxe.ui.components.Spacer.registerBehaviours","haxe/ui/macros/Macros.hx",551,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_8b59af7b867b8ccb_700_cloneComponent,"haxe.ui.components.Spacer","cloneComponent",0x2d4de47c,"haxe.ui.components.Spacer.cloneComponent","haxe/ui/macros/helpers/ClassBuilder.hx",700,0x8cdaad7b)
HX_LOCAL_STACK_FRAME(_hx_pos_f5a54bb0734e13eb_521_self,"haxe.ui.components.Spacer","self",0x9b5a9b68,"haxe.ui.components.Spacer.self","haxe/ui/macros/Macros.hx",521,0x27866361)
namespace haxe{
namespace ui{
...
void Spacer_obj::registerBehaviours(){
            	HX_STACKFRAME(&_hx_pos_f5a54bb0734e13eb_551_registerBehaviours)
HXDLIN( 551)		this->super::registerBehaviours();
            	}


 ::haxe::ui::backend::ComponentBase Spacer_obj::cloneComponent(){
            	HX_STACKFRAME(&_hx_pos_8b59af7b867b8ccb_700_cloneComponent)
HXLINE( 469)		 ::haxe::ui::components::Spacer c = ( ( ::haxe::ui::components::Spacer)(this->super::cloneComponent()) );
HXLINE( 484)		{
...
HXLINE( 493)		return c;
 ...
 ::haxe::ui::backend::ComponentBase Spacer_obj::self(){
            	HX_GC_STACKFRAME(&_hx_pos_f5a54bb0734e13eb_521_self)
HXDLIN( 521)		return  ::haxe::ui::components::Spacer_obj::__alloc( HX_CTX );
            	}
