...
class HXCPP_CLASS_ATTRIBUTES Slider_obj : public  ::hx::widgets::Control_obj
{
	...
	public:
		...
		int get_tickFreq();
		::Dynamic get_tickFreq_dyn();

		int set_tickFreq(int value);
		::Dynamic set_tickFreq_dyn();

		int get_lineSize();
		::Dynamic get_lineSize_dyn();

		int set_lineSize(int value);
		::Dynamic set_lineSize_dyn();

		int get_pageSize();
		::Dynamic get_pageSize_dyn();

		int set_pageSize(int value);
		::Dynamic set_pageSize_dyn();

		int get_thumbLength();
		::Dynamic get_thumbLength_dyn();

		int set_thumbLength(int value);
		::Dynamic set_thumbLength_dyn();

		int setTick(int value);
		::Dynamic setTick_dyn();
