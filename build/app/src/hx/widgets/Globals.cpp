...
HX_LOCAL_STACK_FRAME(_hx_pos_2cf361316a3bbd0c_56_yield,"hx.widgets.Globals","yield",0x44a9dc92,"hx.widgets.Globals.yield","hx/widgets/Globals.hx",56,0x06c8ab2d)
namespace hx{
namespace widgets{
...
HXLINE(  17)		::cpp::Pointer<  wxString > s = ::cpp::Pointer_obj::fromRaw((new wxString(command.utf8_str())));
...
bool Globals_obj::yield(){
            	HX_STACKFRAME(&_hx_pos_2cf361316a3bbd0c_56_yield)
HXDLIN(  56)		return ::wxYield();
            	}
