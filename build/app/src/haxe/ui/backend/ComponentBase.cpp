...
HX_LOCAL_STACK_FRAME(_hx_pos_99836deeea93cd49_997_set_width,"haxe.ui.backend.ComponentBase","set_width",0x7105581d,"haxe.ui.backend.ComponentBase.set_width","haxe/ui/backend/ComponentBase.hx",997,0xb60bbb7d)
HX_LOCAL_STACK_FRAME(_hx_pos_99836deeea93cd49_1006_get_width,"haxe.ui.backend.ComponentBase","get_width",0x8db46c11,"haxe.ui.backend.ComponentBase.get_width","haxe/ui/backend/ComponentBase.hx",1006,0xb60bbb7d)
HX_LOCAL_STACK_FRAME(_hx_pos_99836deeea93cd49_1017_set_height,"haxe.ui.backend.ComponentBase","set_height",0x29f739f0,"haxe.ui.backend.ComponentBase.set_height","haxe/ui/backend/ComponentBase.hx",1017,0xb60bbb7d)
HX_LOCAL_STACK_FRAME(_hx_pos_99836deeea93cd49_1026_get_height,"haxe.ui.backend.ComponentBase","get_height",0x26799b7c,"haxe.ui.backend.ComponentBase.get_height","haxe/ui/backend/ComponentBase.hx",1026,0xb60bbb7d)
...
HX_DEFINE_DYNAMIC_FUNC0(ComponentBase_obj,restorePercentSizes,(void))
 ...
 ::Dynamic ComponentBase_obj::set_width( ::Dynamic value){
            	HX_STACKFRAME(&_hx_pos_99836deeea93cd49_997_set_width)
HXLINE( 998)		if (::hx::IsEq( this->_width,value )) {
HXLINE( 999)			return value;
            		}
HXLINE(1001)		this->_width = value;
HXLINE(1002)		this->set_componentWidth(value);
HXLINE(1003)		return value;
            	}


HX_DEFINE_DYNAMIC_FUNC1(ComponentBase_obj,set_width,return )

 ::Dynamic ComponentBase_obj::get_width(){
            	HX_STACKFRAME(&_hx_pos_99836deeea93cd49_1006_get_width)
HXLINE(1007)		Float f = ( (Float)(this->get_componentWidth()) );
HXLINE(1008)		return f;
            	}


HX_DEFINE_DYNAMIC_FUNC0(ComponentBase_obj,get_width,return )

 ::Dynamic ComponentBase_obj::set_height( ::Dynamic value){
            	HX_STACKFRAME(&_hx_pos_99836deeea93cd49_1017_set_height)
HXLINE(1018)		if (::hx::IsEq( this->_height,value )) {
HXLINE(1019)			return value;
            		}
HXLINE(1021)		this->_height = value;
HXLINE(1022)		this->set_componentHeight(value);
HXLINE(1023)		return value;
            	}


HX_DEFINE_DYNAMIC_FUNC1(ComponentBase_obj,set_height,return )

 ::Dynamic ComponentBase_obj::get_height(){
            	HX_STACKFRAME(&_hx_pos_99836deeea93cd49_1026_get_height)
HXLINE(1027)		Float f = ( (Float)(this->get_componentHeight()) );
HXLINE(1028)		return f;
            	}


HX_DEFINE_DYNAMIC_FUNC0(ComponentBase_obj,get_height,return )
...
HXDLIN(1095)			if (!(::hx::IsLessEq( this->get_width(),0 ))) {
HXLINE(1095)				_hx_tmp1 = ::hx::IsLessEq( this->get_height(),0 );
            			}
            			else {
...
HXDLIN(1240)		 ::Dynamic _hx_tmp1 = this->get_width();
...
HXDLIN(1286)		if (::hx::IsEq( this->get_width(),0 )) {
HXLINE(1286)			_hx_tmp = ::hx::IsEq( this->get_height(),0 );
            		}
            		else {
...
HXLINE(1291)		Float w = ( (Float)(this->get_width()) );
HXLINE(1292)		Float h = ( (Float)(this->get_height()) );
