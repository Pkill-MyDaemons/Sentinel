...
HX_LOCAL_STACK_FRAME(_hx_pos_b6a660bd5bf0b597_23_setIcon,"hx.widgets.TaskBarIcon","setIcon",0x63d4a2b7,"hx.widgets.TaskBarIcon.setIcon","hx/widgets/TaskBarIcon.hx",23,0xd5fb5a96)
HX_LOCAL_STACK_FRAME(_hx_pos_b6a660bd5bf0b597_32_removeIcon,"hx.widgets.TaskBarIcon","removeIcon",0xe0535ce1,"hx.widgets.TaskBarIcon.removeIcon","hx/widgets/TaskBarIcon.hx",32,0xd5fb5a96)
HX_LOCAL_STACK_FRAME(_hx_pos_b6a660bd5bf0b597_37_get_isIconInstalled,"hx.widgets.TaskBarIcon","get_isIconInstalled",0xac4208ca,"hx.widgets.TaskBarIcon.get_isIconInstalled","hx/widgets/TaskBarIcon.hx",37,0xd5fb5a96)
HX_LOCAL_STACK_FRAME(_hx_pos_b6a660bd5bf0b597_44_setBitmap,"hx.widgets.TaskBarIcon","setBitmap",0x278196ad,"hx.widgets.TaskBarIcon.setBitmap","hx/widgets/TaskBarIcon.hx",44,0xd5fb5a96)
HX_LOCAL_STACK_FRAME(_hx_pos_b6a660bd5bf0b597_62_get_taskBarIconRef,"hx.widgets.TaskBarIcon","get_taskBarIconRef",0x3806ad39,"hx.widgets.TaskBarIcon.get_taskBarIconRef","hx/widgets/TaskBarIcon.hx",62,0xd5fb5a96)
namespace hx{
namespace widgets{
...
void TaskBarIcon_obj::setIcon( ::hx::widgets::BitmapBundle icon,::String tooltip){
            	HX_STACKFRAME(&_hx_pos_b6a660bd5bf0b597_23_setIcon)
HXDLIN(  23)		 wxTaskBarIcon * _hx_tmp = this->get_taskBarIconRef()->ptr;
HXDLIN(  23)		 wxBitmapBundle & _hx_tmp1 = icon->get_bitmapBundleRef()->get_ref();
HXDLIN(  23)		 wxString _hx_tmp2 = wxString::FromUTF8(tooltip.utf8_str());
HXDLIN(  23)		(*(_hx_tmp)).SetIcon(_hx_tmp1,_hx_tmp2);
            	}


HX_DEFINE_DYNAMIC_FUNC2(TaskBarIcon_obj,setIcon,(void))

void TaskBarIcon_obj::removeIcon(){
            	HX_STACKFRAME(&_hx_pos_b6a660bd5bf0b597_32_removeIcon)
HXDLIN(  32)		this->get_taskBarIconRef()->ptr->RemoveIcon();
            	}


HX_DEFINE_DYNAMIC_FUNC0(TaskBarIcon_obj,removeIcon,(void))

bool TaskBarIcon_obj::get_isIconInstalled(){
            	HX_STACKFRAME(&_hx_pos_b6a660bd5bf0b597_37_get_isIconInstalled)
HXDLIN(  37)		return this->get_taskBarIconRef()->ptr->IsIconInstalled();
            	}
...
void TaskBarIcon_obj::setBitmap( ::hx::widgets::Bitmap bitmap,::String tooltip){
            	HX_GC_STACKFRAME(&_hx_pos_b6a660bd5bf0b597_44_setBitmap)
HXLINE(  45)		 ::hx::widgets::BitmapBundle bitmapBundle =  ::hx::widgets::BitmapBundle_obj::__alloc( HX_CTX ,bitmap);
HXLINE(  46)		 wxTaskBarIcon * _hx_tmp = this->get_taskBarIconRef()->ptr;
HXDLIN(  46)		 wxBitmapBundle & _hx_tmp1 = bitmapBundle->get_bitmapBundleRef()->get_ref();
HXDLIN(  46)		 wxString _hx_tmp2 = wxString::FromUTF8(tooltip.utf8_str());
HXDLIN(  46)		(*(_hx_tmp)).SetIcon(_hx_tmp1,_hx_tmp2);
            	}
...
::cpp::Pointer<  wxTaskBarIcon > TaskBarIcon_obj::get_taskBarIconRef(){
            	HX_STACKFRAME(&_hx_pos_b6a660bd5bf0b597_62_get_taskBarIconRef)
