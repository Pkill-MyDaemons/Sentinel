...
class HXCPP_CLASS_ATTRIBUTES MouseState_obj {
	public:
		...
		static inline int GetX( ::Dynamic _hx_) {
			...
			#endif
			#endif
			return (_hx_.mPtr->*( ::hx::interface_cast< ::wx::widgets::MouseState_obj *>(_hx_.mPtr->_hx_getInterface(0x43356aba)))->_hx_GetX)();
		}
		...
		static inline int GetY( ::Dynamic _hx_) {
			...
			#endif
			#endif
			return (_hx_.mPtr->*( ::hx::interface_cast< ::wx::widgets::MouseState_obj *>(_hx_.mPtr->_hx_getInterface(0x43356aba)))->_hx_GetY)();
		}
};
