...
HXLINE(1326)			 ::Dynamic vcw = horizontalConstraint->get_width();
...
HXLINE(1354)			 ::Dynamic vch = verticalConstraint->get_height();
...
HXLINE(1389)		 ::Dynamic vcw = horizontalConstraint->get_width();
...
HXLINE(1430)		 ::Dynamic vch = verticalConstraint->get_height();
...
HXLINE(1486)		if (::hx::IsGreater( clipCX,this->_contents->get_width() )) {
HXLINE(1487)			 ::Dynamic clipCX1 = this->_contents->get_width();
...
HXLINE(1490)		if (::hx::IsGreater( clipCY,this->_contents->get_height() )) {
HXLINE(1491)			 ::Dynamic clipCY1 = this->_contents->get_height();
