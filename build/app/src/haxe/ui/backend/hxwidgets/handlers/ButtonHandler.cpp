...
HXLINE(  34)		 ::haxe::ui::events::MouseEvent clickEvent =  ::haxe::ui::events::MouseEvent_obj::__alloc( HX_CTX ,::haxe::ui::events::MouseEvent_obj::CLICK);
HXLINE(  35)		this->_component->dispatch(clickEvent,null());
            	}
