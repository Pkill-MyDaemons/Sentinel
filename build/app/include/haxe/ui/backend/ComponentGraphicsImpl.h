...
class HXCPP_CLASS_ATTRIBUTES ComponentGraphicsImpl_obj : public  ::haxe::ui::backend::ComponentGraphicsBase_obj
{
	...
	public:
		...
		void __construct( ::haxe::ui::core::Component c);
		...
		static ::hx::ObjectPtr< ComponentGraphicsImpl_obj > __new( ::haxe::ui::core::Component c);
		static ::hx::ObjectPtr< ComponentGraphicsImpl_obj > __alloc(::hx::Ctx *_hx_ctx, ::haxe::ui::core::Component c);
		...
		void addDrawCommand( ::haxe::ui::graphics::DrawCommand command);
		 ...
		 ::haxe::io::Bytes _currentPixels;
		 ::hx::widgets::Image _currentImage;
		 ::hx::widgets::Pen _currentPen;
		int _currentPenColor;
		int _currentPenThickness;
		void onWindowPaint( ::Dynamic e);
		::Dynamic onWindowPaint_dyn();
