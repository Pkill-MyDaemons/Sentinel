...
bool MouseEvent_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x353ae9d0) {
		return inClassId==(int)0x00000001 || inClassId==(int)0x353ae9d0;
	} else {
...
void MouseEvent_obj::__GetFields(Array< ::String> &outFields)
{
	...
	outFields->push(HX_("mouseEventRef",9e,54,d7,4f));
...
static ::hx::StorageInfo MouseEvent_obj_sMemberStorageInfo[] = {
	...
	{::hx::fsUnknown /* ::cpp::Pointer<  wxMouseEvent > */ ,(int)offsetof(MouseEvent_obj,mouseEventRef),HX_("mouseEventRef",9e,54,d7,4f)},
	{ ::hx::fsUnknown, 0, null()}
};
...
static ::String MouseEvent_obj_sMemberFields[] = {
	...
	HX_("mouseEventRef",9e,54,d7,4f),
	HX_("get_mouseEventRef",f5,5f,47,56),
	::String(null()) };
...
void MouseEvent_obj::__register()
{
	...
	__mClass->mName = HX_("hx.widgets.MouseEvent",52,fc,7d,bc);
