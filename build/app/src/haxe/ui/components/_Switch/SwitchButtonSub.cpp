...
HX_DEFINE_STACK_FRAME(_hx_pos_51aa2c71bbb629f6_118_new,"haxe.ui.components._Switch.SwitchButtonSub","new",0xc39f8ceb,"haxe.ui.components._Switch.SwitchButtonSub.new","haxe/ui/components/Switch.hx",118,0x0342e663)
HX_LOCAL_STACK_FRAME(_hx_pos_51aa2c71bbb629f6_122_createChildren,"haxe.ui.components._Switch.SwitchButtonSub","createChildren",0x44aae1b0,"haxe.ui.components._Switch.SwitchButtonSub.createChildren","haxe/ui/components/Switch.hx",122,0x0342e663)
HX_LOCAL_STACK_FRAME(_hx_pos_51aa2c71bbb629f6_142_createChildren,"haxe.ui.components._Switch.SwitchButtonSub","createChildren",0x44aae1b0,"haxe.ui.components._Switch.SwitchButtonSub.createChildren","haxe/ui/components/Switch.hx",142,0x0342e663)
HX_LOCAL_STACK_FRAME(_hx_pos_51aa2c71bbb629f6_153_get_selected,"haxe.ui.components._Switch.SwitchButtonSub","get_selected",0x7a52b879,"haxe.ui.components._Switch.SwitchButtonSub.get_selected","haxe/ui/components/Switch.hx",153,0x0342e663)
HX_LOCAL_STACK_FRAME(_hx_pos_51aa2c71bbb629f6_155_set_selected,"haxe.ui.components._Switch.SwitchButtonSub","set_selected",0x8f4bdbed,"haxe.ui.components._Switch.SwitchButtonSub.set_selected","haxe/ui/components/Switch.hx",155,0x0342e663)
HX_LOCAL_STACK_FRAME(_hx_pos_51aa2c71bbb629f6_185_get_selectedText,"haxe.ui.components._Switch.SwitchButtonSub","get_selectedText",0xa95de1c6,"haxe.ui.components._Switch.SwitchButtonSub.get_selectedText","haxe/ui/components/Switch.hx",185,0x0342e663)
HX_LOCAL_STACK_FRAME(_hx_pos_51aa2c71bbb629f6_187_set_selectedText,"haxe.ui.components._Switch.SwitchButtonSub","set_selectedText",0xff9fcf3a,"haxe.ui.components._Switch.SwitchButtonSub.set_selectedText","haxe/ui/components/Switch.hx",187,0x0342e663)
HX_LOCAL_STACK_FRAME(_hx_pos_51aa2c71bbb629f6_198_get_unselectedText,"haxe.ui.components._Switch.SwitchButtonSub","get_unselectedText",0x9988ed1f,"haxe.ui.components._Switch.SwitchButtonSub.get_unselectedText","haxe/ui/components/Switch.hx",198,0x0342e663)
HX_LOCAL_STACK_FRAME(_hx_pos_51aa2c71bbb629f6_200_set_unselectedText,"haxe.ui.components._Switch.SwitchButtonSub","set_unselectedText",0x76381f93,"haxe.ui.components._Switch.SwitchButtonSub.set_unselectedText","haxe/ui/components/Switch.hx",200,0x0342e663)
HX_LOCAL_STACK_FRAME(_hx_pos_51aa2c71bbb629f6_211_get_pos,"haxe.ui.components._Switch.SwitchButtonSub","get_pos",0x49568436,"haxe.ui.components._Switch.SwitchButtonSub.get_pos","haxe/ui/components/Switch.hx",211,0x0342e663)
HX_LOCAL_STACK_FRAME(_hx_pos_51aa2c71bbb629f6_213_set_pos,"haxe.ui.components._Switch.SwitchButtonSub","set_pos",0x3c581542,"haxe.ui.components._Switch.SwitchButtonSub.set_pos","haxe/ui/components/Switch.hx",213,0x0342e663)
HX_LOCAL_STACK_FRAME(_hx_pos_b1c112e181ae1c65_551_registerBehaviours,"haxe.ui.components._Switch.SwitchButtonSub","registerBehaviours",0x62d5bfae,"haxe.ui.components._Switch.SwitchButtonSub.registerBehaviours","haxe/ui/macros/Macros.hx",551,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_508e58cc2a7fb5a3_700_cloneComponent,"haxe.ui.components._Switch.SwitchButtonSub","cloneComponent",0xa85d32f5,"haxe.ui.components._Switch.SwitchButtonSub.cloneComponent","haxe/ui/macros/helpers/ClassBuilder.hx",700,0x8cdaad7b)
HX_LOCAL_STACK_FRAME(_hx_pos_b1c112e181ae1c65_521_self,"haxe.ui.components._Switch.SwitchButtonSub","self",0x6b49c8a1,"haxe.ui.components._Switch.SwitchButtonSub.self","haxe/ui/macros/Macros.hx",521,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_b1c112e181ae1c65_204_registerComposite,"haxe.ui.components._Switch.SwitchButtonSub","registerComposite",0x7cfc5eef,"haxe.ui.components._Switch.SwitchButtonSub.registerComposite","haxe/ui/macros/Macros.hx",204,0x27866361)
namespace haxe{
namespace ui{
...
void SwitchButtonSub_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_51aa2c71bbb629f6_118_new)
HXLINE( 208)		this->_pos = ((Float)0);
HXLINE( 195)		this->_unselectedText = HX_("",00,00,00,00);
HXLINE( 182)		this->_selectedText = HX_("",00,00,00,00);
HXLINE( 150)		this->_selected = false;
	...
	if (inClassId<=(int)0x13d76ae7) {
		if (inClassId<=(int)0x0f2dd418) {
			if (inClassId<=(int)0x01c1cdbf) {
				return inClassId==(int)0x00000001 || inClassId==(int)0x01c1cdbf;
			} else {
...
void SwitchButtonSub_obj::createChildren(){
            	HX_GC_STACKFRAME(&_hx_pos_51aa2c71bbb629f6_122_createChildren)
HXDLIN( 122)		 ::haxe::ui::components::_Switch::SwitchButtonSub _gthis = ::hx::ObjectPtr<OBJ_>(this);
HXLINE( 123)		this->super::createChildren();
HXLINE( 125)		if (::hx::IsNull( this->_button )) {
            			...
            			void _hx_run( ::haxe::ui::events::MouseEvent e){
            				HX_GC_STACKFRAME(&_hx_pos_51aa2c71bbb629f6_142_createChildren)
HXLINE( 142)				 ::haxe::ui::components::_Switch::SwitchButtonSub _gthis1 = _gthis;
HXDLIN( 142)				_gthis1->set_selected(!(_gthis->get_selected()));
            			}
            			HX_END_LOCAL_FUNC1((void))

HXLINE( 126)			 ::haxe::ui::core::Component component =  ::haxe::ui::core::Component_obj::__alloc( HX_CTX );
HXLINE( 127)			component->addClass(HX_("switch-button-sub-extra",21,e5,65,ac),null(),null());
HXLINE( 128)			this->addComponent(component);
HXLINE( 130)			this->_label =  ::haxe::ui::components::Label_obj::__alloc( HX_CTX );
HXLINE( 131)			this->_label->set_id(HX_("switch-label",9b,83,49,55));
HXLINE( 132)			this->_label->addClass(HX_("switch-label",9b,83,49,55),null(),null());
HXLINE( 133)			this->_label->set_text(this->_unselectedText);
HXLINE( 134)			this->addComponent(this->_label);
HXLINE( 136)			this->_button =  ::haxe::ui::components::Button_obj::__alloc( HX_CTX );
HXLINE( 137)			this->_button->set_id(HX_("switch-button",6b,de,6c,db));
HXLINE( 138)			this->_button->addClass(HX_("switch-button",6b,de,6c,db),null(),null());
HXLINE( 139)			this->addComponent(this->_button);
HXLINE( 141)			this->set_onClick( ::Dynamic(new _hx_Closure_0(_gthis)));
            		}
            	}


bool SwitchButtonSub_obj::get_selected(){
            	HX_STACKFRAME(&_hx_pos_51aa2c71bbb629f6_153_get_selected)
HXDLIN( 153)		return this->_selected;
            	}
...
bool SwitchButtonSub_obj::set_selected(bool value){
            	HX_GC_STACKFRAME(&_hx_pos_51aa2c71bbb629f6_155_set_selected)
HXLINE( 156)		if ((value == this->_selected)) {
HXLINE( 157)			return value;
            		}
HXLINE( 160)		this->invalidateComponent(HX_("data",2a,56,63,42),false);
HXLINE( 161)		{
HXLINE( 161)			bool _hx_tmp;
HXDLIN( 161)			if (::hx::IsNotNull( this->_layout )) {
HXLINE( 161)				_hx_tmp = (this->_layoutLocked == true);
            			}
            			else {
HXLINE( 161)				_hx_tmp = true;
            			}
HXDLIN( 161)			if (!(_hx_tmp)) {
HXLINE( 161)				this->invalidateComponent(HX_("layout",aa,ae,b8,58),false);
            			}
            		}
HXLINE( 162)		this->_selected = value;
HXLINE( 164)		if ((this->_selected == false)) {
HXLINE( 165)			this->_label->set_text(this->_unselectedText);
HXLINE( 166)			this->_label->removeClass(HX_(":selected",95,f4,1e,7c),null(),null());
HXLINE( 167)			this->removeClass(HX_(":selected",95,f4,1e,7c),true,true);
HXLINE( 168)			this->addClass(HX_(":unselected",6e,5e,95,69),true,true);
            		}
            		else {
HXLINE( 170)			this->_label->set_text(this->_selectedText);
HXLINE( 171)			this->_label->addClass(HX_(":selected",95,f4,1e,7c),null(),null());
HXLINE( 172)			this->removeClass(HX_(":unselected",6e,5e,95,69),true,true);
HXLINE( 173)			this->addClass(HX_(":selected",95,f4,1e,7c),true,true);
            		}
HXLINE( 176)		 ::haxe::ui::events::UIEvent event =  ::haxe::ui::events::UIEvent_obj::__alloc( HX_CTX ,::haxe::ui::events::UIEvent_obj::CHANGE,null(),null());
HXLINE( 177)		this->dispatch(event,null());
...
::String SwitchButtonSub_obj::get_selectedText(){
            	HX_STACKFRAME(&_hx_pos_51aa2c71bbb629f6_185_get_selectedText)
HXDLIN( 185)		return this->_selectedText;
            	}
...
::String SwitchButtonSub_obj::set_selectedText(::String value){
            	HX_STACKFRAME(&_hx_pos_51aa2c71bbb629f6_187_set_selectedText)
HXLINE( 188)		this->_selectedText = value;
HXLINE( 189)		bool _hx_tmp;
HXDLIN( 189)		if (this->_componentReady) {
HXLINE( 189)			_hx_tmp = (this->_selected == true);
            		}
            		else {
HXLINE( 189)			_hx_tmp = false;
            		}
HXDLIN( 189)		if (_hx_tmp) {
HXLINE( 190)			this->_label->set_text(this->_selectedText);
            		}
...
::String SwitchButtonSub_obj::get_unselectedText(){
            	HX_STACKFRAME(&_hx_pos_51aa2c71bbb629f6_198_get_unselectedText)
HXDLIN( 198)		return this->_unselectedText;
            	}
...
::String SwitchButtonSub_obj::set_unselectedText(::String value){
            	HX_STACKFRAME(&_hx_pos_51aa2c71bbb629f6_200_set_unselectedText)
HXLINE( 201)		this->_unselectedText = value;
HXLINE( 202)		bool _hx_tmp;
HXDLIN( 202)		if (this->_componentReady) {
HXLINE( 202)			_hx_tmp = (this->_selected == false);
            		}
            		else {
HXLINE( 202)			_hx_tmp = false;
            		}
HXDLIN( 202)		if (_hx_tmp) {
HXLINE( 203)			this->_label->set_text(this->_unselectedText);
            		}
...
Float SwitchButtonSub_obj::get_pos(){
            	HX_STACKFRAME(&_hx_pos_51aa2c71bbb629f6_211_get_pos)
HXDLIN( 211)		return this->_pos;
            	}
...
Float SwitchButtonSub_obj::set_pos(Float value){
            	HX_STACKFRAME(&_hx_pos_51aa2c71bbb629f6_213_set_pos)
HXLINE( 214)		if ((this->_pos == value)) {
HXLINE( 215)			return value;
            		}
HXLINE( 218)		this->_pos = value;
HXLINE( 219)		{
HXLINE( 219)			bool _hx_tmp;
HXDLIN( 219)			if (::hx::IsNotNull( this->_layout )) {
HXLINE( 219)				_hx_tmp = (this->_layoutLocked == true);
            			}
            			else {
HXLINE( 219)				_hx_tmp = true;
            			}
HXDLIN( 219)			if (!(_hx_tmp)) {
HXLINE( 219)				this->invalidateComponent(HX_("layout",aa,ae,b8,58),false);
            			}
            		}
...
void SwitchButtonSub_obj::registerBehaviours(){
            	HX_STACKFRAME(&_hx_pos_b1c112e181ae1c65_551_registerBehaviours)
HXDLIN( 551)		this->super::registerBehaviours();
            	}


 ::haxe::ui::backend::ComponentBase SwitchButtonSub_obj::cloneComponent(){
            	HX_STACKFRAME(&_hx_pos_508e58cc2a7fb5a3_700_cloneComponent)
HXLINE( 469)		 ::haxe::ui::components::_Switch::SwitchButtonSub c = ( ( ::haxe::ui::components::_Switch::SwitchButtonSub)(this->super::cloneComponent()) );
...
HXLINE( 493)		return c;
 ...
 ::haxe::ui::backend::ComponentBase SwitchButtonSub_obj::self(){
            	HX_GC_STACKFRAME(&_hx_pos_b1c112e181ae1c65_521_self)
HXDLIN( 521)		return  ::haxe::ui::components::_Switch::SwitchButtonSub_obj::__alloc( HX_CTX );
            	}


void SwitchButtonSub_obj::registerComposite(){
            	HX_STACKFRAME(&_hx_pos_b1c112e181ae1c65_204_registerComposite)
HXLINE( 205)		this->super::registerComposite();
HXLINE( 221)		this->_defaultLayoutClass = ::hx::ClassOf< ::haxe::ui::components::_Switch::SwitchButtonLayout >();
            	}
