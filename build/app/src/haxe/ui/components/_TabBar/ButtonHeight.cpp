...
HX_DEFINE_STACK_FRAME(_hx_pos_88f3884d2e7ae91a_320_new,"haxe.ui.components._TabBar.ButtonHeight","new",0x19ffbee2,"haxe.ui.components._TabBar.ButtonHeight.new","haxe/ui/components/TabBar.hx",320,0xaabf3019)
HX_LOCAL_STACK_FRAME(_hx_pos_88f3884d2e7ae91a_321_validateData,"haxe.ui.components._TabBar.ButtonHeight","validateData",0x509a871e,"haxe.ui.components._TabBar.ButtonHeight.validateData","haxe/ui/components/TabBar.hx",321,0xaabf3019)
namespace haxe{
namespace ui{
...
void ButtonHeight_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_88f3884d2e7ae91a_320_new)
HXDLIN( 320)		super::__construct(component);
            	}
...
void ButtonHeight_obj::validateData(){
            	HX_STACKFRAME(&_hx_pos_88f3884d2e7ae91a_321_validateData)
HXLINE( 322)		bool _hx_tmp;
HXDLIN( 322)		if (::hx::IsNotNull( this->_value )) {
HXLINE( 322)			_hx_tmp = ::haxe::ui::util::_Variant::Variant_Impl__obj::get_isNull(this->_value);
            		}
            		else {
...
HXLINE( 325)		{
HXLINE( 325)			int _g = 0;
HXDLIN( 325)			::Array< ::Dynamic> _g1 = this->_component->findComponents(null(),::hx::ClassOf< ::haxe::ui::components::Button >(),null());
HXDLIN( 325)			while((_g < _g1->length)){
HXLINE( 325)				 ::haxe::ui::components::Button b = _g1->__get(_g).StaticCast<  ::haxe::ui::components::Button >();
HXDLIN( 325)				_g = (_g + 1);
HXLINE( 326)				b->set_height(::haxe::ui::util::_Variant::Variant_Impl__obj::toFloat(this->_value));
            			}
            		}
            	}
