...
HX_LOCAL_STACK_FRAME(_hx_pos_fc306f5c156c4db6_24_get_alignment,"hx.widgets.HeaderColumn","get_alignment",0xf6f77fec,"hx.widgets.HeaderColumn.get_alignment","hx/widgets/HeaderColumn.hx",24,0x5abe89dc)
HX_LOCAL_STACK_FRAME(_hx_pos_fc306f5c156c4db6_27_set_alignment,"hx.widgets.HeaderColumn","set_alignment",0x3bfd61f8,"hx.widgets.HeaderColumn.set_alignment","hx/widgets/HeaderColumn.hx",27,0x5abe89dc)
HX_LOCAL_STACK_FRAME(_hx_pos_fc306f5c156c4db6_31_get_width,"hx.widgets.HeaderColumn","get_width",0x2754da8f,"hx.widgets.HeaderColumn.get_width","hx/widgets/HeaderColumn.hx",31,0x5abe89dc)
HX_LOCAL_STACK_FRAME(_hx_pos_fc306f5c156c4db6_36_set_width,"hx.widgets.HeaderColumn","set_width",0x0aa5c69b,"hx.widgets.HeaderColumn.set_width","hx/widgets/HeaderColumn.hx",36,0x5abe89dc)
HX_LOCAL_STACK_FRAME(_hx_pos_fc306f5c156c4db6_39_destroy,"hx.widgets.HeaderColumn","destroy",0x129c24ac,"hx.widgets.HeaderColumn.destroy","hx/widgets/HeaderColumn.hx",39,0x5abe89dc)
HX_LOCAL_STACK_FRAME(_hx_pos_fc306f5c156c4db6_52_get_headerColumn,"hx.widgets.HeaderColumn","get_headerColumn",0x99f862da,"hx.widgets.HeaderColumn.get_headerColumn","hx/widgets/HeaderColumn.hx",52,0x5abe89dc)
namespace hx{
namespace widgets{
...
int HeaderColumn_obj::get_alignment(){
            	HX_STACKFRAME(&_hx_pos_fc306f5c156c4db6_24_get_alignment)
HXDLIN(  24)		return this->get_headerColumn()->ptr->GetAlignment();
            	}


HX_DEFINE_DYNAMIC_FUNC0(HeaderColumn_obj,get_alignment,return )

int HeaderColumn_obj::set_alignment(int value){
            	HX_STACKFRAME(&_hx_pos_fc306f5c156c4db6_27_set_alignment)
HXDLIN(  27)		return value;
            	}


HX_DEFINE_DYNAMIC_FUNC1(HeaderColumn_obj,set_alignment,return )

int HeaderColumn_obj::get_width(){
            	HX_STACKFRAME(&_hx_pos_fc306f5c156c4db6_31_get_width)
HXLINE(  32)		int r = this->get_headerColumn()->ptr->GetWidth();
HXLINE(  33)		return r;
            	}
...
int HeaderColumn_obj::set_width(int value){
            	HX_STACKFRAME(&_hx_pos_fc306f5c156c4db6_36_set_width)
...
bool HeaderColumn_obj::destroy(){
            	HX_STACKFRAME(&_hx_pos_fc306f5c156c4db6_39_destroy)
HXLINE(  40)		if (::hx::IsNotNull( this->_ref )) {
HXLINE(  41)			this->_ref->destroy();
HXLINE(  42)			this->_ref = null();
            		}
...
::cpp::Pointer<  wxHeaderColumn > HeaderColumn_obj::get_headerColumn(){
            	HX_STACKFRAME(&_hx_pos_fc306f5c156c4db6_52_get_headerColumn)
