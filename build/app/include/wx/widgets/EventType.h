...
class HXCPP_CLASS_ATTRIBUTES EventType_obj : public ::hx::Object
{
	...
	public:
		...
		static int DATAVIEW_ITEM_START_EDITING;
		static int DATAVIEW_ITEM_CONTEXT_MENU;
		static int PAINT;
		...
		static int TASKBAR_CLICK;
		static int TASKBAR_LEFT_DCLICK;
		static int TASKBAR_LEFT_DOWN;
		static int TASKBAR_LEFT_UP;
		static int TASKBAR_MOVE;
		static int TASKBAR_RIGHT_DCLICK;
		static int TASKBAR_RIGHT_DOWN;
		static int TASKBAR_RIGHT_UP;
};
