...
bool RadioButtonStyle_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x7a9364d4;
}
...
static ::hx::StaticInfo RadioButtonStyle_obj_sStaticStorageInfo[] = {
	{::hx::fsInt,(void *) &RadioButtonStyle_obj::GROUP,HX_("GROUP",1f,eb,e2,17)},
	{::hx::fsInt,(void *) &RadioButtonStyle_obj::SINGLE,HX_("SINGLE",88,12,a4,6b)},
	{ ::hx::fsUnknown, 0, null()}
};
#endif
...
{
	RadioButtonStyle_obj _hx_dummy;
	RadioButtonStyle_obj::_hx_vtable = *(void **)&_hx_dummy;
	::hx::Static(__mClass) = new ::hx::Class_obj();
	__mClass->mName = HX_("wx.widgets.styles.RadioButtonStyle",04,ff,52,0b);
