...
HX_DEFINE_STACK_FRAME(_hx_pos_442bb579fcb4e3b1_64_new,"haxe.ui.components._Switch.TextBehaviour","new",0x7700e7e1,"haxe.ui.components._Switch.TextBehaviour.new","haxe/ui/components/Switch.hx",64,0x0342e663)
HX_LOCAL_STACK_FRAME(_hx_pos_442bb579fcb4e3b1_65_validateData,"haxe.ui.components._Switch.TextBehaviour","validateData",0xf861c63f,"haxe.ui.components._Switch.TextBehaviour.validateData","haxe/ui/components/Switch.hx",65,0x0342e663)
namespace haxe{
namespace ui{
...
void TextBehaviour_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_442bb579fcb4e3b1_64_new)
...
void TextBehaviour_obj::validateData(){
            	HX_GC_STACKFRAME(&_hx_pos_442bb579fcb4e3b1_65_validateData)
...
HXLINE(  69)			label->set_styleNames(HX_("switch-label",9b,83,49,55));
HXLINE(  70)			label->set_id(HX_("switch-label",9b,83,49,55));
HXLINE(  71)			label->set_scriptAccess(false);
HXLINE(  72)			this->_component->addComponentAt(label,0);
HXLINE(  74)			 ::haxe::ui::components::Spacer spacer =  ::haxe::ui::components::Spacer_obj::__alloc( HX_CTX );
HXLINE(  75)			spacer->set_percentWidth(100);
HXLINE(  76)			this->_component->addComponentAt(spacer,1);
HXLINE(  78)			{
HXLINE(  78)				 ::haxe::ui::core::Component _this = this->_component;
HXDLIN(  78)				_this->invalidateComponent(HX_("style",31,a5,1d,84),false);
HXDLIN(  78)				_this->_style = null();
            			}
            		}
HXLINE(  82)		label->set_text(::haxe::ui::util::_Variant::Variant_Impl__obj::toString(this->_value));
            	}
