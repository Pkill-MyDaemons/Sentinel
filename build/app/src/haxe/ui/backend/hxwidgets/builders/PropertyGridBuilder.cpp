...
HXLINE(  43)							::String prop2 = item->get_label();
HXDLIN(  43)							 ::hx::widgets::PGProperty prop3 = propGrid->appendIntProperty(prop2,::Std_obj::_hx_int(( (Float)(item->get_value()) )),itemId);
HXLINE(  44)							this->_propertyMap->set(item,prop3);
...
HXLINE(  49)							{
HXLINE(  49)								int _g4 = 0;
HXDLIN(  49)								int _g5 = ds->get_size();
HXDLIN(  49)								while((_g4 < _g5)){
HXLINE(  49)									_g4 = (_g4 + 1);
HXDLIN(  49)									int dsi = (_g4 - 1);
...
HXLINE(  58)							 ::hx::widgets::PGProperty prop4 = propGrid->appendEnumProperty(item->get_label(),listItems,indexToSelect,itemId);
HXLINE(  59)							this->_propertyMap->set(item,prop4);
HXLINE(  45)							goto _hx_goto_4;
            						}
            						/* default */{
HXLINE(  61)							::String prop5 = item->get_label();
HXDLIN(  61)							 ::hx::widgets::PGProperty prop6 = propGrid->appendStringProperty(prop5,( (::String)(item->get_value()) ),itemId);
HXLINE(  62)							this->_propertyMap->set(item,prop6);
            						}
            						_hx_goto_4:;
            					}
            				}
...
HXLINE(  84)		 ::haxe::ui::events::UIEvent event1 =  ::haxe::ui::events::UIEvent_obj::__alloc( HX_CTX ,::haxe::ui::events::UIEvent_obj::CHANGE,null(),null());
HXLINE(  85)		event1->target = target;
HXLINE(  86)		this->_component->dispatch(event1,null());
            	}
