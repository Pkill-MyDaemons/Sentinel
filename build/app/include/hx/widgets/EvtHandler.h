...
class HXCPP_CLASS_ATTRIBUTES EvtHandler_obj : public  ::hx::widgets::Object_obj
{
	...
	public:
		...
		::String __ToString() const { return HX_("EvtHandler",47,43,5b,0d); }

		 ::haxe::ds::IntMap _eventMap;
		 ::haxe::ds::IntMap _pausedEvents;
		void pauseEvent(int event);
		::Dynamic pauseEvent_dyn();

		void unpauseEvent(int event);
		::Dynamic unpauseEvent_dyn();
