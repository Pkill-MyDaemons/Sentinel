...
HXLINE(  44)			{
HXLINE(  44)				int _g2 = 0;
HXDLIN(  44)				int _g3 = this->_width;
HXDLIN(  44)				while((_g2 < _g3)){
HXLINE(  44)					_g2 = (_g2 + 1);
HXDLIN(  44)					int x = (_g2 - 1);
...
HXLINE(  50)					{
HXLINE(  50)						int offset1 = ((x + (this->_width * y)) * 3);
HXDLIN(  50)						this->_data.ptr[offset1] = ( (unsigned char)(r) );
HXDLIN(  50)						::cpp::Pointer< unsigned char > _hx_tmp = this->_data;
HXDLIN(  50)						_hx_tmp.ptr[(offset1 + 1)] = ( (unsigned char)(g) );
HXDLIN(  50)						::cpp::Pointer< unsigned char > _hx_tmp1 = this->_data;
HXDLIN(  50)						_hx_tmp1.ptr[(offset1 + 2)] = ( (unsigned char)(b) );
HXDLIN(  50)						if (::hx::IsNotNull( this->_alpha )) {
HXLINE(  50)							int alphaOffset = (x + (this->_width * y));
HXDLIN(  50)							this->_alpha.ptr[alphaOffset] = ( (unsigned char)(a) );
            						}
            					}
            				}
            			}
...
HXLINE(  63)					{
HXLINE(  63)						int offset1 = ((x + (this->_width * y)) * 3);
HXDLIN(  63)						this->_data.ptr[offset1] = ( (unsigned char)(r) );
HXDLIN(  63)						::cpp::Pointer< unsigned char > _hx_tmp = this->_data;
HXDLIN(  63)						_hx_tmp.ptr[(offset1 + 1)] = ( (unsigned char)(g) );
HXDLIN(  63)						::cpp::Pointer< unsigned char > _hx_tmp1 = this->_data;
HXDLIN(  63)						_hx_tmp1.ptr[(offset1 + 2)] = ( (unsigned char)(b) );
HXDLIN(  63)						if (::hx::IsNotNull( this->_alpha )) {
HXLINE(  63)							int alphaOffset = (x + (this->_width * y));
HXDLIN(  63)							this->_alpha.ptr[alphaOffset] = ( (unsigned char)(a) );
            						}
            					}
            				}
            			}
...
HXLINE(  70)			{
HXLINE(  70)				int _g2 = 0;
HXDLIN(  70)				int _g3 = this->_width;
HXDLIN(  70)				while((_g2 < _g3)){
HXLINE(  70)					_g2 = (_g2 + 1);
HXDLIN(  70)					int x = (_g2 - 1);
...
HXLINE(  75)					{
HXLINE(  75)						int offset1 = ((x + (this->_width * y)) * 3);
HXDLIN(  75)						this->_data.ptr[offset1] = ( (unsigned char)(r) );
HXDLIN(  75)						::cpp::Pointer< unsigned char > _hx_tmp = this->_data;
HXDLIN(  75)						_hx_tmp.ptr[(offset1 + 1)] = ( (unsigned char)(g) );
HXDLIN(  75)						::cpp::Pointer< unsigned char > _hx_tmp1 = this->_data;
HXDLIN(  75)						_hx_tmp1.ptr[(offset1 + 2)] = ( (unsigned char)(b) );
            					}
            				}
            			}
            		}
...
HXLINE(  86)			{
HXLINE(  86)				int offset = ((x + (this->_width * y)) * 3);
HXDLIN(  86)				this->_data.ptr[offset] = ( (unsigned char)(r) );
HXDLIN(  86)				::cpp::Pointer< unsigned char > _hx_tmp = this->_data;
HXDLIN(  86)				_hx_tmp.ptr[(offset + 1)] = ( (unsigned char)(g) );
HXDLIN(  86)				::cpp::Pointer< unsigned char > _hx_tmp1 = this->_data;
HXDLIN(  86)				_hx_tmp1.ptr[(offset + 2)] = ( (unsigned char)(b) );
HXDLIN(  86)				if (::hx::IsNotNull( this->_alpha )) {
HXLINE(  86)					int alphaOffset = (x + (this->_width * y));
HXDLIN(  86)					this->_alpha.ptr[alphaOffset] = ( (unsigned char)(a) );
            				}
            			}
            		}
            		else {
HXLINE(  88)			int r1 = ((c & 16711680) >> 16);
HXLINE(  89)			int g1 = ((c & 65280) >> 8);
HXLINE(  90)			int b1 = (c & 255);
HXLINE(  91)			{
HXLINE(  91)				int offset1 = ((x + (this->_width * y)) * 3);
HXDLIN(  91)				this->_data.ptr[offset1] = ( (unsigned char)(r1) );
HXDLIN(  91)				::cpp::Pointer< unsigned char > _hx_tmp2 = this->_data;
HXDLIN(  91)				_hx_tmp2.ptr[(offset1 + 1)] = ( (unsigned char)(g1) );
HXDLIN(  91)				::cpp::Pointer< unsigned char > _hx_tmp3 = this->_data;
HXDLIN(  91)				_hx_tmp3.ptr[(offset1 + 2)] = ( (unsigned char)(b1) );
            			}
            		}
            	}
...
HXLINE(  97)			{
HXLINE(  97)				int _g2 = 0;
HXDLIN(  97)				int _g3 = this->_width;
HXDLIN(  97)				while((_g2 < _g3)){
HXLINE(  97)					_g2 = (_g2 + 1);
HXDLIN(  97)					int x = (_g2 - 1);
