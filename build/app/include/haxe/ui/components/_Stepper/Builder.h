...
#define INCLUDED_haxe_ui_components__Stepper_Builder
...
HX_DECLARE_CLASS4(haxe,ui,components,_Stepper,Builder)
...
class HXCPP_CLASS_ATTRIBUTES Builder_obj : public  ::haxe::ui::core::CompositeBuilder_obj
{
	...
	public:
		enum { _hx_ClassId = 0x18c93c15 };

		void __construct( ::haxe::ui::components::Stepper stepper);
		inline void *operator new(size_t inSize, bool inContainer=true,const char *inName="haxe.ui.components._Stepper.Builder")
			{ return ::hx::Object::operator new(inSize,inContainer,inName); }
		inline void *operator new(size_t inSize, int extra)
			{ return ::hx::Object::operator new(inSize+extra,true,"haxe.ui.components._Stepper.Builder"); }
		static ::hx::ObjectPtr< Builder_obj > __new( ::haxe::ui::components::Stepper stepper);
		static ::hx::ObjectPtr< Builder_obj > __alloc(::hx::Ctx *_hx_ctx, ::haxe::ui::components::Stepper stepper);
...
#endif /* INCLUDED_haxe_ui_components__Stepper_Builder */ 
