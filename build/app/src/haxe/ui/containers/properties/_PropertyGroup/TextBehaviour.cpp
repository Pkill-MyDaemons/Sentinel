...
HX_DEFINE_STACK_FRAME(_hx_pos_a53e01794596cbf6_30_new,"haxe.ui.containers.properties._PropertyGroup.TextBehaviour","new",0x8966e950,"haxe.ui.containers.properties._PropertyGroup.TextBehaviour.new","haxe/ui/containers/properties/PropertyGroup.hx",30,0xad7e5fc5)
HX_LOCAL_STACK_FRAME(_hx_pos_a53e01794596cbf6_31_validateData,"haxe.ui.containers.properties._PropertyGroup.TextBehaviour","validateData",0x13fd9ef0,"haxe.ui.containers.properties._PropertyGroup.TextBehaviour.validateData","haxe/ui/containers/properties/PropertyGroup.hx",31,0xad7e5fc5)
namespace haxe{
namespace ui{
...
void TextBehaviour_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_a53e01794596cbf6_30_new)
...
void TextBehaviour_obj::validateData(){
            	HX_STACKFRAME(&_hx_pos_a53e01794596cbf6_31_validateData)
HXLINE(  32)		 ::haxe::ui::components::Label label = this->_component->findComponent(HX_("property-group-header-label",3a,6d,5e,f5),null(),null(),null()).StaticCast<  ::haxe::ui::components::Label >();
HXLINE(  33)		label->set_text(::haxe::ui::util::_Variant::Variant_Impl__obj::toString(this->_value));
            	}
