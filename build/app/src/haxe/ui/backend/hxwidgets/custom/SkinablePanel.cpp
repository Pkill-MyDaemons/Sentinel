...
HXLINE(  73)							if ((i == 3)) {
HXLINE(  74)								 ::haxe::ui::geom::Rectangle dstRect2 = dstRect;
HXDLIN(  74)								dstRect2->height = (dstRect2->height + 2);
            							}
            							else {
HXLINE(  76)								if ((i == 4)) {
HXLINE(  77)									 ::haxe::ui::geom::Rectangle dstRect3 = dstRect;
HXDLIN(  77)									dstRect3->width = (dstRect3->width + 2);
HXLINE(  78)									 ::haxe::ui::geom::Rectangle dstRect4 = dstRect;
HXDLIN(  78)									dstRect4->height = (dstRect4->height + 2);
            								}
            								else {
HXLINE(  80)									if ((i == 5)) {
HXLINE(  81)										 ::haxe::ui::geom::Rectangle dstRect5 = dstRect;
HXDLIN(  81)										dstRect5->height = (dstRect5->height + 2);
            									}
            									else {
HXLINE(  83)										if ((i == 7)) {
HXLINE(  84)											 ::haxe::ui::geom::Rectangle dstRect6 = dstRect;
HXDLIN(  84)											dstRect6->width = (dstRect6->width + 2);
            										}
            									}
            								}
            							}
