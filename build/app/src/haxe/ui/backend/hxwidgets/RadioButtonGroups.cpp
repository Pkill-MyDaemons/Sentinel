...
bool RadioButtonGroups_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x170b3e3c;
}
...
static ::hx::StaticInfo RadioButtonGroups_obj_sStaticStorageInfo[] = {
	{::hx::fsObject /*  ::haxe::ds::StringMap */ ,(void *) &RadioButtonGroups_obj::_groups,HX_("_groups",f3,35,9f,8a)},
	{ ::hx::fsUnknown, 0, null()}
};
#endif
...
{
	RadioButtonGroups_obj _hx_dummy;
	RadioButtonGroups_obj::_hx_vtable = *(void **)&_hx_dummy;
	::hx::Static(__mClass) = new ::hx::Class_obj();
	__mClass->mName = HX_("haxe.ui.backend.hxwidgets.RadioButtonGroups",26,ed,f4,b1);
