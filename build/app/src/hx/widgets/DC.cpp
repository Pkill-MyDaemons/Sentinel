...
HX_LOCAL_STACK_FRAME(_hx_pos_430522e7e40ac393_76_drawRectangle,"hx.widgets.DC","drawRectangle",0xc0b9d699,"hx.widgets.DC.drawRectangle","hx/widgets/DC.hx",76,0x88dcc500)
HX_LOCAL_STACK_FRAME(_hx_pos_430522e7e40ac393_80_drawPoint,"hx.widgets.DC","drawPoint",0xf1ecb9ba,"hx.widgets.DC.drawPoint","hx/widgets/DC.hx",80,0x88dcc500)
HX_LOCAL_STACK_FRAME(_hx_pos_430522e7e40ac393_84_drawRoundedRectangle,"hx.widgets.DC","drawRoundedRectangle",0x1b91c518,"hx.widgets.DC.drawRoundedRectangle","hx/widgets/DC.hx",84,0x88dcc500)
HX_LOCAL_STACK_FRAME(_hx_pos_430522e7e40ac393_88_drawCircle,"hx.widgets.DC","drawCircle",0x1c152966,"hx.widgets.DC.drawCircle","hx/widgets/DC.hx",88,0x88dcc500)
HX_LOCAL_STACK_FRAME(_hx_pos_430522e7e40ac393_93_set_background,"hx.widgets.DC","set_background",0x874e41dd,"hx.widgets.DC.set_background","hx/widgets/DC.hx",93,0x88dcc500)
HX_LOCAL_STACK_FRAME(_hx_pos_430522e7e40ac393_100_drawBitmap,"hx.widgets.DC","drawBitmap",0xb713c745,"hx.widgets.DC.drawBitmap","hx/widgets/DC.hx",100,0x88dcc500)
HX_LOCAL_STACK_FRAME(_hx_pos_430522e7e40ac393_108_get_dcRef,"hx.widgets.DC","get_dcRef",0x7cbbdf79,"hx.widgets.DC.get_dcRef","hx/widgets/DC.hx",108,0x88dcc500)
namespace hx{
namespace widgets{
...
HXLINE(  71)		 wxString str = wxString::FromUTF8(text.utf8_str());
...
void DC_obj::drawRectangle(int x,int y,int width,int height){
            	HX_STACKFRAME(&_hx_pos_430522e7e40ac393_76_drawRectangle)
HXDLIN(  76)		this->get_dcRef()->ptr->DrawRectangle(x,y,width,height);
            	}


HX_DEFINE_DYNAMIC_FUNC4(DC_obj,drawRectangle,(void))

void DC_obj::drawPoint(int x,int y){
            	HX_STACKFRAME(&_hx_pos_430522e7e40ac393_80_drawPoint)
HXDLIN(  80)		this->get_dcRef()->ptr->DrawPoint(x,y);
            	}


HX_DEFINE_DYNAMIC_FUNC2(DC_obj,drawPoint,(void))

void DC_obj::drawRoundedRectangle(int x,int y,int width,int height,Float radius){
            	HX_STACKFRAME(&_hx_pos_430522e7e40ac393_84_drawRoundedRectangle)
HXDLIN(  84)		this->get_dcRef()->ptr->DrawRoundedRectangle(x,y,width,height,radius);
            	}
...
void DC_obj::drawCircle(int x,int y,int radius){
            	HX_STACKFRAME(&_hx_pos_430522e7e40ac393_88_drawCircle)
HXDLIN(  88)		this->get_dcRef()->ptr->DrawCircle(x,y,radius);
            	}
...
HX_DEFINE_DYNAMIC_FUNC3(DC_obj,drawCircle,(void))
 ...
 ::hx::widgets::Brush DC_obj::set_background( ::hx::widgets::Brush value){
            	HX_STACKFRAME(&_hx_pos_430522e7e40ac393_93_set_background)
HXLINE(  94)		 wxDC * _hx_tmp = this->get_dcRef()->ptr;
HXDLIN(  94)		(*(_hx_tmp)).SetBackground(value->get_brushRef()->get_ref());
...
void DC_obj::drawBitmap( ::hx::widgets::Bitmap bmp,::hx::Null< Float >  __o_x,::hx::Null< Float >  __o_y){
            	...
            	HX_STACKFRAME(&_hx_pos_430522e7e40ac393_100_drawBitmap)
HXDLIN( 100)		 wxDC * _hx_tmp = this->get_dcRef()->ptr;
HXDLIN( 100)		(*(_hx_tmp)).DrawBitmap(bmp->get_bitmapRef()->get_ref(),x,y);
            	}
...
::cpp::Pointer<  wxDC > DC_obj::get_dcRef(){
            	HX_STACKFRAME(&_hx_pos_430522e7e40ac393_108_get_dcRef)
