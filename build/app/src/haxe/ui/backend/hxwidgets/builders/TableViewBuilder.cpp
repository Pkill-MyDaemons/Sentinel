...
HX_LOCAL_STACK_FRAME(_hx_pos_7cc01605335f5667_147_onItemChanged,"haxe.ui.backend.hxwidgets.builders.TableViewBuilder","onItemChanged",0xda3f9a77,"haxe.ui.backend.hxwidgets.builders.TableViewBuilder.onItemChanged","haxe/ui/backend/hxwidgets/builders/TableViewBuilder.hx",147,0x5bef613c)
HX_LOCAL_STACK_FRAME(_hx_pos_7cc01605335f5667_192_onTableResized,"haxe.ui.backend.hxwidgets.builders.TableViewBuilder","onTableResized",0xcdfa266c,"haxe.ui.backend.hxwidgets.builders.TableViewBuilder.onTableResized","haxe/ui/backend/hxwidgets/builders/TableViewBuilder.hx",192,0x5bef613c)
HX_LOCAL_STACK_FRAME(_hx_pos_7cc01605335f5667_195_getRendererInfo,"haxe.ui.backend.hxwidgets.builders.TableViewBuilder","getRendererInfo",0xcb9ea57c,"haxe.ui.backend.hxwidgets.builders.TableViewBuilder.getRendererInfo","haxe/ui/backend/hxwidgets/builders/TableViewBuilder.hx",195,0x5bef613c)
HX_LOCAL_STACK_FRAME(_hx_pos_7cc01605335f5667_206_resizeColumns,"haxe.ui.backend.hxwidgets.builders.TableViewBuilder","resizeColumns",0xe7d7b27e,"haxe.ui.backend.hxwidgets.builders.TableViewBuilder.resizeColumns","haxe/ui/backend/hxwidgets/builders/TableViewBuilder.hx",206,0x5bef613c)
namespace haxe{
namespace ui{
namespace backend{
namespace hxwidgets{
...
HXLINE( 136)			this->headersCreated = true;
HXLINE( 138)			 ::haxe::ui::containers::TableView _hx_tmp7 = this->_table;
HXDLIN( 138)			_hx_tmp7->set_dataSource(this->_table->get_dataSource());
HXLINE( 139)			this->_table->registerEvent(::haxe::ui::events::UIEvent_obj::RESIZE,this->onTableResized_dyn(),null());
HXLINE( 141)			this->_table->get_window()->bind(::wx::widgets::EventType_obj::DATAVIEW_ITEM_VALUE_CHANGED,this->onItemChanged_dyn(),null());
            		}
HXLINE( 144)		this->resizeColumns();
            	}
...
void TableViewBuilder_obj::onItemChanged( ::hx::widgets::Event e){
            	HX_GC_STACKFRAME(&_hx_pos_7cc01605335f5667_147_onItemChanged)
HXLINE( 148)		 ::hx::widgets::DataViewEvent dve = e->convertTo(::hx::ClassOf< ::hx::widgets::DataViewEvent >()).StaticCast<  ::hx::widgets::DataViewEvent >();
HXLINE( 149)		 ::hx::widgets::DataViewListCtrl dataList = ::hx::TCast<  ::hx::widgets::DataViewListCtrl >::cast(this->_component->get_window());
HXLINE( 150)		int column = dve->get_column();
HXLINE( 151)		int row = dataList->itemToRow(dve->get_item());
HXLINE( 152)		 ::Dynamic columnInfo = this->columns->__get(column);
HXLINE( 153)		 ::Dynamic renderer = this->getRendererInfo(column);
HXLINE( 154)		 ::Dynamic newValue = dataList->getValue(row,column);
HXLINE( 156)		 ::Dynamic realValue = null();
HXLINE( 157)		bool sendEvent = false;
HXLINE( 158)		::String _hx_switch_0 = ( (::String)(renderer->__Field(HX_("type",ba,f2,08,4d),::hx::paccDynamic)) );
            		if (  (_hx_switch_0==HX_("checkbox",43,d2,f5,ac)) ){
HXLINE( 160)			::String realValue1;
HXDLIN( 160)			if (::hx::IsNull( newValue )) {
HXLINE( 160)				realValue1 = HX_("null",87,9e,0e,49);
            			}
            			else {
HXLINE( 160)				realValue1 = ::Std_obj::string(newValue);
            			}
HXDLIN( 160)			realValue = (realValue1 == HX_("true",4e,a7,03,4d));
HXLINE( 161)			sendEvent = true;
HXLINE( 159)			goto _hx_goto_8;
            		}
            		if (  (_hx_switch_0==HX_("image",5b,1f,69,bd)) ){
HXLINE( 165)			if (::hx::IsNull( newValue )) {
HXLINE( 165)				realValue = HX_("null",87,9e,0e,49);
            			}
            			else {
HXLINE( 165)				realValue = ::Std_obj::string(newValue);
            			}
HXDLIN( 165)			goto _hx_goto_8;
            		}
            		if (  (_hx_switch_0==HX_("number",c9,86,7a,a1)) ){
HXLINE( 167)			realValue = ::Std_obj::parseInt(( (::String)(newValue) ));
HXLINE( 168)			sendEvent = true;
HXLINE( 166)			goto _hx_goto_8;
            		}
            		if (  (_hx_switch_0==HX_("progress",ad,f7,2a,86)) ){
HXLINE( 163)			realValue = ::Std_obj::parseInt(( (::String)(newValue) ));
...
HXLINE( 170)				realValue = ::Std_obj::string(newValue);
            		...
            		_hx_goto_8:;
HXLINE( 173)		if (::hx::IsNotNull( realValue )) {
HXLINE( 174)			 ::Dynamic item = this->_table->get_dataSource()->get(row);
HXLINE( 175)			::Reflect_obj::setField(item,( (::String)(columnInfo->__Field(HX_("id",db,5b,00,00),::hx::paccDynamic)) ),realValue);
HXLINE( 177)			if ((sendEvent == true)) {
HXLINE( 178)				 ::haxe::ui::events::ItemEvent e1 =  ::haxe::ui::events::ItemEvent_obj::__alloc( HX_CTX ,::haxe::ui::events::ItemEvent_obj::COMPONENT_EVENT,null(),null());
HXLINE( 179)				e1->bubble = true;
HXLINE( 180)				if (::hx::IsNotNull( renderer->__Field(HX_("component",bd,f0,53,0f),::hx::paccDynamic) )) {
HXLINE( 181)					e1->source = ( ( ::haxe::ui::core::Component)(renderer->__Field(HX_("component",bd,f0,53,0f),::hx::paccDynamic)) );
            				}
HXLINE( 183)				e1->sourceEvent =  ::haxe::ui::events::UIEvent_obj::__alloc( HX_CTX ,::haxe::ui::events::UIEvent_obj::CHANGE,null(),null());
HXLINE( 184)				e1->itemIndex = row;
HXLINE( 185)				e1->data = item;
HXLINE( 186)				this->_table->dispatch(e1,null());
            			}
            		}
            	}
...
void TableViewBuilder_obj::onTableResized( ::haxe::ui::events::UIEvent _){
            	HX_STACKFRAME(&_hx_pos_7cc01605335f5667_192_onTableResized)
HXDLIN( 192)		this->resizeColumns();
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(TableViewBuilder_obj,onTableResized,(void))
 ...
 ::Dynamic TableViewBuilder_obj::getRendererInfo(int index){
            	HX_STACKFRAME(&_hx_pos_7cc01605335f5667_195_getRendererInfo)
HXLINE( 196)		if ((index > (this->renderers->length - 1))) {
HXLINE( 197)			return  ::Dynamic(::hx::Anon_obj::Create(2)
            				->setFixed(0,HX_("component",bd,f0,53,0f),null())
            				->setFixed(1,HX_("type",ba,f2,08,4d),HX_("label",f4,0d,af,6f)));
            		}
HXLINE( 203)		return this->renderers->__get(index);
            	}
...
void TableViewBuilder_obj::resizeColumns(){
            	HX_STACKFRAME(&_hx_pos_7cc01605335f5667_206_resizeColumns)
HXLINE( 207)		if (::hx::IsNull( this->_component->get_window() )) {
HXLINE( 208)			return;
            		}
HXLINE( 210)		 ::hx::widgets::DataViewListCtrl dataList = ::hx::TCast<  ::hx::widgets::DataViewListCtrl >::cast(this->_component->get_window());
HXLINE( 211)		 ::hx::widgets::Size size = dataList->get_clientSize();
HXLINE( 212)		int i = 0;
HXLINE( 213)		Float ucx = ( (Float)(size->width) );
HXLINE( 214)		{
HXLINE( 214)			int _g = 0;
HXDLIN( 214)			::Array< ::Dynamic> _g1 = this->columns;
HXDLIN( 214)			while((_g < _g1->length)){
HXLINE( 214)				 ::Dynamic c = _g1->__get(_g);
HXDLIN( 214)				_g = (_g + 1);
HXLINE( 215)				if (::hx::IsNull( c->__Field(HX_("percentWidth",01,51,1b,fe),::hx::paccDynamic) )) {
HXLINE( 216)					 ::hx::widgets::DataViewColumn dc = dataList->getColumn(i);
HXLINE( 217)					 ::Dynamic cx = c->__Field(HX_("width",06,b6,62,ca),::hx::paccDynamic);
HXLINE( 218)					dc->set_width(::Std_obj::_hx_int(( (Float)(cx) )));
HXLINE( 219)					ucx = (ucx - ( (Float)(cx) ));
            				}
HXLINE( 221)				i = (i + 1);
            			}
            		}
HXLINE( 224)		ucx = (ucx - ::haxe::ui::core::Platform_obj::get_vscrollWidth());
HXLINE( 226)		int i1 = 0;
HXLINE( 227)		{
HXLINE( 227)			int _g2 = 0;
HXDLIN( 227)			::Array< ::Dynamic> _g3 = this->columns;
HXDLIN( 227)			while((_g2 < _g3->length)){
HXLINE( 227)				 ::Dynamic c1 = _g3->__get(_g2);
HXDLIN( 227)				_g2 = (_g2 + 1);
HXLINE( 228)				if (::hx::IsNotNull( c1->__Field(HX_("percentWidth",01,51,1b,fe),::hx::paccDynamic) )) {
HXLINE( 229)					 ::hx::widgets::DataViewColumn dc1 = dataList->getColumn(i1);
HXLINE( 230)					Float cx1 = ((ucx * ( (Float)(c1->__Field(HX_("percentWidth",01,51,1b,fe),::hx::paccDynamic)) )) / ( (Float)(100) ));
HXLINE( 231)					dc1->set_width(::Std_obj::_hx_int(cx1));
            				}
HXLINE( 233)				i1 = (i1 + 1);
            			}
            		}
HXLINE( 235)		dataList->refresh(null());
            	}
