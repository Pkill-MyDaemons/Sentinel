...
HX_LOCAL_STACK_FRAME(_hx_pos_e5919ba300320f41_34_getHours,"Date","getHours",0x256fe079,"Date.getHours","/opt/homebrew/lib/haxe/std/cpp/_std/Date.hx",34,0xca557239)
HX_LOCAL_STACK_FRAME(_hx_pos_e5919ba300320f41_38_getMinutes,"Date","getMinutes",0xad798749,"Date.getMinutes","/opt/homebrew/lib/haxe/std/cpp/_std/Date.hx",38,0xca557239)
HX_LOCAL_STACK_FRAME(_hx_pos_e5919ba300320f41_42_getSeconds,"Date","getSeconds",0xb428a6a9,"Date.getSeconds","/opt/homebrew/lib/haxe/std/cpp/_std/Date.hx",42,0xca557239)
HX_LOCAL_STACK_FRAME(_hx_pos_e5919ba300320f41_46_getFullYear,"Date","getFullYear",0x72528782,"Date.getFullYear","/opt/homebrew/lib/haxe/std/cpp/_std/Date.hx",46,0xca557239)
HX_LOCAL_STACK_FRAME(_hx_pos_e5919ba300320f41_50_getMonth,"Date","getMonth",0x066b78ea,"Date.getMonth","/opt/homebrew/lib/haxe/std/cpp/_std/Date.hx",50,0xca557239)
HX_LOCAL_STACK_FRAME(_hx_pos_e5919ba300320f41_54_getDate,"Date","getDate",0x021307c4,"Date.getDate","/opt/homebrew/lib/haxe/std/cpp/_std/Date.hx",54,0xca557239)
HX_LOCAL_STACK_FRAME(_hx_pos_e5919ba300320f41_58_getDay,"Date","getDay",0x598d4986,"Date.getDay","/opt/homebrew/lib/haxe/std/cpp/_std/Date.hx",58,0xca557239)
...
HX_LOCAL_STACK_FRAME(_hx_pos_e5919ba300320f41_98_now,"Date","now",0x9aa26af6,"Date.now","/opt/homebrew/lib/haxe/std/cpp/_std/Date.hx",98,0xca557239)
...
int Date_obj::getHours(){
            	HX_STACKFRAME(&_hx_pos_e5919ba300320f41_34_getHours)
...
int Date_obj::getMinutes(){
            	HX_STACKFRAME(&_hx_pos_e5919ba300320f41_38_getMinutes)
...
int Date_obj::getSeconds(){
            	HX_STACKFRAME(&_hx_pos_e5919ba300320f41_42_getSeconds)
...
int Date_obj::getFullYear(){
            	HX_STACKFRAME(&_hx_pos_e5919ba300320f41_46_getFullYear)
...
int Date_obj::getMonth(){
            	HX_STACKFRAME(&_hx_pos_e5919ba300320f41_50_getMonth)
...
int Date_obj::getDate(){
            	HX_STACKFRAME(&_hx_pos_e5919ba300320f41_54_getDate)
...
int Date_obj::getDay(){
            	HX_STACKFRAME(&_hx_pos_e5919ba300320f41_58_getDay)
...
HX_DEFINE_DYNAMIC_FUNC0(Date_obj,toString,return )
 ...
 ::Date Date_obj::now(){
            	HX_STACKFRAME(&_hx_pos_e5919ba300320f41_98_now)
