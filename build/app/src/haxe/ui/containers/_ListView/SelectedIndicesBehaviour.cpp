...
HX_DEFINE_STACK_FRAME(_hx_pos_38ee9375c76dbd6e_505_new,"haxe.ui.containers._ListView.SelectedIndicesBehaviour","new",0xb006b839,"haxe.ui.containers._ListView.SelectedIndicesBehaviour.new","haxe/ui/containers/ListView.hx",505,0xe137bf10)
HX_LOCAL_STACK_FRAME(_hx_pos_38ee9375c76dbd6e_507_get,"haxe.ui.containers._ListView.SelectedIndicesBehaviour","get",0xb001686f,"haxe.ui.containers._ListView.SelectedIndicesBehaviour.get","haxe/ui/containers/ListView.hx",507,0xe137bf10)
HX_LOCAL_STACK_FRAME(_hx_pos_38ee9375c76dbd6e_510_validateData,"haxe.ui.containers._ListView.SelectedIndicesBehaviour","validateData",0x91bb2ae7,"haxe.ui.containers._ListView.SelectedIndicesBehaviour.validateData","haxe/ui/containers/ListView.hx",510,0xe137bf10)
namespace haxe{
namespace ui{
...
void SelectedIndicesBehaviour_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_38ee9375c76dbd6e_505_new)
HXDLIN( 505)		super::__construct(component);
            	}
...
bool SelectedIndicesBehaviour_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::haxe::ui::util::VariantType SelectedIndicesBehaviour_obj::get(){
            	HX_STACKFRAME(&_hx_pos_38ee9375c76dbd6e_507_get)
HXDLIN( 507)		if (::haxe::ui::util::_Variant::Variant_Impl__obj::get_isNull(this->_value)) {
HXDLIN( 507)			return ::haxe::ui::util::_Variant::Variant_Impl__obj::fromArray(::cpp::VirtualArray_obj::__new(0));
            		}
            		else {
HXDLIN( 507)			return this->_value;
            		}
HXDLIN( 507)		return null();
            	}


void SelectedIndicesBehaviour_obj::validateData(){
            	HX_GC_STACKFRAME(&_hx_pos_38ee9375c76dbd6e_510_validateData)
HXLINE( 511)		 ::haxe::ui::containers::ListView listView = ::hx::TCast<  ::haxe::ui::containers::ListView >::cast(this->_component);
HXLINE( 512)		::Array< int > selectedIndices = listView->get_selectedIndices();
HXLINE( 513)		 ::haxe::ui::core::Component contents = this->_component->findComponent(HX_("scrollview-contents",15,b7,70,a7),null(),false,HX_("css",c3,83,4b,00)).StaticCast<  ::haxe::ui::core::Component >();
HXLINE( 514)		 ::haxe::ui::containers::_ListView::ListViewBuilder builder = ::hx::TCast<  ::haxe::ui::containers::_ListView::ListViewBuilder >::cast(this->_component->_compositeBuilder);
HXLINE( 515)		 ::haxe::ui::containers::ListViewEvents events = ::hx::TCast<  ::haxe::ui::containers::ListViewEvents >::cast(this->_component->_internalEvents);
HXLINE( 517)		{
HXLINE( 517)			int _g = 0;
HXDLIN( 517)			::Array< ::Dynamic> _g1;
HXDLIN( 517)			if (::hx::IsNull( contents->_children )) {
HXLINE( 517)				_g1 = ::Array_obj< ::Dynamic>::__new(0);
            			}
            			else {
HXLINE( 517)				_g1 = contents->_children;
            			}
HXDLIN( 517)			while((_g < _g1->length)){
HXLINE( 517)				 ::haxe::ui::core::Component child = _g1->__get(_g).StaticCast<  ::haxe::ui::core::Component >();
HXDLIN( 517)				_g = (_g + 1);
HXLINE( 518)				if ((selectedIndices->indexOf(::hx::TCast<  ::haxe::ui::core::ItemRenderer >::cast(child)->itemIndex,null()) != -1)) {
HXLINE( 519)					builder->addItemRendererClass(child,HX_(":selected",95,f4,1e,7c),null());
            				}
            				else {
HXLINE( 521)					builder->addItemRendererClass(child,HX_(":selected",95,f4,1e,7c),false);
            				}
            			}
            		}
HXLINE( 525)		if ((listView->get_virtual() == true)) {
HXLINE( 526)			int _g2 = 0;
HXDLIN( 526)			while((_g2 < selectedIndices->length)){
HXLINE( 526)				int i = selectedIndices->__get(_g2);
HXDLIN( 526)				_g2 = (_g2 + 1);
HXLINE( 527)				builder->ensureVirtualItemVisible(i);
            			}
            		}
HXLINE( 531)		bool _hx_tmp;
HXDLIN( 531)		if ((listView->get_selectedIndex() != -1)) {
HXLINE( 531)			_hx_tmp = (listView->get_selectedIndices()->length != 0);
            		}
            		else {
HXLINE( 531)			_hx_tmp = false;
            		}
HXDLIN( 531)		if (_hx_tmp) {
HXLINE( 532)			 ::haxe::ui::events::UIEvent event =  ::haxe::ui::events::UIEvent_obj::__alloc( HX_CTX ,::haxe::ui::events::UIEvent_obj::CHANGE,null(),null());
HXLINE( 533)			event->relatedEvent = events->lastEvent;
HXLINE( 534)			this->_component->dispatch(event,null());
            		}
            	}
