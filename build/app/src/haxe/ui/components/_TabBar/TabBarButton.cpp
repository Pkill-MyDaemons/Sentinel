...
HX_DEFINE_STACK_FRAME(_hx_pos_8285d904a115228d_657_new,"haxe.ui.components._TabBar.TabBarButton","new",0x2a2531f9,"haxe.ui.components._TabBar.TabBarButton.new","haxe/ui/components/TabBar.hx",657,0xaabf3019)
HX_LOCAL_STACK_FRAME(_hx_pos_8285d904a115228d_661_get_closable,"haxe.ui.components._TabBar.TabBarButton","get_closable",0xefc04377,"haxe.ui.components._TabBar.TabBarButton.get_closable","haxe/ui/components/TabBar.hx",661,0xaabf3019)
HX_LOCAL_STACK_FRAME(_hx_pos_8285d904a115228d_664_set_closable,"haxe.ui.components._TabBar.TabBarButton","set_closable",0x04b966eb,"haxe.ui.components._TabBar.TabBarButton.set_closable","haxe/ui/components/TabBar.hx",664,0xaabf3019)
HX_LOCAL_STACK_FRAME(_hx_pos_8285d904a115228d_690_onCloseClicked,"haxe.ui.components._TabBar.TabBarButton","onCloseClicked",0x39ad9095,"haxe.ui.components._TabBar.TabBarButton.onCloseClicked","haxe/ui/components/TabBar.hx",690,0xaabf3019)
HX_LOCAL_STACK_FRAME(_hx_pos_b85e0875f6bf2718_204_registerComposite,"haxe.ui.components._TabBar.TabBarButton","registerComposite",0xb5fb807d,"haxe.ui.components._TabBar.TabBarButton.registerComposite","haxe/ui/macros/Macros.hx",204,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_b85e0875f6bf2718_551_registerBehaviours,"haxe.ui.components._TabBar.TabBarButton","registerBehaviours",0x0913fa60,"haxe.ui.components._TabBar.TabBarButton.registerBehaviours","haxe/ui/macros/Macros.hx",551,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_46772a0e91034aca_700_cloneComponent,"haxe.ui.components._TabBar.TabBarButton","cloneComponent",0xf017aca7,"haxe.ui.components._TabBar.TabBarButton.cloneComponent","haxe/ui/macros/helpers/ClassBuilder.hx",700,0x8cdaad7b)
HX_LOCAL_STACK_FRAME(_hx_pos_b85e0875f6bf2718_521_self,"haxe.ui.components._TabBar.TabBarButton","self",0xb9b48fd3,"haxe.ui.components._TabBar.TabBarButton.self","haxe/ui/macros/Macros.hx",521,0x27866361)
namespace haxe{
namespace ui{
...
void TabBarButton_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_8285d904a115228d_657_new)
HXLINE( 658)		this->_closable = false;
HXLINE( 657)		super::__construct();
            	}
...
bool TabBarButton_obj::get_closable(){
            	HX_STACKFRAME(&_hx_pos_8285d904a115228d_661_get_closable)
HXDLIN( 661)		return this->_closable;
            	}
...
bool TabBarButton_obj::set_closable(bool value){
            	HX_GC_STACKFRAME(&_hx_pos_8285d904a115228d_664_set_closable)
HXLINE( 665)		if ((this->_closable == value)) {
HXLINE( 666)			return value;
            		}
HXLINE( 669)		this->_closable = value;
HXLINE( 670)		 ::haxe::ui::components::Image existing = ( ( ::haxe::ui::components::Image)(this->findComponent(HX_("tab-close-button",5f,35,00,26),::hx::ClassOf< ::haxe::ui::components::Image >(),false,null())) );
HXLINE( 672)		 ::haxe::ui::components::ButtonEvents events = ::hx::TCast<  ::haxe::ui::components::ButtonEvents >::cast(this->_internalEvents);
HXLINE( 673)		events->recursiveStyling = false;
HXLINE( 674)		bool _hx_tmp;
HXDLIN( 674)		if ((this->_closable == true)) {
HXLINE( 674)			_hx_tmp = ::hx::IsNull( existing );
            		}
            		else {
HXLINE( 674)			_hx_tmp = false;
            		}
HXDLIN( 674)		if (_hx_tmp) {
HXLINE( 675)			this->set_iconPosition(HX_("far-left",7d,bc,22,51));
HXLINE( 676)			 ::haxe::ui::components::Image image =  ::haxe::ui::components::Image_obj::__alloc( HX_CTX );
HXLINE( 677)			image->set_id(HX_("tab-close-button",5f,35,00,26));
HXLINE( 678)			image->addClass(HX_("tab-close-button",5f,35,00,26),null(),null());
HXLINE( 679)			image->set_includeInLayout(false);
HXLINE( 680)			image->set_scriptAccess(false);
HXLINE( 681)			image->set_onClick(this->onCloseClicked_dyn());
HXLINE( 682)			this->addComponent(image);
            		}
            		else {
HXLINE( 683)			if (::hx::IsNotNull( existing )) {
HXLINE( 684)				this->removeComponent(existing,null(),null());
            			}
            		}
...
void TabBarButton_obj::onCloseClicked( ::haxe::ui::events::MouseEvent e){
            	HX_GC_STACKFRAME(&_hx_pos_8285d904a115228d_690_onCloseClicked)
HXLINE( 691)		 ::haxe::ui::components::TabBar tabbar = ( ( ::haxe::ui::components::TabBar)(this->findAncestor(null(),::hx::ClassOf< ::haxe::ui::components::TabBar >(),null())) );
HXLINE( 693)		 ::haxe::ui::components::_TabBar::Builder builder = ::hx::TCast<  ::haxe::ui::components::_TabBar::Builder >::cast(tabbar->_compositeBuilder);
HXLINE( 694)		int index = builder->_container->getComponentIndex(::hx::ObjectPtr<OBJ_>(this));
HXLINE( 695)		 ::haxe::ui::events::UIEvent event =  ::haxe::ui::events::UIEvent_obj::__alloc( HX_CTX ,::haxe::ui::events::UIEvent_obj::BEFORE_CLOSE,null(),index);
HXLINE( 696)		tabbar->dispatch(event,null());
HXLINE( 697)		if ((event->canceled == false)) {
HXLINE( 698)			if ((index != -1)) {
HXLINE( 699)				tabbar->removeTab(index);
            			}
            		}
            	}
...
void TabBarButton_obj::registerComposite(){
            	HX_STACKFRAME(&_hx_pos_b85e0875f6bf2718_204_registerComposite)
HXLINE( 205)		this->super::registerComposite();
HXLINE( 221)		this->_defaultLayoutClass = ::hx::ClassOf< ::haxe::ui::components::_TabBar::TabBarButtonLayout >();
            	}


void TabBarButton_obj::registerBehaviours(){
            	HX_STACKFRAME(&_hx_pos_b85e0875f6bf2718_551_registerBehaviours)
HXDLIN( 551)		this->super::registerBehaviours();
            	}


 ::haxe::ui::backend::ComponentBase TabBarButton_obj::cloneComponent(){
            	HX_STACKFRAME(&_hx_pos_46772a0e91034aca_700_cloneComponent)
HXLINE( 469)		 ::haxe::ui::components::_TabBar::TabBarButton c = ( ( ::haxe::ui::components::_TabBar::TabBarButton)(this->super::cloneComponent()) );
HXLINE( 484)		{
...
HXLINE( 493)		return c;
 ...
 ::haxe::ui::backend::ComponentBase TabBarButton_obj::self(){
            	HX_GC_STACKFRAME(&_hx_pos_b85e0875f6bf2718_521_self)
HXDLIN( 521)		return  ::haxe::ui::components::_TabBar::TabBarButton_obj::__alloc( HX_CTX );
            	}
