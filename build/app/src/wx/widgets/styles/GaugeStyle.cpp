...
bool GaugeStyle_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x1000c0e0;
}
...
static ::hx::StaticInfo GaugeStyle_obj_sStaticStorageInfo[] = {
	{::hx::fsInt,(void *) &GaugeStyle_obj::HORIZONTAL,HX_("HORIZONTAL",e4,70,cd,07)},
	{::hx::fsInt,(void *) &GaugeStyle_obj::VERTICAL,HX_("VERTICAL",76,4c,9b,c3)},
	{::hx::fsInt,(void *) &GaugeStyle_obj::SMOOTH,HX_("SMOOTH",2e,b4,ed,b9)},
	{ ::hx::fsUnknown, 0, null()}
};
#endif
...
static ::String GaugeStyle_obj_sStaticFields[] = {
	...
	HX_("SMOOTH",2e,b4,ed,b9),
	::String(null())
};

void GaugeStyle_obj::__register()
{
	GaugeStyle_obj _hx_dummy;
	GaugeStyle_obj::_hx_vtable = *(void **)&_hx_dummy;
	::hx::Static(__mClass) = new ::hx::Class_obj();
	__mClass->mName = HX_("wx.widgets.styles.GaugeStyle",d8,08,71,d1);
