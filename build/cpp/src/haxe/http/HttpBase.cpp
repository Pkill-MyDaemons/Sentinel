...
HX_DEFINE_STACK_FRAME(_hx_pos_b51bce7432a8fe4b_71_new,"haxe.http.HttpBase","new",0x98384fa9,"haxe.http.HttpBase.new","/opt/homebrew/lib/haxe/std/haxe/http/HttpBase.hx",71,0x1d30e27f)
HX_LOCAL_STACK_FRAME(_hx_pos_b51bce7432a8fe4b_85_setHeader,"haxe.http.HttpBase","setHeader",0xf9141ad8,"haxe.http.HttpBase.setHeader","/opt/homebrew/lib/haxe/std/haxe/http/HttpBase.hx",85,0x1d30e27f)
HX_LOCAL_STACK_FRAME(_hx_pos_b51bce7432a8fe4b_142_setPostData,"haxe.http.HttpBase","setPostData",0x36d5f0b5,"haxe.http.HttpBase.setPostData","/opt/homebrew/lib/haxe/std/haxe/http/HttpBase.hx",142,0x1d30e27f)
HX_LOCAL_STACK_FRAME(_hx_pos_b51bce7432a8fe4b_196___default_onData,"haxe.http.HttpBase","__default_onData",0xb2f8141e,"haxe.http.HttpBase.__default_onData","/opt/homebrew/lib/haxe/std/haxe/http/HttpBase.hx",196,0x1d30e27f)
HX_LOCAL_STACK_FRAME(_hx_pos_b51bce7432a8fe4b_205___default_onBytes,"haxe.http.HttpBase","__default_onBytes",0xcf297ff7,"haxe.http.HttpBase.__default_onBytes","/opt/homebrew/lib/haxe/std/haxe/http/HttpBase.hx",205,0x1d30e27f)
HX_LOCAL_STACK_FRAME(_hx_pos_b51bce7432a8fe4b_214___default_onError,"haxe.http.HttpBase","__default_onError",0x84bb4354,"haxe.http.HttpBase.__default_onError","/opt/homebrew/lib/haxe/std/haxe/http/HttpBase.hx",214,0x1d30e27f)
HX_LOCAL_STACK_FRAME(_hx_pos_b51bce7432a8fe4b_223___default_onStatus,"haxe.http.HttpBase","__default_onStatus",0x53b30a26,"haxe.http.HttpBase.__default_onStatus","/opt/homebrew/lib/haxe/std/haxe/http/HttpBase.hx",223,0x1d30e27f)
HX_LOCAL_STACK_FRAME(_hx_pos_b51bce7432a8fe4b_229_hasOnData,"haxe.http.HttpBase","hasOnData",0xc242adec,"haxe.http.HttpBase.hasOnData","/opt/homebrew/lib/haxe/std/haxe/http/HttpBase.hx",229,0x1d30e27f)
HX_LOCAL_STACK_FRAME(_hx_pos_b51bce7432a8fe4b_232_success,"haxe.http.HttpBase","success",0xfe1e7d8c,"haxe.http.HttpBase.success","/opt/homebrew/lib/haxe/std/haxe/http/HttpBase.hx",232,0x1d30e27f)
HX_LOCAL_STACK_FRAME(_hx_pos_b51bce7432a8fe4b_241_get_responseData,"haxe.http.HttpBase","get_responseData",0x92ecd8eb,"haxe.http.HttpBase.get_responseData","/opt/homebrew/lib/haxe/std/haxe/http/HttpBase.hx",241,0x1d30e27f)
namespace haxe{
namespace http{

void HttpBase_obj::__construct(::String url){
            	HX_STACKFRAME(&_hx_pos_b51bce7432a8fe4b_71_new)
...
void HttpBase_obj::setHeader(::String name,::String value){
            	HX_STACKFRAME(&_hx_pos_b51bce7432a8fe4b_85_setHeader)
HXLINE(  86)		{
HXLINE(  86)			int _g = 0;
...
void HttpBase_obj::setPostData(::String data){
            	HX_STACKFRAME(&_hx_pos_b51bce7432a8fe4b_142_setPostData)
...
void _hx_run(::String data){
            	HX_STACKFRAME(&_hx_pos_b51bce7432a8fe4b_196___default_onData)
            	}
...
void _hx_run( ::haxe::io::Bytes data){
            	HX_STACKFRAME(&_hx_pos_b51bce7432a8fe4b_205___default_onBytes)
            	}
HX_END_LOCAL_FUNC1((void))
HX_END_DEFAULT_FUNC
...
void _hx_run(::String msg){
            	HX_STACKFRAME(&_hx_pos_b51bce7432a8fe4b_214___default_onError)
            	}
HX_END_LOCAL_FUNC1((void))
HX_END_DEFAULT_FUNC
...
void _hx_run(int status){
            	HX_STACKFRAME(&_hx_pos_b51bce7432a8fe4b_223___default_onStatus)
            	}
HX_END_LOCAL_FUNC1((void))
HX_END_DEFAULT_FUNC

bool HttpBase_obj::hasOnData(){
            	HX_STACKFRAME(&_hx_pos_b51bce7432a8fe4b_229_hasOnData)
...
void HttpBase_obj::success( ::haxe::io::Bytes data){
            	HX_STACKFRAME(&_hx_pos_b51bce7432a8fe4b_232_success)
...
::String HttpBase_obj::get_responseData(){
            	HX_STACKFRAME(&_hx_pos_b51bce7432a8fe4b_241_get_responseData)
