...
HX_DEFINE_STACK_FRAME(_hx_pos_6dab477d00188c38_33_new,"sys.ssl.Certificate","new",0x5388a2e6,"sys.ssl.Certificate.new","/opt/homebrew/lib/haxe/std/cpp/_std/sys/ssl/Certificate.hx",33,0xad85b463)
HX_LOCAL_STACK_FRAME(_hx_pos_d4154975e9f2091d_134___init__,"::sys::ssl::Certificate_obj","__init__",0x6779d94e,"::sys::ssl::Certificate_obj.__init__","/opt/homebrew/lib/haxe/std/cpp/_std/sys/ssl/Certificate.hx",134,0xad85b463)
HX_LOCAL_STACK_FRAME(_hx_pos_6dab477d00188c38_39_loadFile,"sys.ssl.Certificate","loadFile",0xca3fe77c,"sys.ssl.Certificate.loadFile","/opt/homebrew/lib/haxe/std/cpp/_std/sys/ssl/Certificate.hx",39,0xad85b463)
HX_LOCAL_STACK_FRAME(_hx_pos_6dab477d00188c38_43_loadPath,"sys.ssl.Certificate","loadPath",0xd0d5fea5,"sys.ssl.Certificate.loadPath","/opt/homebrew/lib/haxe/std/cpp/_std/sys/ssl/Certificate.hx",43,0xad85b463)
HX_LOCAL_STACK_FRAME(_hx_pos_6dab477d00188c38_50_loadDefaults,"sys.ssl.Certificate","loadDefaults",0xcc9e6992,"sys.ssl.Certificate.loadDefaults","/opt/homebrew/lib/haxe/std/cpp/_std/sys/ssl/Certificate.hx",50,0xad85b463)
...
void Certificate_obj::__construct( ::Dynamic x, ::sys::ssl::Certificate h){
            	HX_STACKFRAME(&_hx_pos_6dab477d00188c38_33_new)
...
void Certificate_obj::__init__(){
            	HX_STACKFRAME(&_hx_pos_d4154975e9f2091d_134___init__)
HXDLIN( 134)		_hx_ssl_init();
            	}


 ::sys::ssl::Certificate Certificate_obj::loadFile(::String file){
            	HX_GC_STACKFRAME(&_hx_pos_6dab477d00188c38_39_loadFile)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Certificate_obj,loadFile,return )
 ...
 ::sys::ssl::Certificate Certificate_obj::loadPath(::String path){
            	HX_GC_STACKFRAME(&_hx_pos_6dab477d00188c38_43_loadPath)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Certificate_obj,loadPath,return )
 ...
 ::sys::ssl::Certificate Certificate_obj::loadDefaults(){
            	HX_GC_STACKFRAME(&_hx_pos_6dab477d00188c38_50_loadDefaults)
