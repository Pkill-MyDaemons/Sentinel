...
HXLINE(  16)		int style = ((::wx::widgets::styles::DialogStyle_obj::CAPTION | ::wx::widgets::styles::DialogStyle_obj::SYSTEM_MENU) | ::wx::widgets::Defs_obj::CENTRE);
HXLINE(  17)		if (this->_dialog->closable) {
HXLINE(  17)			style = (style | ::wx::widgets::styles::DialogStyle_obj::CLOSE_BOX);
            		}
HXLINE(  18)		params->push(style);
HXLINE(  19)		return params;
            	}
