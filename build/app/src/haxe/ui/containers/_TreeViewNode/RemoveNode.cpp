...
HX_DEFINE_STACK_FRAME(_hx_pos_df73aed6e95f91be_166_new,"haxe.ui.containers._TreeViewNode.RemoveNode","new",0x459ed52c,"haxe.ui.containers._TreeViewNode.RemoveNode.new","haxe/ui/containers/TreeViewNode.hx",166,0x9b33be2e)
HX_LOCAL_STACK_FRAME(_hx_pos_df73aed6e95f91be_167_call,"haxe.ui.containers._TreeViewNode.RemoveNode","call",0x9e134652,"haxe.ui.containers._TreeViewNode.RemoveNode.call","haxe/ui/containers/TreeViewNode.hx",167,0x9b33be2e)
namespace haxe{
namespace ui{
...
void RemoveNode_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_df73aed6e95f91be_166_new)
...
bool RemoveNode_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::haxe::ui::util::VariantType RemoveNode_obj::call( ::Dynamic param){
            	HX_STACKFRAME(&_hx_pos_df73aed6e95f91be_167_call)
HXLINE( 168)		 ::haxe::ui::containers::TreeViewNode node = ( ( ::haxe::ui::containers::TreeViewNode)(param) );
HXLINE( 169)		this->_component->removeComponent(node,null(),null());
HXLINE( 170)		return ::haxe::ui::util::_Variant::Variant_Impl__obj::fromComponent(node);
            	}
