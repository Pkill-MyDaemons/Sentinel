...
HX_LOCAL_STACK_FRAME(_hx_pos_eef86d0ad0db16ee_64_seek,"sys.io.FileInput","seek",0x37d7f1ff,"sys.io.FileInput.seek","/opt/homebrew/lib/haxe/std/cpp/_std/sys/io/FileInput.hx",64,0x68952500)
namespace sys{
namespace io{
...
void FileInput_obj::seek(int p, ::sys::io::FileSeek pos){
            	HX_STACKFRAME(&_hx_pos_eef86d0ad0db16ee_64_seek)
