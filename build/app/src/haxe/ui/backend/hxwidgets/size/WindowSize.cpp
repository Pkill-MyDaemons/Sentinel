...
HXLINE(  22)			 ::haxe::ui::core::Component _this1 = this->component;
HXDLIN(  22)			::Array< ::Dynamic> _hx_tmp2;
HXDLIN(  22)			if (::hx::IsNull( _this1->_children )) {
HXLINE(  22)				_hx_tmp2 = ::Array_obj< ::Dynamic>::__new(0);
            			}
            			else {
HXLINE(  22)				_hx_tmp2 = _this1->_children;
            			}
HXDLIN(  22)			 ::Dynamic _hx_tmp3 = _hx_tmp2->__get(0).StaticCast<  ::haxe::ui::core::Component >()->get_componentHeight();
HXDLIN(  22)			if (::hx::IsGreater( _hx_tmp3,this->component->get_componentHeight() )) {
...
HXLINE(  36)			 ::haxe::ui::core::Component _this1 = this->component;
HXDLIN(  36)			::Array< ::Dynamic> _hx_tmp2;
HXDLIN(  36)			if (::hx::IsNull( _this1->_children )) {
HXLINE(  36)				_hx_tmp2 = ::Array_obj< ::Dynamic>::__new(0);
            			}
            			else {
HXLINE(  36)				_hx_tmp2 = _this1->_children;
            			}
HXDLIN(  36)			 ::Dynamic _hx_tmp3 = _hx_tmp2->__get(0).StaticCast<  ::haxe::ui::core::Component >()->get_componentWidth();
HXDLIN(  36)			if (::hx::IsGreater( _hx_tmp3,this->component->get_componentWidth() )) {
