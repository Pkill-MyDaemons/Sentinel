...
HX_DEFINE_STACK_FRAME(_hx_pos_4f2b2cb206b06446_112_new,"haxe.ui.containers.menus._MenuItem.Builder","new",0xe1722b8c,"haxe.ui.containers.menus._MenuItem.Builder.new","haxe/ui/containers/menus/MenuItem.hx",112,0x19b927e6)
HX_LOCAL_STACK_FRAME(_hx_pos_4f2b2cb206b06446_113_create,"haxe.ui.containers.menus._MenuItem.Builder","create",0xe5314f50,"haxe.ui.containers.menus._MenuItem.Builder.create","haxe/ui/containers/menus/MenuItem.hx",113,0x19b927e6)
...
void Builder_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_4f2b2cb206b06446_112_new)
...
void Builder_obj::create(){
            	HX_GC_STACKFRAME(&_hx_pos_4f2b2cb206b06446_113_create)
HXLINE( 114)		this->super::create();
HXLINE( 116)		 ::haxe::ui::containers::HBox box =  ::haxe::ui::containers::HBox_obj::__alloc( HX_CTX );
HXLINE( 117)		box->set_id(HX_("menuitem-container",26,c0,84,fc));
HXLINE( 119)		box->set_verticalAlign(HX_("center",d5,25,db,05));
HXLINE( 121)		 ::haxe::ui::components::Label label =  ::haxe::ui::components::Label_obj::__alloc( HX_CTX );
HXLINE( 122)		label->set_id(HX_("menuitem-label",59,c2,dd,b5));
HXLINE( 124)		label->set_styleNames(HX_("menuitem-label",59,c2,dd,b5));
HXLINE( 125)		label->set_scriptAccess(false);
HXLINE( 126)		box->addComponent(label);
HXLINE( 128)		 ::haxe::ui::components::Label label1 =  ::haxe::ui::components::Label_obj::__alloc( HX_CTX );
HXLINE( 129)		label1->set_id(HX_("menuitem-shortcut-label",a8,00,78,8b));
HXLINE( 130)		label1->set_styleNames(HX_("menuitem-shortcut-label",a8,00,78,8b));
HXLINE( 131)		label1->set_scriptAccess(false);
HXLINE( 132)		box->addComponent(label1);
HXLINE( 134)		this->_component->addComponent(box);
            	}
