...
HXLINE(  26)		 ::hx::widgets::Bitmap bmp =  ::hx::widgets::Bitmap_obj::__alloc( HX_CTX ,null(),null());
...
static ::hx::StorageInfo StaticBitmap_obj_sMemberStorageInfo[] = {
	{::hx::fsUnknown /* ::cpp::Pointer<  wxStaticBitmap > */ ,(int)offsetof(StaticBitmap_obj,bitmapRef),HX_("bitmapRef",a4,e0,df,c6)},
	{ ::hx::fsUnknown, 0, null()}
};
...
{
	StaticBitmap_obj _hx_dummy;
	StaticBitmap_obj::_hx_vtable = *(void **)&_hx_dummy;
	::hx::Static(__mClass) = new ::hx::Class_obj();
	__mClass->mName = HX_("hx.widgets.StaticBitmap",1a,79,73,7c);
