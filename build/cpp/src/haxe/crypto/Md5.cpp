...
HX_DEFINE_STACK_FRAME(_hx_pos_f91a0d7ccbf22f8b_55_new,"haxe.crypto.Md5","new",0x90507feb,"haxe.crypto.Md5.new","/opt/homebrew/lib/haxe/std/haxe/crypto/Md5.hx",55,0x51835a0d)
HX_LOCAL_STACK_FRAME(_hx_pos_f91a0d7ccbf22f8b_57_bitOR,"haxe.crypto.Md5","bitOR",0xbf34737b,"haxe.crypto.Md5.bitOR","/opt/homebrew/lib/haxe/std/haxe/crypto/Md5.hx",57,0x51835a0d)
HX_LOCAL_STACK_FRAME(_hx_pos_f91a0d7ccbf22f8b_63_bitXOR,"haxe.crypto.Md5","bitXOR",0x8eb76a23,"haxe.crypto.Md5.bitXOR","/opt/homebrew/lib/haxe/std/haxe/crypto/Md5.hx",63,0x51835a0d)
HX_LOCAL_STACK_FRAME(_hx_pos_f91a0d7ccbf22f8b_69_bitAND,"haxe.crypto.Md5","bitAND",0x8ea5f55f,"haxe.crypto.Md5.bitAND","/opt/homebrew/lib/haxe/std/haxe/crypto/Md5.hx",69,0x51835a0d)
HX_LOCAL_STACK_FRAME(_hx_pos_f91a0d7ccbf22f8b_75_addme,"haxe.crypto.Md5","addme",0x2873c404,"haxe.crypto.Md5.addme","/opt/homebrew/lib/haxe/std/haxe/crypto/Md5.hx",75,0x51835a0d)
HX_LOCAL_STACK_FRAME(_hx_pos_f91a0d7ccbf22f8b_81_hex,"haxe.crypto.Md5","hex",0x904bf266,"haxe.crypto.Md5.hex","/opt/homebrew/lib/haxe/std/haxe/crypto/Md5.hx",81,0x51835a0d)
HX_LOCAL_STACK_FRAME(_hx_pos_f91a0d7ccbf22f8b_155_rol,"haxe.crypto.Md5","rol",0x9053919a,"haxe.crypto.Md5.rol","/opt/homebrew/lib/haxe/std/haxe/crypto/Md5.hx",155,0x51835a0d)
HX_LOCAL_STACK_FRAME(_hx_pos_f91a0d7ccbf22f8b_159_cmn,"haxe.crypto.Md5","cmn",0x90482e0f,"haxe.crypto.Md5.cmn","/opt/homebrew/lib/haxe/std/haxe/crypto/Md5.hx",159,0x51835a0d)
HX_LOCAL_STACK_FRAME(_hx_pos_f91a0d7ccbf22f8b_163_ff,"haxe.crypto.Md5","ff",0xde352415,"haxe.crypto.Md5.ff","/opt/homebrew/lib/haxe/std/haxe/crypto/Md5.hx",163,0x51835a0d)
HX_LOCAL_STACK_FRAME(_hx_pos_f91a0d7ccbf22f8b_167_gg,"haxe.crypto.Md5","gg",0xde3524f5,"haxe.crypto.Md5.gg","/opt/homebrew/lib/haxe/std/haxe/crypto/Md5.hx",167,0x51835a0d)
HX_LOCAL_STACK_FRAME(_hx_pos_f91a0d7ccbf22f8b_171_hh,"haxe.crypto.Md5","hh",0xde3525d5,"haxe.crypto.Md5.hh","/opt/homebrew/lib/haxe/std/haxe/crypto/Md5.hx",171,0x51835a0d)
HX_LOCAL_STACK_FRAME(_hx_pos_f91a0d7ccbf22f8b_175_ii,"haxe.crypto.Md5","ii",0xde3526b5,"haxe.crypto.Md5.ii","/opt/homebrew/lib/haxe/std/haxe/crypto/Md5.hx",175,0x51835a0d)
HX_LOCAL_STACK_FRAME(_hx_pos_f91a0d7ccbf22f8b_178_doEncode,"haxe.crypto.Md5","doEncode",0x943f9096,"haxe.crypto.Md5.doEncode","/opt/homebrew/lib/haxe/std/haxe/crypto/Md5.hx",178,0x51835a0d)
HX_LOCAL_STACK_FRAME(_hx_pos_f91a0d7ccbf22f8b_29_encode,"haxe.crypto.Md5","encode",0x979f4b6b,"haxe.crypto.Md5.encode","/opt/homebrew/lib/haxe/std/haxe/crypto/Md5.hx",29,0x51835a0d)
HX_LOCAL_STACK_FRAME(_hx_pos_f91a0d7ccbf22f8b_120_str2blks,"haxe.crypto.Md5","str2blks",0x2f788968,"haxe.crypto.Md5.str2blks","/opt/homebrew/lib/haxe/std/haxe/crypto/Md5.hx",120,0x51835a0d)
namespace haxe{
namespace crypto{

void Md5_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_f91a0d7ccbf22f8b_55_new)
            	}
...
int Md5_obj::bitOR(int a,int b){
            	HX_STACKFRAME(&_hx_pos_f91a0d7ccbf22f8b_57_bitOR)
...
int Md5_obj::bitXOR(int a,int b){
            	HX_STACKFRAME(&_hx_pos_f91a0d7ccbf22f8b_63_bitXOR)
...
int Md5_obj::bitAND(int a,int b){
            	HX_STACKFRAME(&_hx_pos_f91a0d7ccbf22f8b_69_bitAND)
...
int Md5_obj::addme(int x,int y){
            	HX_STACKFRAME(&_hx_pos_f91a0d7ccbf22f8b_75_addme)
...
::String Md5_obj::hex(::Array< int > a){
            	HX_STACKFRAME(&_hx_pos_f91a0d7ccbf22f8b_81_hex)
...
int Md5_obj::rol(int num,int cnt){
            	HX_STACKFRAME(&_hx_pos_f91a0d7ccbf22f8b_155_rol)
...
int Md5_obj::cmn(int q,int a,int b,int x,int s,int t){
            	HX_STACKFRAME(&_hx_pos_f91a0d7ccbf22f8b_159_cmn)
...
int Md5_obj::ff(int a,int b,int c,int d,int x,int s,int t){
            	HX_STACKFRAME(&_hx_pos_f91a0d7ccbf22f8b_163_ff)
...
int Md5_obj::gg(int a,int b,int c,int d,int x,int s,int t){
            	HX_STACKFRAME(&_hx_pos_f91a0d7ccbf22f8b_167_gg)
...
int Md5_obj::hh(int a,int b,int c,int d,int x,int s,int t){
            	HX_STACKFRAME(&_hx_pos_f91a0d7ccbf22f8b_171_hh)
...
int Md5_obj::ii(int a,int b,int c,int d,int x,int s,int t){
            	HX_STACKFRAME(&_hx_pos_f91a0d7ccbf22f8b_175_ii)
...
::Array< int > Md5_obj::doEncode(::Array< int > x){
            	HX_STACKFRAME(&_hx_pos_f91a0d7ccbf22f8b_178_doEncode)
...
::String Md5_obj::encode(::String s){
            	HX_GC_STACKFRAME(&_hx_pos_f91a0d7ccbf22f8b_29_encode)
...
::Array< int > Md5_obj::str2blks(::String str){
            	HX_STACKFRAME(&_hx_pos_f91a0d7ccbf22f8b_120_str2blks)
...
HXDLIN( 145)		int index1 = (i >> 2);
HXDLIN( 145)		blks2[index1] = (blks2->__get(index1) | (128 << (::hx::Mod((l + i),4) * 8)));
HXLINE( 146)		int k = ((nblk * 16) - 2);
HXLINE( 147)		blks[k] = (l & 255);
HXLINE( 148)		::Array< int > blks3 = blks;
HXDLIN( 148)		int k1 = k;
HXDLIN( 148)		blks3[k1] = (blks3->__get(k1) | ((::hx::UShr(l,8) & 255) << 8));
HXLINE( 149)		::Array< int > blks4 = blks;
HXDLIN( 149)		int k2 = k;
HXDLIN( 149)		blks4[k2] = (blks4->__get(k2) | ((::hx::UShr(l,16) & 255) << 16));
HXLINE( 150)		::Array< int > blks5 = blks;
HXDLIN( 150)		int k3 = k;
HXDLIN( 150)		blks5[k3] = (blks5->__get(k3) | ((::hx::UShr(l,24) & 255) << 24));
