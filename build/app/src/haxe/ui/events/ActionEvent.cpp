...
bool ActionEvent_obj::__GetStatic(const ::String &inName, Dynamic &outValue, ::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 10:
		if (HX_FIELD_EQ(inName,"ACTION_END") ) { outValue = ( ACTION_END ); return true; }
		break;
	case 12:
		if (HX_FIELD_EQ(inName,"ACTION_START") ) { outValue = ( ACTION_START ); return true; }
	}
	return false;
}
...
bool ActionEvent_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 10:
		if (HX_FIELD_EQ(inName,"ACTION_END") ) { ACTION_END=ioValue.Cast< ::String >(); return true; }
		break;
	case 12:
		if (HX_FIELD_EQ(inName,"ACTION_START") ) { ACTION_START=ioValue.Cast< ::String >(); return true; }
	}
	return false;
}
...
void ActionEvent_obj::__register()
{
	...
	__mClass->mGetStaticField = &ActionEvent_obj::__GetStatic;
	__mClass->mSetStaticField = &ActionEvent_obj::__SetStatic;
...
HXDLIN(   5)		ACTION_START = ::haxe::ui::events::_EventType::EventType_Impl__obj::name(HX_("actionstart",ec,04,43,c3));
            	}
{
            	HX_STACKFRAME(&_hx_pos_7005d81cc0561536_6_boot)
HXDLIN(   6)		ACTION_END = ::haxe::ui::events::_EventType::EventType_Impl__obj::name(HX_("actionend",e5,7d,aa,11));
            	}
}
