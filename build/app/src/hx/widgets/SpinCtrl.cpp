...
HX_LOCAL_STACK_FRAME(_hx_pos_d600236ec1c343fd_29_get_min,"hx.widgets.SpinCtrl","get_min",0xa187e4a5,"hx.widgets.SpinCtrl.get_min","hx/widgets/SpinCtrl.hx",29,0x99d87452)
HX_LOCAL_STACK_FRAME(_hx_pos_d600236ec1c343fd_31_set_min,"hx.widgets.SpinCtrl","set_min",0x948975b1,"hx.widgets.SpinCtrl.set_min","hx/widgets/SpinCtrl.hx",31,0x99d87452)
HX_LOCAL_STACK_FRAME(_hx_pos_d600236ec1c343fd_38_get_max,"hx.widgets.SpinCtrl","get_max",0xa187ddb7,"hx.widgets.SpinCtrl.get_max","hx/widgets/SpinCtrl.hx",38,0x99d87452)
HX_LOCAL_STACK_FRAME(_hx_pos_d600236ec1c343fd_40_set_max,"hx.widgets.SpinCtrl","set_max",0x94896ec3,"hx.widgets.SpinCtrl.set_max","hx/widgets/SpinCtrl.hx",40,0x99d87452)
HX_LOCAL_STACK_FRAME(_hx_pos_d600236ec1c343fd_51_get_spinCtrlRef,"hx.widgets.SpinCtrl","get_spinCtrlRef",0xe2ae05d9,"hx.widgets.SpinCtrl.get_spinCtrlRef","hx/widgets/SpinCtrl.hx",51,0x99d87452)
namespace hx{
namespace widgets{
...
int SpinCtrl_obj::get_min(){
            	HX_STACKFRAME(&_hx_pos_d600236ec1c343fd_29_get_min)
HXDLIN(  29)		return this->get_spinCtrlRef()->ptr->GetMin();
            	}


HX_DEFINE_DYNAMIC_FUNC0(SpinCtrl_obj,get_min,return )

int SpinCtrl_obj::set_min(int value){
            	HX_STACKFRAME(&_hx_pos_d600236ec1c343fd_31_set_min)
HXLINE(  32)		 wxSpinCtrl * _hx_tmp = this->get_spinCtrlRef()->ptr;
HXDLIN(  32)		(*(_hx_tmp)).SetRange(value,this->get_max());
HXLINE(  33)		return value;
            	}


HX_DEFINE_DYNAMIC_FUNC1(SpinCtrl_obj,set_min,return )

int SpinCtrl_obj::get_max(){
            	HX_STACKFRAME(&_hx_pos_d600236ec1c343fd_38_get_max)
HXDLIN(  38)		return this->get_spinCtrlRef()->ptr->GetMax();
            	}


HX_DEFINE_DYNAMIC_FUNC0(SpinCtrl_obj,get_max,return )

int SpinCtrl_obj::set_max(int value){
            	HX_STACKFRAME(&_hx_pos_d600236ec1c343fd_40_set_max)
HXLINE(  41)		 wxSpinCtrl * _hx_tmp = this->get_spinCtrlRef()->ptr;
HXDLIN(  41)		(*(_hx_tmp)).SetRange(this->get_min(),value);
HXLINE(  42)		return value;
            	}


HX_DEFINE_DYNAMIC_FUNC1(SpinCtrl_obj,set_max,return )

::cpp::Pointer<  wxSpinCtrl > SpinCtrl_obj::get_spinCtrlRef(){
            	HX_STACKFRAME(&_hx_pos_d600236ec1c343fd_51_get_spinCtrlRef)
