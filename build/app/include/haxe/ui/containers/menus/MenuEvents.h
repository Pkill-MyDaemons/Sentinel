...
class HXCPP_CLASS_ATTRIBUTES MenuEvents_obj : public  ::haxe::ui::events::Events_obj
{
	...
	public:
		...
		static void __boot();
		static int TIME_MOUSE_OPENS_MS;
		...
		::Dynamic onItemClick_dyn();
		 ...
		 ::haxe::ui::events::MouseEvent lastEventSubMenu;
		void onItemMouseOver( ::haxe::ui::events::MouseEvent event);
		::Dynamic onItemMouseOver_dyn();

		bool isMouseAimingForSubMenu( ::haxe::ui::events::MouseEvent event);
		::Dynamic isMouseAimingForSubMenu_dyn();
