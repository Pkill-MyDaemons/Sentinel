...
class HXCPP_CLASS_ATTRIBUTES Bitmap_obj : public  ::hx::widgets::GDIObject_obj
{
	...
	public:
		enum { _hx_ClassId = 0x593c61a6 };

		void __construct( ::hx::widgets::Image image,::cpp::Pointer<  wxBitmap > bitmap);
		...
		static ::hx::ObjectPtr< Bitmap_obj > __new( ::hx::widgets::Image image,::cpp::Pointer<  wxBitmap > bitmap);
		static ::hx::ObjectPtr< Bitmap_obj > __alloc(::hx::Ctx *_hx_ctx, ::hx::widgets::Image image,::cpp::Pointer<  wxBitmap > bitmap);
		...
		::Dynamic getSubBitmap_dyn();
		 ...
		 ::hx::widgets::Image convertToImage();
		::Dynamic convertToImage_dyn();

		bool equals( ::hx::widgets::Bitmap bmp);
		::Dynamic equals_dyn();
