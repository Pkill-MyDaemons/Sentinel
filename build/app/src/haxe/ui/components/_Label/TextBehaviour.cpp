...
HX_DEFINE_STACK_FRAME(_hx_pos_8d3364b1bfc8293e_130_new,"haxe.ui.components._Label.TextBehaviour","new",0xc370ad8f,"haxe.ui.components._Label.TextBehaviour.new","haxe/ui/components/Label.hx",130,0xeb990e51)
HX_LOCAL_STACK_FRAME(_hx_pos_8d3364b1bfc8293e_131_validateData,"haxe.ui.components._Label.TextBehaviour","validateData",0x26eedad1,"haxe.ui.components._Label.TextBehaviour.validateData","haxe/ui/components/Label.hx",131,0xeb990e51)
namespace haxe{
namespace ui{
...
void TextBehaviour_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_8d3364b1bfc8293e_130_new)
...
void TextBehaviour_obj::validateData(){
            	HX_GC_STACKFRAME(&_hx_pos_8d3364b1bfc8293e_131_validateData)
HXLINE( 132)		 ::haxe::ui::styles::Style _hx_tmp = this->_component->getTextDisplay()->get_textStyle();
HXDLIN( 132)		if (::hx::IsInstanceNotEq( _hx_tmp,this->_component->get_style() )) {
HXLINE( 133)			 ::haxe::ui::core::Component _this = this->_component;
HXDLIN( 133)			_this->invalidateComponent(HX_("style",31,a5,1d,84),false);
HXDLIN( 133)			_this->_style = null();
            		}
HXLINE( 135)		 ::haxe::ui::core::TextDisplay _hx_tmp1 = this->_component->getTextDisplay();
HXDLIN( 135)		::String _hx_tmp2;
HXDLIN( 135)		if (::hx::IsNull( this->_value )) {
HXLINE( 135)			_hx_tmp2 = HX_("null",87,9e,0e,49);
            		}
            		else {
HXLINE( 135)			_hx_tmp2 = ::haxe::ui::util::_Variant::Variant_Impl__obj::toString(this->_value);
            		}
HXDLIN( 135)		_hx_tmp1->set_text((HX_("",00,00,00,00) + _hx_tmp2));
HXLINE( 136)		 ::haxe::ui::core::Component _hx_tmp3 = this->_component;
HXDLIN( 136)		_hx_tmp3->dispatch( ::haxe::ui::events::UIEvent_obj::__alloc( HX_CTX ,::haxe::ui::events::UIEvent_obj::CHANGE,null(),null()),null());
            	}
