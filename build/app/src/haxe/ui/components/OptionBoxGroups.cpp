...
HX_DEFINE_STACK_FRAME(_hx_pos_4d0c124ac8f3c03a_185_new,"haxe.ui.components.OptionBoxGroups","new",0x79379796,"haxe.ui.components.OptionBoxGroups.new","haxe/ui/components/OptionBox.hx",185,0x8f34a36f)
HX_LOCAL_STACK_FRAME(_hx_pos_4d0c124ac8f3c03a_191_get,"haxe.ui.components.OptionBoxGroups","get",0x793247cc,"haxe.ui.components.OptionBoxGroups.get","haxe/ui/components/OptionBox.hx",191,0x8f34a36f)
HX_LOCAL_STACK_FRAME(_hx_pos_4d0c124ac8f3c03a_195_set,"haxe.ui.components.OptionBoxGroups","set",0x793b62d8,"haxe.ui.components.OptionBoxGroups.set","haxe/ui/components/OptionBox.hx",195,0x8f34a36f)
HX_LOCAL_STACK_FRAME(_hx_pos_4d0c124ac8f3c03a_198_add,"haxe.ui.components.OptionBoxGroups","add",0x792db957,"haxe.ui.components.OptionBoxGroups.add","haxe/ui/components/OptionBox.hx",198,0x8f34a36f)
HX_LOCAL_STACK_FRAME(_hx_pos_4d0c124ac8f3c03a_210_remove,"haxe.ui.components.OptionBoxGroups","remove",0xa8acbace,"haxe.ui.components.OptionBoxGroups.remove","haxe/ui/components/OptionBox.hx",210,0x8f34a36f)
HX_LOCAL_STACK_FRAME(_hx_pos_4d0c124ac8f3c03a_222_reset,"haxe.ui.components.OptionBoxGroups","reset",0x3594ca85,"haxe.ui.components.OptionBoxGroups.reset","haxe/ui/components/OptionBox.hx",222,0x8f34a36f)
HX_LOCAL_STACK_FRAME(_hx_pos_4d0c124ac8f3c03a_175_get_instance,"haxe.ui.components.OptionBoxGroups","get_instance",0x549b75a8,"haxe.ui.components.OptionBoxGroups.get_instance","haxe/ui/components/OptionBox.hx",175,0x8f34a36f)
namespace haxe{
namespace ui{
namespace components{

void OptionBoxGroups_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_4d0c124ac8f3c03a_185_new)
HXDLIN( 185)		this->_groups =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
            	}
...
::Array< ::Dynamic> OptionBoxGroups_obj::get(::String name){
            	HX_STACKFRAME(&_hx_pos_4d0c124ac8f3c03a_191_get)
HXDLIN( 191)		return ( (::Array< ::Dynamic>)(this->_groups->get(name)) );
            	}
...
void OptionBoxGroups_obj::set(::String name,::Array< ::Dynamic> options){
            	HX_STACKFRAME(&_hx_pos_4d0c124ac8f3c03a_195_set)
HXDLIN( 195)		this->_groups->set(name,options);
            	}
...
void OptionBoxGroups_obj::add(::String name, ::haxe::ui::components::OptionBox optionbox){
            	HX_STACKFRAME(&_hx_pos_4d0c124ac8f3c03a_198_add)
HXLINE( 199)		::Array< ::Dynamic> arr = this->get(name);
HXLINE( 200)		if (::hx::IsNull( arr )) {
HXLINE( 201)			arr = ::Array_obj< ::Dynamic>::__new(0);
            		}
HXLINE( 204)		if ((arr->indexOf(optionbox,null()) == -1)) {
HXLINE( 205)			arr->push(optionbox);
            		}
HXLINE( 207)		this->set(name,arr);
            	}
...
void OptionBoxGroups_obj::remove(::String name, ::haxe::ui::components::OptionBox optionbox){
            	HX_STACKFRAME(&_hx_pos_4d0c124ac8f3c03a_210_remove)
HXLINE( 211)		::Array< ::Dynamic> arr = this->get(name);
HXLINE( 212)		if (::hx::IsNull( arr )) {
HXLINE( 213)			return;
            		}
HXLINE( 216)		arr->remove(optionbox);
HXLINE( 217)		if ((arr->length == 0)) {
HXLINE( 218)			this->_groups->remove(name);
            		}
            	}
...
void OptionBoxGroups_obj::reset(::String name){
            	HX_STACKFRAME(&_hx_pos_4d0c124ac8f3c03a_222_reset)
HXLINE( 223)		::Array< ::Dynamic> arr = this->get(name);
HXLINE( 224)		if (::hx::IsNull( arr )) {
HXLINE( 225)			return;
            		}
HXLINE( 228)		 ::haxe::ui::components::OptionBox selection = null();
HXLINE( 229)		{
HXLINE( 229)			int _g = 0;
HXDLIN( 229)			while((_g < arr->length)){
HXLINE( 229)				 ::haxe::ui::components::OptionBox item = arr->__get(_g).StaticCast<  ::haxe::ui::components::OptionBox >();
HXDLIN( 229)				_g = (_g + 1);
HXLINE( 230)				if ((item->get_selected() == true)) {
HXLINE( 231)					selection = item;
HXLINE( 232)					goto _hx_goto_5;
            				}
            			}
            			_hx_goto_5:;
            		}
HXLINE( 236)		if (::hx::IsNull( selection )) {
HXLINE( 237)			return;
            		}
HXLINE( 240)		::hx::TCast<  ::haxe::ui::components::OptionBoxBuilder >::cast(selection->_compositeBuilder)->setSelection(selection,false,true);
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(OptionBoxGroups_obj,reset,(void))
 ...
 ::haxe::ui::components::OptionBoxGroups OptionBoxGroups_obj::get_instance(){
            	HX_GC_STACKFRAME(&_hx_pos_4d0c124ac8f3c03a_175_get_instance)
HXLINE( 176)		if (::hx::IsNull( ::haxe::ui::components::OptionBoxGroups_obj::_instance )) {
HXLINE( 177)			::haxe::ui::components::OptionBoxGroups_obj::_instance =  ::haxe::ui::components::OptionBoxGroups_obj::__alloc( HX_CTX );
            		}
HXLINE( 179)		return ::haxe::ui::components::OptionBoxGroups_obj::_instance;
            	}
