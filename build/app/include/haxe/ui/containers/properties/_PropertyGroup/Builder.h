...
class HXCPP_CLASS_ATTRIBUTES Builder_obj : public  ::haxe::ui::core::CompositeBuilder_obj
{
	...
	public:
		...
		void applyForPropertyRow( ::haxe::ui::core::Component target, ::Dynamic cb);
		::Dynamic applyForPropertyRow_dyn();

		void onPropertyEditorChange( ::haxe::ui::events::UIEvent event);
		::Dynamic onPropertyEditorChange_dyn();

		void onPropertyEditorClick( ::haxe::ui::events::UIEvent event);
		::Dynamic onPropertyEditorClick_dyn();
