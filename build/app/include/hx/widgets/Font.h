...
class HXCPP_CLASS_ATTRIBUTES Font_obj : public  ::hx::widgets::GDIObject_obj
{
	...
	public:
		enum { _hx_ClassId = 0x6d21678e };

		void __construct(::hx::Null< int >  __o_size, ::Dynamic family, ::Dynamic style, ::Dynamic weight,::hx::Null< bool >  __o_underlined,::String faceName);
		...
		static ::hx::ObjectPtr< Font_obj > __new(::hx::Null< int >  __o_size, ::Dynamic family, ::Dynamic style, ::Dynamic weight,::hx::Null< bool >  __o_underlined,::String faceName);
		static ::hx::ObjectPtr< Font_obj > __alloc(::hx::Ctx *_hx_ctx,::hx::Null< int >  __o_size, ::Dynamic family, ::Dynamic style, ::Dynamic weight,::hx::Null< bool >  __o_underlined,::String faceName);
		...
		::String set_faceName(::String value);
