...
HX_DEFINE_STACK_FRAME(_hx_pos_bae50982b9dbaef1_273_new,"haxe.ui.components._TextField.IconBehaviour","new",0x4c9203dc,"haxe.ui.components._TextField.IconBehaviour.new","haxe/ui/components/TextField.hx",273,0x9dfe9498)
HX_LOCAL_STACK_FRAME(_hx_pos_bae50982b9dbaef1_274_validateData,"haxe.ui.components._TextField.IconBehaviour","validateData",0xcc58d2e4,"haxe.ui.components._TextField.IconBehaviour.validateData","haxe/ui/components/TextField.hx",274,0x9dfe9498)
namespace haxe{
namespace ui{
...
void IconBehaviour_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_bae50982b9dbaef1_273_new)
...
void IconBehaviour_obj::validateData(){
            	HX_GC_STACKFRAME(&_hx_pos_bae50982b9dbaef1_274_validateData)
HXLINE( 275)		 ::haxe::ui::components::TextField textfield = ::hx::TCast<  ::haxe::ui::components::TextField >::cast(this->_component);
HXLINE( 276)		 ::haxe::ui::components::Image icon = textfield->findComponent(null(),::hx::ClassOf< ::haxe::ui::components::Image >(),false,null()).StaticCast<  ::haxe::ui::components::Image >();
HXLINE( 277)		bool _hx_tmp;
HXDLIN( 277)		bool _hx_tmp1;
HXDLIN( 277)		if (::hx::IsNotNull( this->_value )) {
HXLINE( 277)			_hx_tmp1 = ::haxe::ui::util::_Variant::Variant_Impl__obj::get_isNull(this->_value);
            		}
            		else {
HXLINE( 277)			_hx_tmp1 = true;
            		}
HXDLIN( 277)		if (_hx_tmp1) {
HXLINE( 277)			_hx_tmp = ::hx::IsNotNull( icon );
            		}
            		else {
HXLINE( 277)			_hx_tmp = false;
            		}
HXDLIN( 277)		if (_hx_tmp) {
HXLINE( 278)			textfield->removeComponent(icon,null(),null());
            		}
            		else {
HXLINE( 280)			if (::hx::IsNull( icon )) {
HXLINE( 281)				icon =  ::haxe::ui::components::Image_obj::__alloc( HX_CTX );
HXLINE( 282)				icon->set_id(HX_("textfield-icon",19,52,0f,5b));
HXLINE( 283)				icon->addClass(HX_("icon",79,e7,b2,45),null(),null());
HXLINE( 284)				icon->set_scriptAccess(false);
HXLINE( 285)				textfield->addComponentAt(icon,0);
            			}
HXLINE( 287)			icon->set_resource(::haxe::ui::util::_Variant::Variant_Impl__obj::fromString(::haxe::ui::util::_Variant::Variant_Impl__obj::toString(this->_value)));
            		}
            	}
