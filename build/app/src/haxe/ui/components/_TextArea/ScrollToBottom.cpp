...
HX_DEFINE_STACK_FRAME(_hx_pos_b42e19636eed0715_288_new,"haxe.ui.components._TextArea.ScrollToBottom","new",0x6131fd00,"haxe.ui.components._TextArea.ScrollToBottom.new","haxe/ui/components/TextArea.hx",288,0xfe441d7d)
HX_LOCAL_STACK_FRAME(_hx_pos_b42e19636eed0715_289_call,"haxe.ui.components._TextArea.ScrollToBottom","call",0xa342f7fe,"haxe.ui.components._TextArea.ScrollToBottom.call","haxe/ui/components/TextArea.hx",289,0xfe441d7d)
namespace haxe{
namespace ui{
...
void ScrollToBottom_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_b42e19636eed0715_288_new)
...
bool ScrollToBottom_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x3c5dd90d) {
		...
		return inClassId==(int)0x441046d4;
	}
}

 ::haxe::ui::util::VariantType ScrollToBottom_obj::call( ::Dynamic param){
            	HX_STACKFRAME(&_hx_pos_b42e19636eed0715_289_call)
HXLINE( 290)		 ::haxe::ui::components::VerticalScroll vscroll = this->_component->findComponent(null(),::hx::ClassOf< ::haxe::ui::components::VerticalScroll >(),false,null()).StaticCast<  ::haxe::ui::components::VerticalScroll >();
HXLINE( 291)		if (::hx::IsNotNull( vscroll )) {
HXLINE( 292)			vscroll->set_pos(vscroll->get_max());
            		}
