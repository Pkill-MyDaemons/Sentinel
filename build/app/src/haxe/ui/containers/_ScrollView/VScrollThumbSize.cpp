...
HX_DEFINE_STACK_FRAME(_hx_pos_2f081d39f226dea4_515_new,"haxe.ui.containers._ScrollView.VScrollThumbSize","new",0xa0b46aad,"haxe.ui.containers._ScrollView.VScrollThumbSize.new","haxe/ui/containers/ScrollView.hx",515,0x01b76681)
HX_LOCAL_STACK_FRAME(_hx_pos_2f081d39f226dea4_521_validateData,"haxe.ui.containers._ScrollView.VScrollThumbSize","validateData",0x8c8589f3,"haxe.ui.containers._ScrollView.VScrollThumbSize.validateData","haxe/ui/containers/ScrollView.hx",521,0x01b76681)
namespace haxe{
namespace ui{
...
void VScrollThumbSize_obj::__construct( ::haxe::ui::containers::ScrollView scrollview){
            	HX_STACKFRAME(&_hx_pos_2f081d39f226dea4_515_new)
HXLINE( 516)		super::__construct(scrollview);
HXLINE( 517)		this->_scrollview = scrollview;
            	}
...
void VScrollThumbSize_obj::validateData(){
            	HX_STACKFRAME(&_hx_pos_2f081d39f226dea4_521_validateData)
HXDLIN( 521)		if ((this->_scrollview->get_virtual() == true)) {
HXLINE( 522)			 ::haxe::ui::components::VerticalScroll vscroll = this->_scrollview->findComponent(null(),::hx::ClassOf< ::haxe::ui::components::VerticalScroll >(),false,null()).StaticCast<  ::haxe::ui::components::VerticalScroll >();
HXLINE( 523)			if (::hx::IsNull( vscroll )) {
HXLINE( 524)				vscroll = ::hx::TCast<  ::haxe::ui::containers::ScrollViewBuilder >::cast(this->_scrollview->_compositeBuilder)->createVScroll();
            			}
HXLINE( 526)			if (::hx::IsNotNull( vscroll )) {
HXLINE( 527)				vscroll->set_thumbSize(::haxe::ui::util::_Variant::Variant_Impl__obj::toFloat(this->_value));
            			}
            		}
            	}
