...
HX_LOCAL_STACK_FRAME(_hx_pos_dc5d2f1fbec87564_700_cloneLayout,"haxe.ui.layouts.HorizontalContinuousLayout","cloneLayout",0x86fba40d,"haxe.ui.layouts.HorizontalContinuousLayout.cloneLayout","haxe/ui/macros/helpers/ClassBuilder.hx",700,0x8cdaad7b)
HX_LOCAL_STACK_FRAME(_hx_pos_555f0a33327242d7_113_self,"haxe.ui.layouts.HorizontalContinuousLayout","self",0x4f90b8a6,"haxe.ui.layouts.HorizontalContinuousLayout.self","haxe/ui/macros/LayoutMacros.hx",113,0xe44eaad7)
namespace haxe{
namespace ui{
namespace layouts{
...
HXLINE( 193)		return  ::haxe::ui::geom::Size_obj::__alloc( HX_CTX ,ucx,ucy);
 ...
 ::haxe::ui::layouts::Layout HorizontalContinuousLayout_obj::cloneLayout(){
            	HX_STACKFRAME(&_hx_pos_dc5d2f1fbec87564_700_cloneLayout)
HXLINE(  85)		 ::haxe::ui::layouts::HorizontalContinuousLayout c = ( ( ::haxe::ui::layouts::HorizontalContinuousLayout)(this->super::cloneLayout()) );
HXLINE( 101)		return c;
            	}


 ::haxe::ui::layouts::Layout HorizontalContinuousLayout_obj::self(){
            	HX_GC_STACKFRAME(&_hx_pos_555f0a33327242d7_113_self)
HXDLIN( 113)		return  ::haxe::ui::layouts::HorizontalContinuousLayout_obj::__alloc( HX_CTX );
            	}
