...
HX_DEFINE_STACK_FRAME(_hx_pos_73e3f42abe9d2281_304_new,"haxe.ui.containers._ScrollView.HScrollPos","new",0x407b4e98,"haxe.ui.containers._ScrollView.HScrollPos.new","haxe/ui/containers/ScrollView.hx",304,0x01b76681)
HX_LOCAL_STACK_FRAME(_hx_pos_73e3f42abe9d2281_309_get,"haxe.ui.containers._ScrollView.HScrollPos","get",0x4075fece,"haxe.ui.containers._ScrollView.HScrollPos.get","haxe/ui/containers/ScrollView.hx",309,0x01b76681)
HX_LOCAL_STACK_FRAME(_hx_pos_73e3f42abe9d2281_317_validateData,"haxe.ui.containers._ScrollView.HScrollPos","validateData",0x50a650a8,"haxe.ui.containers._ScrollView.HScrollPos.validateData","haxe/ui/containers/ScrollView.hx",317,0x01b76681)
namespace haxe{
namespace ui{
...
void HScrollPos_obj::__construct( ::haxe::ui::containers::ScrollView scrollview){
            	HX_STACKFRAME(&_hx_pos_73e3f42abe9d2281_304_new)
HXLINE( 305)		super::__construct(scrollview);
HXLINE( 306)		this->_scrollview = scrollview;
            	}
...
bool HScrollPos_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::haxe::ui::util::VariantType HScrollPos_obj::get(){
            	HX_STACKFRAME(&_hx_pos_73e3f42abe9d2281_309_get)
...
HXLINE( 311)		if (::hx::IsNull( hscroll )) {
HXLINE( 312)			return ::haxe::ui::util::_Variant::Variant_Impl__obj::fromInt(0);
            		}
HXLINE( 314)		return ::haxe::ui::util::_Variant::Variant_Impl__obj::fromFloat(hscroll->get_pos());
            	}


void HScrollPos_obj::validateData(){
            	HX_STACKFRAME(&_hx_pos_73e3f42abe9d2281_317_validateData)
HXLINE( 318)		 ::haxe::ui::components::HorizontalScroll hscroll = this->_scrollview->findComponent(null(),::hx::ClassOf< ::haxe::ui::components::HorizontalScroll >(),false,null()).StaticCast<  ::haxe::ui::components::HorizontalScroll >();
HXLINE( 319)		if ((this->_scrollview->get_virtual() == true)) {
HXLINE( 320)			if (::hx::IsNull( hscroll )) {
HXLINE( 321)				hscroll = ::hx::TCast<  ::haxe::ui::containers::ScrollViewBuilder >::cast(this->_scrollview->_compositeBuilder)->createHScroll();
            			}
HXLINE( 323)			if (::hx::IsNotNull( hscroll )) {
HXLINE( 324)				hscroll->set_pos(( (Float)(::haxe::ui::util::_Variant::Variant_Impl__obj::toFloat(this->_value)) ));
            			}
            		}
            		else {
HXLINE( 327)			if (::hx::IsNotNull( hscroll )) {
HXLINE( 328)				hscroll->set_pos(( (Float)(::haxe::ui::util::_Variant::Variant_Impl__obj::toFloat(this->_value)) ));
            			}
            		}
            	}
