...
HXDLIN( 170)				if (::hx::IsGreater( icon->get_height(),0 )) {
...
HXLINE( 170)					_hx_tmp = ::hx::IsGreater( icon->get_height(),ucy );
            				}
            				else {
HXLINE( 170)					_hx_tmp = false;
            				}
HXDLIN( 170)				if (_hx_tmp) {
HXLINE( 171)					 ::Dynamic ratio = icon->get_width();
HXDLIN( 171)					Float ratio1 = (( (Float)(ratio) ) / ( (Float)(icon->get_height()) ));
...
HXDLIN( 183)			 ::Dynamic _hx_tmp3 = icon->get_width();
...
HXDLIN( 197)			 ::Dynamic _hx_tmp6 = icon->get_width();
