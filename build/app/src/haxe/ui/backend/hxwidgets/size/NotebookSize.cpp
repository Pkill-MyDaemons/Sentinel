...
HX_LOCAL_STACK_FRAME(_hx_pos_0b21bf54338821c1_12_get_height,"haxe.ui.backend.hxwidgets.size.NotebookSize","get_height",0x8ce580f0,"haxe.ui.backend.hxwidgets.size.NotebookSize.get_height","haxe/ui/backend/hxwidgets/size/NotebookSize.hx",12,0x6cfc1451)
HX_LOCAL_STACK_FRAME(_hx_pos_0b21bf54338821c1_21_get_usableWidthModifier,"haxe.ui.backend.hxwidgets.size.NotebookSize","get_usableWidthModifier",0xae9c12bc,"haxe.ui.backend.hxwidgets.size.NotebookSize.get_usableWidthModifier","haxe/ui/backend/hxwidgets/size/NotebookSize.hx",21,0x6cfc1451)
HX_LOCAL_STACK_FRAME(_hx_pos_0b21bf54338821c1_29_get_usableHeightModifier,"haxe.ui.backend.hxwidgets.size.NotebookSize","get_usableHeightModifier",0x642e663f,"haxe.ui.backend.hxwidgets.size.NotebookSize.get_usableHeightModifier","haxe/ui/backend/hxwidgets/size/NotebookSize.hx",29,0x6cfc1451)
namespace haxe{
namespace ui{
namespace backend{
namespace hxwidgets{
...
Float NotebookSize_obj::get_height(){
            	HX_STACKFRAME(&_hx_pos_0b21bf54338821c1_12_get_height)
HXLINE(  13)		int h = this->component->get_window()->get_bestSize()->height;
HXLINE(  16)		h = (h + 4);
HXLINE(  18)		return ( (Float)(h) );
            	}


Float NotebookSize_obj::get_usableWidthModifier(){
            	HX_STACKFRAME(&_hx_pos_0b21bf54338821c1_21_get_usableWidthModifier)
HXLINE(  22)		bool _hx_tmp;
HXDLIN(  22)		if (::hx::IsNotNull( this->component )) {
HXLINE(  22)			_hx_tmp = ::hx::IsNull( this->component->get_window() );
            		}
            		else {
...
HXLINE(  25)		int m = ::hx::TCast<  ::hx::widgets::Notebook >::cast(this->component->get_window())->calcSizeFromPage()->width;
HXLINE(  26)		return ( (Float)(m) );
            	}


Float NotebookSize_obj::get_usableHeightModifier(){
            	HX_STACKFRAME(&_hx_pos_0b21bf54338821c1_29_get_usableHeightModifier)
HXLINE(  30)		bool _hx_tmp;
HXDLIN(  30)		if (::hx::IsNotNull( this->component )) {
HXLINE(  30)			_hx_tmp = ::hx::IsNull( this->component->get_window() );
            		}
            		else {
...
HXLINE(  33)		int m = ::hx::TCast<  ::hx::widgets::Notebook >::cast(this->component->get_window())->calcSizeFromPage()->height;
HXLINE(  34)		return ( (Float)(m) );
            	}
