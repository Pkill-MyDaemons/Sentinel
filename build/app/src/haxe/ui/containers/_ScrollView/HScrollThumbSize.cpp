...
HX_DEFINE_STACK_FRAME(_hx_pos_4e6cf53abbd4f873_469_new,"haxe.ui.containers._ScrollView.HScrollThumbSize","new",0x073369fb,"haxe.ui.containers._ScrollView.HScrollThumbSize.new","haxe/ui/containers/ScrollView.hx",469,0x01b76681)
HX_LOCAL_STACK_FRAME(_hx_pos_4e6cf53abbd4f873_475_validateData,"haxe.ui.containers._ScrollView.HScrollThumbSize","validateData",0x2a5f30e5,"haxe.ui.containers._ScrollView.HScrollThumbSize.validateData","haxe/ui/containers/ScrollView.hx",475,0x01b76681)
namespace haxe{
namespace ui{
...
void HScrollThumbSize_obj::__construct( ::haxe::ui::containers::ScrollView scrollview){
            	HX_STACKFRAME(&_hx_pos_4e6cf53abbd4f873_469_new)
HXLINE( 470)		super::__construct(scrollview);
HXLINE( 471)		this->_scrollview = scrollview;
            	}
...
void HScrollThumbSize_obj::validateData(){
            	HX_STACKFRAME(&_hx_pos_4e6cf53abbd4f873_475_validateData)
HXDLIN( 475)		if ((this->_scrollview->get_virtual() == true)) {
HXLINE( 476)			 ::haxe::ui::components::HorizontalScroll hscroll = this->_scrollview->findComponent(null(),::hx::ClassOf< ::haxe::ui::components::HorizontalScroll >(),false,null()).StaticCast<  ::haxe::ui::components::HorizontalScroll >();
HXLINE( 477)			if (::hx::IsNull( hscroll )) {
HXLINE( 478)				hscroll = ::hx::TCast<  ::haxe::ui::containers::ScrollViewBuilder >::cast(this->_scrollview->_compositeBuilder)->createHScroll();
            			}
HXLINE( 480)			if (::hx::IsNotNull( hscroll )) {
HXLINE( 481)				hscroll->set_thumbSize(::haxe::ui::util::_Variant::Variant_Impl__obj::toFloat(this->_value));
            			}
            		}
            	}
