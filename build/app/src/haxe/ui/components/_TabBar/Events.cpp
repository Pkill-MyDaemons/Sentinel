...
HX_DEFINE_STACK_FRAME(_hx_pos_8c22a69be7cd1f4e_339_new,"haxe.ui.components._TabBar.Events","new",0xac4d1b42,"haxe.ui.components._TabBar.Events.new","haxe/ui/components/TabBar.hx",339,0xaabf3019)
HX_LOCAL_STACK_FRAME(_hx_pos_8c22a69be7cd1f4e_344_register,"haxe.ui.components._TabBar.Events","register",0xe361a841,"haxe.ui.components._TabBar.Events.register","haxe/ui/components/TabBar.hx",344,0xaabf3019)
HX_LOCAL_STACK_FRAME(_hx_pos_8c22a69be7cd1f4e_355_unregister,"haxe.ui.components._TabBar.Events","unregister",0x1f10431a,"haxe.ui.components._TabBar.Events.unregister","haxe/ui/components/TabBar.hx",355,0xaabf3019)
HX_LOCAL_STACK_FRAME(_hx_pos_8c22a69be7cd1f4e_358_onMouseWheel,"haxe.ui.components._TabBar.Events","onMouseWheel",0x95161313,"haxe.ui.components._TabBar.Events.onMouseWheel","haxe/ui/components/TabBar.hx",358,0xaabf3019)
HX_LOCAL_STACK_FRAME(_hx_pos_8c22a69be7cd1f4e_372_onTabMouseDown,"haxe.ui.components._TabBar.Events","onTabMouseDown",0x2b60e02f,"haxe.ui.components._TabBar.Events.onTabMouseDown","haxe/ui/components/TabBar.hx",372,0xaabf3019)
namespace haxe{
namespace ui{
...
void Events_obj::__construct( ::haxe::ui::components::TabBar tabbar){
            	HX_STACKFRAME(&_hx_pos_8c22a69be7cd1f4e_339_new)
HXLINE( 340)		super::__construct(tabbar);
HXLINE( 341)		this->_tabbar = tabbar;
            	}
...
void Events_obj::_hx_register(){
            	HX_STACKFRAME(&_hx_pos_8c22a69be7cd1f4e_344_register)
HXLINE( 345)		 ::haxe::ui::components::_TabBar::Builder builder = ::hx::TCast<  ::haxe::ui::components::_TabBar::Builder >::cast(this->_tabbar->_compositeBuilder);
HXLINE( 346)		{
HXLINE( 346)			int _g = 0;
HXDLIN( 346)			 ::haxe::ui::containers::HBox _this = builder->_container;
...
HXLINE( 346)				 ::haxe::ui::core::Component t = _g1->__get(_g).StaticCast<  ::haxe::ui::core::Component >();
HXDLIN( 346)				_g = (_g + 1);
HXLINE( 347)				if ((t->hasEvent(::haxe::ui::events::MouseEvent_obj::MOUSE_DOWN,this->onTabMouseDown_dyn()) == false)) {
HXLINE( 348)					t->registerEvent(::haxe::ui::events::MouseEvent_obj::MOUSE_DOWN,this->onTabMouseDown_dyn(),null());
            				}
            			}
            		}
HXLINE( 351)		this->registerEvent(::haxe::ui::events::MouseEvent_obj::MOUSE_WHEEL,this->onMouseWheel_dyn(),null());
            	}


void Events_obj::unregister(){
            	HX_STACKFRAME(&_hx_pos_8c22a69be7cd1f4e_355_unregister)
HXDLIN( 355)		this->unregisterEvent(::haxe::ui::events::MouseEvent_obj::MOUSE_WHEEL,this->onMouseWheel_dyn());
            	}


void Events_obj::onMouseWheel( ::haxe::ui::events::MouseEvent event){
            	HX_STACKFRAME(&_hx_pos_8c22a69be7cd1f4e_358_onMouseWheel)
HXLINE( 359)		 ::haxe::ui::components::_TabBar::Builder builder = ::hx::TCast<  ::haxe::ui::components::_TabBar::Builder >::cast(this->_tabbar->_compositeBuilder);
HXLINE( 360)		bool _hx_tmp;
HXDLIN( 360)		if (::hx::IsNotNull( builder->_scrollLeft )) {
HXLINE( 360)			_hx_tmp = (builder->_scrollLeft->get_hidden() == true);
            		}
            		else {
...
HXLINE( 363)		if ((event->delta < 0)) {
HXLINE( 364)			builder->scrollRight();
            		}
            		else {
HXLINE( 366)			builder->scrollLeft();
            		}
HXLINE( 369)		event->cancel();
            	}
...
void Events_obj::onTabMouseDown( ::haxe::ui::events::MouseEvent event){
            	HX_STACKFRAME(&_hx_pos_8c22a69be7cd1f4e_372_onTabMouseDown)
HXLINE( 373)		 ::haxe::ui::components::_TabBar::Builder builder = ::hx::TCast<  ::haxe::ui::components::_TabBar::Builder >::cast(this->_tabbar->_compositeBuilder);
HXLINE( 374)		 ::haxe::ui::core::Component button = event->target;
HXLINE( 375)		 ::haxe::ui::components::Image close = button->findComponent(HX_("tab-close-button",5f,35,00,26),::hx::ClassOf< ::haxe::ui::components::Image >(),false,null()).StaticCast<  ::haxe::ui::components::Image >();
HXLINE( 376)		bool select = true;
HXLINE( 377)		if (::hx::IsNotNull( close )) {
HXLINE( 378)			select = !(close->hitTest(event->screenX,event->screenY,null()));
            		}
HXLINE( 380)		if ((select == true)) {
HXLINE( 381)			 ::haxe::ui::components::TabBar _hx_tmp = this->_tabbar;
HXDLIN( 381)			_hx_tmp->set_selectedIndex(builder->_container->getComponentIndex(button));
            		}
            	}
