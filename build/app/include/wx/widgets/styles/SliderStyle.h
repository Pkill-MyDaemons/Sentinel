...
class HXCPP_CLASS_ATTRIBUTES SliderStyle_obj : public ::hx::Object
{
	...
	public:
		...
		inline static ::hx::ObjectPtr< SliderStyle_obj > __new() {
			::hx::ObjectPtr< SliderStyle_obj > __this = new SliderStyle_obj();
			__this->__construct();
			return __this;
		}

		inline static ::hx::ObjectPtr< SliderStyle_obj > __alloc(::hx::Ctx *_hx_ctx) {
		...
		::String __ToString() const { return HX_("SliderStyle",30,0f,32,d8); }
