...
HX_DEFINE_STACK_FRAME(_hx_pos_701ee7c2cd4a57d1_57_new,"haxe.ui.components._Switch.SelectedBehaviour","new",0x31c990f3,"haxe.ui.components._Switch.SelectedBehaviour.new","haxe/ui/components/Switch.hx",57,0x0342e663)
HX_LOCAL_STACK_FRAME(_hx_pos_701ee7c2cd4a57d1_59_validateData,"haxe.ui.components._Switch.SelectedBehaviour","validateData",0x52f86aed,"haxe.ui.components._Switch.SelectedBehaviour.validateData","haxe/ui/components/Switch.hx",59,0x0342e663)
namespace haxe{
namespace ui{
...
void SelectedBehaviour_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_701ee7c2cd4a57d1_57_new)
HXDLIN(  57)		super::__construct(component);
            	}
...
bool SelectedBehaviour_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x3c5dd90d) {
		...
		return inClassId==(int)0x69853507 || inClassId==(int)0x7e17fa9f;
	}
}

void SelectedBehaviour_obj::validateData(){
            	HX_STACKFRAME(&_hx_pos_701ee7c2cd4a57d1_59_validateData)
HXDLIN(  59)		 ::haxe::ui::components::_Switch::SwitchButtonSub _hx_tmp = this->_component->findComponent(null(),::hx::ClassOf< ::haxe::ui::components::_Switch::SwitchButtonSub >(),null(),null()).StaticCast<  ::haxe::ui::components::_Switch::SwitchButtonSub >();
HXDLIN(  59)		_hx_tmp->set_selected(::haxe::ui::util::_Variant::Variant_Impl__obj::toBool(this->_value));
            	}
