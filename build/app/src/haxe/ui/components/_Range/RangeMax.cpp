...
HX_DEFINE_STACK_FRAME(_hx_pos_3bc9dc675deae08b_107_new,"haxe.ui.components._Range.RangeMax","new",0x35cd8643,"haxe.ui.components._Range.RangeMax.new","haxe/ui/components/Range.hx",107,0x313cba28)
HX_LOCAL_STACK_FRAME(_hx_pos_3bc9dc675deae08b_108_validateData,"haxe.ui.components._Range.RangeMax","validateData",0x92934b9d,"haxe.ui.components._Range.RangeMax.validateData","haxe/ui/components/Range.hx",108,0x313cba28)
namespace haxe{
namespace ui{
...
void RangeMax_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_3bc9dc675deae08b_107_new)
...
void RangeMax_obj::validateData(){
            	HX_STACKFRAME(&_hx_pos_3bc9dc675deae08b_108_validateData)
HXLINE( 109)		 ::haxe::ui::components::Range range = ::hx::TCast<  ::haxe::ui::components::Range >::cast(this->_component);
HXLINE( 110)		range->set_max(::haxe::ui::util::_Variant::Variant_Impl__obj::toFloat(this->_value));
HXLINE( 111)		Float _hx_tmp = range->get_end();
HXDLIN( 111)		if (::hx::IsGreater( _hx_tmp,range->get_max() )) {
HXLINE( 112)			range->set_end(( (Float)(range->get_max()) ));
            		}
HXLINE( 114)		{
HXLINE( 114)			 ::haxe::ui::core::Component _this = this->_component;
HXDLIN( 114)			bool _hx_tmp1;
HXDLIN( 114)			if (::hx::IsNotNull( _this->_layout )) {
HXLINE( 114)				_hx_tmp1 = (_this->_layoutLocked == true);
            			}
            			else {
HXLINE( 114)				_hx_tmp1 = true;
            			}
HXDLIN( 114)			if (!(_hx_tmp1)) {
HXLINE( 114)				_this->invalidateComponent(HX_("layout",aa,ae,b8,58),false);
            			}
            		}
            	}
