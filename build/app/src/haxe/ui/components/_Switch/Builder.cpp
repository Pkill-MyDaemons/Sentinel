...
HX_DEFINE_STACK_FRAME(_hx_pos_2a882ec7d3708272_96_new,"haxe.ui.components._Switch.Builder","new",0xfe240b6c,"haxe.ui.components._Switch.Builder.new","haxe/ui/components/Switch.hx",96,0x0342e663)
HX_LOCAL_STACK_FRAME(_hx_pos_2a882ec7d3708272_101_create,"haxe.ui.components._Switch.Builder","create",0x07c49b70,"haxe.ui.components._Switch.Builder.create","haxe/ui/components/Switch.hx",101,0x0342e663)
HX_LOCAL_STACK_FRAME(_hx_pos_2a882ec7d3708272_104_create,"haxe.ui.components._Switch.Builder","create",0x07c49b70,"haxe.ui.components._Switch.Builder.create","haxe/ui/components/Switch.hx",104,0x0342e663)
namespace haxe{
namespace ui{
...
void Builder_obj::__construct( ::haxe::ui::components::Switch s){
            	HX_STACKFRAME(&_hx_pos_2a882ec7d3708272_96_new)
HXLINE(  97)		super::__construct(s);
HXLINE(  98)		this->_switch = s;
            	}
...
void Builder_obj::create(){
            	HX_GC_STACKFRAME(&_hx_pos_2a882ec7d3708272_101_create)
HXDLIN( 101)		 ::haxe::ui::components::_Switch::Builder _gthis = ::hx::ObjectPtr<OBJ_>(this);
HXLINE( 102)		if (::hx::IsNull( this->_button )) {
            			...
            			void _hx_run( ::haxe::ui::events::UIEvent e){
            				HX_GC_STACKFRAME(&_hx_pos_2a882ec7d3708272_104_create)
HXLINE( 105)				 ::haxe::ui::components::Switch _gthis1 = _gthis->_switch;
HXDLIN( 105)				_gthis1->set_selected(_gthis->_button->get_selected());
HXLINE( 106)				 ::haxe::ui::components::Switch _gthis2 = _gthis->_switch;
HXDLIN( 106)				_gthis2->dispatch( ::haxe::ui::events::UIEvent_obj::__alloc( HX_CTX ,::haxe::ui::events::UIEvent_obj::CHANGE,null(),null()),null());
            			}
            			HX_END_LOCAL_FUNC1((void))

HXLINE( 103)			this->_button =  ::haxe::ui::components::_Switch::SwitchButtonSub_obj::__alloc( HX_CTX );
HXLINE( 104)			this->_button->set_onChange( ::Dynamic(new _hx_Closure_0(_gthis)));
HXLINE( 108)			this->_component->addComponent(this->_button);
            		}
            	}
