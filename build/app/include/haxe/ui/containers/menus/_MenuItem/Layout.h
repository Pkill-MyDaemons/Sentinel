...
#define INCLUDED_haxe_ui_containers_menus__MenuItem_Layout
...
#endif
HX_DECLARE_CLASS5(haxe,ui,containers,menus,_MenuItem,Layout)
...
class HXCPP_CLASS_ATTRIBUTES Layout_obj : public  ::haxe::ui::layouts::HorizontalLayout_obj
{
	...
	public:
		enum { _hx_ClassId = 0x020e6eb3 };

		void __construct();
		inline void *operator new(size_t inSize, bool inContainer=true,const char *inName="haxe.ui.containers.menus._MenuItem.Layout")
			{ return ::hx::Object::operator new(inSize,inContainer,inName); }
		inline void *operator new(size_t inSize, int extra)
			{ return ::hx::Object::operator new(inSize+extra,true,"haxe.ui.containers.menus._MenuItem.Layout"); }
...
#endif /* INCLUDED_haxe_ui_containers_menus__MenuItem_Layout */ 
