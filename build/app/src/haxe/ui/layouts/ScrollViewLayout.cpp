...
HXLINE( 134)				 ::Dynamic _hx_tmp3 = contents->get_width();
HXDLIN( 134)				if (::hx::IsGreater( _hx_tmp3,this->get_component()->get_width() )) {
...
HXLINE( 137)				 ::Dynamic _hx_tmp4 = contents->get_height();
HXDLIN( 137)				if (::hx::IsGreater( _hx_tmp4,this->get_component()->get_height() )) {
