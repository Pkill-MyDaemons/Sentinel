...
HXLINE( 159)				_hx_tmp1 = !(::haxe::ui::util::_Variant::Variant_Impl__obj::get_isNull(this->_previousValue));
            			}
            			else {
...
HXLINE( 167)				_hx_tmp2 = !(::haxe::ui::util::_Variant::Variant_Impl__obj::get_isNull(this->_previousValue));
            			}
            			else {
HXLINE( 167)				_hx_tmp2 = false;
            			}
HXDLIN( 167)			if (_hx_tmp2) {
HXLINE( 168)				 ::haxe::ui::containers::TreeViewNode previousSelection1 = ::hx::TCast<  ::haxe::ui::containers::TreeViewNode >::cast(::haxe::ui::util::_Variant::Variant_Impl__obj::toComponent(this->_previousValue));
HXLINE( 169)				 ::haxe::ui::core::ItemRenderer renderer1 = previousSelection1->findComponent(null(),::hx::ClassOf< ::haxe::ui::core::ItemRenderer >(),true,null()).StaticCast<  ::haxe::ui::core::ItemRenderer >();
HXLINE( 170)				if (::hx::IsNotNull( renderer1 )) {
HXLINE( 171)					renderer1->removeClass(HX_(":node-selected",cc,28,1b,90),true,true);
            				}
            			}
...
HXLINE( 181)			 ::haxe::ui::core::ItemRenderer renderer2 = node->findComponent(null(),::hx::ClassOf< ::haxe::ui::core::ItemRenderer >(),true,null()).StaticCast<  ::haxe::ui::core::ItemRenderer >();
HXLINE( 182)			if (::hx::IsNotNull( renderer2 )) {
HXLINE( 183)				renderer2->addClass(HX_(":node-selected",cc,28,1b,90),true,true);
            			}
HXLINE( 186)			::hx::TCast<  ::haxe::ui::containers::ScrollView >::cast(this->_component)->ensureVisible(node);
            		}
HXLINE( 189)		 ::haxe::ui::events::UIEvent event =  ::haxe::ui::events::UIEvent_obj::__alloc( HX_CTX ,::haxe::ui::events::UIEvent_obj::CHANGE,null(),null());
HXLINE( 190)		this->_component->dispatch(event,null());
            	}
