...
HX_LOCAL_STACK_FRAME(_hx_pos_8649703b52818f70_700_cloneLayout,"haxe.ui.containers._TabView.Layout","cloneLayout",0xe439584c,"haxe.ui.containers._TabView.Layout.cloneLayout","haxe/ui/macros/helpers/ClassBuilder.hx",700,0x8cdaad7b)
HX_LOCAL_STACK_FRAME(_hx_pos_3aa258adf8e6fec6_113_self,"haxe.ui.containers._TabView.Layout","self",0x14427287,"haxe.ui.containers._TabView.Layout.self","haxe/ui/macros/LayoutMacros.hx",113,0xe44eaad7)
namespace haxe{
namespace ui{
...
HXLINE(  54)				 ::Dynamic _hx_tmp1 = this->get_component()->get_height();
HXDLIN(  54)				Float _hx_tmp2 = (( (Float)(_hx_tmp1) ) - ( (Float)(tabs->get_height()) ));
HXDLIN(  54)				Float _hx_tmp3 = (_hx_tmp2 - this->get_paddingBottom());
HXDLIN(  54)				tabs->set_top((_hx_tmp3 + this->marginTop(tabs)));
            			}
            		}
            		else {
HXLINE(  57)			tabs->set_left(this->get_paddingLeft());
HXLINE(  58)			Float _hx_tmp4 = this->get_paddingTop();
HXDLIN(  58)			tabs->set_top((_hx_tmp4 + this->marginTop(tabs)));
HXLINE(  60)			content->set_left(this->get_paddingLeft());
HXLINE(  61)			if (::hx::IsNotEq( tabs->get_height(),0 )) {
HXLINE(  62)				 ::Dynamic _hx_tmp5 = tabs->get_top();
HXDLIN(  62)				Float _hx_tmp6 = (_hx_tmp5 + tabs->get_height());
HXDLIN(  62)				Float _hx_tmp7 = (_hx_tmp6 - this->marginTop(tabs));
HXDLIN(  62)				content->set_top((_hx_tmp7 + this->marginTop(content)));
            			}
            		}
            	}
...
HXLINE(  92)		return size;
 ...
 ::haxe::ui::layouts::Layout Layout_obj::cloneLayout(){
            	HX_STACKFRAME(&_hx_pos_8649703b52818f70_700_cloneLayout)
HXLINE(  85)		 ::haxe::ui::containers::_TabView::Layout c = ( ( ::haxe::ui::containers::_TabView::Layout)(this->super::cloneLayout()) );
HXLINE( 101)		return c;
            	}


 ::haxe::ui::layouts::Layout Layout_obj::self(){
            	HX_GC_STACKFRAME(&_hx_pos_3aa258adf8e6fec6_113_self)
HXDLIN( 113)		return  ::haxe::ui::containers::_TabView::Layout_obj::__alloc( HX_CTX );
            	}
