...
HXLINE(   9)		 wxString strLabel = wxString::FromUTF8(label.utf8_str());
HXLINE(  10)		 wxString strName = wxString::FromUTF8(name.utf8_str());
HXLINE(  11)		 wxString strValue = wxString::FromUTF8(value.utf8_str());
