...
HXLINE( 342)		 ::Dynamic w = this->_toolTip->get_width();
HXLINE( 343)		 ::Dynamic h = this->_toolTip->get_height();
...
HXLINE( 349)			x = (( (Float)(x) ) - ( (Float)(w) ));
            		}
HXLINE( 351)		if (((y + h) > maxY)) {
HXLINE( 352)			Float y1 = (this->_lastMouseEvent->screenY - ( (Float)(h) ));
