...
class HXCPP_CLASS_ATTRIBUTES StaticTextStyle_obj : public ::hx::Object
{
	...
	public:
		...
		inline static ::hx::ObjectPtr< StaticTextStyle_obj > __new() {
			::hx::ObjectPtr< StaticTextStyle_obj > __this = new StaticTextStyle_obj();
			__this->__construct();
			return __this;
		}

		inline static ::hx::ObjectPtr< StaticTextStyle_obj > __alloc(::hx::Ctx *_hx_ctx) {
		...
		::String __ToString() const { return HX_("StaticTextStyle",96,3a,b0,b3); }
