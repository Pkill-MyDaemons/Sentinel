...
class HXCPP_CLASS_ATTRIBUTES FileDialogStyle_obj : public ::hx::Object
{
	...
	public:
		...
		inline static ::hx::ObjectPtr< FileDialogStyle_obj > __new() {
			::hx::ObjectPtr< FileDialogStyle_obj > __this = new FileDialogStyle_obj();
			__this->__construct();
			return __this;
		}

		inline static ::hx::ObjectPtr< FileDialogStyle_obj > __alloc(::hx::Ctx *_hx_ctx) {
		...
		::String __ToString() const { return HX_("FileDialogStyle",0d,66,dc,69); }
