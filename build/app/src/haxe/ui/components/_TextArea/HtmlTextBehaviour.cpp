...
HX_DEFINE_STACK_FRAME(_hx_pos_3c7da51bc4e9742d_259_new,"haxe.ui.components._TextArea.HtmlTextBehaviour","new",0xf604171c,"haxe.ui.components._TextArea.HtmlTextBehaviour.new","haxe/ui/components/TextArea.hx",259,0xfe441d7d)
HX_LOCAL_STACK_FRAME(_hx_pos_3c7da51bc4e9742d_260_validateData,"haxe.ui.components._TextArea.HtmlTextBehaviour","validateData",0xfe2a57a4,"haxe.ui.components._TextArea.HtmlTextBehaviour.validateData","haxe/ui/components/TextArea.hx",260,0xfe441d7d)
namespace haxe{
namespace ui{
...
void HtmlTextBehaviour_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_3c7da51bc4e9742d_259_new)
...
void HtmlTextBehaviour_obj::validateData(){
            	HX_STACKFRAME(&_hx_pos_3c7da51bc4e9742d_260_validateData)
HXLINE( 261)		 ::haxe::ui::components::TextArea textarea = ::hx::TCast<  ::haxe::ui::components::TextArea >::cast(this->_component);
HXLINE( 262)		::String htmlText;
HXDLIN( 262)		if (::hx::IsNotNull( this->_value )) {
HXLINE( 262)			htmlText = ::haxe::ui::util::_Variant::Variant_Impl__obj::toString(this->_value);
            		}
            		else {
HXLINE( 262)			htmlText = HX_("",00,00,00,00);
            		}
HXLINE( 263)		::haxe::ui::components::_TextArea::TextAreaHelper_obj::validateHtmlText(textarea,htmlText);
HXLINE( 264)		if ((textarea->get_autoScrollToBottom() == true)) {
HXLINE( 265)			textarea->scrollToBottom();
            		}
            	}
