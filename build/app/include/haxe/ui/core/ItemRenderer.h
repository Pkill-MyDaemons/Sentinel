...
class HXCPP_CLASS_ATTRIBUTES ItemRenderer_obj : public  ::haxe::ui::containers::Box_obj
{
	...
	public:
		...
		virtual void _onItemMouseOver( ::haxe::ui::events::MouseEvent event);
		::Dynamic _onItemMouseOver_dyn();

		virtual void _onItemMouseOut( ::haxe::ui::events::MouseEvent event);
		::Dynamic _onItemMouseOut_dyn();

		virtual void _onItemMouseDown( ::haxe::ui::events::MouseEvent event);
		::Dynamic _onItemMouseDown_dyn();

		virtual void _onItemMouseUp( ::haxe::ui::events::MouseEvent event);
		...
		virtual void onDataChanged( ::Dynamic data);
