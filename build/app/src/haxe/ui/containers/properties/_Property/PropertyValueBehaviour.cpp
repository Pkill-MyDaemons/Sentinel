...
HXLINE( 111)		 ::haxe::ui::containers::properties::PropertyBuilder builder = ::hx::TCast<  ::haxe::ui::containers::properties::PropertyBuilder >::cast(this->_property->_compositeBuilder);
HXLINE( 112)		if (::hx::IsNotNull( builder->get_actualEditor() )) {
HXLINE( 113)			 ::haxe::ui::core::Component _hx_tmp = builder->get_actualEditor();
HXDLIN( 113)			_hx_tmp->set_value(::haxe::ui::util::_Variant::Variant_Impl__obj::toDynamic(this->_value));
            		}
            	}
