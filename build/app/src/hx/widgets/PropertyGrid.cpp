...
HXLINE(  36)		 wxString strName = wxString::FromUTF8(name.utf8_str());
...
HXLINE(  44)		 wxString strId = wxString::FromUTF8(id.utf8_str());
HXLINE(  45)		 wxString strAttrName = wxString::FromUTF8(attrName.utf8_str());
