...
HX_LOCAL_STACK_FRAME(_hx_pos_c4300f45363458fd_33_setLabelMarkup,"hx.widgets.Control","setLabelMarkup",0x710d0248,"hx.widgets.Control.setLabelMarkup","hx/widgets/Control.hx",33,0xb3674fa0)
HX_LOCAL_STACK_FRAME(_hx_pos_c4300f45363458fd_45_get_controlRef,"hx.widgets.Control","get_controlRef",0x3e7e384d,"hx.widgets.Control.get_controlRef","hx/widgets/Control.hx",45,0xb3674fa0)
namespace hx{
namespace widgets{
...
HXLINE(  27)		::cpp::Pointer<  wxString > s = ::cpp::Pointer_obj::fromRaw((new wxString(value.utf8_str())));
HXLINE(  28)		 wxControl * _hx_tmp = this->get_controlRef()->ptr;
HXDLIN(  28)		(*(_hx_tmp)).SetLabel(s->get_ref());
HXLINE(  29)		s->destroy();
...
bool Control_obj::setLabelMarkup(::String value){
            	HX_STACKFRAME(&_hx_pos_c4300f45363458fd_33_setLabelMarkup)
HXLINE(  34)		::cpp::Pointer<  wxString > s = ::cpp::Pointer_obj::fromRaw((new wxString(value.utf8_str())));
HXLINE(  35)		 wxControl * b = this->get_controlRef()->ptr;
HXDLIN(  35)		bool b1 = (*(b)).SetLabelMarkup(s->get_ref());
HXLINE(  36)		s->destroy();
HXLINE(  37)		return b1;
            	}


HX_DEFINE_DYNAMIC_FUNC1(Control_obj,setLabelMarkup,return )

::cpp::Pointer<  wxControl > Control_obj::get_controlRef(){
            	HX_STACKFRAME(&_hx_pos_c4300f45363458fd_45_get_controlRef)
HXDLIN(  45)		return this->_ref->reinterpret();
            	}
...
::hx::Val Control_obj::__Field(const ::String &inName,::hx::PropertyAccess inCallProp)
{
	...
	case 10:
		...
		break;
	case 14:
		if (HX_FIELD_EQ(inName,"setLabelMarkup") ) { return ::hx::Val( setLabelMarkup_dyn() ); }
...
void Control_obj::__GetFields(Array< ::String> &outFields)
{
	...
	outFields->push(HX_("controlRef",f6,dd,aa,04));
	super::__GetFields(outFields);
};

#ifdef HXCPP_SCRIPTABLE
static ::hx::StorageInfo Control_obj_sMemberStorageInfo[] = {
	{::hx::fsUnknown /* ::cpp::Pointer<  wxControl > */ ,(int)offsetof(Control_obj,controlRef),HX_("controlRef",f6,dd,aa,04)},
	{ ::hx::fsUnknown, 0, null()}
};
...
static ::String Control_obj_sMemberFields[] = {
	...
	HX_("setLabelMarkup",3a,30,2f,ad),
	HX_("controlRef",f6,dd,aa,04),
	HX_("get_controlRef",3f,66,a0,7a),
	::String(null()) };
...
{
	Control_obj _hx_dummy;
	Control_obj::_hx_vtable = *(void **)&_hx_dummy;
	::hx::Static(__mClass) = new ::hx::Class_obj();
	__mClass->mName = HX_("hx.widgets.Control",a0,56,a3,5c);
