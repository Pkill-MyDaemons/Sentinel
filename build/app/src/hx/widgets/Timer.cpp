...
HX_DEFINE_STACK_FRAME(_hx_pos_d5ac74360a9847e3_8_new,"hx.widgets.Timer","new",0xa412a93a,"hx.widgets.Timer.new","hx/widgets/Timer.hx",8,0xd1771678)
HX_LOCAL_STACK_FRAME(_hx_pos_d5ac74360a9847e3_20_get_id,"hx.widgets.Timer","get_id",0xc0609e8a,"hx.widgets.Timer.get_id","hx/widgets/Timer.hx",20,0xd1771678)
HX_LOCAL_STACK_FRAME(_hx_pos_d5ac74360a9847e3_24_start,"hx.widgets.Timer","start",0xb7d5b7bc,"hx.widgets.Timer.start","hx/widgets/Timer.hx",24,0xd1771678)
HX_LOCAL_STACK_FRAME(_hx_pos_d5ac74360a9847e3_28_stop,"hx.widgets.Timer","stop",0xef9ad5e8,"hx.widgets.Timer.stop","hx/widgets/Timer.hx",28,0xd1771678)
HX_LOCAL_STACK_FRAME(_hx_pos_d5ac74360a9847e3_36_get_timerRef,"hx.widgets.Timer","get_timerRef",0x3f4b2a7d,"hx.widgets.Timer.get_timerRef","hx/widgets/Timer.hx",36,0xd1771678)
namespace hx{
namespace widgets{
...
void Timer_obj::__construct( ::hx::widgets::Window window,::hx::Null< int >  __o_milliseconds,::hx::Null< bool >  __o_oneShot,::hx::Null< int >  __o_id){
            	...
            	HX_STACKFRAME(&_hx_pos_d5ac74360a9847e3_8_new)
HXLINE(   9)		super::__construct();
HXLINE(  10)		if (::hx::IsNotNull( window )) {
...
int Timer_obj::get_id(){
            	HX_STACKFRAME(&_hx_pos_d5ac74360a9847e3_20_get_id)
HXDLIN(  20)		return this->get_timerRef()->ptr->GetId();
            	}


HX_DEFINE_DYNAMIC_FUNC0(Timer_obj,get_id,return )

bool Timer_obj::start(int milliseconds,::hx::Null< bool >  __o_oneShot){
            		bool oneShot = __o_oneShot.Default(false);
            	HX_STACKFRAME(&_hx_pos_d5ac74360a9847e3_24_start)
HXDLIN(  24)		return this->get_timerRef()->ptr->Start(milliseconds,oneShot);
            	}
...
void Timer_obj::stop(){
            	HX_STACKFRAME(&_hx_pos_d5ac74360a9847e3_28_stop)
HXDLIN(  28)		this->get_timerRef()->ptr->Stop();
            	}
...
::cpp::Pointer<  wxTimer > Timer_obj::get_timerRef(){
            	HX_STACKFRAME(&_hx_pos_d5ac74360a9847e3_36_get_timerRef)
...
static ::hx::StorageInfo Timer_obj_sMemberStorageInfo[] = {
	{::hx::fsInt,(int)offsetof(Timer_obj,id),HX_("id",db,5b,00,00)},
