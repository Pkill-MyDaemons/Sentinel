...
HXLINE( 133)			 ::Dynamic _hx_tmp1 = this->get_component()->get_height();
HXDLIN( 133)			Float _hx_tmp2 = (( (Float)(_hx_tmp1) ) - ( (Float)(inc->get_height()) ));
...
HXLINE( 141)			u = (u - ( (Float)(thumb->get_height()) ));
...
HXLINE( 145)				 ::Dynamic y2 = deinc->get_height();
...
HXLINE( 158)			 ::Dynamic ucy1 = deinc->get_height();
...
HXLINE( 161)			 ::Dynamic ucy2 = inc->get_height();
