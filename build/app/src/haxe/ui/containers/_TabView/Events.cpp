...
HXLINE( 312)		if ((tabs->hasEvent(::haxe::ui::events::UIEvent_obj::CHANGE,this->onTabChanged_dyn()) == false)) {
HXLINE( 313)			tabs->registerEvent(::haxe::ui::events::UIEvent_obj::CHANGE,this->onTabChanged_dyn(),null());
            		}
HXLINE( 315)		if ((tabs->hasEvent(::haxe::ui::events::UIEvent_obj::BEFORE_CHANGE,this->onTabBeforeChanged_dyn()) == false)) {
HXLINE( 316)			tabs->registerEvent(::haxe::ui::events::UIEvent_obj::BEFORE_CHANGE,this->onTabBeforeChanged_dyn(),null());
            		}
HXLINE( 318)		if ((tabs->hasEvent(::haxe::ui::events::UIEvent_obj::BEFORE_CLOSE,this->onBeforeTabClosed_dyn()) == false)) {
HXLINE( 319)			tabs->registerEvent(::haxe::ui::events::UIEvent_obj::BEFORE_CLOSE,this->onBeforeTabClosed_dyn(),null());
            		}
HXLINE( 321)		if ((tabs->hasEvent(::haxe::ui::events::UIEvent_obj::CLOSE,this->onTabClosed_dyn()) == false)) {
HXLINE( 322)			tabs->registerEvent(::haxe::ui::events::UIEvent_obj::CLOSE,this->onTabClosed_dyn(),null());
            		}
            	}
...
HXLINE( 328)		tabs->unregisterEvent(::haxe::ui::events::UIEvent_obj::CHANGE,this->onTabChanged_dyn());
HXLINE( 329)		tabs->unregisterEvent(::haxe::ui::events::UIEvent_obj::BEFORE_CHANGE,this->onTabBeforeChanged_dyn());
HXLINE( 330)		tabs->unregisterEvent(::haxe::ui::events::UIEvent_obj::BEFORE_CLOSE,this->onBeforeTabClosed_dyn());
HXLINE( 331)		tabs->unregisterEvent(::haxe::ui::events::UIEvent_obj::CLOSE,this->onTabClosed_dyn());
            	}
...
HXDLIN( 335)		this->_tabview->dispatch(event,null());
            	}
...
HXDLIN( 346)		_hx_tmp->dispatch( ::haxe::ui::events::UIEvent_obj::__alloc( HX_CTX ,::haxe::ui::events::UIEvent_obj::CLOSE,event->data,null()),null());
            	}
...
HXDLIN( 356)		this->_tabview->dispatch(event,null());
            	}
