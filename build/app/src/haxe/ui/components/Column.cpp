...
HX_LOCAL_STACK_FRAME(_hx_pos_8b4a53d6261f9d71_204_registerComposite,"haxe.ui.components.Column","registerComposite",0x4e668c32,"haxe.ui.components.Column.registerComposite","haxe/ui/macros/Macros.hx",204,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_8b4a53d6261f9d71_551_registerBehaviours,"haxe.ui.components.Column","registerBehaviours",0xce532d0b,"haxe.ui.components.Column.registerBehaviours","haxe/ui/macros/Macros.hx",551,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_8e96c8c9b50ac217_700_cloneComponent,"haxe.ui.components.Column","cloneComponent",0x29a76dd2,"haxe.ui.components.Column.cloneComponent","haxe/ui/macros/helpers/ClassBuilder.hx",700,0x8cdaad7b)
HX_LOCAL_STACK_FRAME(_hx_pos_8b4a53d6261f9d71_521_self,"haxe.ui.components.Column","self",0x96533d3e,"haxe.ui.components.Column.self","haxe/ui/macros/Macros.hx",521,0x27866361)
namespace haxe{
namespace ui{
...
void Column_obj::registerComposite(){
            	HX_STACKFRAME(&_hx_pos_8b4a53d6261f9d71_204_registerComposite)
HXLINE( 205)		this->super::registerComposite();
HXLINE( 213)		this->_internalEventsClass = ::hx::ClassOf< ::haxe::ui::components::_Column::Events >();
            	}


void Column_obj::registerBehaviours(){
            	HX_STACKFRAME(&_hx_pos_8b4a53d6261f9d71_551_registerBehaviours)
HXDLIN( 551)		this->super::registerBehaviours();
            	}


 ::haxe::ui::backend::ComponentBase Column_obj::cloneComponent(){
            	HX_STACKFRAME(&_hx_pos_8e96c8c9b50ac217_700_cloneComponent)
HXLINE( 469)		 ::haxe::ui::components::Column c = ( ( ::haxe::ui::components::Column)(this->super::cloneComponent()) );
HXLINE( 484)		{
...
HXLINE( 493)		return c;
 ...
 ::haxe::ui::backend::ComponentBase Column_obj::self(){
            	HX_GC_STACKFRAME(&_hx_pos_8b4a53d6261f9d71_521_self)
HXDLIN( 521)		return  ::haxe::ui::components::Column_obj::__alloc( HX_CTX );
            	}
