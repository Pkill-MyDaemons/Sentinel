...
HXLINE(  11)			 ::hx::widgets::Window _hx_tmp1 = this->_component->get_window();
HXDLIN(  11)			_hx_tmp1->set_toolTip(this->extractTip(::haxe::ui::util::_Variant::Variant_Impl__obj::toDynamic(this->_value)));
            		}
            	}
