...
#define INCLUDED_haxe_ui_containers__TreeViewNode_ClearNodes
...
HX_DECLARE_CLASS4(haxe,ui,containers,_TreeViewNode,ClearNodes)
...
class HXCPP_CLASS_ATTRIBUTES ClearNodes_obj : public  ::haxe::ui::behaviours::Behaviour_obj
{
	...
	public:
		enum { _hx_ClassId = 0x79563dbc };

		void __construct( ::haxe::ui::core::Component component);
		inline void *operator new(size_t inSize, bool inContainer=true,const char *inName="haxe.ui.containers._TreeViewNode.ClearNodes")
			{ return ::hx::Object::operator new(inSize,inContainer,inName); }
		inline void *operator new(size_t inSize, int extra)
			{ return ::hx::Object::operator new(inSize+extra,true,"haxe.ui.containers._TreeViewNode.ClearNodes"); }
...
#endif /* INCLUDED_haxe_ui_containers__TreeViewNode_ClearNodes */ 
