...
HX_DEFINE_STACK_FRAME(_hx_pos_58ad1e656d884cc0_21_new,"haxe.ui.containers.menus._MenuCheckBox.TextBehaviour","new",0xf26f6e11,"haxe.ui.containers.menus._MenuCheckBox.TextBehaviour.new","haxe/ui/containers/menus/MenuCheckBox.hx",21,0x8c3cb656)
HX_LOCAL_STACK_FRAME(_hx_pos_58ad1e656d884cc0_22_validateData,"haxe.ui.containers.menus._MenuCheckBox.TextBehaviour","validateData",0xa7e8fa0f,"haxe.ui.containers.menus._MenuCheckBox.TextBehaviour.validateData","haxe/ui/containers/menus/MenuCheckBox.hx",22,0x8c3cb656)
namespace haxe{
namespace ui{
...
void TextBehaviour_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_58ad1e656d884cc0_21_new)
...
bool TextBehaviour_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x37b9aa84) {
		if (inClassId<=(int)0x2ace54d7) {
			return inClassId==(int)0x00000001 || inClassId==(int)0x2ace54d7;
		} else {
...
void TextBehaviour_obj::validateData(){
            	HX_GC_STACKFRAME(&_hx_pos_58ad1e656d884cc0_22_validateData)
HXLINE(  23)		 ::haxe::ui::components::CheckBox checkbox = this->_component->findComponent(null(),::hx::ClassOf< ::haxe::ui::components::CheckBox >(),false,null()).StaticCast<  ::haxe::ui::components::CheckBox >();
HXLINE(  24)		if (::hx::IsNull( checkbox )) {
HXLINE(  25)			checkbox =  ::haxe::ui::components::CheckBox_obj::__alloc( HX_CTX );
HXLINE(  26)			checkbox->set_styleNames(HX_("menuitem-checkbox",fe,2a,b2,34));
HXLINE(  27)			checkbox->set_scriptAccess(false);
HXLINE(  28)			this->_component->addComponent(checkbox);
            		}
HXLINE(  31)		checkbox->set_text(::haxe::ui::util::_Variant::Variant_Impl__obj::toString(this->_value));
            	}
