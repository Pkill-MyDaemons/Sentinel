...
bool FontStyle_Impl__obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x089eea51;
}
...
static ::hx::StaticInfo FontStyle_Impl__obj_sStaticStorageInfo[] = {
	{::hx::fsInt,(void *) &FontStyle_Impl__obj::NORMAL,HX_("NORMAL",27,1e,ec,e2)},
	{::hx::fsInt,(void *) &FontStyle_Impl__obj::ITALIC,HX_("ITALIC",f0,da,e6,b8)},
	{::hx::fsInt,(void *) &FontStyle_Impl__obj::SLANT,HX_("SLANT",ce,f3,af,fc)},
	{ ::hx::fsUnknown, 0, null()}
};
#endif
...
void FontStyle_Impl__obj::__register()
{
	...
	__mClass->mName = HX_("wx.widgets._FontStyle.FontStyle_Impl_",03,f7,19,7e);
...
HXDLIN(   6)		NORMAL = ::wxFONTSTYLE_NORMAL;
            	}
{
            	HX_STACKFRAME(&_hx_pos_04ac6a0355ce5b6b_7_boot)
HXDLIN(   7)		ITALIC = ::wxFONTSTYLE_ITALIC;
            	}
{
            	HX_STACKFRAME(&_hx_pos_04ac6a0355ce5b6b_8_boot)
HXDLIN(   8)		SLANT = ::wxFONTSTYLE_SLANT;
            	}
}
