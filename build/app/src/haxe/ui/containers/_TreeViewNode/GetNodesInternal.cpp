...
HX_DEFINE_STACK_FRAME(_hx_pos_ea194d7842686a70_207_new,"haxe.ui.containers._TreeViewNode.GetNodesInternal","new",0xe24f46de,"haxe.ui.containers._TreeViewNode.GetNodesInternal.new","haxe/ui/containers/TreeViewNode.hx",207,0x9b33be2e)
HX_LOCAL_STACK_FRAME(_hx_pos_ea194d7842686a70_208_call,"haxe.ui.containers._TreeViewNode.GetNodesInternal","call",0x1bc65060,"haxe.ui.containers._TreeViewNode.GetNodesInternal.call","haxe/ui/containers/TreeViewNode.hx",208,0x9b33be2e)
namespace haxe{
namespace ui{
...
void GetNodesInternal_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_ea194d7842686a70_207_new)
...
bool GetNodesInternal_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x3c5dd90d) {
		...
		return inClassId==(int)0x73db3670;
	}
}

 ::haxe::ui::util::VariantType GetNodesInternal_obj::call( ::Dynamic param){
            	HX_STACKFRAME(&_hx_pos_ea194d7842686a70_208_call)
HXLINE( 209)		::Array< ::Dynamic> nodes = this->_component->findComponents(null(),::hx::ClassOf< ::haxe::ui::containers::TreeViewNode >(),3);
HXLINE( 210)		return ::haxe::ui::util::_Variant::Variant_Impl__obj::fromArray(nodes);
            	}
...
::hx::ObjectPtr< GetNodesInternal_obj > GetNodesInternal_obj::__alloc(::hx::Ctx *_hx_ctx, ::haxe::ui::core::Component component) {
	GetNodesInternal_obj *__this = (GetNodesInternal_obj*)(::hx::Ctx::alloc(_hx_ctx, sizeof(GetNodesInternal_obj), true, "haxe.ui.containers._TreeViewNode.GetNodesInternal"));
...
void GetNodesInternal_obj::__register()
{
	...
	__mClass->mName = HX_("haxe.ui.containers._TreeViewNode.GetNodesInternal",ec,3f,f7,5a);
