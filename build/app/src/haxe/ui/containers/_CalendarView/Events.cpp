...
HXLINE(  43)			_hx_tmp = (button->hasEvent(::haxe::ui::events::MouseEvent_obj::CLICK,null()) == false);
            		}
            		else {
HXLINE(  43)			_hx_tmp = false;
            		}
HXDLIN(  43)		if (_hx_tmp) {
HXLINE(  44)			button->registerEvent(::haxe::ui::events::MouseEvent_obj::CLICK,this->onPrevMonth_dyn(),null());
            		}
...
HXLINE(  48)			_hx_tmp1 = (button1->hasEvent(::haxe::ui::events::MouseEvent_obj::CLICK,null()) == false);
            		}
            		else {
HXLINE(  48)			_hx_tmp1 = false;
            		}
HXDLIN(  48)		if (_hx_tmp1) {
HXLINE(  49)			button1->registerEvent(::haxe::ui::events::MouseEvent_obj::CLICK,this->onNextMonth_dyn(),null());
            		}
...
HXLINE(  53)			_hx_tmp2 = (stepper->hasEvent(::haxe::ui::events::UIEvent_obj::CHANGE,null()) == false);
            		}
            		else {
HXLINE(  53)			_hx_tmp2 = false;
            		}
HXDLIN(  53)		if (_hx_tmp2) {
HXLINE(  54)			stepper->registerEvent(::haxe::ui::events::UIEvent_obj::CHANGE,this->onYearChange_dyn(),null());
            		}
...
HXLINE(  61)		if ((this->_target->findComponent(null(),::hx::ClassOf< ::haxe::ui::components::Calendar >(),null(),null()).StaticCast<  ::haxe::ui::components::Calendar >()->hasEvent(::haxe::ui::events::UIEvent_obj::CHANGE,this->onCalendarChange_dyn()) == false)) {
HXLINE(  62)			this->_target->findComponent(null(),::hx::ClassOf< ::haxe::ui::components::Calendar >(),null(),null()).StaticCast<  ::haxe::ui::components::Calendar >()->registerEvent(::haxe::ui::events::UIEvent_obj::CHANGE,this->onCalendarChange_dyn(),null());
            		}
HXLINE(  65)		this->registerEvent(::haxe::ui::events::MouseEvent_obj::MOUSE_WHEEL,this->onMouseWheel_dyn(),null());
            	}
...
HXLINE(  81)			Float _hx_tmp1 = stepper->get_pos();
HXDLIN(  81)			if ((_hx_tmp1 < calendar->get_date()->getFullYear())) {
...
void Events_obj::onCalendarChange( ::haxe::ui::events::UIEvent event){
...
HXDLIN(  96)		_hx_tmp->dispatch( ::haxe::ui::events::UIEvent_obj::__alloc( HX_CTX ,::haxe::ui::events::UIEvent_obj::CHANGE,null(),null()),null());
            	}
