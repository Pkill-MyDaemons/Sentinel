...
class HXCPP_CLASS_ATTRIBUTES Component_obj : public  ::haxe::ui::backend::ComponentImpl_obj
{
	...
	public:
		...
		::Dynamic onComponentCreated_dyn();
		...
		::Dynamic set_componentAnimation_dyn();
		 ...
		 ::Dynamic userData;
		 ::Dynamic userDataAs(::hx::Class c);
		::Dynamic userDataAs_dyn();
		...
		bool hitTest( ::Dynamic left, ::Dynamic top,::hx::Null< bool >  allowZeroSized);
		...
		::Dynamic get_namedComponents_dyn();
		 ...
		 ::haxe::ds::StringMap namedComponentsMap;
		 ::haxe::ds::StringMap get_namedComponentsMap();
		::Dynamic get_namedComponentsMap_dyn();
		...
		::Dynamic set_paddingBottom_dyn();
		 ...
		 ::Dynamic get_horizontalSpacing();
		::Dynamic get_horizontalSpacing_dyn();

		 ::Dynamic set_horizontalSpacing( ::Dynamic value);
		::Dynamic set_horizontalSpacing_dyn();

		 ::Dynamic get_verticalSpacing();
		::Dynamic get_verticalSpacing_dyn();

		 ::Dynamic set_verticalSpacing( ::Dynamic value);
		::Dynamic set_verticalSpacing_dyn();
