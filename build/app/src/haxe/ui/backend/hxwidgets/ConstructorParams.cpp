...
bool ConstructorParams_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x1f5b6c9b;
}
...
{
	ConstructorParams_obj _hx_dummy;
	ConstructorParams_obj::_hx_vtable = *(void **)&_hx_dummy;
	::hx::Static(__mClass) = new ::hx::Class_obj();
	__mClass->mName = HX_("haxe.ui.backend.hxwidgets.ConstructorParams",85,1b,45,ba);
