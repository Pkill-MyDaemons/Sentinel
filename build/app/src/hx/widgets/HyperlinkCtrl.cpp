...
HXLINE(  17)			 wxString textStr = wxString::FromUTF8(text.utf8_str());
HXLINE(  18)			 wxString urlStr = wxString::FromUTF8(url.utf8_str());
HXLINE(  19)			 wxHyperlinkCtrl * _hx_tmp = this->get_linkRef()->ptr;
...
HXDLIN(  19)			(*(_hx_tmp)).Create(_hx_tmp1,id,textStr,urlStr,_hx_tmp2,_hx_tmp3,style);
            		}
...
{
	outFields->push(HX_("linkRef",79,31,93,23));
	super::__GetFields(outFields);
};

#ifdef HXCPP_SCRIPTABLE
static ::hx::StorageInfo HyperlinkCtrl_obj_sMemberStorageInfo[] = {
	{::hx::fsUnknown /* ::cpp::Pointer<  wxHyperlinkCtrl > */ ,(int)offsetof(HyperlinkCtrl_obj,linkRef),HX_("linkRef",79,31,93,23)},
	{ ::hx::fsUnknown, 0, null()}
};
...
static ::String HyperlinkCtrl_obj_sMemberFields[] = {
	HX_("linkRef",79,31,93,23),
	HX_("get_linkRef",90,91,8d,a9),
	::String(null()) };
...
{
	HyperlinkCtrl_obj _hx_dummy;
	HyperlinkCtrl_obj::_hx_vtable = *(void **)&_hx_dummy;
	::hx::Static(__mClass) = new ::hx::Class_obj();
	__mClass->mName = HX_("hx.widgets.HyperlinkCtrl",b4,57,3a,73);
