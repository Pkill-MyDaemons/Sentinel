...
HXLINE(  24)			 wxString messageStr = wxString::FromUTF8(message.utf8_str());
HXLINE(  25)			 wxString captionStr = wxString::FromUTF8(caption.utf8_str());
HXLINE(  26)			 wxString valueStr = wxString::FromUTF8(value.utf8_str());
