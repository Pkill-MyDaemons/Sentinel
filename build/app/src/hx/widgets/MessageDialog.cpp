...
HX_LOCAL_STACK_FRAME(_hx_pos_4249a7d73a4fa149_38_get_messageDialogRef,"hx.widgets.MessageDialog","get_messageDialogRef",0x9c23c429,"hx.widgets.MessageDialog.get_messageDialogRef","hx/widgets/MessageDialog.hx",38,0xa874c58e)
HX_LOCAL_STACK_FRAME(_hx_pos_4249a7d73a4fa149_30_messageBox,"hx.widgets.MessageDialog","messageBox",0x70271000,"hx.widgets.MessageDialog.messageBox","hx/widgets/MessageDialog.hx",30,0xa874c58e)
namespace hx{
namespace widgets{
...
HXLINE(  21)			 wxString messageStr = wxString::FromUTF8(message.utf8_str());
HXLINE(  22)			 wxString captionStr = wxString::FromUTF8(caption.utf8_str());
...
::cpp::Pointer<  wxMessageDialog > MessageDialog_obj::get_messageDialogRef(){
            	HX_STACKFRAME(&_hx_pos_4249a7d73a4fa149_38_get_messageDialogRef)
...
int MessageDialog_obj::messageBox(::String message,::String caption,int style, ::hx::widgets::Window parent){
            	HX_STACKFRAME(&_hx_pos_4249a7d73a4fa149_30_messageBox)
HXDLIN(  30)		 wxString _hx_tmp = wxString::FromUTF8(message.utf8_str());
HXDLIN(  30)		 wxString _hx_tmp1 = wxString::FromUTF8(caption.utf8_str());
HXDLIN(  30)		return wxMessageBox(_hx_tmp,_hx_tmp1,style,::hx::widgets::Window_obj::toRaw(parent));
            	}


STATIC_HX_DEFINE_DYNAMIC_FUNC4(MessageDialog_obj,messageBox,return )
...
bool MessageDialog_obj::__GetStatic(const ::String &inName, Dynamic &outValue, ::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 10:
...
static ::String MessageDialog_obj_sStaticFields[] = {
...
void MessageDialog_obj::__register()
{
	...
	__mClass->mGetStaticField = &MessageDialog_obj::__GetStatic;
	__mClass->mSetStaticField = &::hx::Class_obj::SetNoStaticField;
	__mClass->mStatics = ::hx::Class_obj::dupFunctions(MessageDialog_obj_sStaticFields);
