...
class HXCPP_CLASS_ATTRIBUTES ButtonStyle_obj : public ::hx::Object
{
	...
	public:
		...
		inline static ::hx::ObjectPtr< ButtonStyle_obj > __new() {
			::hx::ObjectPtr< ButtonStyle_obj > __this = new ButtonStyle_obj();
			__this->__construct();
			return __this;
		}

		inline static ::hx::ObjectPtr< ButtonStyle_obj > __alloc(::hx::Ctx *_hx_ctx) {
		...
		::String __ToString() const { return HX_("ButtonStyle",bf,fd,fa,b5); }
