...
HX_LOCAL_STACK_FRAME(_hx_pos_eaf2ed8d718df123_42_normalizeText,"haxe.ui.backend.hxwidgets.behaviours.ControlLabel","normalizeText",0x0e333bc0,"haxe.ui.backend.hxwidgets.behaviours.ControlLabel.normalizeText","haxe/ui/backend/hxwidgets/behaviours/ControlLabel.hx",42,0x0dcc09eb)
namespace haxe{
namespace ui{
namespace backend{
namespace hxwidgets{
...
HXLINE(  27)		if (::hx::IsNull( this->_component->get_window() )) {
HXLINE(  28)			return;
            		}
HXLINE(  31)		 ::hx::widgets::Control ctrl = ::hx::TCast<  ::hx::widgets::Control >::cast(this->_component->get_window());
HXLINE(  32)		if (::hx::IsNotNull( this->_value )) {
HXLINE(  33)			 ::haxe::ui::core::Component _hx_tmp = this->_component;
HXDLIN(  33)			_hx_tmp->set(HX_("originalLabel",e3,03,a0,ca),::haxe::ui::util::_Variant::Variant_Impl__obj::toString(this->_value));
HXLINE(  34)			::String s = ::haxe::ui::util::_Variant::Variant_Impl__obj::toString(this->_value);
HXDLIN(  34)			s = ::StringTools_obj::replace(s,HX_("\\n",92,50,00,00),HX_("\r\n",5d,0b,00,00));
HXDLIN(  34)			ctrl->set_label(s);
HXLINE(  35)			{
HXLINE(  35)				 ::haxe::ui::core::Component _this = this->_component;
HXDLIN(  35)				bool _hx_tmp1;
HXDLIN(  35)				if (::hx::IsNotNull( _this->_layout )) {
HXLINE(  35)					_hx_tmp1 = (_this->_layoutLocked == true);
            				}
            				else {
HXLINE(  35)					_hx_tmp1 = true;
            				}
HXDLIN(  35)				if (!(_hx_tmp1)) {
HXLINE(  35)					_this->invalidateComponent(HX_("layout",aa,ae,b8,58),false);
            				}
            			}
HXLINE(  36)			{
HXLINE(  36)				 ::haxe::ui::core::Component _this1 = this->_component;
HXDLIN(  36)				_this1->invalidateComponent(HX_("style",31,a5,1d,84),false);
HXDLIN(  36)				{
            				}
            			}
            		}
            		else {
HXLINE(  38)			this->_component->set(HX_("originalLabel",e3,03,a0,ca),null());
            		}
            	}


::String ControlLabel_obj::normalizeText(::String s){
            	HX_STACKFRAME(&_hx_pos_eaf2ed8d718df123_42_normalizeText)
HXLINE(  43)		s = ::StringTools_obj::replace(s,HX_("\\n",92,50,00,00),HX_("\r\n",5d,0b,00,00));
HXLINE(  44)		return s;
            	}
