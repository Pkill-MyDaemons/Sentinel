...
HXLINE(  16)			 wxString str = wxString::FromUTF8(text.utf8_str());
HXLINE(  17)			 wxString str2 = wxString::FromUTF8(HX_("",00,00,00,00).utf8_str());
...
HXLINE(  53)		::cpp::Pointer<  wxString > s = ::cpp::Pointer_obj::fromRaw((new wxString(value.utf8_str())));
