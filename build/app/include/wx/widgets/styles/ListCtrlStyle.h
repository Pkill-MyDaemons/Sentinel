...
class HXCPP_CLASS_ATTRIBUTES ListCtrlStyle_obj : public ::hx::Object
{
	...
	public:
		...
		inline static ::hx::ObjectPtr< ListCtrlStyle_obj > __new() {
			::hx::ObjectPtr< ListCtrlStyle_obj > __this = new ListCtrlStyle_obj();
			__this->__construct();
			return __this;
		}

		inline static ::hx::ObjectPtr< ListCtrlStyle_obj > __alloc(::hx::Ctx *_hx_ctx) {
		...
		::String __ToString() const { return HX_("ListCtrlStyle",28,d8,c0,9c); }
