...
HXLINE(  20)		::String larr;
HXDLIN(  20)		if (::hx::IsNull( lhs )) {
HXLINE(  20)			larr = HX_("null",87,9e,0e,49);
            		}
            		else {
HXLINE(  20)			larr = ::haxe::ui::containers::dialogs::_Dialog::DialogButton_Impl__obj::toString(lhs);
            		}
HXDLIN(  20)		::Array< ::String > larr1 = larr.split(HX_("|",7c,00,00,00));
HXLINE(  21)		::String rarr;
HXDLIN(  21)		if (::hx::IsNull( rhs )) {
HXLINE(  21)			rarr = HX_("null",87,9e,0e,49);
            		}
            		else {
HXLINE(  21)			rarr = ::haxe::ui::containers::dialogs::_Dialog::DialogButton_Impl__obj::toString(rhs);
            		}
HXDLIN(  21)		::Array< ::String > rarr1 = rarr.split(HX_("|",7c,00,00,00));
HXLINE(  22)		{
HXLINE(  22)			int _g = 0;
HXDLIN(  22)			while((_g < rarr1->length)){
HXLINE(  22)				::String r = rarr1->__get(_g);
HXDLIN(  22)				_g = (_g + 1);
HXLINE(  23)				if ((larr1->indexOf(r,null()) == -1)) {
HXLINE(  24)					larr1->push(r);
            				}
            			}
            		}
HXLINE(  27)		return larr1->join(HX_("|",7c,00,00,00));
            	}
...
HXLINE(  32)		::String larr;
HXDLIN(  32)		if (::hx::IsNull( lhs )) {
HXLINE(  32)			larr = HX_("null",87,9e,0e,49);
            		}
            		else {
HXLINE(  32)			larr = ::haxe::ui::containers::dialogs::_Dialog::DialogButton_Impl__obj::toString(lhs);
            		}
HXDLIN(  32)		::Array< ::String > larr1 = larr.split(HX_("|",7c,00,00,00));
HXLINE(  33)		::String _hx_tmp;
HXDLIN(  33)		if (::hx::IsNull( rhs )) {
HXLINE(  33)			_hx_tmp = HX_("null",87,9e,0e,49);
            		}
            		else {
HXLINE(  33)			_hx_tmp = ::haxe::ui::containers::dialogs::_Dialog::DialogButton_Impl__obj::toString(rhs);
            		}
HXDLIN(  33)		return (larr1->indexOf(_hx_tmp,null()) != -1);
            	}
