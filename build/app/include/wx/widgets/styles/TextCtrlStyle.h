...
class HXCPP_CLASS_ATTRIBUTES TextCtrlStyle_obj : public ::hx::Object
{
	...
	public:
		...
		inline static ::hx::ObjectPtr< TextCtrlStyle_obj > __new() {
			::hx::ObjectPtr< TextCtrlStyle_obj > __this = new TextCtrlStyle_obj();
			__this->__construct();
			return __this;
		}

		inline static ::hx::ObjectPtr< TextCtrlStyle_obj > __alloc(::hx::Ctx *_hx_ctx) {
		...
		::String __ToString() const { return HX_("TextCtrlStyle",f9,25,1f,48); }
