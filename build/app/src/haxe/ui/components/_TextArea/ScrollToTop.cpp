...
HX_DEFINE_STACK_FRAME(_hx_pos_ab8e31ef5801bd44_278_new,"haxe.ui.components._TextArea.ScrollToTop","new",0x61affe84,"haxe.ui.components._TextArea.ScrollToTop.new","haxe/ui/components/TextArea.hx",278,0xfe441d7d)
HX_LOCAL_STACK_FRAME(_hx_pos_ab8e31ef5801bd44_279_call,"haxe.ui.components._TextArea.ScrollToTop","call",0x110649fa,"haxe.ui.components._TextArea.ScrollToTop.call","haxe/ui/components/TextArea.hx",279,0xfe441d7d)
namespace haxe{
namespace ui{
...
void ScrollToTop_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_ab8e31ef5801bd44_278_new)
...
bool ScrollToTop_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::haxe::ui::util::VariantType ScrollToTop_obj::call( ::Dynamic param){
            	HX_STACKFRAME(&_hx_pos_ab8e31ef5801bd44_279_call)
HXLINE( 280)		 ::haxe::ui::components::VerticalScroll vscroll = this->_component->findComponent(null(),::hx::ClassOf< ::haxe::ui::components::VerticalScroll >(),false,null()).StaticCast<  ::haxe::ui::components::VerticalScroll >();
HXLINE( 281)		if (::hx::IsNotNull( vscroll )) {
HXLINE( 282)			vscroll->set_pos(( (Float)(0) ));
            		}
