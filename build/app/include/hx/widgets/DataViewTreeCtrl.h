...
class HXCPP_CLASS_ATTRIBUTES DataViewTreeCtrl_obj : public  ::hx::widgets::DataViewCtrl_obj
{
	...
	public:
		...
		static void __boot();
		static  wxDataViewItem NULL_ITEM;
		...
		::Dynamic appendContainer_dyn();
		 ...
		 ::hx::widgets::DataViewItem prependContainer( ::hx::widgets::DataViewItem parent,::String text,::hx::Null< int >  icon,::hx::Null< int >  expanded);
		::Dynamic prependContainer_dyn();

		 ::hx::widgets::DataViewItem insertContainer( ::hx::widgets::DataViewItem parent, ::hx::widgets::DataViewItem previous,::String text,::hx::Null< int >  icon,::hx::Null< int >  expanded);
		::Dynamic insertContainer_dyn();

		 ::hx::widgets::DataViewItem appendItem( ::hx::widgets::DataViewItem parent,::String text,::hx::Null< int >  icon);
		::Dynamic appendItem_dyn();

		 ::hx::widgets::DataViewItem prependItem( ::hx::widgets::DataViewItem parent,::String text,::hx::Null< int >  icon);
		::Dynamic prependItem_dyn();

		 ::hx::widgets::DataViewItem insertItem( ::hx::widgets::DataViewItem parent, ::hx::widgets::DataViewItem previous,::String text,::hx::Null< int >  icon);
		...
		int getItemIndex( ::hx::widgets::DataViewItem parent, ::hx::widgets::DataViewItem item);
		::Dynamic getItemIndex_dyn();

		 ::hx::widgets::DataViewItem getNextItem( ::hx::widgets::DataViewItem parent, ::hx::widgets::DataViewItem item,::hx::Null< bool >  wrap);
		::Dynamic getNextItem_dyn();

		 ::hx::widgets::DataViewItem getPrevItem( ::hx::widgets::DataViewItem parent, ::hx::widgets::DataViewItem item,::hx::Null< bool >  wrap);
		::Dynamic getPrevItem_dyn();
