...
HXLINE(  69)			::Dynamic _hx_tmp1 =  ::hx::interface_check(builder->editor,0xfafb3fc3);
HXDLIN(  69)			::haxe::ui::core::IDataComponent_obj::set_dataSource(_hx_tmp1,::haxe::ui::util::_Variant::Variant_Impl__obj::toDataSource(value));
            		}
            	}
