...
HX_DEFINE_STACK_FRAME(_hx_pos_cc46ed79f42626d1_17_new,"hx.widgets.App","new",0x6858ed56,"hx.widgets.App.new","hx/widgets/App.hx",17,0x19b9a55c)
HX_LOCAL_STACK_FRAME(_hx_pos_cc46ed79f42626d1_32_init,"hx.widgets.App","init",0xe22f755a,"hx.widgets.App.init","hx/widgets/App.hx",32,0x19b9a55c)
HX_LOCAL_STACK_FRAME(_hx_pos_cc46ed79f42626d1_38_run,"hx.widgets.App","run",0x685c0441,"hx.widgets.App.run","hx/widgets/App.hx",38,0x19b9a55c)
HX_LOCAL_STACK_FRAME(_hx_pos_cc46ed79f42626d1_41_exit,"hx.widgets.App","exit",0xdf923168,"hx.widgets.App.exit","hx/widgets/App.hx",41,0x19b9a55c)
HX_LOCAL_STACK_FRAME(_hx_pos_cc46ed79f42626d1_52_setCLocale,"hx.widgets.App","setCLocale",0x439007a5,"hx.widgets.App.setCLocale","hx/widgets/App.hx",52,0x19b9a55c)
HX_LOCAL_STACK_FRAME(_hx_pos_cc46ed79f42626d1_56_get_topWindow,"hx.widgets.App","get_topWindow",0x85e70cb2,"hx.widgets.App.get_topWindow","hx/widgets/App.hx",56,0x19b9a55c)
HX_LOCAL_STACK_FRAME(_hx_pos_cc46ed79f42626d1_63_set_topWindow,"hx.widgets.App","set_topWindow",0xcaeceebe,"hx.widgets.App.set_topWindow","hx/widgets/App.hx",63,0x19b9a55c)
HX_LOCAL_STACK_FRAME(_hx_pos_cc46ed79f42626d1_68_get_traits,"hx.widgets.App","get_traits",0x83993e78,"hx.widgets.App.get_traits","hx/widgets/App.hx",68,0x19b9a55c)
HX_LOCAL_STACK_FRAME(_hx_pos_cc46ed79f42626d1_77_get_name,"hx.widgets.App","get_name",0x887a551e,"hx.widgets.App.get_name","hx/widgets/App.hx",77,0x19b9a55c)
HX_LOCAL_STACK_FRAME(_hx_pos_cc46ed79f42626d1_80_set_name,"hx.widgets.App","set_name",0x36d7ae92,"hx.widgets.App.set_name","hx/widgets/App.hx",80,0x19b9a55c)
HX_LOCAL_STACK_FRAME(_hx_pos_cc46ed79f42626d1_90_get_appRef,"hx.widgets.App","get_appRef",0xcddcecc5,"hx.widgets.App.get_appRef","hx/widgets/App.hx",90,0x19b9a55c)
HX_LOCAL_STACK_FRAME(_hx_pos_cc46ed79f42626d1_48_setInstance,"hx.widgets.App","setInstance",0x1abdec4d,"hx.widgets.App.setInstance","hx/widgets/App.hx",48,0x19b9a55c)
namespace hx{
namespace widgets{

void App_obj::__construct(::hx::Null< bool >  __o_setInstance){
            		bool setInstance = __o_setInstance.Default(true);
            	HX_STACKFRAME(&_hx_pos_cc46ed79f42626d1_17_new)
HXLINE(  18)		this->_ref = ::cpp::Pointer_obj::fromRaw((new wxApp()))->reinterpret();
HXLINE(  19)		if (setInstance) {
HXLINE(  20)			::hx::widgets::App_obj::instance = ::hx::ObjectPtr<OBJ_>(this);
HXLINE(  21)			::hx::widgets::App_obj::setInstance(::hx::ObjectPtr<OBJ_>(this));
            		}
HXLINE(  24)		super::__construct();
HXLINE(  25)		int systemLanguage = wxLocale::GetSystemLanguage();
HXLINE(  26)		if ((systemLanguage != 1)) {
HXLINE(  27)			this->_locale = ::cpp::Pointer_obj::fromRaw((new wxLocale(systemLanguage)));
            		}
            	}
...
bool App_obj::init(){
            	HX_STACKFRAME(&_hx_pos_cc46ed79f42626d1_32_init)
HXLINE(  33)		::wx::widgets::Entry_obj::start(::Sys_obj::args());
HXLINE(  34)		return this->get_appRef()->ptr->OnInit();
            	}
...
void App_obj::run(){
            	HX_STACKFRAME(&_hx_pos_cc46ed79f42626d1_38_run)
HXDLIN(  38)		this->get_appRef()->ptr->OnRun();
            	}
...
void App_obj::exit(){
            	HX_STACKFRAME(&_hx_pos_cc46ed79f42626d1_41_exit)
HXLINE(  42)		this->_locale->destroy();
HXLINE(  43)		this->get_appRef()->ptr->OnExit();
HXLINE(  44)		::wx::widgets::Entry_obj::cleanup();
            	}
...
void App_obj::setCLocale(){
            	HX_STACKFRAME(&_hx_pos_cc46ed79f42626d1_52_setCLocale)
HXDLIN(  52)		this->get_appRef()->ptr->SetCLocale();
            	}


HX_DEFINE_DYNAMIC_FUNC0(App_obj,setCLocale,(void))

 ::hx::widgets::Window App_obj::get_topWindow(){
            	HX_GC_STACKFRAME(&_hx_pos_cc46ed79f42626d1_56_get_topWindow)
HXLINE(  57)		 wxWindow* p = this->get_appRef()->ptr->GetTopWindow();
HXLINE(  58)		 ::hx::widgets::Window win =  ::hx::widgets::Window_obj::__alloc( HX_CTX ,null(),null());
HXLINE(  59)		win->_ref = ::cpp::Pointer_obj::fromRaw(p)->reinterpret();
HXLINE(  60)		return win;
            	}


HX_DEFINE_DYNAMIC_FUNC0(App_obj,get_topWindow,return )

 ::hx::widgets::Window App_obj::set_topWindow( ::hx::widgets::Window value){
            	HX_STACKFRAME(&_hx_pos_cc46ed79f42626d1_63_set_topWindow)
HXDLIN(  63)		return value;
            	}


HX_DEFINE_DYNAMIC_FUNC1(App_obj,set_topWindow,return )

 ::hx::widgets::AppTraits App_obj::get_traits(){
            	HX_GC_STACKFRAME(&_hx_pos_cc46ed79f42626d1_68_get_traits)
HXLINE(  69)		 wxAppTraits* p = this->get_appRef()->ptr->GetTraits();
HXLINE(  70)		 ::hx::widgets::AppTraits appTraits =  ::hx::widgets::AppTraits_obj::__alloc( HX_CTX );
HXLINE(  71)		appTraits->_ref = ::cpp::Pointer_obj::fromRaw(p);
HXLINE(  72)		return appTraits;
            	}


HX_DEFINE_DYNAMIC_FUNC0(App_obj,get_traits,return )

::String App_obj::get_name(){
            	HX_STACKFRAME(&_hx_pos_cc46ed79f42626d1_77_get_name)
HXDLIN(  77)		return ::String(this->get_appRef()->ptr->GetAppName().ToUTF8().data());
            	}


HX_DEFINE_DYNAMIC_FUNC0(App_obj,get_name,return )

::String App_obj::set_name(::String name){
            	HX_STACKFRAME(&_hx_pos_cc46ed79f42626d1_80_set_name)
HXLINE(  81)		 wxApp * _hx_tmp = this->get_appRef()->ptr;
HXDLIN(  81)		(*(_hx_tmp)).SetAppName(wxString::FromUTF8(name.utf8_str()));
HXLINE(  82)		return name;
            	}


HX_DEFINE_DYNAMIC_FUNC1(App_obj,set_name,return )

::cpp::Pointer<  wxApp > App_obj::get_appRef(){
            	HX_STACKFRAME(&_hx_pos_cc46ed79f42626d1_90_get_appRef)
...
void App_obj::setInstance( ::hx::widgets::App instance){
            	HX_STACKFRAME(&_hx_pos_cc46ed79f42626d1_48_setInstance)
HXDLIN(  48)		wxApp::SetInstance(instance->get_appRef()->get_raw());
            	}
...
::hx::Val App_obj::__Field(const ::String &inName,::hx::PropertyAccess inCallProp)
{
	...
	case 8:
		...
		break;
	case 9:
		if (HX_FIELD_EQ(inName,"topWindow") ) { if (inCallProp == ::hx::paccAlways) return ::hx::Val( get_topWindow() ); }
		break;
	case 10:
		...
		break;
	case 13:
		if (HX_FIELD_EQ(inName,"get_topWindow") ) { return ::hx::Val( get_topWindow_dyn() ); }
		if (HX_FIELD_EQ(inName,"set_topWindow") ) { return ::hx::Val( set_topWindow_dyn() ); }
	}
...
::hx::Val App_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 7:
		...
		break;
	case 9:
		if (HX_FIELD_EQ(inName,"topWindow") ) { if (inCallProp == ::hx::paccAlways) return ::hx::Val( set_topWindow(inValue.Cast<  ::hx::widgets::Window >()) ); }
	}
...
void App_obj::__GetFields(Array< ::String> &outFields)
{
	...
	outFields->push(HX_("topWindow",65,0c,c8,1a));
...
static ::String App_obj_sMemberFields[] = {
	...
	HX_("get_topWindow",3c,e0,2b,dc),
	HX_("set_topWindow",48,c2,31,21),
