...
HX_LOCAL_STACK_FRAME(_hx_pos_e436dd27744fbe07_700_cloneLayout,"haxe.ui.layouts.DefaultLayout","cloneLayout",0xf6d863ad,"haxe.ui.layouts.DefaultLayout.cloneLayout","haxe/ui/macros/helpers/ClassBuilder.hx",700,0x8cdaad7b)
HX_LOCAL_STACK_FRAME(_hx_pos_24cbcad6bf4c2b19_113_self,"haxe.ui.layouts.DefaultLayout","self",0xf1e84506,"haxe.ui.layouts.DefaultLayout.self","haxe/ui/macros/LayoutMacros.hx",113,0xe44eaad7)
namespace haxe{
namespace ui{
namespace layouts{
...
HXLINE( 176)				child->moveComponent(xpos,ypos);
 ...
 ::haxe::ui::layouts::Layout DefaultLayout_obj::cloneLayout(){
            	HX_STACKFRAME(&_hx_pos_e436dd27744fbe07_700_cloneLayout)
HXLINE(  85)		 ::haxe::ui::layouts::DefaultLayout c = ( ( ::haxe::ui::layouts::DefaultLayout)(this->super::cloneLayout()) );
HXLINE(  96)		c->_calcFullWidths = this->_calcFullWidths;
HXDLIN(  96)		c->_calcFullHeights = this->_calcFullHeights;
HXDLIN(  96)		c->_roundFullWidths = this->_roundFullWidths;
HXLINE( 101)		return c;
            	}


 ::haxe::ui::layouts::Layout DefaultLayout_obj::self(){
            	HX_GC_STACKFRAME(&_hx_pos_24cbcad6bf4c2b19_113_self)
HXDLIN( 113)		return  ::haxe::ui::layouts::DefaultLayout_obj::__alloc( HX_CTX );
            	}
