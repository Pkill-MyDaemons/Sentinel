...
class HXCPP_CLASS_ATTRIBUTES MessageDialogStyle_obj : public ::hx::Object
{
	...
	public:
		...
		inline static ::hx::ObjectPtr< MessageDialogStyle_obj > __new() {
			::hx::ObjectPtr< MessageDialogStyle_obj > __this = new MessageDialogStyle_obj();
			__this->__construct();
			return __this;
		}

		inline static ::hx::ObjectPtr< MessageDialogStyle_obj > __alloc(::hx::Ctx *_hx_ctx) {
		...
		::String __ToString() const { return HX_("MessageDialogStyle",e2,98,cd,d4); }
