...
HX_DEFINE_STACK_FRAME(_hx_pos_f73c957e942350e0_621_new,"haxe.ui.containers._ScrollView.ScrollPolicyBehaviour","new",0xf2d4dd89,"haxe.ui.containers._ScrollView.ScrollPolicyBehaviour.new","haxe/ui/containers/ScrollView.hx",621,0x01b76681)
HX_LOCAL_STACK_FRAME(_hx_pos_f73c957e942350e0_626_validateData,"haxe.ui.containers._ScrollView.ScrollPolicyBehaviour","validateData",0x5fc5db97,"haxe.ui.containers._ScrollView.ScrollPolicyBehaviour.validateData","haxe/ui/containers/ScrollView.hx",626,0x01b76681)
namespace haxe{
namespace ui{
...
void ScrollPolicyBehaviour_obj::__construct( ::haxe::ui::containers::ScrollView scrollview){
            	HX_STACKFRAME(&_hx_pos_f73c957e942350e0_621_new)
HXLINE( 622)		super::__construct(scrollview);
HXLINE( 623)		this->_scrollview = scrollview;
            	}
...
void ScrollPolicyBehaviour_obj::validateData(){
            	HX_STACKFRAME(&_hx_pos_f73c957e942350e0_626_validateData)
HXLINE( 627)		 ::haxe::ui::containers::ScrollView _hx_tmp = this->_scrollview;
HXDLIN( 627)		_hx_tmp->set_horizontalScrollPolicy(::haxe::ui::util::_Variant::Variant_Impl__obj::toString(this->_value));
HXLINE( 628)		 ::haxe::ui::containers::ScrollView _hx_tmp1 = this->_scrollview;
HXDLIN( 628)		_hx_tmp1->set_verticalScrollPolicy(::haxe::ui::util::_Variant::Variant_Impl__obj::toString(this->_value));
            	}
