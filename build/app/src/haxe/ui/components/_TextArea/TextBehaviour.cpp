...
HX_DEFINE_STACK_FRAME(_hx_pos_f76e1717003544b4_247_new,"haxe.ui.components._TextArea.TextBehaviour","new",0xe884ee87,"haxe.ui.components._TextArea.TextBehaviour.new","haxe/ui/components/TextArea.hx",247,0xfe441d7d)
HX_LOCAL_STACK_FRAME(_hx_pos_f76e1717003544b4_248_validateData,"haxe.ui.components._TextArea.TextBehaviour","validateData",0xa576bad9,"haxe.ui.components._TextArea.TextBehaviour.validateData","haxe/ui/components/TextArea.hx",248,0xfe441d7d)
namespace haxe{
namespace ui{
...
void TextBehaviour_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_f76e1717003544b4_247_new)
...
bool TextBehaviour_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x37b9aa84) {
		if (inClassId<=(int)0x0447a717) {
			return inClassId==(int)0x00000001 || inClassId==(int)0x0447a717;
		} else {
...
void TextBehaviour_obj::validateData(){
            	HX_STACKFRAME(&_hx_pos_f76e1717003544b4_248_validateData)
HXLINE( 249)		 ::haxe::ui::components::TextArea textarea = ::hx::TCast<  ::haxe::ui::components::TextArea >::cast(this->_component);
HXLINE( 250)		::String text;
HXDLIN( 250)		if (::hx::IsNotNull( this->_value )) {
HXLINE( 250)			text = ::haxe::ui::util::_Variant::Variant_Impl__obj::toString(this->_value);
            		}
            		else {
HXLINE( 250)			text = HX_("",00,00,00,00);
            		}
HXLINE( 251)		::haxe::ui::components::_TextArea::TextAreaHelper_obj::validateText(textarea,text);
HXLINE( 252)		if ((textarea->get_autoScrollToBottom() == true)) {
HXLINE( 253)			textarea->scrollToBottom();
            		}
            	}
...
::hx::ObjectPtr< TextBehaviour_obj > TextBehaviour_obj::__alloc(::hx::Ctx *_hx_ctx, ::haxe::ui::core::Component component) {
	TextBehaviour_obj *__this = (TextBehaviour_obj*)(::hx::Ctx::alloc(_hx_ctx, sizeof(TextBehaviour_obj), true, "haxe.ui.components._TextArea.TextBehaviour"));
...
void TextBehaviour_obj::__register()
{
	...
	__mClass->mName = HX_("haxe.ui.components._TextArea.TextBehaviour",15,9f,a3,6e);
