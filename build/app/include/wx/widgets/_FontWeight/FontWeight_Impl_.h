...
class HXCPP_CLASS_ATTRIBUTES FontWeight_Impl__obj : public ::hx::Object
{
	...
	public:
		...
		inline static ::hx::ObjectPtr< FontWeight_Impl__obj > __new() {
			::hx::ObjectPtr< FontWeight_Impl__obj > __this = new FontWeight_Impl__obj();
			__this->__construct();
			return __this;
		}

		inline static ::hx::ObjectPtr< FontWeight_Impl__obj > __alloc(::hx::Ctx *_hx_ctx) {
		...
		::String __ToString() const { return HX_("FontWeight_Impl_",a7,98,34,a0); }
