...
bool IconMap_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x1ba5bd9e;
}
...
HXLINE(  19)		int index = -1;
HXLINE(  20)		 ::hx::widgets::ImageList imageList = ( ( ::hx::widgets::ImageList)(this->_objectsToImageList->get(object)) );
...
HXLINE(  36)		 ::hx::widgets::ImageList imageList = ( ( ::hx::widgets::ImageList)(this->_objectsToImageList->get(object)) );
HXLINE(  37)		if (::hx::IsNull( imageList )) {
HXLINE(  38)			imageList =  ::hx::widgets::ImageList_obj::__alloc( HX_CTX ,16,16);
...
HXLINE(  48)		if ((::haxe::Resource_obj::listNames()->indexOf(icon,null()) == -1)) {
HXLINE(  49)			::haxe::Log_obj::trace(HX_("WARNING: icon not found",70,7b,9e,f7),::hx::SourceInfo(HX_("haxe/ui/backend/hxwidgets/IconMap.hx",18,ac,3d,f6),49,HX_("haxe.ui.backend.hxwidgets.IconMap",08,84,43,4d),HX_("addImage",7a,45,c6,36)));
HXLINE(  50)			return -1;
            		}
HXLINE(  52)		imageList->add(::hx::widgets::Bitmap_obj::fromHaxeResource(icon));
HXLINE(  53)		iconList->push(icon);
HXLINE(  55)		return iconList->indexOf(icon,null());
            	}
...
{
	outFields->push(HX_("_objectsToImageList",09,a0,fa,1d));
	outFields->push(HX_("_imageListToIcon",4e,c3,18,78));
	super::__GetFields(outFields);
};

#ifdef HXCPP_SCRIPTABLE
static ::hx::StorageInfo IconMap_obj_sMemberStorageInfo[] = {
	{::hx::fsObject /*  ::haxe::ds::ObjectMap */ ,(int)offsetof(IconMap_obj,_objectsToImageList),HX_("_objectsToImageList",09,a0,fa,1d)},
	{::hx::fsObject /*  ::haxe::ds::ObjectMap */ ,(int)offsetof(IconMap_obj,_imageListToIcon),HX_("_imageListToIcon",4e,c3,18,78)},
	{ ::hx::fsUnknown, 0, null()}
};
...
static ::String IconMap_obj_sMemberFields[] = {
	HX_("_objectsToImageList",09,a0,fa,1d),
	HX_("_imageListToIcon",4e,c3,18,78),
	HX_("getImageIndex",ed,bd,54,26),
...
{
	IconMap_obj _hx_dummy;
	IconMap_obj::_hx_vtable = *(void **)&_hx_dummy;
	::hx::Static(__mClass) = new ::hx::Class_obj();
	__mClass->mName = HX_("haxe.ui.backend.hxwidgets.IconMap",08,84,43,4d);
