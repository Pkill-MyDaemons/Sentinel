...
class HXCPP_CLASS_ATTRIBUTES FontData_obj : public ::hx::Object
{
	...
	public:
		...
		inline static ::hx::ObjectPtr< FontData_obj > __new() {
			::hx::ObjectPtr< FontData_obj > __this = new FontData_obj();
			__this->__construct();
			return __this;
		}

		inline static ::hx::ObjectPtr< FontData_obj > __alloc(::hx::Ctx *_hx_ctx) {
			...
			*(void **)__this = FontData_obj::_hx_vtable;
{
		...
		::String __ToString() const { return HX_("FontData",b9,2f,93,9e); }
