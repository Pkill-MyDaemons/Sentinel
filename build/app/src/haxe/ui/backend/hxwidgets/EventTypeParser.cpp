...
HX_LOCAL_STACK_FRAME(_hx_pos_b2a1c764ea1119f7_32_toString,"haxe.ui.backend.hxwidgets.EventTypeParser","toString",0x3b028382,"haxe.ui.backend.hxwidgets.EventTypeParser.toString","haxe/ui/backend/hxwidgets/EventTypeParser.hx",32,0xa9db93c8)
namespace haxe{
namespace ui{
namespace backend{
namespace hxwidgets{
...
HXLINE(  22)			return ::wx::widgets::EventType_obj::SPINCTRL;
HXDLIN(  22)			goto _hx_goto_0;
            		}
            		if (  (_hx_switch_0==HX_("EventType.TEXT",87,07,ef,98)) ){
HXLINE(  20)			return ::wx::widgets::EventType_obj::TEXT;
HXDLIN(  20)			goto _hx_goto_0;
            		}
            		if (  (_hx_switch_0==HX_("EventType.TOGGLEBUTTON",60,3d,3e,c1)) ){
HXLINE(  14)			return ::wx::widgets::EventType_obj::TOGGLEBUTTON;
HXDLIN(  14)			goto _hx_goto_0;
            		}
            		/* default */{
HXLINE(  26)			::haxe::Log_obj::trace(((HX_("WARNING: hxWidgets event \"",59,fe,fa,d6) + event) + HX_("\" not recognised",fa,2a,a2,aa)),::hx::SourceInfo(HX_("haxe/ui/backend/hxwidgets/EventTypeParser.hx",c8,93,db,a9),26,HX_("haxe.ui.backend.hxwidgets.EventTypeParser",58,60,1a,18),HX_("fromString",db,2d,74,54)));
            		}
            		_hx_goto_0:;
HXLINE(  29)		return 0;
            	}
...
::String EventTypeParser_obj::toString(int eventType){
            	HX_STACKFRAME(&_hx_pos_b2a1c764ea1119f7_32_toString)
HXLINE(  33)		if ((eventType == ::wx::widgets::EventType_obj::SLIDER)) {
HXLINE(  34)			return HX_("EventType.SLIDER",7b,cf,e1,8f);
            		}
            		else {
HXLINE(  35)			if ((eventType == ::wx::widgets::EventType_obj::BUTTON)) {
HXLINE(  36)				return HX_("EventType.BUTTON",4c,6b,bd,f9);
            			}
            			else {
HXLINE(  37)				if ((eventType == ::wx::widgets::EventType_obj::HYPERLINK)) {
HXLINE(  38)					return HX_("EventType.HYPERLINK",2c,9f,4e,d0);
            				}
            				else {
HXLINE(  39)					if ((eventType == ::wx::widgets::EventType_obj::TOGGLEBUTTON)) {
HXLINE(  40)						return HX_("EventType.TOGGLEBUTTON",60,3d,3e,c1);
            					}
            					else {
HXLINE(  41)						if ((eventType == ::wx::widgets::EventType_obj::NOTEBOOK_PAGE_CHANGED)) {
HXLINE(  42)							return HX_("EventType.NOTEBOOK_PAGE_CHANGED",6e,d0,38,a0);
            						}
            						else {
HXLINE(  43)							if ((eventType == ::wx::widgets::EventType_obj::RADIOBUTTON)) {
HXLINE(  44)								return HX_("EventType.RADIOBUTTON",73,e9,3e,ec);
            							}
            							else {
HXLINE(  45)								if ((eventType == ::wx::widgets::EventType_obj::CHECKBOX)) {
HXLINE(  46)									return HX_("EventType.CHECKBOX",1d,4a,2b,45);
            								}
            								else {
HXLINE(  47)									if ((eventType == ::wx::widgets::EventType_obj::CHOICE)) {
HXLINE(  48)										return HX_("EventType.CHOICE",bb,c8,8c,e0);
            									}
            									else {
HXLINE(  49)										if ((eventType == ::wx::widgets::EventType_obj::LIST_ITEM_SELECTED)) {
HXLINE(  50)											return HX_("EventType.LIST_ITEM_SELECTED",c0,e3,e4,5d);
            										}
            										else {
HXLINE(  51)											if ((eventType == ::wx::widgets::EventType_obj::TEXT)) {
HXLINE(  52)												return HX_("EventType.TEXT",87,07,ef,98);
            											}
            											else {
HXLINE(  53)												if ((eventType == ::wx::widgets::EventType_obj::MENU)) {
HXLINE(  54)													return HX_("EventType.MENU",79,80,4e,94);
            												}
            												else {
HXLINE(  55)													if ((eventType == ::wx::widgets::EventType_obj::SPINCTRL)) {
HXLINE(  56)														return HX_("EventType.SPINCTRL",47,eb,97,0e);
            													}
            													else {
HXLINE(  57)														if ((eventType == ::wx::widgets::EventType_obj::CALENDAR_SEL_CHANGED)) {
HXLINE(  58)															return HX_("EventType.CALENDAR_SEL_CHANGED",68,28,cf,27);
            														}
            														else {
HXLINE(  59)															if ((eventType == ::wx::widgets::EventType_obj::DATAVIEW_SELECTION_CHANGED)) {
HXLINE(  60)																return HX_("EventType.DATAVIEW_SELECTION_CHANGED",eb,e2,9f,a3);
            															}
            															else {
HXLINE(  62)																::haxe::Log_obj::trace(((HX_("WARNING: hxWidgets event \"",59,fe,fa,d6) + eventType) + HX_("\" not recognised",fa,2a,a2,aa)),::hx::SourceInfo(HX_("haxe/ui/backend/hxwidgets/EventTypeParser.hx",c8,93,db,a9),62,HX_("haxe.ui.backend.hxwidgets.EventTypeParser",58,60,1a,18),HX_("toString",ac,d0,6e,38)));
            															}
            														}
            													}
            												}
