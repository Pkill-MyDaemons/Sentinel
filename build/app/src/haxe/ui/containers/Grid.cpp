...
HX_LOCAL_STACK_FRAME(_hx_pos_107ba3536cf6d5b6_551_registerBehaviours,"haxe.ui.containers.Grid","registerBehaviours",0xf5002397,"haxe.ui.containers.Grid.registerBehaviours","haxe/ui/macros/Macros.hx",551,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_4e3f01045388a5f3_700_cloneComponent,"haxe.ui.containers.Grid","cloneComponent",0x6f5b2e5e,"haxe.ui.containers.Grid.cloneComponent","haxe/ui/macros/helpers/ClassBuilder.hx",700,0x8cdaad7b)
HX_LOCAL_STACK_FRAME(_hx_pos_107ba3536cf6d5b6_521_self,"haxe.ui.containers.Grid","self",0xb2bb16ca,"haxe.ui.containers.Grid.self","haxe/ui/macros/Macros.hx",521,0x27866361)
namespace haxe{
namespace ui{
...
bool Grid_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x241810fb) {
		...
		if (inClassId<=(int)0x4ba87886) {
			return inClassId==(int)0x24ec0772 || inClassId==(int)0x4ba87886;
		} else {
...
void Grid_obj::registerBehaviours(){
            	HX_STACKFRAME(&_hx_pos_107ba3536cf6d5b6_551_registerBehaviours)
HXDLIN( 551)		this->super::registerBehaviours();
            	}


 ::haxe::ui::backend::ComponentBase Grid_obj::cloneComponent(){
            	HX_STACKFRAME(&_hx_pos_4e3f01045388a5f3_700_cloneComponent)
HXLINE( 469)		 ::haxe::ui::containers::Grid c = ( ( ::haxe::ui::containers::Grid)(this->super::cloneComponent()) );
HXLINE( 480)		c->set_columns(this->get_columns());
HXLINE( 484)		{
...
HXLINE( 493)		return c;
 ...
 ::haxe::ui::backend::ComponentBase Grid_obj::self(){
            	HX_GC_STACKFRAME(&_hx_pos_107ba3536cf6d5b6_521_self)
HXDLIN( 521)		return  ::haxe::ui::containers::Grid_obj::__alloc( HX_CTX );
            	}
