...
HX_LOCAL_STACK_FRAME(_hx_pos_821f1863fac1c1d8_700_cloneLayout,"haxe.ui.layouts.VerticalGridLayout","cloneLayout",0xce588296,"haxe.ui.layouts.VerticalGridLayout.cloneLayout","haxe/ui/macros/helpers/ClassBuilder.hx",700,0x8cdaad7b)
HX_LOCAL_STACK_FRAME(_hx_pos_1ecacd2fd78b4897_113_self,"haxe.ui.layouts.VerticalGridLayout","self",0x2531e2fd,"haxe.ui.layouts.VerticalGridLayout.self","haxe/ui/macros/LayoutMacros.hx",113,0xe44eaad7)
namespace haxe{
namespace ui{
namespace layouts{
...
HXLINE( 258)					 ::Dynamic _hx_tmp = child1->get_height();
HXDLIN( 258)					if (::hx::IsGreater( _hx_tmp,rowHeights->__get(rowIndex) )) {
HXLINE( 259)						rowHeights[rowIndex] = ( (Float)(child1->get_height()) );
            					}
            				}
...
HX_DEFINE_DYNAMIC_FUNC0(VerticalGridLayout_obj,calcExplicitHeights,return )
 ...
 ::haxe::ui::layouts::Layout VerticalGridLayout_obj::cloneLayout(){
            	HX_STACKFRAME(&_hx_pos_821f1863fac1c1d8_700_cloneLayout)
HXLINE(  85)		 ::haxe::ui::layouts::VerticalGridLayout c = ( ( ::haxe::ui::layouts::VerticalGridLayout)(this->super::cloneLayout()) );
HXLINE(  96)		c->set_columns(this->get_columns());
HXLINE( 101)		return c;
            	}


 ::haxe::ui::layouts::Layout VerticalGridLayout_obj::self(){
            	HX_GC_STACKFRAME(&_hx_pos_1ecacd2fd78b4897_113_self)
HXDLIN( 113)		return  ::haxe::ui::layouts::VerticalGridLayout_obj::__alloc( HX_CTX );
            	}
