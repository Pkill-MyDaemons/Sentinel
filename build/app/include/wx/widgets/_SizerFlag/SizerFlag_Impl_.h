...
class HXCPP_CLASS_ATTRIBUTES SizerFlag_Impl__obj : public ::hx::Object
{
	...
	public:
		...
		inline static ::hx::ObjectPtr< SizerFlag_Impl__obj > __new() {
			::hx::ObjectPtr< SizerFlag_Impl__obj > __this = new SizerFlag_Impl__obj();
			__this->__construct();
			return __this;
		}

		inline static ::hx::ObjectPtr< SizerFlag_Impl__obj > __alloc(::hx::Ctx *_hx_ctx) {
		...
		::String __ToString() const { return HX_("SizerFlag_Impl_",1d,25,f8,fd); }
