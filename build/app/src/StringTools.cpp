...
HX_LOCAL_STACK_FRAME(_hx_pos_5093819ee31b3c37_394_rpad,"StringTools","rpad",0x27b4d7a5,"StringTools.rpad","/opt/homebrew/lib/haxe/std/StringTools.hx",394,0xbfe6ab9c)
...
::String StringTools_obj::rpad(::String s,::String c,int l){
            	HX_GC_STACKFRAME(&_hx_pos_5093819ee31b3c37_394_rpad)
