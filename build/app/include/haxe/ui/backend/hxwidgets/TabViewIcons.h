...
class HXCPP_CLASS_ATTRIBUTES TabViewIcons_obj : public ::hx::Object
{
	...
	public:
		...
		inline static ::hx::ObjectPtr< TabViewIcons_obj > __new() {
			::hx::ObjectPtr< TabViewIcons_obj > __this = new TabViewIcons_obj();
			__this->__construct();
			return __this;
		}

		inline static ::hx::ObjectPtr< TabViewIcons_obj > __alloc(::hx::Ctx *_hx_ctx) {
		...
		::String __ToString() const { return HX_("TabViewIcons",40,71,d7,9c); }
