...
class HXCPP_CLASS_ATTRIBUTES RadioButtonGroups_obj : public ::hx::Object
{
	...
	public:
		...
		inline static ::hx::ObjectPtr< RadioButtonGroups_obj > __new() {
			::hx::ObjectPtr< RadioButtonGroups_obj > __this = new RadioButtonGroups_obj();
			__this->__construct();
			return __this;
		}

		inline static ::hx::ObjectPtr< RadioButtonGroups_obj > __alloc(::hx::Ctx *_hx_ctx) {
		...
		::String __ToString() const { return HX_("RadioButtonGroups",61,25,29,41); }
