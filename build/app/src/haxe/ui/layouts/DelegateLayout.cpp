...
HX_LOCAL_STACK_FRAME(_hx_pos_afbf8957e49a8ab1_700_cloneLayout,"haxe.ui.layouts.DelegateLayout","cloneLayout",0x560e2e3f,"haxe.ui.layouts.DelegateLayout.cloneLayout","haxe/ui/macros/helpers/ClassBuilder.hx",700,0x8cdaad7b)
HX_LOCAL_STACK_FRAME(_hx_pos_405e0d4e09f3c69f_113_self,"haxe.ui.layouts.DelegateLayout","self",0x9273dc34,"haxe.ui.layouts.DelegateLayout.self","haxe/ui/macros/LayoutMacros.hx",113,0xe44eaad7)
namespace haxe{
namespace ui{
namespace layouts{
...
HXLINE(  33)		return size;
 ...
 ::haxe::ui::layouts::Layout DelegateLayout_obj::cloneLayout(){
            	HX_STACKFRAME(&_hx_pos_afbf8957e49a8ab1_700_cloneLayout)
HXLINE(  85)		 ::haxe::ui::layouts::DelegateLayout c = ( ( ::haxe::ui::layouts::DelegateLayout)(this->super::cloneLayout()) );
HXLINE(  94)		if (::hx::IsNotNull( this->_size )) {
HXLINE(  94)			c->_size = this->_size;
            		}
HXLINE( 101)		return c;
            	}


 ::haxe::ui::layouts::Layout DelegateLayout_obj::self(){
            	HX_GC_STACKFRAME(&_hx_pos_405e0d4e09f3c69f_113_self)
HXDLIN( 113)		return  ::haxe::ui::layouts::DelegateLayout_obj::__alloc( HX_CTX ,null());
            	}
