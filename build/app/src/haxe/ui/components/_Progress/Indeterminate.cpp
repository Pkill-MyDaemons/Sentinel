...
HX_DEFINE_STACK_FRAME(_hx_pos_d87b03eddc7875f2_88_new,"haxe.ui.components._Progress.Indeterminate","new",0x18d798c5,"haxe.ui.components._Progress.Indeterminate.new","haxe/ui/components/Progress.hx",88,0x4b000a8a)
HX_LOCAL_STACK_FRAME(_hx_pos_d87b03eddc7875f2_92_get,"haxe.ui.components._Progress.Indeterminate","get",0x18d248fb,"haxe.ui.components._Progress.Indeterminate.get","haxe/ui/components/Progress.hx",92,0x4b000a8a)
HX_LOCAL_STACK_FRAME(_hx_pos_d87b03eddc7875f2_95_set,"haxe.ui.components._Progress.Indeterminate","set",0x18db6407,"haxe.ui.components._Progress.Indeterminate.set","haxe/ui/components/Progress.hx",95,0x4b000a8a)
HX_LOCAL_STACK_FRAME(_hx_pos_d87b03eddc7875f2_110_detatch,"haxe.ui.components._Progress.Indeterminate","detatch",0x0cdf8c90,"haxe.ui.components._Progress.Indeterminate.detatch","haxe/ui/components/Progress.hx",110,0x4b000a8a)
namespace haxe{
namespace ui{
...
void Indeterminate_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_d87b03eddc7875f2_88_new)
...
bool Indeterminate_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::haxe::ui::util::VariantType Indeterminate_obj::get(){
            	HX_STACKFRAME(&_hx_pos_d87b03eddc7875f2_92_get)
HXDLIN(  92)		return this->_value;
            	}


void Indeterminate_obj::set( ::haxe::ui::util::VariantType value){
            	HX_STACKFRAME(&_hx_pos_d87b03eddc7875f2_95_set)
HXLINE(  96)		if (::haxe::ui::util::_Variant::Variant_Impl__obj::eq(value,this->_value)) {
HXLINE(  97)			return;
            		}
HXLINE( 100)		this->super::set(value);
HXLINE( 102)		if (::haxe::ui::util::_Variant::Variant_Impl__obj::eq(value,::haxe::ui::util::_Variant::Variant_Impl__obj::fromBool(false))) {
HXLINE( 103)			this->_component->removeClass(HX_(":indeterminate",81,da,8e,29),null(),null());
            		}
            		else {
HXLINE( 105)			this->_component->addClass(HX_(":indeterminate",81,da,8e,29),null(),null());
            		}
            	}


void Indeterminate_obj::detatch(){
            	HX_STACKFRAME(&_hx_pos_d87b03eddc7875f2_110_detatch)
HXLINE( 111)		this->super::detatch();
HXLINE( 112)		this->_component->removeClass(HX_(":indeterminate",81,da,8e,29),null(),null());
            	}
