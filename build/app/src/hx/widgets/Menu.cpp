...
HXLINE(  12)			 wxString str = wxString::FromUTF8(text.utf8_str());
HXLINE(  13)			this->_ref = ::cpp::Pointer_obj::fromRaw((new wxMenu(str,style)))->reinterpret();
            		}
...
bool Menu_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x467ba226) {
		...
		return inClassId==(int)0x71ba4f5e;
	}
}
...
HXLINE(  36)		 wxString str = wxString::FromUTF8(text.utf8_str());
HXLINE(  37)		::cpp::Pointer<  wxMenuItem > menuItemRef = ::cpp::Pointer_obj::fromRaw(this->get_menuRef()->ptr->AppendCheckItem(id,str));
...
HXLINE(  45)		 wxString str = wxString::FromUTF8(text.utf8_str());
HXLINE(  46)		::cpp::Pointer<  wxMenuItem > menuItemRef = ::cpp::Pointer_obj::fromRaw(this->get_menuRef()->ptr->AppendRadioItem(id,str));
...
HXLINE(  62)		 wxString str = wxString::FromUTF8(text.utf8_str());
HXLINE(  63)		 wxMenu * menuItemRef = this->get_menuRef()->ptr;
HXDLIN(  63)		::cpp::Pointer<  wxMenuItem > menuItemRef1 = ::cpp::Pointer_obj::fromRaw((*(menuItemRef)).AppendSubMenu(menu->get_menuRef()->get_raw(),str));
...
{
	outFields->push(HX_("menuRef",f4,58,57,ba));
	super::__GetFields(outFields);
};

#ifdef HXCPP_SCRIPTABLE
static ::hx::StorageInfo Menu_obj_sMemberStorageInfo[] = {
	{::hx::fsUnknown /* ::cpp::Pointer<  wxMenu > */ ,(int)offsetof(Menu_obj,menuRef),HX_("menuRef",f4,58,57,ba)},
	{ ::hx::fsUnknown, 0, null()}
};
...
static ::String Menu_obj_sMemberFields[] = {
	...
	HX_("appendCheckItem",c1,80,04,cc),
	HX_("appendRadioItem",74,8e,f1,21),
	HX_("appendSeparator",2b,53,e4,63),
	HX_("appendSubMenu",85,70,7d,4f),
	HX_("menuRef",f4,58,57,ba),
	HX_("get_menuRef",0b,b9,51,40),
	::String(null()) };
...
void Menu_obj::__register()
{
	...
	__mClass->mName = HX_("hx.widgets.Menu",7c,02,c9,ca);
