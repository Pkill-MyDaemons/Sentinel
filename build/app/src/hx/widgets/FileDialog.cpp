...
HX_LOCAL_STACK_FRAME(_hx_pos_21d6d11d3be5536d_80_get_paths,"hx.widgets.FileDialog","get_paths",0x14b629d8,"hx.widgets.FileDialog.get_paths","hx/widgets/FileDialog.hx",80,0x881aaa1b)
HX_LOCAL_STACK_FRAME(_hx_pos_21d6d11d3be5536d_91_get_filterIndex,"hx.widgets.FileDialog","get_filterIndex",0x37916a64,"hx.widgets.FileDialog.get_filterIndex","hx/widgets/FileDialog.hx",91,0x881aaa1b)
HX_LOCAL_STACK_FRAME(_hx_pos_21d6d11d3be5536d_93_set_filterIndex,"hx.widgets.FileDialog","set_filterIndex",0x335ce770,"hx.widgets.FileDialog.set_filterIndex","hx/widgets/FileDialog.hx",93,0x881aaa1b)
HX_LOCAL_STACK_FRAME(_hx_pos_21d6d11d3be5536d_99_get_message,"hx.widgets.FileDialog","get_message",0xde74d2f1,"hx.widgets.FileDialog.get_message","hx/widgets/FileDialog.hx",99,0x881aaa1b)
HX_LOCAL_STACK_FRAME(_hx_pos_21d6d11d3be5536d_103_set_message,"hx.widgets.FileDialog","set_message",0xe8e1d9fd,"hx.widgets.FileDialog.set_message","hx/widgets/FileDialog.hx",103,0x881aaa1b)
HX_LOCAL_STACK_FRAME(_hx_pos_21d6d11d3be5536d_110_get_path,"hx.widgets.FileDialog","get_path",0xcebaca3b,"hx.widgets.FileDialog.get_path","hx/widgets/FileDialog.hx",110,0x881aaa1b)
HX_LOCAL_STACK_FRAME(_hx_pos_21d6d11d3be5536d_114_set_path,"hx.widgets.FileDialog","set_path",0x7d1823af,"hx.widgets.FileDialog.set_path","hx/widgets/FileDialog.hx",114,0x881aaa1b)
HX_LOCAL_STACK_FRAME(_hx_pos_21d6d11d3be5536d_128_get_wildcard,"hx.widgets.FileDialog","get_wildcard",0x3bddc170,"hx.widgets.FileDialog.get_wildcard","hx/widgets/FileDialog.hx",128,0x881aaa1b)
HX_LOCAL_STACK_FRAME(_hx_pos_21d6d11d3be5536d_132_set_wildcard,"hx.widgets.FileDialog","set_wildcard",0x50d6e4e4,"hx.widgets.FileDialog.set_wildcard","hx/widgets/FileDialog.hx",132,0x881aaa1b)
HX_LOCAL_STACK_FRAME(_hx_pos_21d6d11d3be5536d_145_get_fileDialogRef,"hx.widgets.FileDialog","get_fileDialogRef",0x4634f3f9,"hx.widgets.FileDialog.get_fileDialogRef","hx/widgets/FileDialog.hx",145,0x881aaa1b)
namespace hx{
namespace widgets{
...
HXLINE(  28)			 wxString messageStr = wxString::FromUTF8(message.utf8_str());
HXLINE(  29)			 wxString defaultDirStr = wxString::FromUTF8(defaultDir.utf8_str());
HXLINE(  30)			 wxString defaultFileStr = wxString::FromUTF8(defaultFile.utf8_str());
HXLINE(  31)			 wxString wildcardStr = wxString::FromUTF8(wildcard.utf8_str());
...
HXLINE(  53)		 wxString s = wxString::FromUTF8(value.utf8_str());
...
HXLINE(  64)		 wxString s = wxString::FromUTF8(value.utf8_str());
...
::Array< ::String > FileDialog_obj::get_paths(){
            	HX_GC_STACKFRAME(&_hx_pos_21d6d11d3be5536d_80_get_paths)
HXLINE(  81)		 ::hx::widgets::ArrayString wxArray =  ::hx::widgets::ArrayString_obj::__alloc( HX_CTX );
HXLINE(  82)		 wxFileDialog * _hx_tmp = this->get_fileDialogRef()->ptr;
HXDLIN(  82)		(*(_hx_tmp)).GetPaths(wxArray->get_arraystringRef()->get_ref());
HXLINE(  83)		 ::hx::widgets::ArrayString array =  ::hx::widgets::ArrayString_obj::__alloc( HX_CTX );
HXLINE(  84)		::Array< ::String > r = wxArray->toArray();
HXLINE(  85)		wxArray->destroy();
HXLINE(  86)		return r;
            	}


HX_DEFINE_DYNAMIC_FUNC0(FileDialog_obj,get_paths,return )

int FileDialog_obj::get_filterIndex(){
            	HX_STACKFRAME(&_hx_pos_21d6d11d3be5536d_91_get_filterIndex)
HXDLIN(  91)		return this->get_fileDialogRef()->ptr->GetFilterIndex();
            	}
...
int FileDialog_obj::set_filterIndex(int value){
            	HX_STACKFRAME(&_hx_pos_21d6d11d3be5536d_93_set_filterIndex)
HXLINE(  94)		this->get_fileDialogRef()->ptr->SetFilterIndex(value);
...
::String FileDialog_obj::get_message(){
            	HX_STACKFRAME(&_hx_pos_21d6d11d3be5536d_99_get_message)
HXLINE( 100)		 wxString r = this->get_fileDialogRef()->ptr->GetMessage();
HXLINE( 101)		return ::String(::String(r.ToUTF8().data()));
            	}
...
::String FileDialog_obj::set_message(::String value){
            	HX_STACKFRAME(&_hx_pos_21d6d11d3be5536d_103_set_message)
HXLINE( 104)		 wxString s = wxString::FromUTF8(value.utf8_str());
HXLINE( 105)		this->get_fileDialogRef()->ptr->SetMessage(s);
...
::String FileDialog_obj::get_path(){
            	HX_STACKFRAME(&_hx_pos_21d6d11d3be5536d_110_get_path)
HXLINE( 111)		 wxString r = this->get_fileDialogRef()->ptr->GetPath();
HXLINE( 112)		return ::String(::String(r.ToUTF8().data()));
            	}
...
::String FileDialog_obj::set_path(::String value){
            	HX_STACKFRAME(&_hx_pos_21d6d11d3be5536d_114_set_path)
HXLINE( 115)		 wxString s = wxString::FromUTF8(value.utf8_str());
HXLINE( 116)		this->get_fileDialogRef()->ptr->SetPath(s);
...
::String FileDialog_obj::get_wildcard(){
            	HX_STACKFRAME(&_hx_pos_21d6d11d3be5536d_128_get_wildcard)
HXLINE( 129)		 wxString r = this->get_fileDialogRef()->ptr->GetWildcard();
...
::String FileDialog_obj::set_wildcard(::String value){
            	HX_STACKFRAME(&_hx_pos_21d6d11d3be5536d_132_set_wildcard)
HXLINE( 133)		 wxString s = wxString::FromUTF8(value.utf8_str());
HXLINE( 134)		this->get_fileDialogRef()->ptr->SetWildcard(s);
...
::cpp::Pointer<  wxFileDialog > FileDialog_obj::get_fileDialogRef(){
            	HX_STACKFRAME(&_hx_pos_21d6d11d3be5536d_145_get_fileDialogRef)
HXDLIN( 145)		return this->_ref->reinterpret();
            	}
...
::hx::Val FileDialog_obj::__Field(const ::String &inName,::hx::PropertyAccess inCallProp)
{
	...
	case 4:
		...
		break;
	case 5:
		if (HX_FIELD_EQ(inName,"paths") ) { return ::hx::Val( inCallProp == ::hx::paccAlways ? get_paths() : paths ); }
		break;
	case 7:
	...
	case 9:
		...
		if (HX_FIELD_EQ(inName,"get_paths") ) { return ::hx::Val( get_paths_dyn() ); }
		break;
	case 11:
...
static ::hx::StorageInfo FileDialog_obj_sMemberStorageInfo[] = {
	...
	{::hx::fsObject /* ::Array< ::String > */ ,(int)offsetof(FileDialog_obj,paths),HX_("paths",2e,0b,57,bd)},
