...
HX_DEFINE_STACK_FRAME(_hx_pos_ba418526ce7b3618_22_new,"haxe.ui.backend.CallLaterImpl","new",0xecae2eb4,"haxe.ui.backend.CallLaterImpl.new","haxe/ui/backend/CallLaterImpl.hx",22,0xcf690bdd)
namespace haxe{
namespace ui{
namespace backend{

void CallLaterImpl_obj::__construct( ::Dynamic fn){
            	HX_STACKFRAME(&_hx_pos_ba418526ce7b3618_22_new)
HXDLIN(  22)		::haxe::MainLoop_obj::runInMainThread(fn);
            	}
