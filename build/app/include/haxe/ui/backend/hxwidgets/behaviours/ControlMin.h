...
class HXCPP_CLASS_ATTRIBUTES ControlMin_obj : public  ::haxe::ui::behaviours::DataBehaviour_obj
{
	public:
	...
	public:
		...
		::String __ToString() const { return HX_("ControlMin",55,1a,58,fb); }
