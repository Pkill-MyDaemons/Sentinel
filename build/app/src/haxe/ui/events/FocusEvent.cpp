...
HXDLIN(   4)		FOCUS_IN = ::haxe::ui::events::_EventType::EventType_Impl__obj::name(HX_("focusin",bd,61,83,41));
            	}
{
            	HX_STACKFRAME(&_hx_pos_2a2fb5a6f53a027a_5_boot)
HXDLIN(   5)		FOCUS_OUT = ::haxe::ui::events::_EventType::EventType_Impl__obj::name(HX_("focusout",b6,b7,76,11));
            	}
}
