...
HX_DEFINE_STACK_FRAME(_hx_pos_2899711b6bd2adc3_6_new,"haxe.ui.backend.hxwidgets.builders.MenuBuilder","new",0x5bfcd173,"haxe.ui.backend.hxwidgets.builders.MenuBuilder.new","haxe/ui/backend/hxwidgets/builders/MenuBuilder.hx",6,0xe1d22f7c)
HX_LOCAL_STACK_FRAME(_hx_pos_2899711b6bd2adc3_7_show,"haxe.ui.backend.hxwidgets.builders.MenuBuilder","show",0x248ac48a,"haxe.ui.backend.hxwidgets.builders.MenuBuilder.show","haxe/ui/backend/hxwidgets/builders/MenuBuilder.hx",7,0xe1d22f7c)
namespace haxe{
namespace ui{
namespace backend{
namespace hxwidgets{
...
void MenuBuilder_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_2899711b6bd2adc3_6_new)
...
bool MenuBuilder_obj::show(){
            	HX_STACKFRAME(&_hx_pos_2899711b6bd2adc3_7_show)
HXLINE(   8)		::haxe::ui::core::Screen_obj::get_instance()->addComponent(this->_component);
HXLINE(   9)		return true;
            	}
