...
HX_DEFINE_STACK_FRAME(_hx_pos_934ba5857642ff2e_203_new,"haxe.ui.components._TextField.MaxCharsBehaviour","new",0x4ceb12bc,"haxe.ui.components._TextField.MaxCharsBehaviour.new","haxe/ui/components/TextField.hx",203,0x9dfe9498)
HX_LOCAL_STACK_FRAME(_hx_pos_934ba5857642ff2e_204_validateData,"haxe.ui.components._TextField.MaxCharsBehaviour","validateData",0xcc96e804,"haxe.ui.components._TextField.MaxCharsBehaviour.validateData","haxe/ui/components/TextField.hx",204,0x9dfe9498)
namespace haxe{
namespace ui{
...
void MaxCharsBehaviour_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_934ba5857642ff2e_203_new)
HXDLIN( 203)		super::__construct(component);
            	}
...
void MaxCharsBehaviour_obj::validateData(){
            	HX_STACKFRAME(&_hx_pos_934ba5857642ff2e_204_validateData)
HXLINE( 205)		 ::haxe::ui::components::TextField textfield = ::hx::TCast<  ::haxe::ui::components::TextField >::cast(this->_component);
HXLINE( 206)		::haxe::ui::components::_TextField::TextFieldHelper_obj::validateText(textfield,textfield->get_text());
            	}
