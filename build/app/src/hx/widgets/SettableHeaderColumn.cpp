...
HX_LOCAL_STACK_FRAME(_hx_pos_bfdcff6a04f31103_19_set_alignment,"hx.widgets.SettableHeaderColumn","set_alignment",0x780c8344,"hx.widgets.SettableHeaderColumn.set_alignment","hx/widgets/SettableHeaderColumn.hx",19,0x0d82fb10)
HX_LOCAL_STACK_FRAME(_hx_pos_bfdcff6a04f31103_29_get_settableHeaderColumnRef,"hx.widgets.SettableHeaderColumn","get_settableHeaderColumnRef",0x34363a19,"hx.widgets.SettableHeaderColumn.get_settableHeaderColumnRef","hx/widgets/SettableHeaderColumn.hx",29,0x0d82fb10)
namespace hx{
namespace widgets{
...
HXLINE(   9)		 wxString s = wxString::FromUTF8(value.utf8_str());
...
int SettableHeaderColumn_obj::set_alignment(int value){
            	HX_STACKFRAME(&_hx_pos_bfdcff6a04f31103_19_set_alignment)
HXLINE(  20)		this->get_settableHeaderColumnRef()->ptr->SetAlignment(( ( wxAlignment)(value) ));
HXLINE(  21)		return value;
            	}


::cpp::Pointer<  wxSettableHeaderColumn > SettableHeaderColumn_obj::get_settableHeaderColumnRef(){
            	HX_STACKFRAME(&_hx_pos_bfdcff6a04f31103_29_get_settableHeaderColumnRef)
