...
HXLINE(  22)			 wxString messageStr = wxString::FromUTF8(message.utf8_str());
HXLINE(  23)			 wxString defaultPathStr = wxString::FromUTF8(defaultPath.utf8_str());
...
HXLINE(  36)		 wxString s = wxString::FromUTF8(value.utf8_str());
