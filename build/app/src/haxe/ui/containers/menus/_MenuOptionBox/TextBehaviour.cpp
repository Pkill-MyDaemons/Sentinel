...
HX_DEFINE_STACK_FRAME(_hx_pos_15c6089df9a0f1e9_50_new,"haxe.ui.containers.menus._MenuOptionBox.TextBehaviour","new",0xf77a1c10,"haxe.ui.containers.menus._MenuOptionBox.TextBehaviour.new","haxe/ui/containers/menus/MenuOptionBox.hx",50,0x896244ad)
HX_LOCAL_STACK_FRAME(_hx_pos_15c6089df9a0f1e9_51_validateData,"haxe.ui.containers.menus._MenuOptionBox.TextBehaviour","validateData",0x8ece1430,"haxe.ui.containers.menus._MenuOptionBox.TextBehaviour.validateData","haxe/ui/containers/menus/MenuOptionBox.hx",51,0x896244ad)
namespace haxe{
namespace ui{
...
void TextBehaviour_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_15c6089df9a0f1e9_50_new)
...
void TextBehaviour_obj::validateData(){
            	HX_GC_STACKFRAME(&_hx_pos_15c6089df9a0f1e9_51_validateData)
HXLINE(  52)		 ::haxe::ui::components::OptionBox optionbox = this->_component->findComponent(null(),::hx::ClassOf< ::haxe::ui::components::OptionBox >(),false,null()).StaticCast<  ::haxe::ui::components::OptionBox >();
HXLINE(  53)		if (::hx::IsNull( optionbox )) {
HXLINE(  54)			optionbox =  ::haxe::ui::components::OptionBox_obj::__alloc( HX_CTX );
HXLINE(  55)			optionbox->set_styleNames(HX_("menuitem-optionbox",9b,0c,7d,bf));
HXLINE(  56)			optionbox->set_scriptAccess(false);
HXLINE(  57)			this->_component->addComponent(optionbox);
            		}
HXLINE(  60)		optionbox->set_text(::haxe::ui::util::_Variant::Variant_Impl__obj::toString(this->_value));
            	}
