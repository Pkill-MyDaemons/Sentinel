...
HX_DEFINE_STACK_FRAME(_hx_pos_1a0c135d750f3af9_43_new,"haxe.ui.containers.menus._MenuItem.IconBehaviour","new",0xae92f5b5,"haxe.ui.containers.menus._MenuItem.IconBehaviour.new","haxe/ui/containers/menus/MenuItem.hx",43,0x19b927e6)
HX_LOCAL_STACK_FRAME(_hx_pos_1a0c135d750f3af9_44_validateData,"haxe.ui.containers.menus._MenuItem.IconBehaviour","validateData",0x44515deb,"haxe.ui.containers.menus._MenuItem.IconBehaviour.validateData","haxe/ui/containers/menus/MenuItem.hx",44,0x19b927e6)
namespace haxe{
namespace ui{
...
void IconBehaviour_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_1a0c135d750f3af9_43_new)
...
void IconBehaviour_obj::validateData(){
            	HX_GC_STACKFRAME(&_hx_pos_1a0c135d750f3af9_44_validateData)
HXLINE(  45)		bool _hx_tmp;
HXDLIN(  45)		if (::hx::IsNotNull( this->_value )) {
HXLINE(  45)			_hx_tmp = ::haxe::ui::util::_Variant::Variant_Impl__obj::get_isNull(this->_value);
            		}
            		else {
...
HXLINE(  49)		 ::haxe::ui::components::Image icon = this->_component->findComponent(HX_("menuitem-icon",b4,86,8f,80),null(),true,null()).StaticCast<  ::haxe::ui::components::Image >();
HXLINE(  50)		if (::hx::IsNull( icon )) {
HXLINE(  51)			icon =  ::haxe::ui::components::Image_obj::__alloc( HX_CTX );
HXLINE(  52)			icon->set_scriptAccess(false);
HXLINE(  53)			icon->set_id(HX_("menuitem-icon",b4,86,8f,80));
HXLINE(  54)			icon->addClass(HX_("menuitem-icon",b4,86,8f,80),null(),null());
HXLINE(  55)			icon->addClass(HX_("icon",79,e7,b2,45),null(),null());
HXLINE(  56)			this->_component->addComponentAt(icon,0);
            		}
HXLINE(  58)		icon->set_resource(this->_value);
            	}
