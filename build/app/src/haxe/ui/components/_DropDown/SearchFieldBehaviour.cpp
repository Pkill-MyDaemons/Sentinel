...
HX_DEFINE_STACK_FRAME(_hx_pos_646b3b3d2ba35bc9_206_new,"haxe.ui.components._DropDown.SearchFieldBehaviour","new",0xa8cf14c1,"haxe.ui.components._DropDown.SearchFieldBehaviour.new","haxe/ui/components/DropDown.hx",206,0x145b8c86)
HX_LOCAL_STACK_FRAME(_hx_pos_646b3b3d2ba35bc9_207_get,"haxe.ui.components._DropDown.SearchFieldBehaviour","get",0xa8c9c4f7,"haxe.ui.components._DropDown.SearchFieldBehaviour.get","haxe/ui/components/DropDown.hx",207,0x145b8c86)
HX_LOCAL_STACK_FRAME(_hx_pos_646b3b3d2ba35bc9_212_set,"haxe.ui.components._DropDown.SearchFieldBehaviour","set",0xa8d2e003,"haxe.ui.components._DropDown.SearchFieldBehaviour.set","haxe/ui/components/DropDown.hx",212,0x145b8c86)
namespace haxe{
namespace ui{
...
void SearchFieldBehaviour_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_646b3b3d2ba35bc9_206_new)
HXDLIN( 206)		super::__construct(component);
            	}
...
bool SearchFieldBehaviour_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::haxe::ui::util::VariantType SearchFieldBehaviour_obj::get(){
            	HX_STACKFRAME(&_hx_pos_646b3b3d2ba35bc9_207_get)
HXLINE( 208)		 ::haxe::ui::components::DropDownEvents events = ::hx::TCast<  ::haxe::ui::components::DropDownEvents >::cast(this->_component->_internalEvents);
HXLINE( 209)		return ::haxe::ui::util::_Variant::Variant_Impl__obj::fromComponent(events->get_searchField());
            	}


void SearchFieldBehaviour_obj::set( ::haxe::ui::util::VariantType value){
            	HX_STACKFRAME(&_hx_pos_646b3b3d2ba35bc9_212_set)
HXLINE( 213)		 ::haxe::ui::components::DropDownEvents events = ::hx::TCast<  ::haxe::ui::components::DropDownEvents >::cast(this->_component->_internalEvents);
HXLINE( 214)		events->set_searchField(( ( ::haxe::ui::components::TextField)(::haxe::ui::util::_Variant::Variant_Impl__obj::toComponent(value)) ));
            	}
