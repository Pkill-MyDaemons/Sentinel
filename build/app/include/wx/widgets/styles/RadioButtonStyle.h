...
class HXCPP_CLASS_ATTRIBUTES RadioButtonStyle_obj : public ::hx::Object
{
	...
	public:
		...
		inline static ::hx::ObjectPtr< RadioButtonStyle_obj > __new() {
			::hx::ObjectPtr< RadioButtonStyle_obj > __this = new RadioButtonStyle_obj();
			__this->__construct();
			return __this;
		}

		inline static ::hx::ObjectPtr< RadioButtonStyle_obj > __alloc(::hx::Ctx *_hx_ctx) {
		...
		::String __ToString() const { return HX_("RadioButtonStyle",c4,44,68,20); }
