...
class HXCPP_CLASS_ATTRIBUTES StockBrushes_obj : public ::hx::Object
{
	...
	public:
		...
		inline static ::hx::ObjectPtr< StockBrushes_obj > __new() {
			::hx::ObjectPtr< StockBrushes_obj > __this = new StockBrushes_obj();
			__this->__construct();
			return __this;
		}

		inline static ::hx::ObjectPtr< StockBrushes_obj > __alloc(::hx::Ctx *_hx_ctx) {
		...
		::String __ToString() const { return HX_("StockBrushes",52,d7,00,89); }
