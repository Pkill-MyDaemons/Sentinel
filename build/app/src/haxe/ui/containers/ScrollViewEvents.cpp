...
HXLINE( 895)			this->_inertia->__SetField(HX_("timestamp",d6,d4,ce,a5), ::__time_stamp(),::hx::paccDynamic);
            		}
...
HXLINE(1006)			Float now =  ::__time_stamp();
...
HXLINE(1028)			this->_inertia->__SetField(HX_("timestamp",d6,d4,ce,a5), ::__time_stamp(),::hx::paccDynamic);
...
HXLINE(1035)				Float _hx_tmp3 = this->_scrollview->get_hscrollPos();
HXDLIN(1035)				( ( ::haxe::ui::geom::Point)(this->_inertia->__Field(HX_("target",51,f3,ec,86),::hx::paccDynamic)) )->x = ( (Float)(::Math_obj::round((_hx_tmp3 - ( ( ::haxe::ui::geom::Point)(this->_inertia->__Field(HX_("amplitude",43,15,fb,69),::hx::paccDynamic)) )->x))) );
            			}
            			else {
HXLINE(1037)				Float _hx_tmp4 = this->_scrollview->get_hscrollPos();
HXDLIN(1037)				( ( ::haxe::ui::geom::Point)(this->_inertia->__Field(HX_("target",51,f3,ec,86),::hx::paccDynamic)) )->x = ( (Float)(::Math_obj::round((_hx_tmp4 + ( ( ::haxe::ui::geom::Point)(this->_inertia->__Field(HX_("amplitude",43,15,fb,69),::hx::paccDynamic)) )->x))) );
            			}
...
HXLINE(1045)				Float _hx_tmp5 = this->_scrollview->get_vscrollPos();
HXDLIN(1045)				( ( ::haxe::ui::geom::Point)(this->_inertia->__Field(HX_("target",51,f3,ec,86),::hx::paccDynamic)) )->y = ( (Float)(::Math_obj::round((_hx_tmp5 - ( ( ::haxe::ui::geom::Point)(this->_inertia->__Field(HX_("amplitude",43,15,fb,69),::hx::paccDynamic)) )->y))) );
            			}
            			else {
HXLINE(1047)				Float _hx_tmp6 = this->_scrollview->get_vscrollPos();
HXDLIN(1047)				( ( ::haxe::ui::geom::Point)(this->_inertia->__Field(HX_("target",51,f3,ec,86),::hx::paccDynamic)) )->y = ( (Float)(::Math_obj::round((_hx_tmp6 + ( ( ::haxe::ui::geom::Point)(this->_inertia->__Field(HX_("amplitude",43,15,fb,69),::hx::paccDynamic)) )->y))) );
            			}
HXLINE(1050)			bool _hx_tmp7;
HXDLIN(1050)			Float _hx_tmp8 = this->_scrollview->get_hscrollPos();
HXDLIN(1050)			if ((_hx_tmp8 == ( ( ::haxe::ui::geom::Point)(this->_inertia->__Field(HX_("target",51,f3,ec,86),::hx::paccDynamic)) )->x)) {
HXLINE(1050)				Float _hx_tmp9 = this->_scrollview->get_vscrollPos();
HXDLIN(1050)				_hx_tmp7 = (_hx_tmp9 == ( ( ::haxe::ui::geom::Point)(this->_inertia->__Field(HX_("target",51,f3,ec,86),::hx::paccDynamic)) )->y);
            			}
            			else {
HXLINE(1050)				_hx_tmp7 = false;
            			}
HXDLIN(1050)			if (_hx_tmp7) {
...
HXLINE(1056)			Float _hx_tmp10 = this->_scrollview->get_hscrollPos();
HXDLIN(1056)			if ((_hx_tmp10 == ( ( ::haxe::ui::geom::Point)(this->_inertia->__Field(HX_("target",51,f3,ec,86),::hx::paccDynamic)) )->x)) {
HXLINE(1057)				( ( ::haxe::ui::geom::Point)(this->_inertia->__Field(HX_("amplitude",43,15,fb,69),::hx::paccDynamic)) )->x = ( (Float)(0) );
            			}
HXLINE(1059)			Float _hx_tmp11 = this->_scrollview->get_vscrollPos();
HXDLIN(1059)			if ((_hx_tmp11 == ( ( ::haxe::ui::geom::Point)(this->_inertia->__Field(HX_("target",51,f3,ec,86),::hx::paccDynamic)) )->y)) {
...
HXLINE(1072)		Float elapsed =  ::__time_stamp();
