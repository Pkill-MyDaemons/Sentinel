...
HX_DEFINE_STACK_FRAME(_hx_pos_5c034a44b24c866b_221_new,"haxe.ui.containers._TreeViewNode.TreeViewNodeEvents","new",0xc5e9c844,"haxe.ui.containers._TreeViewNode.TreeViewNodeEvents.new","haxe/ui/containers/TreeViewNode.hx",221,0x9b33be2e)
namespace haxe{
namespace ui{
...
void TreeViewNodeEvents_obj::__construct( ::haxe::ui::containers::TreeViewNode node){
            	HX_STACKFRAME(&_hx_pos_5c034a44b24c866b_221_new)
HXLINE( 222)		super::__construct(node);
HXLINE( 223)		this->_node = node;
            	}
