...
class HXCPP_CLASS_ATTRIBUTES StandardId_obj : public ::hx::Object
{
	...
	public:
		...
		inline static ::hx::ObjectPtr< StandardId_obj > __new() {
			::hx::ObjectPtr< StandardId_obj > __this = new StandardId_obj();
			__this->__construct();
			return __this;
		}

		inline static ::hx::ObjectPtr< StandardId_obj > __alloc(::hx::Ctx *_hx_ctx) {
		...
		::String __ToString() const { return HX_("StandardId",98,84,13,99); }
