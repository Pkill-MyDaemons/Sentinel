...
HX_DEFINE_STACK_FRAME(_hx_pos_bb42a3261ab0b0aa_220_new,"haxe.ui.components._TabBar.SelectedTab","new",0xb84bb695,"haxe.ui.components._TabBar.SelectedTab.new","haxe/ui/components/TabBar.hx",220,0xaabf3019)
HX_LOCAL_STACK_FRAME(_hx_pos_bb42a3261ab0b0aa_221_get,"haxe.ui.components._TabBar.SelectedTab","get",0xb84666cb,"haxe.ui.components._TabBar.SelectedTab.get","haxe/ui/components/TabBar.hx",221,0xaabf3019)
namespace haxe{
namespace ui{
...
void SelectedTab_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_bb42a3261ab0b0aa_220_new)
...
bool SelectedTab_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::haxe::ui::util::VariantType SelectedTab_obj::get(){
            	HX_STACKFRAME(&_hx_pos_bb42a3261ab0b0aa_221_get)
HXLINE( 222)		 ::haxe::ui::components::_TabBar::Builder builder = ::hx::TCast<  ::haxe::ui::components::_TabBar::Builder >::cast(this->_component->_compositeBuilder);
HXLINE( 223)		return ::haxe::ui::util::_Variant::Variant_Impl__obj::fromComponent(builder->_container->findComponent(HX_("tabbar-button-selected",67,00,aa,e0),null(),false,HX_("css",c3,83,4b,00)).StaticCast<  ::haxe::ui::core::Component >());
            	}
