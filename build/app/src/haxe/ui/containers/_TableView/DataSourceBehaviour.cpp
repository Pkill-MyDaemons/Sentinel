...
HX_DEFINE_STACK_FRAME(_hx_pos_39fbe7471cd72fbf_765_new,"haxe.ui.containers._TableView.DataSourceBehaviour","new",0x0f08d2fa,"haxe.ui.containers._TableView.DataSourceBehaviour.new","haxe/ui/containers/TableView.hx",765,0x8a42a716)
HX_LOCAL_STACK_FRAME(_hx_pos_39fbe7471cd72fbf_767_set,"haxe.ui.containers._TableView.DataSourceBehaviour","set",0x0f0c9e3c,"haxe.ui.containers._TableView.DataSourceBehaviour.set","haxe/ui/containers/TableView.hx",767,0x8a42a716)
HX_LOCAL_STACK_FRAME(_hx_pos_39fbe7471cd72fbf_774_set,"haxe.ui.containers._TableView.DataSourceBehaviour","set",0x0f0c9e3c,"haxe.ui.containers._TableView.DataSourceBehaviour.set","haxe/ui/containers/TableView.hx",774,0x8a42a716)
HX_LOCAL_STACK_FRAME(_hx_pos_39fbe7471cd72fbf_788_get,"haxe.ui.containers._TableView.DataSourceBehaviour","get",0x0f038330,"haxe.ui.containers._TableView.DataSourceBehaviour.get","haxe/ui/containers/TableView.hx",788,0x8a42a716)
namespace haxe{
namespace ui{
...
void DataSourceBehaviour_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_39fbe7471cd72fbf_765_new)
HXLINE( 766)		this->_firstPass = true;
HXLINE( 765)		super::__construct(component);
            	}
...
void DataSourceBehaviour_obj::set( ::haxe::ui::util::VariantType value){
            	HX_GC_STACKFRAME(&_hx_pos_39fbe7471cd72fbf_767_set)
HXDLIN( 767)		 ::haxe::ui::containers::_TableView::DataSourceBehaviour _gthis = ::hx::ObjectPtr<OBJ_>(this);
HXLINE( 768)		this->super::set(value);
HXLINE( 769)		 ::haxe::ui::data::DataSource dataSource = ::haxe::ui::util::_Variant::Variant_Impl__obj::toDataSource(this->_value);
HXLINE( 770)		if (::hx::IsNotNull( dataSource )) {
            			HX_BEGIN_LOCAL_FUNC_S1(::hx::LocalFunc,_hx_Closure_0, ::haxe::ui::containers::_TableView::DataSourceBehaviour,_gthis) HXARGC(0)
            			void _hx_run(){
            				HX_GC_STACKFRAME(&_hx_pos_39fbe7471cd72fbf_774_set)
HXLINE( 775)				{
HXLINE( 775)					 ::haxe::ui::core::Component _this = _gthis->_component;
HXDLIN( 775)					bool _hx_tmp;
HXDLIN( 775)					if (::hx::IsNotNull( _this->_layout )) {
HXLINE( 775)						_hx_tmp = (_this->_layoutLocked == true);
            					}
            					else {
HXLINE( 775)						_hx_tmp = true;
            					}
HXDLIN( 775)					if (!(_hx_tmp)) {
HXLINE( 775)						_this->invalidateComponent(HX_("layout",aa,ae,b8,58),false);
            					}
            				}
HXLINE( 776)				if ((_gthis->_firstPass == true)) {
HXLINE( 778)					_gthis->_firstPass = false;
HXLINE( 779)					{
HXLINE( 779)						 ::haxe::ui::core::Component _this1 = _gthis->_component;
HXDLIN( 779)						bool _hx_tmp1;
HXDLIN( 779)						if (::hx::IsNotNull( _this1->_layout )) {
HXLINE( 779)							_hx_tmp1 = (_this1->_layoutLocked == true);
            						}
            						else {
HXLINE( 779)							_hx_tmp1 = true;
            						}
HXDLIN( 779)						if (!(_hx_tmp1)) {
HXLINE( 779)							_this1->invalidateComponent(HX_("layout",aa,ae,b8,58),false);
            						}
            					}
            				}
            			}
...
HXLINE( 771)			if (::hx::IsNull( dataSource->transformer )) {
HXLINE( 772)				dataSource->transformer =  ::haxe::ui::data::transformation::NativeTypeTransformer_obj::__alloc( HX_CTX );
            			}
HXLINE( 774)			dataSource->onDataSourceChange =  ::Dynamic(new _hx_Closure_0(_gthis));
HXLINE( 782)			{
HXLINE( 782)				 ::haxe::ui::core::Component _this = this->_component;
HXDLIN( 782)				bool _hx_tmp;
HXDLIN( 782)				if (::hx::IsNotNull( _this->_layout )) {
HXLINE( 782)					_hx_tmp = (_this->_layoutLocked == true);
            				}
            				else {
HXLINE( 782)					_hx_tmp = true;
            				}
HXDLIN( 782)				if (!(_hx_tmp)) {
HXLINE( 782)					_this->invalidateComponent(HX_("layout",aa,ae,b8,58),false);
            				}
            			}
            		}
            		else {
HXLINE( 784)			 ::haxe::ui::core::Component _this1 = this->_component;
HXDLIN( 784)			bool _hx_tmp1;
HXDLIN( 784)			if (::hx::IsNotNull( _this1->_layout )) {
HXLINE( 784)				_hx_tmp1 = (_this1->_layoutLocked == true);
            			}
            			else {
HXLINE( 784)				_hx_tmp1 = true;
            			}
HXDLIN( 784)			if (!(_hx_tmp1)) {
HXLINE( 784)				_this1->invalidateComponent(HX_("layout",aa,ae,b8,58),false);
            			}
            		}
            	}
 ...
 ::haxe::ui::util::VariantType DataSourceBehaviour_obj::get(){
            	HX_GC_STACKFRAME(&_hx_pos_39fbe7471cd72fbf_788_get)
HXLINE( 789)		bool _hx_tmp;
HXDLIN( 789)		if (::hx::IsNotNull( this->_value )) {
HXLINE( 789)			_hx_tmp = ::haxe::ui::util::_Variant::Variant_Impl__obj::get_isNull(this->_value);
            		}
            		else {
HXLINE( 789)			_hx_tmp = true;
            		}
HXDLIN( 789)		if (_hx_tmp) {
HXLINE( 790)			this->_value = ::haxe::ui::util::_Variant::Variant_Impl__obj::fromDataSource( ::haxe::ui::data::ArrayDataSource_obj::__alloc( HX_CTX ,null()));
HXLINE( 791)			this->set(this->_value);
            		}
HXLINE( 793)		return this->_value;
            	}
