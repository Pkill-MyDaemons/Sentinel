...
HX_LOCAL_STACK_FRAME(_hx_pos_eb0e0e3f322ec97e_46_get,"haxe.ui.backend.hxwidgets.behaviours.TextCtrlWordWrap","get",0x7c028a71,"haxe.ui.backend.hxwidgets.behaviours.TextCtrlWordWrap.get","haxe/ui/backend/hxwidgets/behaviours/TextCtrlWordWrap.hx",46,0x33891f96)
HX_LOCAL_STACK_FRAME(_hx_pos_eb0e0e3f322ec97e_54_copyMap,"haxe.ui.backend.hxwidgets.behaviours.TextCtrlWordWrap","copyMap",0x5d2e1942,"haxe.ui.backend.hxwidgets.behaviours.TextCtrlWordWrap.copyMap","haxe/ui/backend/hxwidgets/behaviours/TextCtrlWordWrap.hx",54,0x33891f96)
namespace haxe{
namespace ui{
namespace backend{
namespace hxwidgets{
...
HXLINE(  33)		int _hx_tmp1 = oldControl->get_position()->x;
HXDLIN(  33)		newControl1->move(_hx_tmp1,oldControl->get_position()->y);
HXLINE(  34)		newControl1->set_size(oldControl->get_size());
HXLINE(  35)		newControl1->show(oldControl->get_shown());
HXLINE(  36)		newControl1->set_enabled(oldControl->get_enabled());
HXLINE(  37)		oldControl->destroy();
HXLINE(  38)		this->_component->set_window(newControl1);
HXLINE(  39)		{
HXLINE(  39)			 ::haxe::ui::core::Component _this = this->_component;
HXDLIN(  39)			_this->invalidateComponent(HX_("style",31,a5,1d,84),false);
HXDLIN(  39)			{
            			}
            		}
HXLINE(  41)		{
HXLINE(  41)			 ::Dynamic k2 = eventMap->keys();
HXDLIN(  41)			while(( (bool)(k2->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE(  41)				::String k3 = ( (::String)(k2->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
HXLINE(  42)				 ::haxe::ui::core::Component _hx_tmp2 = this->_component;
HXDLIN(  42)				_hx_tmp2->mapEvent(k3,eventMap->get(k3));
            			}
            		}
            	}
 ...
 ::haxe::ui::util::VariantType TextCtrlWordWrap_obj::get(){
            	HX_STACKFRAME(&_hx_pos_eb0e0e3f322ec97e_46_get)
HXLINE(  47)		if (::hx::IsNull( this->_component->get_window() )) {
HXLINE(  48)			return ::haxe::ui::util::_Variant::Variant_Impl__obj::fromBool(false);
            		}
HXLINE(  51)		int _hx_tmp = this->_component->get_window()->get_windowStyle();
HXDLIN(  51)		return ::haxe::ui::util::_Variant::Variant_Impl__obj::fromBool(((_hx_tmp & ::wx::widgets::styles::TextCtrlStyle_obj::PASSWORD) == ::wx::widgets::styles::TextCtrlStyle_obj::PASSWORD));
            	}


 ::haxe::ds::StringMap TextCtrlWordWrap_obj::copyMap( ::haxe::ds::StringMap map){
            	HX_GC_STACKFRAME(&_hx_pos_eb0e0e3f322ec97e_54_copyMap)
HXLINE(  55)		 ::haxe::ds::StringMap newMap =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
HXLINE(  57)		{
HXLINE(  57)			 ::Dynamic k = map->keys();
HXDLIN(  57)			while(( (bool)(k->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE(  57)				::String k1 = ( (::String)(k->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
HXLINE(  58)				newMap->set(k1,map->get(k1));
            			}
            		}
HXLINE(  61)		return newMap;
            	}
