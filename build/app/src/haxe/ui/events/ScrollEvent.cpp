...
HXDLIN(   4)		CHANGE = ::haxe::ui::events::_EventType::EventType_Impl__obj::name(HX_("scrollchange",3d,71,a0,da));
            	}
{
            	HX_STACKFRAME(&_hx_pos_f10aa61761c00fbd_5_boot)
HXDLIN(   5)		START = ::haxe::ui::events::_EventType::EventType_Impl__obj::name(HX_("scrollstart",35,4d,bb,3a));
            	}
{
            	HX_STACKFRAME(&_hx_pos_f10aa61761c00fbd_6_boot)
HXDLIN(   6)		STOP = ::haxe::ui::events::_EventType::EventType_Impl__obj::name(HX_("scrollstop",8f,52,42,1f));
            	}
{
            	HX_STACKFRAME(&_hx_pos_f10aa61761c00fbd_7_boot)
HXDLIN(   7)		SCROLL = ::haxe::ui::events::_EventType::EventType_Impl__obj::name(HX_("scrollscroll",da,b7,92,6a));
            	}
}
