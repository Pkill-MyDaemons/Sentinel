...
HX_LOCAL_STACK_FRAME(_hx_pos_d81d57e82ad7930d_40_set_menuBar,"hx.widgets.Frame","set_menuBar",0x94d18fd9,"hx.widgets.Frame.set_menuBar","hx/widgets/Frame.hx",40,0xed4a8f10)
HX_LOCAL_STACK_FRAME(_hx_pos_d81d57e82ad7930d_46_center,"hx.widgets.Frame","center",0xbee375d3,"hx.widgets.Frame.center","hx/widgets/Frame.hx",46,0xed4a8f10)
HX_LOCAL_STACK_FRAME(_hx_pos_d81d57e82ad7930d_54_get_frameRef,"hx.widgets.Frame","get_frameRef",0x6307c9ad,"hx.widgets.Frame.get_frameRef","hx/widgets/Frame.hx",54,0xed4a8f10)
namespace hx{
namespace widgets{
...
HXLINE(  17)			 wxString str = wxString::FromUTF8(title.utf8_str());
HXLINE(  18)			 wxFrame * _hx_tmp = this->get_frameRef()->ptr;
...
HXDLIN(  18)			(*(_hx_tmp)).Create(_hx_tmp1,id,str,_hx_tmp2,_hx_tmp3,style);
            		}
...
bool Frame_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x3ade267e) {
		if (inClassId<=(int)0x2045b63e) {
			if (inClassId<=(int)0x120af58e) {
				return inClassId==(int)0x00000001 || inClassId==(int)0x120af58e;
			} else {
...
HXLINE(  30)		 ::hx::widgets::MenuBar m =  ::hx::widgets::MenuBar_obj::__alloc( HX_CTX ,0,false);
HXLINE(  31)		 wxMenuBar* rawMenuBar = this->get_frameRef()->ptr->GetMenuBar();
HXLINE(  32)		if (::hx::IsNull( rawMenuBar )) {
HXLINE(  33)			return null();
            		}
HXLINE(  35)		::cpp::Pointer<  wxMenuBar > p = ::cpp::Pointer_obj::fromRaw(rawMenuBar);
HXLINE(  36)		m->_ref = p->reinterpret();
HXLINE(  37)		return m;
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(Frame_obj,get_menuBar,return )
 ...
 ::hx::widgets::MenuBar Frame_obj::set_menuBar( ::hx::widgets::MenuBar value){
            	HX_STACKFRAME(&_hx_pos_d81d57e82ad7930d_40_set_menuBar)
HXLINE(  41)		 wxFrame * _hx_tmp = this->get_frameRef()->ptr;
HXDLIN(  41)		(*(_hx_tmp)).SetMenuBar(value->get_menuBarRef()->get_raw());
...
void Frame_obj::center(){
            	HX_STACKFRAME(&_hx_pos_d81d57e82ad7930d_46_center)
HXDLIN(  46)		this->get_frameRef()->ptr->Center();
            	}
...
::cpp::Pointer<  wxFrame > Frame_obj::get_frameRef(){
            	HX_STACKFRAME(&_hx_pos_d81d57e82ad7930d_54_get_frameRef)
...
void Frame_obj::__GetFields(Array< ::String> &outFields)
{
	...
	outFields->push(HX_("frameRef",26,b3,f4,1c));
	super::__GetFields(outFields);
};

#ifdef HXCPP_SCRIPTABLE
static ::hx::StorageInfo Frame_obj_sMemberStorageInfo[] = {
	{::hx::fsUnknown /* ::cpp::Pointer<  wxFrame > */ ,(int)offsetof(Frame_obj,frameRef),HX_("frameRef",26,b3,f4,1c)},
	{ ::hx::fsUnknown, 0, null()}
};
...
static ::String Frame_obj_sMemberFields[] = {
	HX_("get_menuBar",8b,91,45,40),
	HX_("set_menuBar",97,98,b2,4a),
	HX_("center",d5,25,db,05),
	HX_("frameRef",26,b3,f4,1c),
	HX_("get_frameRef",2f,67,0e,d2),
	::String(null()) };
...
void Frame_obj::__register()
{
	...
	__mClass->mName = HX_("hx.widgets.Frame",b0,fc,d8,a5);
