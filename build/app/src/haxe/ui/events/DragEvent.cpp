...
bool DragEvent_obj::__GetStatic(const ::String &inName, Dynamic &outValue, ::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 4:
		...
		break;
	case 8:
		if (HX_FIELD_EQ(inName,"DRAG_END") ) { outValue = ( DRAG_END ); return true; }
		break;
	case 10:
		if (HX_FIELD_EQ(inName,"DRAG_START") ) { outValue = ( DRAG_START ); return true; }
	}
	return false;
}
...
bool DragEvent_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 4:
		...
		break;
	case 8:
		if (HX_FIELD_EQ(inName,"DRAG_END") ) { DRAG_END=ioValue.Cast< ::String >(); return true; }
		break;
	case 10:
		if (HX_FIELD_EQ(inName,"DRAG_START") ) { DRAG_START=ioValue.Cast< ::String >(); return true; }
	}
	return false;
}
...
void DragEvent_obj::__register()
{
	...
	__mClass->mGetStaticField = &DragEvent_obj::__GetStatic;
	__mClass->mSetStaticField = &DragEvent_obj::__SetStatic;
...
HXDLIN(   4)		DRAG_START = ::haxe::ui::events::_EventType::EventType_Impl__obj::name(HX_("dragstart",ee,73,33,53));
            	}
{
            	HX_STACKFRAME(&_hx_pos_7375a4962759c4c6_5_boot)
HXDLIN(   5)		DRAG = ::haxe::ui::events::_EventType::EventType_Impl__obj::name(HX_("drag",f4,2b,70,42));
            	}
{
            	HX_STACKFRAME(&_hx_pos_7375a4962759c4c6_6_boot)
HXDLIN(   6)		DRAG_END = ::haxe::ui::events::_EventType::EventType_Impl__obj::name(HX_("dragend",67,c8,51,f1));
            	}
}
