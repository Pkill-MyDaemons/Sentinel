...
class HXCPP_CLASS_ATTRIBUTES HyperlinkCtrlStyle_obj : public ::hx::Object
{
	...
	public:
		...
		inline static ::hx::ObjectPtr< HyperlinkCtrlStyle_obj > __new() {
			::hx::ObjectPtr< HyperlinkCtrlStyle_obj > __this = new HyperlinkCtrlStyle_obj();
			__this->__construct();
			return __this;
		}

		inline static ::hx::ObjectPtr< HyperlinkCtrlStyle_obj > __alloc(::hx::Ctx *_hx_ctx) {
		...
		::String __ToString() const { return HX_("HyperlinkCtrlStyle",60,cf,ba,bc); }
