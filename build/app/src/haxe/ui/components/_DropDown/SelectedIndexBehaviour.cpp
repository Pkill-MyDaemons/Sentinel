...
HX_DEFINE_STACK_FRAME(_hx_pos_8cb14cd8617c91e4_146_new,"haxe.ui.components._DropDown.SelectedIndexBehaviour","new",0xe7862c1c,"haxe.ui.components._DropDown.SelectedIndexBehaviour.new","haxe/ui/components/DropDown.hx",146,0x145b8c86)
HX_LOCAL_STACK_FRAME(_hx_pos_8cb14cd8617c91e4_147_validateData,"haxe.ui.components._DropDown.SelectedIndexBehaviour","validateData",0xe83da2a4,"haxe.ui.components._DropDown.SelectedIndexBehaviour.validateData","haxe/ui/components/DropDown.hx",147,0x145b8c86)
HX_LOCAL_STACK_FRAME(_hx_pos_8cb14cd8617c91e4_152_get,"haxe.ui.components._DropDown.SelectedIndexBehaviour","get",0xe780dc52,"haxe.ui.components._DropDown.SelectedIndexBehaviour.get","haxe/ui/components/DropDown.hx",152,0x145b8c86)
HX_LOCAL_STACK_FRAME(_hx_pos_8cb14cd8617c91e4_160_set,"haxe.ui.components._DropDown.SelectedIndexBehaviour","set",0xe789f75e,"haxe.ui.components._DropDown.SelectedIndexBehaviour.set","haxe/ui/components/DropDown.hx",160,0x145b8c86)
namespace haxe{
namespace ui{
...
void SelectedIndexBehaviour_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_8cb14cd8617c91e4_146_new)
HXDLIN( 146)		super::__construct(component);
            	}
...
void SelectedIndexBehaviour_obj::validateData(){
            	HX_STACKFRAME(&_hx_pos_8cb14cd8617c91e4_147_validateData)
HXLINE( 148)		::Dynamic handler = ::hx::TCast<  ::haxe::ui::components::DropDownBuilder >::cast(this->_component->_compositeBuilder)->get_handler();
HXLINE( 149)		::haxe::ui::components::IDropDownHandler_obj::set_selectedIndex(handler,::haxe::ui::util::_Variant::Variant_Impl__obj::toInt(this->_value));
            	}


 ::haxe::ui::util::VariantType SelectedIndexBehaviour_obj::get(){
            	HX_STACKFRAME(&_hx_pos_8cb14cd8617c91e4_152_get)
HXLINE( 153)		if ((this->_component->get_isReady() == false)) {
HXLINE( 154)			return this->super::get();
            		}
HXLINE( 156)		::Dynamic handler = ::hx::TCast<  ::haxe::ui::components::DropDownBuilder >::cast(this->_component->_compositeBuilder)->get_handler();
HXLINE( 157)		return ::haxe::ui::util::_Variant::Variant_Impl__obj::fromInt(::haxe::ui::components::IDropDownHandler_obj::get_selectedIndex(handler));
            	}


void SelectedIndexBehaviour_obj::set( ::haxe::ui::util::VariantType value){
            	HX_STACKFRAME(&_hx_pos_8cb14cd8617c91e4_160_set)
HXLINE( 161)		if ((this->_component->get_isReady() == false)) {
HXLINE( 162)			this->super::set(value);
HXLINE( 163)			return;
            		}
HXLINE( 165)		if (::haxe::ui::util::_Variant::Variant_Impl__obj::eq(value,this->get())) {
HXLINE( 166)			return;
            		}
HXLINE( 168)		this->_value = value;
HXLINE( 169)		this->invalidateData();
HXLINE( 170)		::Dynamic handler = ::hx::TCast<  ::haxe::ui::components::DropDownBuilder >::cast(this->_component->_compositeBuilder)->get_handler();
HXLINE( 171)		::haxe::ui::components::IDropDownHandler_obj::set_selectedIndex(handler,::haxe::ui::util::_Variant::Variant_Impl__obj::toInt(this->_value));
            	}
