...
class HXCPP_CLASS_ATTRIBUTES ComboBoxStyle_obj : public ::hx::Object
{
	...
	public:
		...
		inline static ::hx::ObjectPtr< ComboBoxStyle_obj > __new() {
			::hx::ObjectPtr< ComboBoxStyle_obj > __this = new ComboBoxStyle_obj();
			__this->__construct();
			return __this;
		}

		inline static ::hx::ObjectPtr< ComboBoxStyle_obj > __alloc(::hx::Ctx *_hx_ctx) {
		...
		::String __ToString() const { return HX_("ComboBoxStyle",74,c1,31,8e); }
