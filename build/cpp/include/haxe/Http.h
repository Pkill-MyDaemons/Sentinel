...
class HXCPP_CLASS_ATTRIBUTES Http_obj : public ::hx::Object
{
	...
	public:
		...
		void fileTransfert(::String argname,::String filename, ::haxe::io::Input file,int size);
		::Dynamic fileTransfert_dyn();

		void customRequest(bool post, ::haxe::io::Output api, ::Dynamic sock,::String method);
		::Dynamic customRequest_dyn();

		void readHttpResponse( ::haxe::io::Output api, ::Dynamic sock);
