...
HX_DEFINE_STACK_FRAME(_hx_pos_6c10682f737128a6_175_new,"haxe.ui.containers._TreeViewNode.ClearNodes","new",0xc2c6df2a,"haxe.ui.containers._TreeViewNode.ClearNodes.new","haxe/ui/containers/TreeViewNode.hx",175,0x9b33be2e)
HX_LOCAL_STACK_FRAME(_hx_pos_6c10682f737128a6_176_call,"haxe.ui.containers._TreeViewNode.ClearNodes","call",0xa3f3fa94,"haxe.ui.containers._TreeViewNode.ClearNodes.call","haxe/ui/containers/TreeViewNode.hx",176,0x9b33be2e)
namespace haxe{
namespace ui{
...
void ClearNodes_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_6c10682f737128a6_175_new)
...
bool ClearNodes_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::haxe::ui::util::VariantType ClearNodes_obj::call( ::Dynamic param){
            	HX_STACKFRAME(&_hx_pos_6c10682f737128a6_176_call)
HXLINE( 177)		 ::haxe::ui::containers::TreeViewNode node = ::hx::TCast<  ::haxe::ui::containers::TreeViewNode >::cast(this->_component);
HXLINE( 178)		::Array< ::Dynamic> nodes = node->findComponents(null(),::hx::ClassOf< ::haxe::ui::containers::TreeViewNode >(),3);
HXLINE( 179)		{
HXLINE( 179)			int _g = 0;
HXDLIN( 179)			while((_g < nodes->length)){
HXLINE( 179)				 ::haxe::ui::containers::TreeViewNode n = nodes->__get(_g).StaticCast<  ::haxe::ui::containers::TreeViewNode >();
HXDLIN( 179)				_g = (_g + 1);
HXLINE( 180)				node->removeComponent(n,null(),null());
            			}
            		}
