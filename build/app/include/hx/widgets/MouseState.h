...
class HXCPP_CLASS_ATTRIBUTES MouseState_obj {
	public:
		...
		static inline int get_x( ::Dynamic _hx_) {
			...
			#endif
			#endif
			return (_hx_.mPtr->*( ::hx::interface_cast< ::hx::widgets::MouseState_obj *>(_hx_.mPtr->_hx_getInterface(0xc03ba76b)))->_hx_get_x)();
		}
		...
		static inline int get_y( ::Dynamic _hx_) {
			...
			#endif
			#endif
			return (_hx_.mPtr->*( ::hx::interface_cast< ::hx::widgets::MouseState_obj *>(_hx_.mPtr->_hx_getInterface(0xc03ba76b)))->_hx_get_y)();
		}
};
