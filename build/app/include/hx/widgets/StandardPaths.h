...
class HXCPP_CLASS_ATTRIBUTES StandardPaths_obj : public ::hx::Object
{
	...
	public:
		...
		::Dynamic get_userLocalDataDir_dyn();
		 ...
		 cpp::Struct<wxStandardPaths::FileLayout, cpp::EnumHandler> get_fileLayout();
		::Dynamic get_fileLayout_dyn();

		 cpp::Struct<wxStandardPaths::FileLayout, cpp::EnumHandler> set_fileLayout( cpp::Struct<wxStandardPaths::FileLayout, cpp::EnumHandler> layout);
		::Dynamic set_fileLayout_dyn();
