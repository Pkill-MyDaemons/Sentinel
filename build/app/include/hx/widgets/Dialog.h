...
class HXCPP_CLASS_ATTRIBUTES Dialog_obj : public  ::hx::widgets::TopLevelWindow_obj
{
	...
	public:
		...
		::Dynamic addMainButtonId_dyn();
		 ...
		 ::hx::widgets::Sizer createSeparatedButtonSizer(int flags);
		::Dynamic createSeparatedButtonSizer_dyn();

		 ::hx::widgets::StdDialogButtonSizer createStdDialogButtonSizer(int flags);
		::Dynamic createStdDialogButtonSizer_dyn();
