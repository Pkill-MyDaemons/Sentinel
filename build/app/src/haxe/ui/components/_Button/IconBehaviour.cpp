...
HX_DEFINE_STACK_FRAME(_hx_pos_26545bda63a80f75_410_new,"haxe.ui.components._Button.IconBehaviour","new",0xe530ed13,"haxe.ui.components._Button.IconBehaviour.new","haxe/ui/components/Button.hx",410,0x45086125)
HX_LOCAL_STACK_FRAME(_hx_pos_26545bda63a80f75_411_validateData,"haxe.ui.components._Button.IconBehaviour","validateData",0x47148acd,"haxe.ui.components._Button.IconBehaviour.validateData","haxe/ui/components/Button.hx",411,0x45086125)
namespace haxe{
namespace ui{
...
void IconBehaviour_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_26545bda63a80f75_410_new)
HXDLIN( 410)		super::__construct(component);
            	}
...
void IconBehaviour_obj::validateData(){
            	HX_GC_STACKFRAME(&_hx_pos_26545bda63a80f75_411_validateData)
HXLINE( 412)		 ::haxe::ui::components::Image icon = this->_component->findComponent(HX_("button-icon",f4,52,38,e9),null(),false,null()).StaticCast<  ::haxe::ui::components::Image >();
HXLINE( 414)		bool _hx_tmp;
HXDLIN( 414)		bool _hx_tmp1;
HXDLIN( 414)		bool _hx_tmp2;
HXDLIN( 414)		if (::hx::IsNotNull( this->_value )) {
HXLINE( 414)			_hx_tmp2 = ::haxe::ui::util::_Variant::Variant_Impl__obj::get_isNull(this->_value);
            		}
            		else {
HXLINE( 414)			_hx_tmp2 = true;
            		}
HXDLIN( 414)		if (!(_hx_tmp2)) {
HXLINE( 414)			 ::haxe::ui::util::VariantType _hx_tmp3 = this->_value;
HXDLIN( 414)			_hx_tmp1 = ::haxe::ui::util::_Variant::Variant_Impl__obj::eq(_hx_tmp3,::haxe::ui::util::_Variant::Variant_Impl__obj::fromString(HX_("",00,00,00,00)));
            		}
            		else {
HXLINE( 414)			_hx_tmp1 = true;
            		}
HXDLIN( 414)		if (_hx_tmp1) {
HXLINE( 414)			_hx_tmp = ::hx::IsNotNull( icon );
            		}
            		else {
HXLINE( 414)			_hx_tmp = false;
            		}
HXDLIN( 414)		if (_hx_tmp) {
HXLINE( 415)			this->_component->get_customStyle()->icon = null();
HXLINE( 416)			this->_component->removeComponent(icon,null(),null());
HXLINE( 417)			return;
            		}
HXLINE( 420)		if (::hx::IsNull( icon )) {
HXLINE( 421)			icon =  ::haxe::ui::components::Image_obj::__alloc( HX_CTX );
HXLINE( 422)			icon->addClass(HX_("icon",79,e7,b2,45),null(),null());
HXLINE( 423)			icon->set_id(HX_("button-icon",f4,52,38,e9));
HXLINE( 424)			icon->set_scriptAccess(false);
HXLINE( 425)			this->_component->addComponentAt(icon,0);
HXLINE( 426)			{
HXLINE( 426)				 ::haxe::ui::core::Component _this = this->_component;
HXDLIN( 426)				_this->invalidateComponent(HX_("style",31,a5,1d,84),false);
HXDLIN( 426)				_this->_style = null();
            			}
            		}
HXLINE( 430)		icon->set_resource(this->_value);
            	}
