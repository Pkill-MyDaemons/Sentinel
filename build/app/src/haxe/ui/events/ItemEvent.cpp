...
bool ItemEvent_obj::__GetStatic(const ::String &inName, Dynamic &outValue, ::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 15:
		if (HX_FIELD_EQ(inName,"COMPONENT_EVENT") ) { outValue = ( COMPONENT_EVENT ); return true; }
		break;
	case 21:
		if (HX_FIELD_EQ(inName,"COMPONENT_CLICK_EVENT") ) { outValue = ( COMPONENT_CLICK_EVENT ); return true; }
		break;
	case 22:
		if (HX_FIELD_EQ(inName,"COMPONENT_CHANGE_EVENT") ) { outValue = ( COMPONENT_CHANGE_EVENT ); return true; }
	}
	return false;
}
...
bool ItemEvent_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 15:
		if (HX_FIELD_EQ(inName,"COMPONENT_EVENT") ) { COMPONENT_EVENT=ioValue.Cast< ::String >(); return true; }
		break;
	case 21:
		if (HX_FIELD_EQ(inName,"COMPONENT_CLICK_EVENT") ) { COMPONENT_CLICK_EVENT=ioValue.Cast< ::String >(); return true; }
		break;
	case 22:
		if (HX_FIELD_EQ(inName,"COMPONENT_CHANGE_EVENT") ) { COMPONENT_CHANGE_EVENT=ioValue.Cast< ::String >(); return true; }
	}
	return false;
}
...
void ItemEvent_obj::__register()
{
	...
	__mClass->mGetStaticField = &ItemEvent_obj::__GetStatic;
	__mClass->mSetStaticField = &ItemEvent_obj::__SetStatic;
...
HXDLIN(   6)		COMPONENT_EVENT = ::haxe::ui::events::_EventType::EventType_Impl__obj::name(HX_("itemcomponentevent",90,6a,39,18));
            	}
{
            	HX_STACKFRAME(&_hx_pos_d64a062362a93ece_7_boot)
HXDLIN(   7)		COMPONENT_CLICK_EVENT = ::haxe::ui::events::_EventType::EventType_Impl__obj::name(HX_("itemcomponentclickevent",9c,78,b3,1a));
            	}
{
            	HX_STACKFRAME(&_hx_pos_d64a062362a93ece_8_boot)
HXDLIN(   8)		COMPONENT_CHANGE_EVENT = ::haxe::ui::events::_EventType::EventType_Impl__obj::name(HX_("itemcomponentchangeevent",a0,df,db,b9));
            	}
}
