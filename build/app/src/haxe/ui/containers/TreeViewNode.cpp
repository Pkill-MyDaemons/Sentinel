...
HX_LOCAL_STACK_FRAME(_hx_pos_679ff0f9fead2ede_693_addNode,"haxe.ui.containers.TreeViewNode","addNode",0x88407904,"haxe.ui.containers.TreeViewNode.addNode","haxe/ui/macros/Macros.hx",693,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_679ff0f9fead2ede_693_removeNode,"haxe.ui.containers.TreeViewNode","removeNode",0x652a76c5,"haxe.ui.containers.TreeViewNode.removeNode","haxe/ui/macros/Macros.hx",693,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_679ff0f9fead2ede_685_clearNodes,"haxe.ui.containers.TreeViewNode","clearNodes",0x13ca29c3,"haxe.ui.containers.TreeViewNode.clearNodes","haxe/ui/macros/Macros.hx",685,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_679ff0f9fead2ede_696_getNodesInternal,"haxe.ui.containers.TreeViewNode","getNodesInternal",0xd31e61b7,"haxe.ui.containers.TreeViewNode.getNodesInternal","haxe/ui/macros/Macros.hx",696,0x27866361)
...
HX_LOCAL_STACK_FRAME(_hx_pos_679ff0f9fead2ede_204_registerComposite,"haxe.ui.containers.TreeViewNode","registerComposite",0xc5a14ca5,"haxe.ui.containers.TreeViewNode.registerComposite","haxe/ui/macros/Macros.hx",204,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_679ff0f9fead2ede_550_registerBehaviours,"haxe.ui.containers.TreeViewNode","registerBehaviours",0xaa80d138,"haxe.ui.containers.TreeViewNode.registerBehaviours","haxe/ui/macros/Macros.hx",550,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_679ff0f9fead2ede_597_get_expanded,"haxe.ui.containers.TreeViewNode","get_expanded",0xf6628d61,"haxe.ui.containers.TreeViewNode.get_expanded","haxe/ui/macros/Macros.hx",597,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_679ff0f9fead2ede_648_set_expanded,"haxe.ui.containers.TreeViewNode","set_expanded",0x0b5bb0d5,"haxe.ui.containers.TreeViewNode.set_expanded","haxe/ui/macros/Macros.hx",648,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_3f1788001432f1e3_700_cloneComponent,"haxe.ui.containers.TreeViewNode","cloneComponent",0x95ea377f,"haxe.ui.containers.TreeViewNode.cloneComponent","haxe/ui/macros/helpers/ClassBuilder.hx",700,0x8cdaad7b)
HX_LOCAL_STACK_FRAME(_hx_pos_679ff0f9fead2ede_521_self,"haxe.ui.containers.TreeViewNode","self",0xb3959cab,"haxe.ui.containers.TreeViewNode.self","haxe/ui/macros/Macros.hx",521,0x27866361)
namespace haxe{
namespace ui{
...
bool TreeViewNode_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x241810fb) {
		if (inClassId<=(int)0x0f2dd418) {
			if (inClassId<=(int)0x02a99f31) {
				return inClassId==(int)0x00000001 || inClassId==(int)0x02a99f31;
			} else {
 ...
 ::haxe::ui::containers::TreeViewNode TreeViewNode_obj::addNode( ::Dynamic data){
            	HX_STACKFRAME(&_hx_pos_679ff0f9fead2ede_693_addNode)
HXDLIN( 693)		return ( ( ::haxe::ui::containers::TreeViewNode)(::haxe::ui::util::_Variant::Variant_Impl__obj::toComponent(this->behaviours->call(HX_("addNode",c3,4c,47,85),data))) );
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(TreeViewNode_obj,addNode,return )
 ...
 ::haxe::ui::containers::TreeViewNode TreeViewNode_obj::removeNode( ::haxe::ui::containers::TreeViewNode node){
            	HX_STACKFRAME(&_hx_pos_679ff0f9fead2ede_693_removeNode)
HXDLIN( 693)		return ( ( ::haxe::ui::containers::TreeViewNode)(::haxe::ui::util::_Variant::Variant_Impl__obj::toComponent(this->behaviours->call(HX_("removeNode",66,44,29,c6),node))) );
            	}
...
void TreeViewNode_obj::clearNodes(){
            	HX_STACKFRAME(&_hx_pos_679ff0f9fead2ede_685_clearNodes)
HXLINE( 686)		if (::hx::IsNull( this->behaviours )) {
HXLINE( 687)			return;
            		}
HXLINE( 689)		this->behaviours->call(HX_("clearNodes",64,f7,c8,74),null());
            	}
...
::Array< ::Dynamic> TreeViewNode_obj::getNodesInternal(){
            	HX_STACKFRAME(&_hx_pos_679ff0f9fead2ede_696_getNodesInternal)
HXLINE( 697)		if (::hx::IsNull( this->behaviours )) {
HXLINE( 698)			return null();
            		}
HXLINE( 700)		return ::haxe::ui::util::_Variant::Variant_Impl__obj::toArray(this->behaviours->call(HX_("getNodesInternal",18,9e,b4,dd),null()));
            	}
...
HXLINE( 136)		return value;
 ...
 ::haxe::ui::util::VariantType TreeViewNode_obj::get_icon(){
            	HX_STACKFRAME(&_hx_pos_54a31cdaf0633586_140_get_icon)
HXDLIN( 140)		return this->_data->__Field(HX_("icon",79,e7,b2,45),::hx::paccDynamic);
            	}


 ::haxe::ui::util::VariantType TreeViewNode_obj::set_icon( ::haxe::ui::util::VariantType value){
...
void TreeViewNode_obj::registerComposite(){
            	HX_STACKFRAME(&_hx_pos_679ff0f9fead2ede_204_registerComposite)
HXLINE( 205)		this->super::registerComposite();
HXLINE( 213)		this->_internalEventsClass = ::hx::ClassOf< ::haxe::ui::containers::_TreeViewNode::TreeViewNodeEvents >();
HXLINE( 217)		this->_compositeBuilderClass = ::hx::ClassOf< ::haxe::ui::containers::_TreeViewNode::TreeViewNodeBuilder >();
            	}


void TreeViewNode_obj::registerBehaviours(){
            	HX_STACKFRAME(&_hx_pos_679ff0f9fead2ede_550_registerBehaviours)
HXLINE( 551)		this->super::registerBehaviours();
HXLINE( 671)		 ::haxe::ui::behaviours::Behaviours _hx_tmp = this->behaviours;
HXDLIN( 671)		_hx_tmp->_hx_register(HX_("expanded",39,11,cf,f9),::hx::ClassOf< ::haxe::ui::containers::_TreeViewNode::Expanded >(),::haxe::ui::util::_Variant::Variant_Impl__obj::fromBool(false));
HXLINE( 706)		this->behaviours->_hx_register(HX_("addNode",c3,4c,47,85),::hx::ClassOf< ::haxe::ui::containers::_TreeViewNode::AddNode >(),null());
HXDLIN( 706)		this->behaviours->_hx_register(HX_("removeNode",66,44,29,c6),::hx::ClassOf< ::haxe::ui::containers::_TreeViewNode::RemoveNode >(),null());
HXDLIN( 706)		this->behaviours->_hx_register(HX_("clearNodes",64,f7,c8,74),::hx::ClassOf< ::haxe::ui::containers::_TreeViewNode::ClearNodes >(),null());
HXDLIN( 706)		this->behaviours->_hx_register(HX_("getNodesInternal",18,9e,b4,dd),::hx::ClassOf< ::haxe::ui::containers::_TreeViewNode::GetNodesInternal >(),null());
            	}


bool TreeViewNode_obj::get_expanded(){
            	HX_STACKFRAME(&_hx_pos_679ff0f9fead2ede_597_get_expanded)
HXLINE( 598)		if (::hx::IsNull( this->behaviours )) {
HXLINE( 599)			return false;
            		}
HXLINE( 601)		return ::haxe::ui::util::_Variant::Variant_Impl__obj::toBool(this->behaviours->get(HX_("expanded",39,11,cf,f9)));
            	}
...
bool TreeViewNode_obj::set_expanded(bool value){
            	HX_GC_STACKFRAME(&_hx_pos_679ff0f9fead2ede_648_set_expanded)
...
HXDLIN( 652)		_hx_tmp->set(HX_("expanded",39,11,cf,f9),::haxe::ui::util::_Variant::Variant_Impl__obj::fromBool(value));
HXLINE( 653)		this->dispatch( ::haxe::ui::events::UIEvent_obj::__alloc( HX_CTX ,::haxe::ui::events::UIEvent_obj::PROPERTY_CHANGE,null(),HX_("expanded",39,11,cf,f9)),null());
...
HX_DEFINE_DYNAMIC_FUNC1(TreeViewNode_obj,set_expanded,return )
 ...
 ::haxe::ui::backend::ComponentBase TreeViewNode_obj::cloneComponent(){
            	HX_STACKFRAME(&_hx_pos_3f1788001432f1e3_700_cloneComponent)
HXLINE( 469)		 ::haxe::ui::containers::TreeViewNode c = ( ( ::haxe::ui::containers::TreeViewNode)(this->super::cloneComponent()) );
HXLINE( 484)		{
...
HXLINE( 493)		return c;
 ...
 ::haxe::ui::backend::ComponentBase TreeViewNode_obj::self(){
            	HX_GC_STACKFRAME(&_hx_pos_679ff0f9fead2ede_521_self)
HXDLIN( 521)		return  ::haxe::ui::containers::TreeViewNode_obj::__alloc( HX_CTX );
            	}
