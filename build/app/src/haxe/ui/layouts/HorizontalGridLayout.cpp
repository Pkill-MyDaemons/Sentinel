...
HX_LOCAL_STACK_FRAME(_hx_pos_0236f6cb8da11327_700_cloneLayout,"haxe.ui.layouts.HorizontalGridLayout","cloneLayout",0x836cf144,"haxe.ui.layouts.HorizontalGridLayout.cloneLayout","haxe/ui/macros/helpers/ClassBuilder.hx",700,0x8cdaad7b)
HX_LOCAL_STACK_FRAME(_hx_pos_cfc2dc7fbe6f28a7_113_self,"haxe.ui.layouts.HorizontalGridLayout","self",0xeef16a8f,"haxe.ui.layouts.HorizontalGridLayout.self","haxe/ui/macros/LayoutMacros.hx",113,0xe44eaad7)
namespace haxe{
namespace ui{
namespace layouts{
...
HX_DEFINE_DYNAMIC_FUNC0(HorizontalGridLayout_obj,calcExplicitHeights,return )
 ...
 ::haxe::ui::layouts::Layout HorizontalGridLayout_obj::cloneLayout(){
            	HX_STACKFRAME(&_hx_pos_0236f6cb8da11327_700_cloneLayout)
HXLINE(  85)		 ::haxe::ui::layouts::HorizontalGridLayout c = ( ( ::haxe::ui::layouts::HorizontalGridLayout)(this->super::cloneLayout()) );
HXLINE(  96)		c->set_rows(this->get_rows());
HXLINE( 101)		return c;
            	}


 ::haxe::ui::layouts::Layout HorizontalGridLayout_obj::self(){
            	HX_GC_STACKFRAME(&_hx_pos_cfc2dc7fbe6f28a7_113_self)
HXDLIN( 113)		return  ::haxe::ui::layouts::HorizontalGridLayout_obj::__alloc( HX_CTX );
            	}
