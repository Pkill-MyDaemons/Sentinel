...
class HXCPP_CLASS_ATTRIBUTES ScrollViewEvents_obj : public  ::haxe::ui::events::Events_obj
{
	...
	public:
		...
		void onComponentAdded( ::haxe::ui::events::UIEvent event);
		::Dynamic onComponentAdded_dyn();

		void onContentsComponentAdded( ::haxe::ui::events::UIEvent event);
		::Dynamic onContentsComponentAdded_dyn();

		void onComponentRemoved( ::haxe::ui::events::UIEvent event);
		::Dynamic onComponentRemoved_dyn();

		void onContentsComponentRemoved( ::haxe::ui::events::UIEvent event);
		::Dynamic onContentsComponentRemoved_dyn();
		...
		void onLeftMouseDown( ::haxe::ui::events::MouseEvent event);
		::Dynamic onLeftMouseDown_dyn();

		void onMiddleMouseDown( ::haxe::ui::events::MouseEvent event);
		::Dynamic onMiddleMouseDown_dyn();

		void onRightMouseDown( ::haxe::ui::events::MouseEvent event);
		...
		virtual void onActionStart( ::haxe::ui::events::ActionEvent event);
