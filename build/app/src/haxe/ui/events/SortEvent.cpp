...
bool SortEvent_obj::__GetStatic(const ::String &inName, Dynamic &outValue, ::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 12:
		if (HX_FIELD_EQ(inName,"SORT_CHANGED") ) { outValue = ( SORT_CHANGED ); return true; }
	}
	return false;
}
...
bool SortEvent_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 12:
		if (HX_FIELD_EQ(inName,"SORT_CHANGED") ) { SORT_CHANGED=ioValue.Cast< ::String >(); return true; }
	}
	return false;
}
...
void SortEvent_obj::__register()
{
	...
	__mClass->mGetStaticField = &SortEvent_obj::__GetStatic;
	__mClass->mSetStaticField = &SortEvent_obj::__SetStatic;
...
HXDLIN(   6)		SORT_CHANGED = ::haxe::ui::events::_EventType::EventType_Impl__obj::name(HX_("sortchanged",56,51,5d,eb));
            	}
}
