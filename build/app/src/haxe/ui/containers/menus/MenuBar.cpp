...
HX_LOCAL_STACK_FRAME(_hx_pos_8cf5a1387c9bbc0c_204_registerComposite,"haxe.ui.containers.menus.MenuBar","registerComposite",0x7ac87dc6,"haxe.ui.containers.menus.MenuBar.registerComposite","haxe/ui/macros/Macros.hx",204,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_8cf5a1387c9bbc0c_244_set_onMenuSelected,"haxe.ui.containers.menus.MenuBar","set_onMenuSelected",0x4f2acb34,"haxe.ui.containers.menus.MenuBar.set_onMenuSelected","haxe/ui/macros/Macros.hx",244,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_8cf5a1387c9bbc0c_244_set_onMenuOpened,"haxe.ui.containers.menus.MenuBar","set_onMenuOpened",0xd3ebeb42,"haxe.ui.containers.menus.MenuBar.set_onMenuOpened","haxe/ui/macros/Macros.hx",244,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_8cf5a1387c9bbc0c_244_set_onMenuClosed,"haxe.ui.containers.menus.MenuBar","set_onMenuClosed",0xc0a93245,"haxe.ui.containers.menus.MenuBar.set_onMenuClosed","haxe/ui/macros/Macros.hx",244,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_8cf5a1387c9bbc0c_550_registerBehaviours,"haxe.ui.containers.menus.MenuBar","registerBehaviours",0x77a49cf7,"haxe.ui.containers.menus.MenuBar.registerBehaviours","haxe/ui/macros/Macros.hx",550,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_8cf5a1387c9bbc0c_597_get_menuStyleNames,"haxe.ui.containers.menus.MenuBar","get_menuStyleNames",0x7aa8e53d,"haxe.ui.containers.menus.MenuBar.get_menuStyleNames","haxe/ui/macros/Macros.hx",597,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_8cf5a1387c9bbc0c_630_set_menuStyleNames,"haxe.ui.containers.menus.MenuBar","set_menuStyleNames",0x575817b1,"haxe.ui.containers.menus.MenuBar.set_menuStyleNames","haxe/ui/macros/Macros.hx",630,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_24366af1f06276e1_700_cloneComponent,"haxe.ui.containers.menus.MenuBar","cloneComponent",0xf12f77be,"haxe.ui.containers.menus.MenuBar.cloneComponent","haxe/ui/macros/helpers/ClassBuilder.hx",700,0x8cdaad7b)
HX_LOCAL_STACK_FRAME(_hx_pos_8cf5a1387c9bbc0c_521_self,"haxe.ui.containers.menus.MenuBar","self",0xe097e82a,"haxe.ui.containers.menus.MenuBar.self","haxe/ui/macros/Macros.hx",521,0x27866361)
namespace haxe{
namespace ui{
...
bool MenuBar_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x2570d72f) {
		...
		if (inClassId<=(int)0x578ca5ac) {
			return inClassId==(int)0x4ba87886 || inClassId==(int)0x578ca5ac;
		} else {
...
void MenuBar_obj::registerComposite(){
            	HX_STACKFRAME(&_hx_pos_8cf5a1387c9bbc0c_204_registerComposite)
HXLINE( 205)		this->super::registerComposite();
HXLINE( 213)		this->_internalEventsClass = ::hx::ClassOf< ::haxe::ui::containers::menus::_MenuBar::Events >();
HXLINE( 217)		this->_compositeBuilderClass = ::hx::ClassOf< ::haxe::ui::containers::menus::_MenuBar::Builder >();
            	}


 ::Dynamic MenuBar_obj::set_onMenuSelected( ::Dynamic value){
            	HX_STACKFRAME(&_hx_pos_8cf5a1387c9bbc0c_244_set_onMenuSelected)
...
HX_DEFINE_DYNAMIC_FUNC1(MenuBar_obj,set_onMenuSelected,return )
 ...
 ::Dynamic MenuBar_obj::set_onMenuOpened( ::Dynamic value){
            	HX_STACKFRAME(&_hx_pos_8cf5a1387c9bbc0c_244_set_onMenuOpened)
HXLINE( 245)		if (::hx::IsNotNull( this->_internal__onMenuOpened )) {
HXLINE( 246)			this->unregisterEvent(::haxe::ui::events::MenuEvent_obj::MENU_OPENED,this->_internal__onMenuOpened);
HXLINE( 247)			this->_internal__onMenuOpened = null();
            		}
HXLINE( 249)		if (::hx::IsNotNull( value )) {
HXLINE( 250)			this->_internal__onMenuOpened = value;
HXLINE( 251)			this->registerEvent(::haxe::ui::events::MenuEvent_obj::MENU_OPENED,value,null());
            		}
HXLINE( 253)		return value;
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(MenuBar_obj,set_onMenuOpened,return )
 ...
 ::Dynamic MenuBar_obj::set_onMenuClosed( ::Dynamic value){
            	HX_STACKFRAME(&_hx_pos_8cf5a1387c9bbc0c_244_set_onMenuClosed)
HXLINE( 245)		if (::hx::IsNotNull( this->_internal__onMenuClosed )) {
HXLINE( 246)			this->unregisterEvent(::haxe::ui::events::MenuEvent_obj::MENU_CLOSED,this->_internal__onMenuClosed);
HXLINE( 247)			this->_internal__onMenuClosed = null();
            		}
HXLINE( 249)		if (::hx::IsNotNull( value )) {
HXLINE( 250)			this->_internal__onMenuClosed = value;
HXLINE( 251)			this->registerEvent(::haxe::ui::events::MenuEvent_obj::MENU_CLOSED,value,null());
            		}
HXLINE( 253)		return value;
            	}
...
void MenuBar_obj::registerBehaviours(){
            	HX_STACKFRAME(&_hx_pos_8cf5a1387c9bbc0c_550_registerBehaviours)
...
::String MenuBar_obj::get_menuStyleNames(){
            	HX_STACKFRAME(&_hx_pos_8cf5a1387c9bbc0c_597_get_menuStyleNames)
...
::String MenuBar_obj::set_menuStyleNames(::String value){
            	HX_GC_STACKFRAME(&_hx_pos_8cf5a1387c9bbc0c_630_set_menuStyleNames)
HXLINE( 631)		{
...
HX_DEFINE_DYNAMIC_FUNC1(MenuBar_obj,set_menuStyleNames,return )
 ...
 ::haxe::ui::backend::ComponentBase MenuBar_obj::cloneComponent(){
            	HX_STACKFRAME(&_hx_pos_24366af1f06276e1_700_cloneComponent)
HXLINE( 469)		 ::haxe::ui::containers::menus::MenuBar c = ( ( ::haxe::ui::containers::menus::MenuBar)(this->super::cloneComponent()) );
HXLINE( 484)		{
...
HXLINE( 493)		return c;
 ...
 ::haxe::ui::backend::ComponentBase MenuBar_obj::self(){
            	HX_GC_STACKFRAME(&_hx_pos_8cf5a1387c9bbc0c_521_self)
HXDLIN( 521)		return  ::haxe::ui::containers::menus::MenuBar_obj::__alloc( HX_CTX );
            	}
