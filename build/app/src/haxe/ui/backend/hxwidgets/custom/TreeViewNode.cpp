...
HX_LOCAL_STACK_FRAME(_hx_pos_cd40792116e72f3f_551_registerBehaviours,"haxe.ui.backend.hxwidgets.custom.TreeViewNode","registerBehaviours",0x1f051f60,"haxe.ui.backend.hxwidgets.custom.TreeViewNode.registerBehaviours","haxe/ui/macros/Macros.hx",551,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_d21f974eec3cbbd0_700_cloneComponent,"haxe.ui.backend.hxwidgets.custom.TreeViewNode","cloneComponent",0xc35251a7,"haxe.ui.backend.hxwidgets.custom.TreeViewNode.cloneComponent","haxe/ui/macros/helpers/ClassBuilder.hx",700,0x8cdaad7b)
HX_LOCAL_STACK_FRAME(_hx_pos_cd40792116e72f3f_521_self,"haxe.ui.backend.hxwidgets.custom.TreeViewNode","self",0xe41ef4d3,"haxe.ui.backend.hxwidgets.custom.TreeViewNode.self","haxe/ui/macros/Macros.hx",521,0x27866361)
namespace haxe{
namespace ui{
namespace backend{
namespace hxwidgets{
	...
	if (inClassId<=(int)0x241810fb) {
		...
		if (inClassId<=(int)0x4ba87886) {
			if (inClassId<=(int)0x31fbae07) {
				return inClassId==(int)0x2eb1d3e1 || inClassId==(int)0x31fbae07;
			} else {
...
void TreeViewNode_obj::registerBehaviours(){
            	HX_STACKFRAME(&_hx_pos_cd40792116e72f3f_551_registerBehaviours)
HXDLIN( 551)		this->super::registerBehaviours();
            	}


 ::haxe::ui::backend::ComponentBase TreeViewNode_obj::cloneComponent(){
            	HX_STACKFRAME(&_hx_pos_d21f974eec3cbbd0_700_cloneComponent)
HXLINE( 469)		 ::haxe::ui::backend::hxwidgets::custom::TreeViewNode c = ( ( ::haxe::ui::backend::hxwidgets::custom::TreeViewNode)(this->super::cloneComponent()) );
HXLINE( 484)		{
...
HXLINE( 493)		return c;
 ...
 ::haxe::ui::backend::ComponentBase TreeViewNode_obj::self(){
            	HX_GC_STACKFRAME(&_hx_pos_cd40792116e72f3f_521_self)
HXDLIN( 521)		return  ::haxe::ui::backend::hxwidgets::custom::TreeViewNode_obj::__alloc( HX_CTX );
            	}
