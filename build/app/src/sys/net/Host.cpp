...
HX_DEFINE_STACK_FRAME(_hx_pos_318499faf034502d_35_new,"sys.net.Host","new",0x056496ac,"sys.net.Host.new","/opt/homebrew/lib/haxe/std/cpp/_std/sys/net/Host.hx",35,0x58ec400b)
HX_LOCAL_STACK_FRAME(_hx_pos_ba07e1fa25fb5df5_57___init__,"::sys::net::Host_obj","__init__",0x01315e0e,"::sys::net::Host_obj.__init__","/opt/homebrew/lib/haxe/std/cpp/_std/sys/net/Host.hx",57,0x58ec400b)
HX_LOCAL_STACK_FRAME(_hx_pos_318499faf034502d_45_toString,"sys.net.Host","toString",0xe5efb6e0,"sys.net.Host.toString","/opt/homebrew/lib/haxe/std/cpp/_std/sys/net/Host.hx",45,0x58ec400b)
namespace sys{
namespace net{

void Host_obj::__construct(::String name){
            	HX_STACKFRAME(&_hx_pos_318499faf034502d_35_new)
...
void Host_obj::__init__(){
            	HX_STACKFRAME(&_hx_pos_ba07e1fa25fb5df5_57___init__)
HXDLIN(  57)		_hx_std_socket_init();
            	}


::String Host_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_318499faf034502d_45_toString)
