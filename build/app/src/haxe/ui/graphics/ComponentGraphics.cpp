...
void ComponentGraphics_obj::__construct( ::haxe::ui::core::Component c){
            	HX_STACKFRAME(&_hx_pos_23705f74a32d5574_5_new)
HXDLIN(   5)		super::__construct(c);
            	}
...
::hx::ObjectPtr< ComponentGraphics_obj > ComponentGraphics_obj::__new( ::haxe::ui::core::Component c) {
	::hx::ObjectPtr< ComponentGraphics_obj > __this = new ComponentGraphics_obj();
	__this->__construct(c);
	return __this;
}

::hx::ObjectPtr< ComponentGraphics_obj > ComponentGraphics_obj::__alloc(::hx::Ctx *_hx_ctx, ::haxe::ui::core::Component c) {
