...
HXDLIN( 278)				if ((child->hasEvent(::haxe::ui::events::MouseEvent_obj::CLICK,this->onDayClicked_dyn()) == false)) {
...
HXLINE( 279)					child->registerEvent(::haxe::ui::events::MouseEvent_obj::CLICK,this->onDayClicked_dyn(),null());
            				}
            			}
            		}
            	}
...
HXDLIN( 285)			_g = (_g + 1);
HXLINE( 286)			child->unregisterEvent(::haxe::ui::events::MouseEvent_obj::CLICK,this->onDayClicked_dyn());
            		}
            	}
