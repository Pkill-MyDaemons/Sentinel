...
HXLINE( 133)			 ::Dynamic _hx_tmp1 = this->get_component()->get_width();
HXDLIN( 133)			Float _hx_tmp2 = (( (Float)(_hx_tmp1) ) - ( (Float)(inc->get_width()) ));
...
HXLINE( 145)				 ::Dynamic x2 = deinc->get_width();
...
HXLINE( 158)			 ::Dynamic ucx1 = deinc->get_width();
...
HXLINE( 161)			 ::Dynamic ucx2 = inc->get_width();
