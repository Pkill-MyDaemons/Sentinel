...
HX_LOCAL_STACK_FRAME(_hx_pos_b622e79a3ddd17cb_227_get_animatable,"haxe.ui.core.Component","get_animatable",0x5e32d675,"haxe.ui.core.Component.get_animatable","haxe/ui/core/Component.hx",227,0x3bb69e3f)
...
bool Component_obj::get_animatable(){
            	HX_STACKFRAME(&_hx_pos_b622e79a3ddd17cb_227_get_animatable)
...
HXLINE(1845)				if (::hx::IsLessEq( this->get_width(),0 )) {
...
HXLINE(1847)					this->set_width(this->_style->initialWidth);
...
HXLINE(1855)				if (::hx::IsLessEq( this->get_height(),0 )) {
...
HXLINE(1857)					this->set_height(this->_style->initialHeight);
...
bool Component_obj::validateComponentLayout(){
            	HX_STACKFRAME(&_hx_pos_b622e79a3ddd17cb_1878_validateComponentLayout)
...
HXLINE(2016)		this->dispatch( ::haxe::ui::events::UIEvent_obj::__alloc( HX_CTX ,::haxe::ui::events::UIEvent_obj::RESIZE,null(),null()),null());
...
HXLINE(2055)				if (::hx::IsLessEq( this->get_width(),0 )) {
...
HXLINE(2057)					this->set_width(style->initialWidth);
...
HXLINE(2065)				if (::hx::IsLessEq( this->get_height(),0 )) {
...
HXLINE(2067)					this->set_height(style->initialHeight);
...
HXLINE(2232)			_hx_tmp1 = ::hx::IsGreater( this->get_width(),0 );
            		}
            		else {
...
HXLINE(2235)			_hx_tmp2 = ::hx::IsGreater( this->get_height(),0 );
            		}
            		else {
