...
class HXCPP_CLASS_ATTRIBUTES Window_obj : public  ::hx::widgets::EvtHandler_obj
{
	...
	public:
		...
		bool showWithEffect( cpp::Struct<wxShowEffect, cpp::EnumHandler> effect,::hx::Null< int >  timeout);

		bool hide();
		::Dynamic hide_dyn();

		bool hideWithEffect( cpp::Struct<wxShowEffect, cpp::EnumHandler> effect,::hx::Null< int >  timeout);
		...
		void addChild( ::hx::widgets::Window child);
		::Dynamic addChild_dyn();

		void removeChild( ::hx::widgets::Window child);
		...
		::Dynamic update_dyn();
		 ...
		 ::Dynamic get_backgroundColour();
		::Dynamic get_backgroundColour_dyn();

		 ::Dynamic set_backgroundColour( ::Dynamic value);
		::Dynamic set_backgroundColour_dyn();

		 ::Dynamic get_foregroundColour();
		::Dynamic get_foregroundColour_dyn();

		 ::Dynamic set_foregroundColour( ::Dynamic value);
		...
		::Dynamic resize_dyn();
		 ...
		 ::hx::widgets::Size get_minSize();

		 ::hx::widgets::Size set_minSize( ::hx::widgets::Size value);

		 ::hx::widgets::Size get_maxSize();

		 ::hx::widgets::Size set_maxSize( ::hx::widgets::Size value);
		...
		::Dynamic resizeClient_dyn();
		 ...
		 ::hx::widgets::Size get_minClientSize();

		 ::hx::widgets::Size set_minClientSize( ::hx::widgets::Size value);

		 ::hx::widgets::Size get_maxClientSize();

		 ::hx::widgets::Size set_maxClientSize( ::hx::widgets::Size value);
		...
		bool popupMenu( ::hx::widgets::Menu menu);
		::Dynamic popupMenu_dyn();
		...
		void captureMouse();
		::Dynamic captureMouse_dyn();

		bool hasCapture;
		bool get_hasCapture();
		::Dynamic get_hasCapture_dyn();

		void releaseMouse();
		::Dynamic releaseMouse_dyn();

		 ::hx::widgets::Validator get_validator();
		::Dynamic get_validator_dyn();

		 ::hx::widgets::Validator set_validator( ::hx::widgets::Validator value);
		::Dynamic set_validator_dyn();
