...
HX_DEFINE_STACK_FRAME(_hx_pos_efde936c15941bc5_188_new,"haxe.ui.containers._TreeViewNode.Expanded","new",0x816e6a7f,"haxe.ui.containers._TreeViewNode.Expanded.new","haxe/ui/containers/TreeViewNode.hx",188,0x9b33be2e)
HX_LOCAL_STACK_FRAME(_hx_pos_efde936c15941bc5_189_validateData,"haxe.ui.containers._TreeViewNode.Expanded","validateData",0x3729ffe1,"haxe.ui.containers._TreeViewNode.Expanded.validateData","haxe/ui/containers/TreeViewNode.hx",189,0x9b33be2e)
namespace haxe{
namespace ui{
...
void Expanded_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_efde936c15941bc5_188_new)
...
void Expanded_obj::validateData(){
            	HX_STACKFRAME(&_hx_pos_efde936c15941bc5_189_validateData)
HXLINE( 190)		 ::haxe::ui::containers::Box childContainer = this->_component->findComponent(HX_("treenode-child-container",e3,70,2d,aa),::hx::ClassOf< ::haxe::ui::containers::Box >(),null(),null()).StaticCast<  ::haxe::ui::containers::Box >();
HXLINE( 191)		if (::hx::IsNull( childContainer )) {
HXLINE( 192)			return;
            		}
HXLINE( 195)		 ::haxe::ui::util::VariantType _hx_tmp = this->_value;
HXDLIN( 195)		if (::haxe::ui::util::_Variant::Variant_Impl__obj::eq(_hx_tmp,::haxe::ui::util::_Variant::Variant_Impl__obj::fromBool(true))) {
HXLINE( 196)			childContainer->show();
            		}
            		else {
HXLINE( 198)			childContainer->hide();
            		}
HXLINE( 201)		 ::haxe::ui::containers::_TreeViewNode::TreeViewNodeBuilder builder = ::hx::TCast<  ::haxe::ui::containers::_TreeViewNode::TreeViewNodeBuilder >::cast(this->_component->_compositeBuilder);
HXLINE( 202)		builder->updateIconClass();
            	}
