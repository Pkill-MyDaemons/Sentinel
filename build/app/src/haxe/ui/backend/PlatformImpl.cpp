...
HXLINE(  55)			int c1 = ::hx::widgets::SystemSettings_obj::getColour(wxSYS_COLOUR_3DFACE);
HXDLIN(  55)			return ((((c1 & 255) << 16) | (c1 & 65280)) | ((c1 & 16711680) >> 16));
HXDLIN(  55)			goto _hx_goto_3;
            		}
            		if (  (_hx_switch_0==HX_("3d-highlight",78,24,1c,2a)) ){
HXLINE(  58)			int c2 = ::hx::widgets::SystemSettings_obj::getColour(wxSYS_COLOUR_3DHIGHLIGHT);
HXDLIN(  58)			return ((((c2 & 255) << 16) | (c2 & 65280)) | ((c2 & 16711680) >> 16));
HXDLIN(  58)			goto _hx_goto_3;
            		}
            		if (  (_hx_switch_0==HX_("3d-hilight",79,a7,2e,18)) ){
HXLINE(  59)			int c3 = ::hx::widgets::SystemSettings_obj::getColour(wxSYS_COLOUR_3DHILIGHT);
HXDLIN(  59)			return ((((c3 & 255) << 16) | (c3 & 65280)) | ((c3 & 16711680) >> 16));
HXDLIN(  59)			goto _hx_goto_3;
            		}
            		if (  (_hx_switch_0==HX_("3d-light",1a,ed,7a,16)) ){
HXLINE(  43)			int c4 = ::hx::widgets::SystemSettings_obj::getColour(wxSYS_COLOUR_3DLIGHT);
HXDLIN(  43)			return ((((c4 & 255) << 16) | (c4 & 65280)) | ((c4 & 16711680) >> 16));
HXDLIN(  43)			goto _hx_goto_3;
            		}
            		if (  (_hx_switch_0==HX_("3d-shadow",1c,27,33,ca)) ){
HXLINE(  56)			int c5 = ::hx::widgets::SystemSettings_obj::getColour(wxSYS_COLOUR_3DSHADOW);
HXDLIN(  56)			return ((((c5 & 255) << 16) | (c5 & 65280)) | ((c5 & 16711680) >> 16));
HXDLIN(  56)			goto _hx_goto_3;
            		}
            		if (  (_hx_switch_0==HX_("active-border",d3,4f,d8,9d)) ){
HXLINE(  31)			int c6 = ::hx::widgets::SystemSettings_obj::getColour(wxSYS_COLOUR_ACTIVEBORDER);
HXDLIN(  31)			return ((((c6 & 255) << 16) | (c6 & 65280)) | ((c6 & 16711680) >> 16));
HXDLIN(  31)			goto _hx_goto_3;
            		}
            		if (  (_hx_switch_0==HX_("active-caption",1f,3a,cd,f3)) ){
HXLINE(  23)			int c7 = ::hx::widgets::SystemSettings_obj::getColour(wxSYS_COLOUR_ACTIVECAPTION);
HXDLIN(  23)			return ((((c7 & 255) << 16) | (c7 & 65280)) | ((c7 & 16711680) >> 16));
HXDLIN(  23)			goto _hx_goto_3;
            		}
            		if (  (_hx_switch_0==HX_("app-workspace",69,d7,51,09)) ){
HXLINE(  33)			int c8 = ::hx::widgets::SystemSettings_obj::getColour(wxSYS_COLOUR_APPWORKSPACE);
HXDLIN(  33)			return ((((c8 & 255) << 16) | (c8 & 65280)) | ((c8 & 16711680) >> 16));
HXDLIN(  33)			goto _hx_goto_3;
            		}
            		if (  (_hx_switch_0==HX_("background",ee,93,1d,26)) ){
HXLINE(  54)			int c9 = ::hx::widgets::SystemSettings_obj::getColour(wxSYS_COLOUR_BACKGROUND);
HXDLIN(  54)			return ((((c9 & 255) << 16) | (c9 & 65280)) | ((c9 & 16711680) >> 16));
HXDLIN(  54)			goto _hx_goto_3;
            		}
            		if (  (_hx_switch_0==HX_("btn-face",6e,ff,08,e5)) ){
HXLINE(  36)			int c10 = ::hx::widgets::SystemSettings_obj::getColour(wxSYS_COLOUR_BTNFACE);
HXDLIN(  36)			return ((((c10 & 255) << 16) | (c10 & 65280)) | ((c10 & 16711680) >> 16));
HXDLIN(  36)			goto _hx_goto_3;
            		}
            		if (  (_hx_switch_0==HX_("btn-highlight",c3,35,17,98)) ){
HXLINE(  41)			int c11 = ::hx::widgets::SystemSettings_obj::getColour(wxSYS_COLOUR_BTNHIGHLIGHT);
HXDLIN(  41)			return ((((c11 & 255) << 16) | (c11 & 65280)) | ((c11 & 16711680) >> 16));
HXDLIN(  41)			goto _hx_goto_3;
            		}
            		if (  (_hx_switch_0==HX_("btn-hilight",04,40,aa,7d)) ){
HXLINE(  57)			int c12 = ::hx::widgets::SystemSettings_obj::getColour(wxSYS_COLOUR_BTNHILIGHT);
HXDLIN(  57)			return ((((c12 & 255) << 16) | (c12 & 65280)) | ((c12 & 16711680) >> 16));
HXDLIN(  57)			goto _hx_goto_3;
            		}
            		if (  (_hx_switch_0==HX_("btn-shadow",f1,28,f9,31)) ){
HXLINE(  37)			int c13 = ::hx::widgets::SystemSettings_obj::getColour(wxSYS_COLOUR_BTNSHADOW);
HXDLIN(  37)			return ((((c13 & 255) << 16) | (c13 & 65280)) | ((c13 & 16711680) >> 16));
HXDLIN(  37)			goto _hx_goto_3;
            		}
            		if (  (_hx_switch_0==HX_("btn-text",7e,17,4d,ee)) ){
HXLINE(  39)			int c14 = ::hx::widgets::SystemSettings_obj::getColour(wxSYS_COLOUR_BTNTEXT);
HXDLIN(  39)			return ((((c14 & 255) << 16) | (c14 & 65280)) | ((c14 & 16711680) >> 16));
HXDLIN(  39)			goto _hx_goto_3;
            		}
            		if (  (_hx_switch_0==HX_("caption-text",b4,f2,08,a6)) ){
HXLINE(  30)			int c15 = ::hx::widgets::SystemSettings_obj::getColour(wxSYS_COLOUR_CAPTIONTEXT);
HXDLIN(  30)			return ((((c15 & 255) << 16) | (c15 & 65280)) | ((c15 & 16711680) >> 16));
HXDLIN(  30)			goto _hx_goto_3;
            		}
            		if (  (_hx_switch_0==HX_("desktop",dc,c5,94,1e)) ){
HXLINE(  22)			int c16 = ::hx::widgets::SystemSettings_obj::getColour(wxSYS_COLOUR_DESKTOP);
HXDLIN(  22)			return ((((c16 & 255) << 16) | (c16 & 65280)) | ((c16 & 16711680) >> 16));
HXDLIN(  22)			goto _hx_goto_3;
            		}
            		if (  (_hx_switch_0==HX_("frame-bk",29,9d,d8,1c)) ){
HXLINE(  60)			int c17 = ::hx::widgets::SystemSettings_obj::getColour(wxSYS_COLOUR_FRAMEBK);
HXDLIN(  60)			return ((((c17 & 255) << 16) | (c17 & 65280)) | ((c17 & 16711680) >> 16));
HXDLIN(  60)			goto _hx_goto_3;
            		}
            		if (  (_hx_switch_0==HX_("gradient-active-caption",1c,c3,f7,ce)) ){
HXLINE(  48)			int c18 = ::hx::widgets::SystemSettings_obj::getColour(wxSYS_COLOUR_GRADIENTACTIVECAPTION);
HXDLIN(  48)			return ((((c18 & 255) << 16) | (c18 & 65280)) | ((c18 & 16711680) >> 16));
HXDLIN(  48)			goto _hx_goto_3;
            		}
            		if (  (_hx_switch_0==HX_("gradient-inactive-caption",01,3f,49,8c)) ){
HXLINE(  49)			int c19 = ::hx::widgets::SystemSettings_obj::getColour(wxSYS_COLOUR_GRADIENTINACTIVECAPTION);
HXDLIN(  49)			return ((((c19 & 255) << 16) | (c19 & 65280)) | ((c19 & 16711680) >> 16));
HXDLIN(  49)			goto _hx_goto_3;
            		}
            		if (  (_hx_switch_0==HX_("gray-text",97,a0,6a,b0)) ){
HXLINE(  38)			int c20 = ::hx::widgets::SystemSettings_obj::getColour(wxSYS_COLOUR_GRAYTEXT);
HXDLIN(  38)			return ((((c20 & 255) << 16) | (c20 & 65280)) | ((c20 & 16711680) >> 16));
HXDLIN(  38)			goto _hx_goto_3;
            		}
            		if (  (_hx_switch_0==HX_("highlight",34,56,00,ed)) ){
HXLINE(  34)			int c21 = ::hx::widgets::SystemSettings_obj::getColour(wxSYS_COLOUR_HIGHLIGHT);
HXDLIN(  34)			return ((((c21 & 255) << 16) | (c21 & 65280)) | ((c21 & 16711680) >> 16));
HXDLIN(  34)			goto _hx_goto_3;
            		}
            		if (  (_hx_switch_0==HX_("highlight-text",a6,94,98,a4)) ){
HXLINE(  35)			int c22 = ::hx::widgets::SystemSettings_obj::getColour(wxSYS_COLOUR_HIGHLIGHTTEXT);
HXDLIN(  35)			return ((((c22 & 255) << 16) | (c22 & 65280)) | ((c22 & 16711680) >> 16));
HXDLIN(  35)			goto _hx_goto_3;
            		}
            		if (  (_hx_switch_0==HX_("hotlight",29,46,af,1a)) ){
HXLINE(  47)			int c23 = ::hx::widgets::SystemSettings_obj::getColour(wxSYS_COLOUR_HOTLIGHT);
HXDLIN(  47)			return ((((c23 & 255) << 16) | (c23 & 65280)) | ((c23 & 16711680) >> 16));
HXDLIN(  47)			goto _hx_goto_3;
            		}
            		if (  (_hx_switch_0==HX_("inactive-border",ce,a8,86,5f)) ){
HXLINE(  32)			int c24 = ::hx::widgets::SystemSettings_obj::getColour(wxSYS_COLOUR_INACTIVEBORDER);
HXDLIN(  32)			return ((((c24 & 255) << 16) | (c24 & 65280)) | ((c24 & 16711680) >> 16));
HXDLIN(  32)			goto _hx_goto_3;
            		}
            		if (  (_hx_switch_0==HX_("inactive-caption",c4,bc,ac,aa)) ){
HXLINE(  24)			int c25 = ::hx::widgets::SystemSettings_obj::getColour(wxSYS_COLOUR_INACTIVECAPTION);
HXDLIN(  24)			return ((((c25 & 255) << 16) | (c25 & 65280)) | ((c25 & 16711680) >> 16));
HXDLIN(  24)			goto _hx_goto_3;
            		}
            		if (  (_hx_switch_0==HX_("inactive-caption-text",16,64,9e,d1)) ){
HXLINE(  40)			int c26 = ::hx::widgets::SystemSettings_obj::getColour(wxSYS_COLOUR_INACTIVECAPTIONTEXT);
HXDLIN(  40)			return ((((c26 & 255) << 16) | (c26 & 65280)) | ((c26 & 16711680) >> 16));
HXDLIN(  40)			goto _hx_goto_3;
            		}
            		if (  (_hx_switch_0==HX_("info-bk",88,bb,ef,0d)) ){
HXLINE(  45)			int c27 = ::hx::widgets::SystemSettings_obj::getColour(wxSYS_COLOUR_INFOBK);
HXDLIN(  45)			return ((((c27 & 255) << 16) | (c27 & 65280)) | ((c27 & 16711680) >> 16));
HXDLIN(  45)			goto _hx_goto_3;
            		}
            		if (  (_hx_switch_0==HX_("info-text",2c,60,dd,41)) ){
HXLINE(  44)			int c28 = ::hx::widgets::SystemSettings_obj::getColour(wxSYS_COLOUR_INFOTEXT);
HXDLIN(  44)			return ((((c28 & 255) << 16) | (c28 & 65280)) | ((c28 & 16711680) >> 16));
HXDLIN(  44)			goto _hx_goto_3;
            		}
            		if (  (_hx_switch_0==HX_("listbox",6d,30,93,0a)) ){
HXLINE(  46)			int c29 = ::hx::widgets::SystemSettings_obj::getColour(wxSYS_COLOUR_LISTBOX);
HXDLIN(  46)			return ((((c29 & 255) << 16) | (c29 & 65280)) | ((c29 & 16711680) >> 16));
HXDLIN(  46)			goto _hx_goto_3;
            		}
            		if (  (_hx_switch_0==HX_("listbox-highlight-text",c6,fb,d7,7e)) ){
HXLINE(  53)			int c30 = ::hx::widgets::SystemSettings_obj::getColour(wxSYS_COLOUR_LISTBOXHIGHLIGHTTEXT);
HXDLIN(  53)			return ((((c30 & 255) << 16) | (c30 & 65280)) | ((c30 & 16711680) >> 16));
HXDLIN(  53)			goto _hx_goto_3;
            		}
            		if (  (_hx_switch_0==HX_("listbox-text",cd,0b,c7,ac)) ){
HXLINE(  52)			int c31 = ::hx::widgets::SystemSettings_obj::getColour(wxSYS_COLOUR_LISTBOXTEXT);
HXDLIN(  52)			return ((((c31 & 255) << 16) | (c31 & 65280)) | ((c31 & 16711680) >> 16));
HXDLIN(  52)			goto _hx_goto_3;
            		}
            		if (  (_hx_switch_0==HX_("menu",9f,45,59,48)) ){
HXLINE(  25)			int c32 = ::hx::widgets::SystemSettings_obj::getColour(wxSYS_COLOUR_MENU);
HXDLIN(  25)			return ((((c32 & 255) << 16) | (c32 & 65280)) | ((c32 & 16711680) >> 16));
HXDLIN(  25)			goto _hx_goto_3;
            		}
            		if (  (_hx_switch_0==HX_("menu-hilight",47,3e,a2,41)) ){
HXLINE(  50)			int c33 = ::hx::widgets::SystemSettings_obj::getColour(wxSYS_COLOUR_MENUHILIGHT);
HXDLIN(  50)			return ((((c33 & 255) << 16) | (c33 & 65280)) | ((c33 & 16711680) >> 16));
HXDLIN(  50)			goto _hx_goto_3;
            		}
            		if (  (_hx_switch_0==HX_("menu-text",5b,e1,ac,3d)) ){
HXLINE(  28)			int c34 = ::hx::widgets::SystemSettings_obj::getColour(wxSYS_COLOUR_MENUTEXT);
HXDLIN(  28)			return ((((c34 & 255) << 16) | (c34 & 65280)) | ((c34 & 16711680) >> 16));
HXDLIN(  28)			goto _hx_goto_3;
            		}
            		if (  (_hx_switch_0==HX_("menubar",94,79,63,ba)) ){
HXLINE(  51)			int c35 = ::hx::widgets::SystemSettings_obj::getColour(wxSYS_COLOUR_MENUBAR);
HXDLIN(  51)			return ((((c35 & 255) << 16) | (c35 & 65280)) | ((c35 & 16711680) >> 16));
HXDLIN(  51)			goto _hx_goto_3;
            		}
            		if (  (_hx_switch_0==HX_("scrollbar",e6,9f,14,3e)) ){
HXLINE(  21)			int c36 = ::hx::widgets::SystemSettings_obj::getColour(wxSYS_COLOUR_SCROLLBAR);
HXDLIN(  21)			return ((((c36 & 255) << 16) | (c36 & 65280)) | ((c36 & 16711680) >> 16));
HXDLIN(  21)			goto _hx_goto_3;
            		}
            		if (  (_hx_switch_0==HX_("window",f0,93,8c,52)) ){
HXLINE(  26)			int c37 = ::hx::widgets::SystemSettings_obj::getColour(wxSYS_COLOUR_WINDOW);
HXDLIN(  26)			return ((((c37 & 255) << 16) | (c37 & 65280)) | ((c37 & 16711680) >> 16));
HXDLIN(  26)			goto _hx_goto_3;
            		}
            		if (  (_hx_switch_0==HX_("window-frame",d0,dc,6e,97)) ){
HXLINE(  27)			int c38 = ::hx::widgets::SystemSettings_obj::getColour(wxSYS_COLOUR_WINDOWFRAME);
HXDLIN(  27)			return ((((c38 & 255) << 16) | (c38 & 65280)) | ((c38 & 16711680) >> 16));
HXDLIN(  27)			goto _hx_goto_3;
            		}
            		if (  (_hx_switch_0==HX_("window-text",6a,0d,a7,93)) ){
HXLINE(  29)			int c39 = ::hx::widgets::SystemSettings_obj::getColour(wxSYS_COLOUR_WINDOWTEXT);
HXDLIN(  29)			return ((((c39 & 255) << 16) | (c39 & 65280)) | ((c39 & 16711680) >> 16));
