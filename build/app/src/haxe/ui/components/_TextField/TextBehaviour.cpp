...
HX_DEFINE_STACK_FRAME(_hx_pos_fbe547e797c77141_249_new,"haxe.ui.components._TextField.TextBehaviour","new",0x4854ee28,"haxe.ui.components._TextField.TextBehaviour.new","haxe/ui/components/TextField.hx",249,0x9dfe9498)
HX_LOCAL_STACK_FRAME(_hx_pos_fbe547e797c77141_250_validateData,"haxe.ui.components._TextField.TextBehaviour","validateData",0x70043f18,"haxe.ui.components._TextField.TextBehaviour.validateData","haxe/ui/components/TextField.hx",250,0x9dfe9498)
namespace haxe{
namespace ui{
...
void TextBehaviour_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_fbe547e797c77141_249_new)
HXDLIN( 249)		super::__construct(component);
            	}
...
void TextBehaviour_obj::validateData(){
            	HX_STACKFRAME(&_hx_pos_fbe547e797c77141_250_validateData)
HXLINE( 251)		 ::haxe::ui::components::TextField textfield = ::hx::TCast<  ::haxe::ui::components::TextField >::cast(this->_component);
HXLINE( 252)		::haxe::ui::components::_TextField::TextFieldHelper_obj::validateText(textfield,::haxe::ui::util::_Variant::Variant_Impl__obj::toString(this->_value));
HXLINE( 254)		bool _hx_tmp;
HXDLIN( 254)		if (::hx::IsNotNull( this->_value )) {
HXLINE( 254)			 ::haxe::ui::util::VariantType _hx_tmp1 = this->_value;
HXDLIN( 254)			_hx_tmp = ::haxe::ui::util::_Variant::Variant_Impl__obj::neq(_hx_tmp1,::haxe::ui::util::_Variant::Variant_Impl__obj::fromString(HX_("",00,00,00,00)));
            		}
            		else {
HXLINE( 254)			_hx_tmp = false;
            		}
HXDLIN( 254)		if (_hx_tmp) {
HXLINE( 255)			this->_value = ::haxe::ui::util::_Variant::Variant_Impl__obj::fromString(textfield->getTextInput()->get_text());
            		}
            	}
