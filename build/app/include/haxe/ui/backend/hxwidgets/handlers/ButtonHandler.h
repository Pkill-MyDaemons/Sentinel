...
class HXCPP_CLASS_ATTRIBUTES ButtonHandler_obj : public  ::haxe::ui::backend::hxwidgets::handlers::NativeHandler_obj
{
	...
	public:
		...
		static ::hx::ObjectPtr< ButtonHandler_obj > __new( ::haxe::ui::components::Button button);
		static ::hx::ObjectPtr< ButtonHandler_obj > __alloc(::hx::Ctx *_hx_ctx, ::haxe::ui::components::Button button);
		...
		void _hx___onToggleEvent( ::hx::widgets::Event event);
		::Dynamic _hx___onToggleEvent_dyn();
