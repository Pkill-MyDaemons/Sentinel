...
HX_DEFINE_STACK_FRAME(_hx_pos_06d8b660a0799600_49_new,"haxe.ui.components.CheckBoxValue","new",0xe85b4eda,"haxe.ui.components.CheckBoxValue.new","haxe/ui/components/CheckBox.hx",49,0xaeb3e5d4)
HX_LOCAL_STACK_FRAME(_hx_pos_06d8b660a0799600_57_onReady,"haxe.ui.components.CheckBoxValue","onReady",0x3079823e,"haxe.ui.components.CheckBoxValue.onReady","haxe/ui/components/CheckBox.hx",57,0xaeb3e5d4)
HX_LOCAL_STACK_FRAME(_hx_pos_06d8b660a0799600_63_applyStyle,"haxe.ui.components.CheckBoxValue","applyStyle",0x7c7dc5a9,"haxe.ui.components.CheckBoxValue.applyStyle","haxe/ui/components/CheckBox.hx",63,0xaeb3e5d4)
HX_LOCAL_STACK_FRAME(_hx_pos_06d8b660a0799600_71_createIcon,"haxe.ui.components.CheckBoxValue","createIcon",0xa54f4d5b,"haxe.ui.components.CheckBoxValue.createIcon","haxe/ui/components/CheckBox.hx",71,0xaeb3e5d4)
HX_LOCAL_STACK_FRAME(_hx_pos_06d8b660a0799600_86_onActionStart,"haxe.ui.components.CheckBoxValue","onActionStart",0x72eaace7,"haxe.ui.components.CheckBoxValue.onActionStart","haxe/ui/components/CheckBox.hx",86,0xaeb3e5d4)
HX_LOCAL_STACK_FRAME(_hx_pos_06d8b660a0799600_94_onActionEnd,"haxe.ui.components.CheckBoxValue","onActionEnd",0x5396a120,"haxe.ui.components.CheckBoxValue.onActionEnd","haxe/ui/components/CheckBox.hx",94,0xaeb3e5d4)
HX_LOCAL_STACK_FRAME(_hx_pos_4bd59a09dfe70b4f_551_registerBehaviours,"haxe.ui.components.CheckBoxValue","registerBehaviours",0x0d71829f,"haxe.ui.components.CheckBoxValue.registerBehaviours","haxe/ui/macros/Macros.hx",551,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_3c92488a26823be7_700_cloneComponent,"haxe.ui.components.CheckBoxValue","cloneComponent",0xcade6966,"haxe.ui.components.CheckBoxValue.cloneComponent","haxe/ui/macros/helpers/ClassBuilder.hx",700,0x8cdaad7b)
HX_LOCAL_STACK_FRAME(_hx_pos_4bd59a09dfe70b4f_521_self,"haxe.ui.components.CheckBoxValue","self",0x6ad7b7d2,"haxe.ui.components.CheckBoxValue.self","haxe/ui/macros/Macros.hx",521,0x27866361)
namespace haxe{
namespace ui{
namespace components{

void CheckBoxValue_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_06d8b660a0799600_49_new)
HXLINE(  84)		this->_down = true;
...
bool CheckBoxValue_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x395782b4) {
		...
		if (inClassId<=(int)0x7114539e) {
			return inClassId==(int)0x4ba87886 || inClassId==(int)0x7114539e;
		} else {
...
void CheckBoxValue_obj::onReady(){
            	HX_STACKFRAME(&_hx_pos_06d8b660a0799600_57_onReady)
HXLINE(  58)		this->createIcon();
HXLINE(  59)		this->registerEvent(::haxe::ui::events::ActionEvent_obj::ACTION_START,this->onActionStart_dyn(),null());
HXLINE(  60)		this->registerEvent(::haxe::ui::events::ActionEvent_obj::ACTION_END,this->onActionEnd_dyn(),null());
            	}


void CheckBoxValue_obj::applyStyle( ::haxe::ui::styles::Style style){
            	HX_STACKFRAME(&_hx_pos_06d8b660a0799600_63_applyStyle)
HXLINE(  64)		this->super::applyStyle(style);
HXLINE(  65)		 ::haxe::ui::components::Image icon = ( ( ::haxe::ui::components::Image)(this->findComponent(null(),::hx::ClassOf< ::haxe::ui::components::Image >(),null(),null())) );
HXLINE(  66)		if (::hx::IsNotNull( icon )) {
HXLINE(  67)			icon->set_resource(style->icon);
            		}
            	}


void CheckBoxValue_obj::createIcon(){
            	HX_GC_STACKFRAME(&_hx_pos_06d8b660a0799600_71_createIcon)
HXLINE(  72)		 ::haxe::ui::components::Image icon = ( ( ::haxe::ui::components::Image)(this->findComponent(null(),::hx::ClassOf< ::haxe::ui::components::Image >(),null(),null())) );
HXLINE(  73)		bool _hx_tmp;
HXDLIN(  73)		if (::hx::IsNull( icon )) {
HXLINE(  73)			_hx_tmp = ::hx::IsNotNull( this->get_parentComponent() );
            		}
            		else {
HXLINE(  73)			_hx_tmp = false;
            		}
HXDLIN(  73)		if (_hx_tmp) {
HXLINE(  74)			icon =  ::haxe::ui::components::Image_obj::__alloc( HX_CTX );
HXLINE(  75)			icon->set_id(((HX_("",00,00,00,00) + this->get_parentComponent()->get_cssName()) + HX_("-icon",26,02,bb,2e)));
HXLINE(  76)			icon->addClass(((HX_("",00,00,00,00) + this->get_parentComponent()->get_cssName()) + HX_("-icon",26,02,bb,2e)),null(),null());
HXLINE(  77)			bool _hx_tmp1;
HXDLIN(  77)			if (::hx::IsNotNull( this->get_style() )) {
HXLINE(  77)				_hx_tmp1 = ::hx::IsNotNull( this->get_style()->icon );
            			}
            			else {
HXLINE(  77)				_hx_tmp1 = false;
            			}
HXDLIN(  77)			if (_hx_tmp1) {
HXLINE(  78)				icon->set_resource(this->get_style()->icon);
            			}
HXLINE(  80)			this->addComponent(icon);
            		}
            	}
...
void CheckBoxValue_obj::onActionStart( ::haxe::ui::events::ActionEvent event){
            	HX_STACKFRAME(&_hx_pos_06d8b660a0799600_86_onActionStart)
HXDLIN(  86)		::String _hx_switch_0 = event->action;
            		if (  (_hx_switch_0==HX_("actionConfirm",ea,0b,2f,06)) ||  (_hx_switch_0==HX_("actionPress",ed,53,ed,9a)) ){
HXLINE(  88)			this->_down = true;
...
void CheckBoxValue_obj::onActionEnd( ::haxe::ui::events::ActionEvent event){
            	HX_STACKFRAME(&_hx_pos_06d8b660a0799600_94_onActionEnd)
HXDLIN(  94)		::String _hx_switch_0 = event->action;
            		if (  (_hx_switch_0==HX_("actionConfirm",ea,0b,2f,06)) ||  (_hx_switch_0==HX_("actionPress",ed,53,ed,9a)) ){
HXLINE(  96)			if ((this->_down == true)) {
HXLINE(  97)				this->_down = false;
HXLINE(  98)				if (::hx::IsNotNull( this->get_parentComponent() )) {
HXLINE(  99)					 ::haxe::ui::components::CheckBox checkbox = ::hx::TCast<  ::haxe::ui::components::CheckBox >::cast(this->get_parentComponent());
HXLINE( 100)					checkbox->set_selected(!(checkbox->get_selected()));
            				}
            			}
...
void CheckBoxValue_obj::registerBehaviours(){
            	HX_STACKFRAME(&_hx_pos_4bd59a09dfe70b4f_551_registerBehaviours)
HXDLIN( 551)		this->super::registerBehaviours();
            	}


 ::haxe::ui::backend::ComponentBase CheckBoxValue_obj::cloneComponent(){
            	HX_STACKFRAME(&_hx_pos_3c92488a26823be7_700_cloneComponent)
HXLINE( 469)		 ::haxe::ui::components::CheckBoxValue c = ( ( ::haxe::ui::components::CheckBoxValue)(this->super::cloneComponent()) );
HXLINE( 484)		{
...
HXLINE( 493)		return c;
 ...
 ::haxe::ui::backend::ComponentBase CheckBoxValue_obj::self(){
            	HX_GC_STACKFRAME(&_hx_pos_4bd59a09dfe70b4f_521_self)
HXDLIN( 521)		return  ::haxe::ui::components::CheckBoxValue_obj::__alloc( HX_CTX );
            	}
