...
HX_LOCAL_STACK_FRAME(_hx_pos_c2edfad6db2aac48_13_boot,"wx.widgets.StandardId","boot",0x75185e3c,"wx.widgets.StandardId.boot","wx/widgets/StandardId.hx",13,0x78315c58)
HX_LOCAL_STACK_FRAME(_hx_pos_c2edfad6db2aac48_14_boot,"wx.widgets.StandardId","boot",0x75185e3c,"wx.widgets.StandardId.boot","wx/widgets/StandardId.hx",14,0x78315c58)
HX_LOCAL_STACK_FRAME(_hx_pos_c2edfad6db2aac48_15_boot,"wx.widgets.StandardId","boot",0x75185e3c,"wx.widgets.StandardId.boot","wx/widgets/StandardId.hx",15,0x78315c58)
namespace wx{
namespace widgets{
...
int StandardId_obj::EXIT;

int StandardId_obj::PREFERENCES;

int StandardId_obj::HIGHEST;
...
bool StandardId_obj::__GetStatic(const ::String &inName, Dynamic &outValue, ::hx::PropertyAccess inCallProp)
{
	...
	case 6:
		...
		break;
	case 7:
		if (HX_FIELD_EQ(inName,"HIGHEST") ) { outValue = ( HIGHEST ); return true; }
		break;
	case 11:
		if (HX_FIELD_EQ(inName,"PREFERENCES") ) { outValue = ( PREFERENCES ); return true; }
	}
	return false;
}
...
bool StandardId_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,::hx::PropertyAccess inCallProp)
{
	...
	case 4:
		...
		if (HX_FIELD_EQ(inName,"EXIT") ) { EXIT=ioValue.Cast< int >(); return true; }
		break;
	case 5:
	...
	case 6:
		...
		break;
	case 7:
		if (HX_FIELD_EQ(inName,"HIGHEST") ) { HIGHEST=ioValue.Cast< int >(); return true; }
		break;
	case 11:
		if (HX_FIELD_EQ(inName,"PREFERENCES") ) { PREFERENCES=ioValue.Cast< int >(); return true; }
	}
	return false;
}
...
static ::hx::StaticInfo StandardId_obj_sStaticStorageInfo[] = {
	...
	{::hx::fsInt,(void *) &StandardId_obj::EXIT,HX_("EXIT",1e,bf,de,2d)},
	{::hx::fsInt,(void *) &StandardId_obj::PREFERENCES,HX_("PREFERENCES",98,c2,2c,49)},
	{::hx::fsInt,(void *) &StandardId_obj::HIGHEST,HX_("HIGHEST",04,ee,55,f3)},
	{ ::hx::fsUnknown, 0, null()}
};
#endif
...
static void StandardId_obj_sMarkStatics(HX_MARK_PARAMS) {
	...
	HX_MARK_MEMBER_NAME(StandardId_obj::EXIT,"EXIT");
	HX_MARK_MEMBER_NAME(StandardId_obj::PREFERENCES,"PREFERENCES");
	HX_MARK_MEMBER_NAME(StandardId_obj::HIGHEST,"HIGHEST");
};
...
static void StandardId_obj_sVisitStatics(HX_VISIT_PARAMS) {
	...
	HX_VISIT_MEMBER_NAME(StandardId_obj::EXIT,"EXIT");
	HX_VISIT_MEMBER_NAME(StandardId_obj::PREFERENCES,"PREFERENCES");
	HX_VISIT_MEMBER_NAME(StandardId_obj::HIGHEST,"HIGHEST");
};
...
static ::String StandardId_obj_sStaticFields[] = {
	...
	HX_("PREFERENCES",98,c2,2c,49),
	HX_("HIGHEST",04,ee,55,f3),
	::String(null())
};
...
{
            	HX_STACKFRAME(&_hx_pos_c2edfad6db2aac48_13_boot)
HXDLIN(  13)		EXIT = ::wxID_EXIT;
            	}
{
            	HX_STACKFRAME(&_hx_pos_c2edfad6db2aac48_14_boot)
HXDLIN(  14)		PREFERENCES = ::wxID_PREFERENCES;
            	}
{
            	HX_STACKFRAME(&_hx_pos_c2edfad6db2aac48_15_boot)
HXDLIN(  15)		HIGHEST = ::wxID_HIGHEST;
            	}
}
