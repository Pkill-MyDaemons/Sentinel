...
bool KeyboardEvent_obj::__GetStatic(const ::String &inName, Dynamic &outValue, ::hx::PropertyAccess inCallProp)
{
	...
	case 8:
		...
		break;
	case 9:
		if (HX_FIELD_EQ(inName,"KEY_PRESS") ) { outValue = ( KEY_PRESS ); return true; }
	}
	return false;
}
...
bool KeyboardEvent_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,::hx::PropertyAccess inCallProp)
{
	...
	case 8:
		...
		break;
	case 9:
		if (HX_FIELD_EQ(inName,"KEY_PRESS") ) { KEY_PRESS=ioValue.Cast< ::String >(); return true; }
	}
	return false;
}
...
HXDLIN(   4)		KEY_DOWN = ::haxe::ui::events::_EventType::EventType_Impl__obj::name(HX_("keydown",81,3d,6e,b1));
            	}
{
            	HX_STACKFRAME(&_hx_pos_c0078f72fb072ee8_5_boot)
HXDLIN(   5)		KEY_PRESS = ::haxe::ui::events::_EventType::EventType_Impl__obj::name(HX_("keypress",84,89,c4,79));
            	}
{
            	HX_STACKFRAME(&_hx_pos_c0078f72fb072ee8_6_boot)
HXDLIN(   6)		KEY_UP = ::haxe::ui::events::_EventType::EventType_Impl__obj::name(HX_("keyup",ba,d5,fe,de));
            	}
}
