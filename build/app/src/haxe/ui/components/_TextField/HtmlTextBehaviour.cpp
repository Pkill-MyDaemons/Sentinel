...
HX_DEFINE_STACK_FRAME(_hx_pos_aca048d79c8b6d12_261_new,"haxe.ui.components._TextField.HtmlTextBehaviour","new",0xcac2fb3d,"haxe.ui.components._TextField.HtmlTextBehaviour.new","haxe/ui/components/TextField.hx",261,0x9dfe9498)
HX_LOCAL_STACK_FRAME(_hx_pos_aca048d79c8b6d12_262_validateData,"haxe.ui.components._TextField.HtmlTextBehaviour","validateData",0xbe086763,"haxe.ui.components._TextField.HtmlTextBehaviour.validateData","haxe/ui/components/TextField.hx",262,0x9dfe9498)
namespace haxe{
namespace ui{
...
void HtmlTextBehaviour_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_aca048d79c8b6d12_261_new)
...
void HtmlTextBehaviour_obj::validateData(){
            	HX_STACKFRAME(&_hx_pos_aca048d79c8b6d12_262_validateData)
HXLINE( 263)		 ::haxe::ui::components::TextField textfield = ::hx::TCast<  ::haxe::ui::components::TextField >::cast(this->_component);
HXLINE( 264)		::haxe::ui::components::_TextField::TextFieldHelper_obj::validateHtmlText(textfield,::haxe::ui::util::_Variant::Variant_Impl__obj::toString(this->_value));
HXLINE( 266)		bool _hx_tmp;
HXDLIN( 266)		if (::hx::IsNotNull( this->_value )) {
HXLINE( 266)			 ::haxe::ui::util::VariantType _hx_tmp1 = this->_value;
HXDLIN( 266)			_hx_tmp = ::haxe::ui::util::_Variant::Variant_Impl__obj::neq(_hx_tmp1,::haxe::ui::util::_Variant::Variant_Impl__obj::fromString(HX_("",00,00,00,00)));
            		}
            		else {
HXLINE( 266)			_hx_tmp = false;
            		}
HXDLIN( 266)		if (_hx_tmp) {
HXLINE( 267)			this->_value = ::haxe::ui::util::_Variant::Variant_Impl__obj::fromString(textfield->getTextInput()->get_htmlText());
            		}
            	}
