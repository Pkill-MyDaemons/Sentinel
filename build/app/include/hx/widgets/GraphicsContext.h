...
class HXCPP_CLASS_ATTRIBUTES GraphicsContext_obj : public  ::hx::widgets::GraphicsObject_obj
{
	...
	public:
		enum { _hx_ClassId = 0x01bca505 };

		void __construct( ::hx::widgets::Window window, ::hx::widgets::WindowDC dc);
		...
		static ::hx::ObjectPtr< GraphicsContext_obj > __new( ::hx::widgets::Window window, ::hx::widgets::WindowDC dc);
		static ::hx::ObjectPtr< GraphicsContext_obj > __alloc(::hx::Ctx *_hx_ctx, ::hx::widgets::Window window, ::hx::widgets::WindowDC dc);
		...
		::String __ToString() const { return HX_("GraphicsContext",44,4c,5c,99); }

		 ::hx::widgets::GraphicsPath createPath();
		::Dynamic createPath_dyn();

		void strokePath( ::hx::widgets::GraphicsPath path);
