...
HX_DEFINE_STACK_FRAME(_hx_pos_dbe83e72de68a548_223_new,"haxe.ui.components._TextArea.DataSourceBehaviour","new",0x07568b4f,"haxe.ui.components._TextArea.DataSourceBehaviour.new","haxe/ui/components/TextArea.hx",223,0xfe441d7d)
HX_LOCAL_STACK_FRAME(_hx_pos_dbe83e72de68a548_224_set,"haxe.ui.components._TextArea.DataSourceBehaviour","set",0x075a5691,"haxe.ui.components._TextArea.DataSourceBehaviour.set","haxe/ui/components/TextArea.hx",224,0xfe441d7d)
HX_LOCAL_STACK_FRAME(_hx_pos_dbe83e72de68a548_229_get,"haxe.ui.components._TextArea.DataSourceBehaviour","get",0x07513b85,"haxe.ui.components._TextArea.DataSourceBehaviour.get","haxe/ui/components/TextArea.hx",229,0xfe441d7d)
namespace haxe{
namespace ui{
...
void DataSourceBehaviour_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_dbe83e72de68a548_223_new)
HXDLIN( 223)		super::__construct(component);
            	}
...
void DataSourceBehaviour_obj::set( ::haxe::ui::util::VariantType value){
            	HX_STACKFRAME(&_hx_pos_dbe83e72de68a548_224_set)
HXLINE( 225)		this->_value = value;
HXLINE( 226)		 ::haxe::ui::core::TextInput _hx_tmp = this->_component->getTextInput();
HXDLIN( 226)		_hx_tmp->set_dataSource(::haxe::ui::util::_Variant::Variant_Impl__obj::toDataSource(value));
            	}


 ::haxe::ui::util::VariantType DataSourceBehaviour_obj::get(){
            	HX_GC_STACKFRAME(&_hx_pos_dbe83e72de68a548_229_get)
HXLINE( 230)		bool _hx_tmp;
HXDLIN( 230)		if (::hx::IsNotNull( this->_value )) {
HXLINE( 230)			_hx_tmp = ::haxe::ui::util::_Variant::Variant_Impl__obj::get_isNull(this->_value);
            		}
            		else {
HXLINE( 230)			_hx_tmp = true;
            		}
HXDLIN( 230)		if (_hx_tmp) {
HXLINE( 231)			this->_value = ::haxe::ui::util::_Variant::Variant_Impl__obj::fromDataSource( ::haxe::ui::data::ArrayDataSource_obj::__alloc( HX_CTX ,null()));
HXLINE( 232)			this->set(this->_value);
            		}
HXLINE( 234)		return this->_value;
            	}
