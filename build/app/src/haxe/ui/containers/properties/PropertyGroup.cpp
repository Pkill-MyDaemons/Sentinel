...
HX_DEFINE_STACK_FRAME(_hx_pos_58db070f8cda55a9_21_new,"haxe.ui.containers.properties.PropertyGroup","new",0x478c4e4b,"haxe.ui.containers.properties.PropertyGroup.new","haxe/ui/containers/properties/PropertyGroup.hx",21,0xad7e5fc5)
HX_LOCAL_STACK_FRAME(_hx_pos_c729f952cb4a8f3f_204_registerComposite,"haxe.ui.containers.properties.PropertyGroup","registerComposite",0x17b4c84f,"haxe.ui.containers.properties.PropertyGroup.registerComposite","haxe/ui/macros/Macros.hx",204,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_c729f952cb4a8f3f_550_registerBehaviours,"haxe.ui.containers.properties.PropertyGroup","registerBehaviours",0x29798a4e,"haxe.ui.containers.properties.PropertyGroup.registerBehaviours","haxe/ui/macros/Macros.hx",550,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_397938b558432c5e_700_cloneComponent,"haxe.ui.containers.properties.PropertyGroup","cloneComponent",0x0d5f2d95,"haxe.ui.containers.properties.PropertyGroup.cloneComponent","haxe/ui/macros/helpers/ClassBuilder.hx",700,0x8cdaad7b)
HX_LOCAL_STACK_FRAME(_hx_pos_c729f952cb4a8f3f_521_self,"haxe.ui.containers.properties.PropertyGroup","self",0x56863b41,"haxe.ui.containers.properties.PropertyGroup.self","haxe/ui/macros/Macros.hx",521,0x27866361)
namespace haxe{
namespace ui{
...
void PropertyGroup_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_58db070f8cda55a9_21_new)
...
bool PropertyGroup_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x2eb1d3e1) {
		...
		if (inClassId<=(int)0x551f812b) {
			return inClassId==(int)0x4ba87886 || inClassId==(int)0x551f812b;
		} else {
...
void PropertyGroup_obj::registerComposite(){
            	HX_STACKFRAME(&_hx_pos_c729f952cb4a8f3f_204_registerComposite)
HXLINE( 205)		this->super::registerComposite();
HXLINE( 213)		this->_internalEventsClass = ::hx::ClassOf< ::haxe::ui::containers::properties::_PropertyGroup::Events >();
HXLINE( 217)		this->_compositeBuilderClass = ::hx::ClassOf< ::haxe::ui::containers::properties::_PropertyGroup::Builder >();
            	}


void PropertyGroup_obj::registerBehaviours(){
            	HX_STACKFRAME(&_hx_pos_c729f952cb4a8f3f_550_registerBehaviours)
HXLINE( 551)		this->super::registerBehaviours();
HXLINE( 667)		this->behaviours->_hx_register(HX_("text",ad,cc,f9,4c),::hx::ClassOf< ::haxe::ui::containers::properties::_PropertyGroup::TextBehaviour >(),null());
HXDLIN( 667)		this->behaviours->_hx_register(HX_("disabled",7c,41,04,7c),::hx::ClassOf< ::haxe::ui::containers::properties::_PropertyGroup::DisabledBehaviour >(),null());
            	}


 ::haxe::ui::backend::ComponentBase PropertyGroup_obj::cloneComponent(){
            	HX_STACKFRAME(&_hx_pos_397938b558432c5e_700_cloneComponent)
HXLINE( 469)		 ::haxe::ui::containers::properties::PropertyGroup c = ( ( ::haxe::ui::containers::properties::PropertyGroup)(this->super::cloneComponent()) );
HXLINE( 484)		{
...
HXLINE( 493)		return c;
 ...
 ::haxe::ui::backend::ComponentBase PropertyGroup_obj::self(){
            	HX_GC_STACKFRAME(&_hx_pos_c729f952cb4a8f3f_521_self)
HXDLIN( 521)		return  ::haxe::ui::containers::properties::PropertyGroup_obj::__alloc( HX_CTX );
            	}
