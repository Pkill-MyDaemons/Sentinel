...
HX_DEFINE_STACK_FRAME(_hx_pos_1c969e78c5d09d9f_16_new,"haxe.ui.containers.CalendarView","new",0x428250df,"haxe.ui.containers.CalendarView.new","haxe/ui/containers/CalendarView.hx",16,0x20b6d730)
HX_LOCAL_STACK_FRAME(_hx_pos_38114a4bcde44c07_550_registerBehaviours,"haxe.ui.containers.CalendarView","registerBehaviours",0x7b6d8e3a,"haxe.ui.containers.CalendarView.registerBehaviours","haxe/ui/macros/Macros.hx",550,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_38114a4bcde44c07_597_get_selectedDate,"haxe.ui.containers.CalendarView","get_selectedDate",0x8e5a3ed3,"haxe.ui.containers.CalendarView.get_selectedDate","haxe/ui/macros/Macros.hx",597,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_38114a4bcde44c07_648_set_selectedDate,"haxe.ui.containers.CalendarView","set_selectedDate",0xe49c2c47,"haxe.ui.containers.CalendarView.set_selectedDate","haxe/ui/macros/Macros.hx",648,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_a802d8e4d93101c0_700_cloneComponent,"haxe.ui.containers.CalendarView","cloneComponent",0x2bafcb81,"haxe.ui.containers.CalendarView.cloneComponent","haxe/ui/macros/helpers/ClassBuilder.hx",700,0x8cdaad7b)
HX_LOCAL_STACK_FRAME(_hx_pos_38114a4bcde44c07_521_self,"haxe.ui.containers.CalendarView","self",0xf2d27a2d,"haxe.ui.containers.CalendarView.self","haxe/ui/macros/Macros.hx",521,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_38114a4bcde44c07_204_registerComposite,"haxe.ui.containers.CalendarView","registerComposite",0x2de2a5e3,"haxe.ui.containers.CalendarView.registerComposite","haxe/ui/macros/Macros.hx",204,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_1c969e78c5d09d9f_17_boot,"haxe.ui.containers.CalendarView","boot",0xe79d72d3,"haxe.ui.containers.CalendarView.boot","haxe/ui/containers/CalendarView.hx",17,0x20b6d730)
...
HX_LOCAL_STACK_FRAME(_hx_pos_1c969e78c5d09d9f_19_boot,"haxe.ui.containers.CalendarView","boot",0xe79d72d3,"haxe.ui.containers.CalendarView.boot","haxe/ui/containers/CalendarView.hx",19,0x20b6d730)
namespace haxe{
namespace ui{
namespace containers{

void CalendarView_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_1c969e78c5d09d9f_16_new)
...
bool CalendarView_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x241810fb) {
		...
		if (inClassId<=(int)0x6fddb0ef) {
			return inClassId==(int)0x4ba87886 || inClassId==(int)0x6fddb0ef;
		} else {
...
void CalendarView_obj::registerBehaviours(){
            	HX_STACKFRAME(&_hx_pos_38114a4bcde44c07_550_registerBehaviours)
HXLINE( 551)		this->super::registerBehaviours();
HXLINE( 671)		 ::haxe::ui::behaviours::Behaviours _hx_tmp = this->behaviours;
HXDLIN( 671)		_hx_tmp->_hx_register(HX_("selectedDate",29,76,fd,d2),::hx::ClassOf< ::haxe::ui::containers::_CalendarView::SelectedDateBehaviour >(),::haxe::ui::util::_Variant::Variant_Impl__obj::fromDate(::Date_obj::now()));
            	}


 ::Date CalendarView_obj::get_selectedDate(){
            	HX_STACKFRAME(&_hx_pos_38114a4bcde44c07_597_get_selectedDate)
...
HX_DEFINE_DYNAMIC_FUNC0(CalendarView_obj,get_selectedDate,return )
 ...
 ::Date CalendarView_obj::set_selectedDate( ::Date value){
            	HX_GC_STACKFRAME(&_hx_pos_38114a4bcde44c07_648_set_selectedDate)
...
HX_DEFINE_DYNAMIC_FUNC1(CalendarView_obj,set_selectedDate,return )
 ...
 ::haxe::ui::backend::ComponentBase CalendarView_obj::cloneComponent(){
            	HX_STACKFRAME(&_hx_pos_a802d8e4d93101c0_700_cloneComponent)
HXLINE( 469)		 ::haxe::ui::containers::CalendarView c = ( ( ::haxe::ui::containers::CalendarView)(this->super::cloneComponent()) );
HXLINE( 484)		{
...
HXLINE( 493)		return c;
 ...
 ::haxe::ui::backend::ComponentBase CalendarView_obj::self(){
            	HX_GC_STACKFRAME(&_hx_pos_38114a4bcde44c07_521_self)
HXDLIN( 521)		return  ::haxe::ui::containers::CalendarView_obj::__alloc( HX_CTX );
            	}


void CalendarView_obj::registerComposite(){
            	HX_STACKFRAME(&_hx_pos_38114a4bcde44c07_204_registerComposite)
HXLINE( 205)		this->super::registerComposite();
HXLINE( 213)		this->_internalEventsClass = ::hx::ClassOf< ::haxe::ui::containers::_CalendarView::Events >();
HXLINE( 221)		this->_defaultLayoutClass = ::hx::ClassOf< ::haxe::ui::layouts::VerticalLayout >();
HXLINE( 217)		this->_compositeBuilderClass = ::hx::ClassOf< ::haxe::ui::containers::_CalendarView::Builder >();
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_1c969e78c5d09d9f_17_boot)
HXDLIN(  17)		MONTH_NAMES = ::Array_obj< ::String >::fromData( _hx_array_data_affaf56d_9,12);
            	}
{
            	HX_STACKFRAME(&_hx_pos_1c969e78c5d09d9f_19_boot)
HXDLIN(  19)		DATE_FORMAT = HX_("%Y-%m-%d",ab,02,52,4d);
            	}
}
