...
HX_DEFINE_STACK_FRAME(_hx_pos_23063b15125c1daa_40_new,"haxe.ui.containers.menus._MenuOptionBox.ShortcutTextBehaviour","new",0x42862caa,"haxe.ui.containers.menus._MenuOptionBox.ShortcutTextBehaviour.new","haxe/ui/containers/menus/MenuOptionBox.hx",40,0x896244ad)
HX_LOCAL_STACK_FRAME(_hx_pos_23063b15125c1daa_41_validateData,"haxe.ui.containers.menus._MenuOptionBox.ShortcutTextBehaviour","validateData",0xd68c2056,"haxe.ui.containers.menus._MenuOptionBox.ShortcutTextBehaviour.validateData","haxe/ui/containers/menus/MenuOptionBox.hx",41,0x896244ad)
namespace haxe{
namespace ui{
...
void ShortcutTextBehaviour_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_23063b15125c1daa_40_new)
...
void ShortcutTextBehaviour_obj::validateData(){
            	HX_STACKFRAME(&_hx_pos_23063b15125c1daa_41_validateData)
HXLINE(  42)		 ::haxe::ui::components::Label label = this->_component->findComponent(HX_("menuitem-shortcut-label",a8,00,78,8b),null(),false,null()).StaticCast<  ::haxe::ui::components::Label >();
HXLINE(  43)		if (::hx::IsNotNull( label )) {
HXLINE(  44)			label->set_text(::haxe::ui::util::_Variant::Variant_Impl__obj::toString(this->_value));
            		}
            	}
