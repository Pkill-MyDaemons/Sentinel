...
HX_DEFINE_STACK_FRAME(_hx_pos_2117ebfac4376b79_46_new,"haxe.ui.containers.menus._MenuCheckBox.SelectedBehaviour","new",0x512eef23,"haxe.ui.containers.menus._MenuCheckBox.SelectedBehaviour.new","haxe/ui/containers/menus/MenuCheckBox.hx",46,0x8c3cb656)
HX_LOCAL_STACK_FRAME(_hx_pos_2117ebfac4376b79_47_validateData,"haxe.ui.containers.menus._MenuCheckBox.SelectedBehaviour","validateData",0x04edc6bd,"haxe.ui.containers.menus._MenuCheckBox.SelectedBehaviour.validateData","haxe/ui/containers/menus/MenuCheckBox.hx",47,0x8c3cb656)
HX_LOCAL_STACK_FRAME(_hx_pos_2117ebfac4376b79_59_get,"haxe.ui.containers.menus._MenuCheckBox.SelectedBehaviour","get",0x51299f59,"haxe.ui.containers.menus._MenuCheckBox.SelectedBehaviour.get","haxe/ui/containers/menus/MenuCheckBox.hx",59,0x8c3cb656)
namespace haxe{
namespace ui{
...
void SelectedBehaviour_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_2117ebfac4376b79_46_new)
...
void SelectedBehaviour_obj::validateData(){
            	HX_GC_STACKFRAME(&_hx_pos_2117ebfac4376b79_47_validateData)
HXLINE(  48)		 ::haxe::ui::components::CheckBox checkbox = this->_component->findComponent(null(),::hx::ClassOf< ::haxe::ui::components::CheckBox >(),false,null()).StaticCast<  ::haxe::ui::components::CheckBox >();
HXLINE(  49)		if (::hx::IsNull( checkbox )) {
HXLINE(  50)			checkbox =  ::haxe::ui::components::CheckBox_obj::__alloc( HX_CTX );
HXLINE(  51)			checkbox->set_styleNames(HX_("menuitem-checkbox",fe,2a,b2,34));
HXLINE(  52)			checkbox->set_scriptAccess(false);
HXLINE(  53)			this->_component->addComponent(checkbox);
            		}
HXLINE(  56)		checkbox->set_selected(::haxe::ui::util::_Variant::Variant_Impl__obj::toBool(this->_value));
            	}


 ::haxe::ui::util::VariantType SelectedBehaviour_obj::get(){
            	HX_STACKFRAME(&_hx_pos_2117ebfac4376b79_59_get)
HXLINE(  60)		 ::haxe::ui::components::CheckBox checkbox = this->_component->findComponent(null(),::hx::ClassOf< ::haxe::ui::components::CheckBox >(),false,null()).StaticCast<  ::haxe::ui::components::CheckBox >();
HXLINE(  61)		if (::hx::IsNull( checkbox )) {
HXLINE(  62)			return ::haxe::ui::util::_Variant::Variant_Impl__obj::fromBool(false);
            		}
HXLINE(  64)		return ::haxe::ui::util::_Variant::Variant_Impl__obj::fromBool(checkbox->get_selected());
            	}
