...
HX_DEFINE_STACK_FRAME(_hx_pos_177bb040d49f0b9e_129_new,"haxe.ui.components._CheckBox.SelectedBehaviour","new",0xcf0e0ca2,"haxe.ui.components._CheckBox.SelectedBehaviour.new","haxe/ui/components/CheckBox.hx",129,0xaeb3e5d4)
HX_LOCAL_STACK_FRAME(_hx_pos_177bb040d49f0b9e_152_validateData,"haxe.ui.components._CheckBox.SelectedBehaviour","validateData",0x27b4815e,"haxe.ui.components._CheckBox.SelectedBehaviour.validateData","haxe/ui/components/CheckBox.hx",152,0xaeb3e5d4)
namespace haxe{
namespace ui{
...
void SelectedBehaviour_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_177bb040d49f0b9e_129_new)
...
void SelectedBehaviour_obj::validateData(){
            	HX_GC_STACKFRAME(&_hx_pos_177bb040d49f0b9e_152_validateData)
HXLINE( 153)		 ::haxe::ui::components::CheckBoxValue valueComponent = this->_component->findComponent(null(),::hx::ClassOf< ::haxe::ui::components::CheckBoxValue >(),null(),null()).StaticCast<  ::haxe::ui::components::CheckBoxValue >();
HXLINE( 154)		if (::hx::IsNull( valueComponent )) {
HXLINE( 155)			return;
            		}
HXLINE( 158)		valueComponent->createIcon();
HXLINE( 160)		 ::haxe::ui::util::VariantType _hx_tmp = this->_value;
HXDLIN( 160)		if (::haxe::ui::util::_Variant::Variant_Impl__obj::eq(_hx_tmp,::haxe::ui::util::_Variant::Variant_Impl__obj::fromBool(true))) {
HXLINE( 161)			valueComponent->addClass(HX_(":selected",95,f4,1e,7c),null(),null());
            		}
            		else {
HXLINE( 163)			valueComponent->removeClass(HX_(":selected",95,f4,1e,7c),null(),null());
            		}
HXLINE( 166)		 ::haxe::ui::events::UIEvent event =  ::haxe::ui::events::UIEvent_obj::__alloc( HX_CTX ,::haxe::ui::events::UIEvent_obj::CHANGE,null(),null());
HXLINE( 167)		event->previousValue = this->_previousValue;
HXLINE( 168)		event->value = this->_value;
HXLINE( 169)		this->_component->dispatch(event,null());
            	}
