...
bool ColourDialog_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x467ba226) {
		if (inClassId<=(int)0x3ade267e) {
			...
			return inClassId==(int)0x4322e2f3 || inClassId==(int)0x467ba226;
		}
	} else {
...
{
	outFields->push(HX_("colourData",96,60,3b,95));
	outFields->push(HX_("selectedColour",07,1d,e5,49));
	outFields->push(HX_("colourDialogRef",7f,67,47,18));
	super::__GetFields(outFields);
};

#ifdef HXCPP_SCRIPTABLE
static ::hx::StorageInfo ColourDialog_obj_sMemberStorageInfo[] = {
	{::hx::fsObject /*  ::hx::widgets::ColourData */ ,(int)offsetof(ColourDialog_obj,colourData),HX_("colourData",96,60,3b,95)},
	{::hx::fsInt,(int)offsetof(ColourDialog_obj,selectedColour),HX_("selectedColour",07,1d,e5,49)},
	{::hx::fsUnknown /* ::cpp::Pointer<  wxColourDialog > */ ,(int)offsetof(ColourDialog_obj,colourDialogRef),HX_("colourDialogRef",7f,67,47,18)},
	{ ::hx::fsUnknown, 0, null()}
};
...
static ::String ColourDialog_obj_sMemberFields[] = {
	HX_("colourData",96,60,3b,95),
	HX_("get_colourData",df,e8,30,0b),
	HX_("selectedColour",07,1d,e5,49),
	HX_("get_selectedColour",d0,fd,7e,e5),
	HX_("colourDialogRef",7f,67,47,18),
	HX_("get_colourDialogRef",96,36,52,a3),
	::String(null()) };
...
{
	ColourDialog_obj _hx_dummy;
	ColourDialog_obj::_hx_vtable = *(void **)&_hx_dummy;
	::hx::Static(__mClass) = new ::hx::Class_obj();
	__mClass->mName = HX_("hx.widgets.ColourDialog",11,e4,e6,de);
