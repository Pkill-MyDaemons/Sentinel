...
HX_DEFINE_STACK_FRAME(_hx_pos_5c891aee2311e82d_33_new,"haxe.ui.containers.menus._MenuItem.ShortcutTextBehaviour","new",0x40a0c99b,"haxe.ui.containers.menus._MenuItem.ShortcutTextBehaviour.new","haxe/ui/containers/menus/MenuItem.hx",33,0x19b927e6)
HX_LOCAL_STACK_FRAME(_hx_pos_5c891aee2311e82d_34_validateData,"haxe.ui.containers.menus._MenuItem.ShortcutTextBehaviour","validateData",0xac58dd45,"haxe.ui.containers.menus._MenuItem.ShortcutTextBehaviour.validateData","haxe/ui/containers/menus/MenuItem.hx",34,0x19b927e6)
namespace haxe{
namespace ui{
...
void ShortcutTextBehaviour_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_5c891aee2311e82d_33_new)
HXDLIN(  33)		super::__construct(component);
            	}
...
void ShortcutTextBehaviour_obj::validateData(){
            	HX_STACKFRAME(&_hx_pos_5c891aee2311e82d_34_validateData)
HXLINE(  35)		 ::haxe::ui::components::Label label = this->_component->findComponent(HX_("menuitem-shortcut-label",a8,00,78,8b),null(),true,null()).StaticCast<  ::haxe::ui::components::Label >();
HXLINE(  36)		if (::hx::IsNotNull( label )) {
HXLINE(  37)			label->set_text(::haxe::ui::util::_Variant::Variant_Impl__obj::toString(this->_value));
            		}
            	}
