...
HXLINE( 102)			 ::haxe::ui::events::MenuEvent event =  ::haxe::ui::events::MenuEvent_obj::__alloc( HX_CTX ,::haxe::ui::events::MenuEvent_obj::MENU_SELECTED,null(),null());
HXLINE( 103)			event->menuItem = menuItem;
HXLINE( 104)			c->dispatch(event,null());
            		}
            	}
...
HXLINE( 112)		if ((type == ::haxe::ui::events::MouseEvent_obj::RIGHT_CLICK)) {
...
HXDLIN( 119)		if ((type == ::haxe::ui::events::MouseEvent_obj::RIGHT_CLICK)) {
HXLINE( 121)			if ((this->_hx___eventMap->exists(::haxe::ui::events::MouseEvent_obj::RIGHT_CLICK) == false)) {
HXLINE( 122)				this->_hx___eventMap->set(::haxe::ui::events::MouseEvent_obj::RIGHT_CLICK,listener);
HXLINE( 123)				 ::hx::widgets::Window _hx_tmp = this->get_frame()->get_children()->__get(0).StaticCast<  ::hx::widgets::Window >();
HXDLIN( 123)				_hx_tmp->bind(::haxe::ui::backend::hxwidgets::EventMapper_obj::HAXEUI_TO_WX->get_int(::haxe::ui::events::MouseEvent_obj::RIGHT_CLICK),this->_hx___onMouseEvent_dyn(),null());
            			}
            		}
            	}
...
HXDLIN( 129)		if ((type == ::haxe::ui::events::MouseEvent_obj::RIGHT_CLICK)) {
...
HXDLIN( 132)			_hx_tmp->unbind(::haxe::ui::backend::hxwidgets::EventMapper_obj::HAXEUI_TO_WX->get_int(::haxe::ui::events::MouseEvent_obj::RIGHT_CLICK),this->_hx___onMouseEvent_dyn(),null());
            		}
            	}
