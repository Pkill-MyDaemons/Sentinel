...
HX_DEFINE_STACK_FRAME(_hx_pos_9a3e1f2e5546618e_177_new,"haxe.ui.components._DropDown.SelectedItemBehaviour","new",0x59e78c9d,"haxe.ui.components._DropDown.SelectedItemBehaviour.new","haxe/ui/components/DropDown.hx",177,0x145b8c86)
HX_LOCAL_STACK_FRAME(_hx_pos_9a3e1f2e5546618e_178_validateData,"haxe.ui.components._DropDown.SelectedItemBehaviour","validateData",0x7436aa03,"haxe.ui.components._DropDown.SelectedItemBehaviour.validateData","haxe/ui/components/DropDown.hx",178,0x145b8c86)
HX_LOCAL_STACK_FRAME(_hx_pos_9a3e1f2e5546618e_183_getDynamic,"haxe.ui.components._DropDown.SelectedItemBehaviour","getDynamic",0x81181aec,"haxe.ui.components._DropDown.SelectedItemBehaviour.getDynamic","haxe/ui/components/DropDown.hx",183,0x145b8c86)
HX_LOCAL_STACK_FRAME(_hx_pos_9a3e1f2e5546618e_191_setDynamic,"haxe.ui.components._DropDown.SelectedItemBehaviour","setDynamic",0x8495b960,"haxe.ui.components._DropDown.SelectedItemBehaviour.setDynamic","haxe/ui/components/DropDown.hx",191,0x145b8c86)
namespace haxe{
namespace ui{
...
void SelectedItemBehaviour_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_9a3e1f2e5546618e_177_new)
...
void SelectedItemBehaviour_obj::validateData(){
            	HX_STACKFRAME(&_hx_pos_9a3e1f2e5546618e_178_validateData)
HXLINE( 179)		::Dynamic handler = ::hx::TCast<  ::haxe::ui::components::DropDownBuilder >::cast(this->_component->_compositeBuilder)->get_handler();
HXLINE( 180)		::haxe::ui::components::IDropDownHandler_obj::set_selectedItem(handler,this->_value);
            	}


 ::Dynamic SelectedItemBehaviour_obj::getDynamic(){
            	HX_STACKFRAME(&_hx_pos_9a3e1f2e5546618e_183_getDynamic)
HXLINE( 184)		if ((this->_component->get_isReady() == false)) {
HXLINE( 185)			return this->_value;
            		}
HXLINE( 187)		::Dynamic handler = ::hx::TCast<  ::haxe::ui::components::DropDownBuilder >::cast(this->_component->_compositeBuilder)->get_handler();
HXLINE( 188)		return ::haxe::ui::components::IDropDownHandler_obj::get_selectedItem(handler);
            	}


void SelectedItemBehaviour_obj::setDynamic( ::Dynamic value){
            	HX_STACKFRAME(&_hx_pos_9a3e1f2e5546618e_191_setDynamic)
HXLINE( 192)		if ((this->_component->get_isReady() == false)) {
HXLINE( 193)			this->super::setDynamic(value);
HXLINE( 194)			return;
            		}
HXLINE( 197)		this->_value = value;
HXLINE( 198)		this->invalidateData();
HXLINE( 199)		::Dynamic handler = ::hx::TCast<  ::haxe::ui::components::DropDownBuilder >::cast(this->_component->_compositeBuilder)->get_handler();
HXLINE( 200)		::haxe::ui::components::IDropDownHandler_obj::set_selectedItem(handler,value);
            	}
