...
HX_DEFINE_STACK_FRAME(_hx_pos_51c0c758e7e931c3_486_new,"haxe.ui.components._TextField.Builder","new",0x70429273,"haxe.ui.components._TextField.Builder.new","haxe/ui/components/TextField.hx",486,0x9dfe9498)
HX_LOCAL_STACK_FRAME(_hx_pos_51c0c758e7e931c3_491_applyStyle,"haxe.ui.components._TextField.Builder","applyStyle",0x327b1730,"haxe.ui.components._TextField.Builder.applyStyle","haxe/ui/components/TextField.hx",491,0x9dfe9498)
HX_LOCAL_STACK_FRAME(_hx_pos_51c0c758e7e931c3_505_isHtml,"haxe.ui.components._TextField.Builder","isHtml",0x6342e642,"haxe.ui.components._TextField.Builder.isHtml","haxe/ui/components/TextField.hx",505,0x9dfe9498)
namespace haxe{
namespace ui{
...
void Builder_obj::__construct( ::haxe::ui::components::TextField textfield){
            	HX_STACKFRAME(&_hx_pos_51c0c758e7e931c3_486_new)
HXLINE( 487)		super::__construct(textfield);
HXLINE( 488)		this->_textfield = textfield;
            	}
...
void Builder_obj::applyStyle( ::haxe::ui::styles::Style style){
            	HX_STACKFRAME(&_hx_pos_51c0c758e7e931c3_491_applyStyle)
HXLINE( 492)		if (::hx::IsNotNull( style->icon )) {
HXLINE( 493)			 ::haxe::ui::components::TextField _hx_tmp = this->_textfield;
HXDLIN( 493)			_hx_tmp->set_icon(::haxe::ui::util::_Variant::Variant_Impl__obj::toString(style->icon));
            		}
HXLINE( 495)		if ((this->_textfield->hasTextInput() == true)) {
HXLINE( 496)			this->_textfield->getTextInput()->set_textStyle(style);
HXLINE( 498)			bool _hx_tmp1;
HXDLIN( 498)			bool _hx_tmp2;
HXDLIN( 498)			bool _hx_tmp3;
HXDLIN( 498)			if ((style->contentType != HX_("auto",6f,df,76,40))) {
HXLINE( 498)				_hx_tmp3 = (style->contentType == HX_("html",6b,95,16,45));
            			}
            			else {
HXLINE( 498)				_hx_tmp3 = true;
            			}
HXDLIN( 498)			if (_hx_tmp3) {
HXLINE( 498)				_hx_tmp2 = this->_textfield->getTextInput()->get_supportsHtml();
            			}
            			else {
HXLINE( 498)				_hx_tmp2 = false;
            			}
HXDLIN( 498)			if (_hx_tmp2) {
HXLINE( 498)				::String v = ::Std_obj::string(this->_textfield->get_text());
HXDLIN( 498)				if (::hx::IsNull( v )) {
HXLINE( 498)					_hx_tmp1 = false;
            				}
            				else {
HXLINE( 498)					_hx_tmp1 = (v.indexOf(HX_("<font ",b5,5d,fb,01),null()) != -1);
            				}
            			}
            			else {
HXLINE( 498)				_hx_tmp1 = false;
...
HXLINE( 499)				 ::haxe::ui::components::TextField _hx_tmp4 = this->_textfield;
HXDLIN( 499)				_hx_tmp4->set_htmlText(this->_textfield->get_text());
            			}
            		}
            	}
...
bool Builder_obj::isHtml(::String v){
            	HX_STACKFRAME(&_hx_pos_51c0c758e7e931c3_505_isHtml)
HXDLIN( 505)		if (::hx::IsNull( v )) {
HXDLIN( 505)			return false;
            		}
            		else {
HXDLIN( 505)			return (v.indexOf(HX_("<font ",b5,5d,fb,01),null()) != -1);
            		}
HXDLIN( 505)		return false;
            	}
