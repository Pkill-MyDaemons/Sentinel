...
HX_LOCAL_STACK_FRAME(_hx_pos_f18c7941052c768a_30_getContent,"sys.io.File","getContent",0xb28b4a0e,"sys.io.File.getContent","/opt/homebrew/lib/haxe/std/cpp/_std/sys/io/File.hx",30,0xf7710252)
...
HX_LOCAL_STACK_FRAME(_hx_pos_f18c7941052c768a_38_saveContent,"sys.io.File","saveContent",0xa5557651,"sys.io.File.saveContent","/opt/homebrew/lib/haxe/std/cpp/_std/sys/io/File.hx",38,0xf7710252)
...
HX_LOCAL_STACK_FRAME(_hx_pos_f18c7941052c768a_59_append,"sys.io.File","append",0x02ba1725,"sys.io.File.append","/opt/homebrew/lib/haxe/std/cpp/_std/sys/io/File.hx",59,0xf7710252)
namespace sys{
namespace io{
...
::String File_obj::getContent(::String path){
            	HX_STACKFRAME(&_hx_pos_f18c7941052c768a_30_getContent)
...
void File_obj::saveContent(::String path,::String content){
            	HX_STACKFRAME(&_hx_pos_f18c7941052c768a_38_saveContent)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(File_obj,write,return )
 ...
 ::sys::io::FileOutput File_obj::append(::String path,::hx::Null< bool >  __o_binary){
            		bool binary = __o_binary.Default(true);
            	HX_GC_STACKFRAME(&_hx_pos_f18c7941052c768a_59_append)
