...
HX_DEFINE_STACK_FRAME(_hx_pos_c47a7887b785ba9e_291_new,"haxe.ui.components._TabBar.GetTab","new",0xe908fa88,"haxe.ui.components._TabBar.GetTab.new","haxe/ui/components/TabBar.hx",291,0xaabf3019)
HX_LOCAL_STACK_FRAME(_hx_pos_c47a7887b785ba9e_292_call,"haxe.ui.components._TabBar.GetTab","call",0xf789d176,"haxe.ui.components._TabBar.GetTab.call","haxe/ui/components/TabBar.hx",292,0xaabf3019)
namespace haxe{
namespace ui{
...
void GetTab_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_c47a7887b785ba9e_291_new)
HXDLIN( 291)		super::__construct(component);
            	}
...
bool GetTab_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::haxe::ui::util::VariantType GetTab_obj::call( ::Dynamic param){
            	HX_STACKFRAME(&_hx_pos_c47a7887b785ba9e_292_call)
HXLINE( 293)		 ::haxe::ui::components::_TabBar::Builder builder = ::hx::TCast<  ::haxe::ui::components::_TabBar::Builder >::cast(this->_component->_compositeBuilder);
HXLINE( 294)		int index = ( (int)(param) );
HXLINE( 295)		 ::haxe::ui::core::Component tab = null();
HXLINE( 296)		 ::haxe::ui::containers::HBox _this = builder->_container;
HXDLIN( 296)		::Array< ::Dynamic> _hx_tmp;
HXDLIN( 296)		if (::hx::IsNull( _this->_children )) {
HXLINE( 296)			_hx_tmp = ::Array_obj< ::Dynamic>::__new(0);
            		}
            		else {
HXLINE( 296)			_hx_tmp = _this->_children;
            		}
HXDLIN( 296)		if ((index < _hx_tmp->length)) {
HXLINE( 297)			 ::haxe::ui::containers::HBox _this1 = builder->_container;
HXDLIN( 297)			::Array< ::Dynamic> tab1;
HXDLIN( 297)			if (::hx::IsNull( _this1->_children )) {
HXLINE( 297)				tab1 = ::Array_obj< ::Dynamic>::__new(0);
            			}
            			else {
HXLINE( 297)				tab1 = _this1->_children;
            			}
HXDLIN( 297)			tab = tab1->__get(index).StaticCast<  ::haxe::ui::core::Component >();
            		}
HXLINE( 299)		return ::haxe::ui::util::_Variant::Variant_Impl__obj::fromComponent(tab);
            	}
