...
class HXCPP_CLASS_ATTRIBUTES ItemContainer_obj {
	public:
		...
		static inline void setString( ::Dynamic _hx_,int n,::String string) {
			...
			#endif
			#endif
			(_hx_.mPtr->*( ::hx::interface_cast< ::hx::widgets::ItemContainer_obj *>(_hx_.mPtr->_hx_getInterface(0x112d794f)))->_hx_setString)(n,string);
		}
		...
		static inline ::String getString( ::Dynamic _hx_,int n) {
			...
			#endif
			#endif
			return (_hx_.mPtr->*( ::hx::interface_cast< ::hx::widgets::ItemContainer_obj *>(_hx_.mPtr->_hx_getInterface(0x112d794f)))->_hx_getString)(n);
		}
		...
		static inline int append( ::Dynamic _hx_,::String string) {
			...
			#endif
			#endif
			return (_hx_.mPtr->*( ::hx::interface_cast< ::hx::widgets::ItemContainer_obj *>(_hx_.mPtr->_hx_getInterface(0x112d794f)))->_hx_append)(string);
		}
};
