...
HXLINE(  44)					v4 = ::hx::IsGreater( v,max );
            				}
            				else {
HXLINE(  44)					v4 = false;
            				}
...
HXLINE(  47)		 ::haxe::ui::events::UIEvent event =  ::haxe::ui::events::UIEvent_obj::__alloc( HX_CTX ,::haxe::ui::events::UIEvent_obj::CHANGE,null(),null());
HXLINE(  48)		this->_component->dispatch(event,null());
            	}
