...
class HXCPP_CLASS_ATTRIBUTES ComponentBase_obj : public  ::haxe::ui::backend::ComponentSurface_obj
{
	public:
	...
	public:
		...
		virtual void postCloneComponent( ::haxe::ui::core::Component c);
		...
		virtual void handlePreReposition();
		::Dynamic handlePreReposition_dyn();

		virtual void handlePostReposition();
		...
		virtual void handleDisabled(bool show);
		...
		virtual bool get_isNativeScroller();
