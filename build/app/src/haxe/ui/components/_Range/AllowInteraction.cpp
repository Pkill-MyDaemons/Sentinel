...
HX_DEFINE_STACK_FRAME(_hx_pos_4f21fe1ac88faa51_159_new,"haxe.ui.components._Range.AllowInteraction","new",0x2b135e25,"haxe.ui.components._Range.AllowInteraction.new","haxe/ui/components/Range.hx",159,0x313cba28)
HX_LOCAL_STACK_FRAME(_hx_pos_4f21fe1ac88faa51_161_get,"haxe.ui.components._Range.AllowInteraction","get",0x2b0e0e5b,"haxe.ui.components._Range.AllowInteraction.get","haxe/ui/components/Range.hx",161,0x313cba28)
HX_LOCAL_STACK_FRAME(_hx_pos_4f21fe1ac88faa51_164_set,"haxe.ui.components._Range.AllowInteraction","set",0x2b172967,"haxe.ui.components._Range.AllowInteraction.set","haxe/ui/components/Range.hx",164,0x313cba28)
namespace haxe{
namespace ui{
...
void AllowInteraction_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_4f21fe1ac88faa51_159_new)
...
bool AllowInteraction_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::haxe::ui::util::VariantType AllowInteraction_obj::get(){
            	HX_STACKFRAME(&_hx_pos_4f21fe1ac88faa51_161_get)
HXDLIN( 161)		return ::haxe::ui::util::_Variant::Variant_Impl__obj::fromBool(::hx::IsNotNull( this->_component->_internalEvents ));
            	}


void AllowInteraction_obj::set( ::haxe::ui::util::VariantType value){
            	HX_STACKFRAME(&_hx_pos_4f21fe1ac88faa51_164_set)
HXLINE( 165)		if (::hx::IsEq( this->_component->get_native(),true )) {
HXLINE( 166)			return;
            		}
HXLINE( 169)		if (::haxe::ui::util::_Variant::Variant_Impl__obj::eq(value,::haxe::ui::util::_Variant::Variant_Impl__obj::fromBool(true))) {
HXLINE( 170)			this->_component->registerInternalEvents(::hx::ClassOf< ::haxe::ui::components::_Range::Events >(),null());
            		}
            		else {
HXLINE( 172)			this->_component->unregisterInternalEvents();
            		}
            	}
