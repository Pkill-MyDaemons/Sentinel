...
HXLINE( 169)				 ::haxe::ui::core::Component _this2 = this->_component;
HXDLIN( 169)				::Array< ::Dynamic> item2;
HXDLIN( 169)				if (::hx::IsNull( _this2->_children )) {
HXLINE( 169)					item2 = ::Array_obj< ::Dynamic>::__new(0);
            				}
            				else {
HXLINE( 169)					item2 = _this2->_children;
            				}
HXDLIN( 169)				 ::haxe::ui::core::Component item3 = item2->__get((i + startDay)).StaticCast<  ::haxe::ui::core::Component >();
HXLINE( 170)				item3->addClass(HX_("calendar-day",0d,66,5d,f6),null(),null());
HXLINE( 171)				item3->set_opacity(1);
HXLINE( 172)				item3->set_hidden(false);
HXLINE( 173)				item3->set_text((HX_("",00,00,00,00) + (i + 1)));
...
HXLINE( 175)					item3->addClass(HX_("calendar-day-selected",db,8f,6a,0b),null(),null());
            				}
...
HXDLIN( 183)			 ::haxe::ui::core::Component _this3 = this->_component;
HXDLIN( 183)			::Array< ::Dynamic> _g7;
HXDLIN( 183)			if (::hx::IsNull( _this3->_children )) {
HXLINE( 183)				_g7 = ::Array_obj< ::Dynamic>::__new(0);
            			}
            			else {
HXLINE( 183)				_g7 = _this3->_children;
            			}
HXDLIN( 183)			int _g8 = _g7->length;
HXDLIN( 183)			while((_g6 < _g8)){
HXLINE( 183)				_g6 = (_g6 + 1);
HXDLIN( 183)				int i1 = (_g6 - 1);
HXLINE( 184)				 ::haxe::ui::core::Component _this4 = this->_component;
HXDLIN( 184)				::Array< ::Dynamic> item4;
HXDLIN( 184)				if (::hx::IsNull( _this4->_children )) {
HXLINE( 184)					item4 = ::Array_obj< ::Dynamic>::__new(0);
            				}
            				else {
HXLINE( 184)					item4 = _this4->_children;
            				}
HXDLIN( 184)				 ::haxe::ui::core::Component item5 = item4->__get(i1).StaticCast<  ::haxe::ui::core::Component >();
HXLINE( 185)				item5->addClass(HX_("calendar-off-day",6f,a3,e0,3a),null(),null());
HXLINE( 186)				item5->set_text((HX_("",00,00,00,00) + (n1 + 1)));
HXLINE( 187)				n1 = (n1 + 1);
            			}
            		}
HXLINE( 190)		this->_component->registerInternalEvents(null(),true);
HXLINE( 192)		 ::haxe::ui::core::Component _hx_tmp2 = this->_component;
HXDLIN( 192)		_hx_tmp2->dispatch( ::haxe::ui::components::CalendarEvent_obj::__alloc( HX_CTX ,HX_("datechange",1e,be,d5,14),null(),null()),null());
            	}
