...
class HXCPP_CLASS_ATTRIBUTES GLOptions_obj : public ::hx::Object
{
	...
	public:
		...
		inline static ::hx::ObjectPtr< GLOptions_obj > __new() {
			::hx::ObjectPtr< GLOptions_obj > __this = new GLOptions_obj();
			__this->__construct();
			return __this;
		}

		inline static ::hx::ObjectPtr< GLOptions_obj > __alloc(::hx::Ctx *_hx_ctx) {
		...
		::String __ToString() const { return HX_("GLOptions",b9,5b,3d,29); }
