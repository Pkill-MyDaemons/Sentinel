...
class HXCPP_CLASS_ATTRIBUTES MessageDialog_obj : public  ::hx::widgets::Dialog_obj
{
	...
	public:
		...
		::String __ToString() const { return HX_("MessageDialog",cf,0d,4e,6f); }

		static int messageBox(::String message,::String caption,int style, ::hx::widgets::Window parent);
