...
HXDLIN(  42)		_hx_tmp->dispatch( ::haxe::ui::events::MouseEvent_obj::__alloc( HX_CTX ,::haxe::ui::events::MouseEvent_obj::RIGHT_MOUSE_DOWN),null());
HXLINE(  43)		 ::haxe::ui::containers::TreeView _hx_tmp1 = this->_treeview;
HXDLIN(  43)		_hx_tmp1->dispatch( ::haxe::ui::events::MouseEvent_obj::__alloc( HX_CTX ,::haxe::ui::events::MouseEvent_obj::RIGHT_CLICK),null());
HXLINE(  44)		 ::haxe::ui::containers::TreeView _hx_tmp2 = this->_treeview;
HXDLIN(  44)		_hx_tmp2->dispatch( ::haxe::ui::events::MouseEvent_obj::__alloc( HX_CTX ,::haxe::ui::events::MouseEvent_obj::RIGHT_MOUSE_UP),null());
            	}
