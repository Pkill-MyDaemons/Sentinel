...
HX_DEFINE_STACK_FRAME(_hx_pos_66d2f04623f2b71b_121_new,"haxe.ui.components._DropDown.DataSourceBehaviour","new",0x38df59a6,"haxe.ui.components._DropDown.DataSourceBehaviour.new","haxe/ui/components/DropDown.hx",121,0x145b8c86)
HX_LOCAL_STACK_FRAME(_hx_pos_66d2f04623f2b71b_122_get,"haxe.ui.components._DropDown.DataSourceBehaviour","get",0x38da09dc,"haxe.ui.components._DropDown.DataSourceBehaviour.get","haxe/ui/components/DropDown.hx",122,0x145b8c86)
HX_LOCAL_STACK_FRAME(_hx_pos_66d2f04623f2b71b_130_set,"haxe.ui.components._DropDown.DataSourceBehaviour","set",0x38e324e8,"haxe.ui.components._DropDown.DataSourceBehaviour.set","haxe/ui/components/DropDown.hx",130,0x145b8c86)
namespace haxe{
namespace ui{
...
void DataSourceBehaviour_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_66d2f04623f2b71b_121_new)
HXDLIN( 121)		super::__construct(component);
            	}
...
bool DataSourceBehaviour_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::haxe::ui::util::VariantType DataSourceBehaviour_obj::get(){
            	HX_GC_STACKFRAME(&_hx_pos_66d2f04623f2b71b_122_get)
HXLINE( 123)		bool _hx_tmp;
HXDLIN( 123)		if (::hx::IsNotNull( this->_value )) {
HXLINE( 123)			_hx_tmp = (::haxe::ui::util::_Variant::Variant_Impl__obj::get_isNull(this->_value) == true);
            		}
            		else {
HXLINE( 123)			_hx_tmp = true;
            		}
HXDLIN( 123)		if (_hx_tmp) {
HXLINE( 124)			this->_value = ::haxe::ui::util::_Variant::Variant_Impl__obj::fromDataSource( ::haxe::ui::data::ArrayDataSource_obj::__alloc( HX_CTX ,null()));
            		}
HXLINE( 127)		return this->_value;
            	}


void DataSourceBehaviour_obj::set( ::haxe::ui::util::VariantType value){
            	HX_STACKFRAME(&_hx_pos_66d2f04623f2b71b_130_set)
HXLINE( 131)		this->super::set(value);
HXLINE( 132)		if (::haxe::ui::util::_Variant::Variant_Impl__obj::eq(value,this->_value)) {
HXLINE( 133)			return;
            		}
...
HXLINE( 137)		::haxe::ui::components::IDropDownHandler_obj::reset(handler);
HXLINE( 138)		bool _hx_tmp;
HXDLIN( 138)		if (::hx::IsNull( this->_component->get_text() )) {
HXLINE( 138)			_hx_tmp = this->_component->get_isReady();
            		}
            		else {
HXLINE( 138)			_hx_tmp = false;
            		}
HXDLIN( 138)		if (_hx_tmp) {
HXLINE( 139)			::hx::TCast<  ::haxe::ui::components::DropDown >::cast(this->_component)->set_selectedIndex(0);
            		}
            	}
