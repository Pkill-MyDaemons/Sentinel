...
HX_LOCAL_STACK_FRAME(_hx_pos_cd239fab779fd691_135_set_selectedIndexes,"hx.widgets.ListCtrl","set_selectedIndexes",0xdd96f020,"hx.widgets.ListCtrl.set_selectedIndexes","hx/widgets/ListCtrl.hx",135,0x66570536)
HX_LOCAL_STACK_FRAME(_hx_pos_cd239fab779fd691_146_get_selectedIndex,"hx.widgets.ListCtrl","get_selectedIndex",0xb0bb0f26,"hx.widgets.ListCtrl.get_selectedIndex","hx/widgets/ListCtrl.hx",146,0x66570536)
HX_LOCAL_STACK_FRAME(_hx_pos_cd239fab779fd691_153_set_selectedIndex,"hx.widgets.ListCtrl","set_selectedIndex",0xd428e732,"hx.widgets.ListCtrl.set_selectedIndex","hx/widgets/ListCtrl.hx",153,0x66570536)
HX_LOCAL_STACK_FRAME(_hx_pos_cd239fab779fd691_167_get_listCtrlRef,"hx.widgets.ListCtrl","get_listCtrlRef",0x4d324759,"hx.widgets.ListCtrl.get_listCtrlRef","hx/widgets/ListCtrl.hx",167,0x66570536)
namespace hx{
namespace widgets{
...
HXLINE( 108)		 wxString s = wxString::FromUTF8(heading.utf8_str());
...
::Array< int > ListCtrl_obj::set_selectedIndexes(::Array< int > value){
            	HX_STACKFRAME(&_hx_pos_cd239fab779fd691_135_set_selectedIndexes)
HXLINE( 136)		{
HXLINE( 136)			int _g = 0;
HXDLIN( 136)			::Array< int > _g1 = this->get_selectedIndexes();
HXDLIN( 136)			while((_g < _g1->length)){
HXLINE( 136)				int i = _g1->__get(_g);
HXDLIN( 136)				_g = (_g + 1);
HXLINE( 137)				this->setItemState(i,0,::wx::widgets::ListState_obj::SELECTED);
            			}
            		}
HXLINE( 139)		{
HXLINE( 139)			int _g2 = 0;
HXDLIN( 139)			while((_g2 < value->length)){
HXLINE( 139)				int i1 = value->__get(_g2);
HXDLIN( 139)				_g2 = (_g2 + 1);
HXLINE( 140)				this->setItemState(i1,::wx::widgets::ListState_obj::SELECTED,::wx::widgets::ListState_obj::SELECTED);
            			}
            		}
...
HX_DEFINE_DYNAMIC_FUNC1(ListCtrl_obj,set_selectedIndexes,return )

int ListCtrl_obj::get_selectedIndex(){
            	HX_STACKFRAME(&_hx_pos_cd239fab779fd691_146_get_selectedIndex)
HXLINE( 147)		::Array< int > indexes = this->get_selectedIndexes();
HXLINE( 148)		if ((indexes->length == 0)) {
HXLINE( 149)			return -1;
            		}
HXLINE( 151)		return indexes->__get(0);
            	}
...
int ListCtrl_obj::set_selectedIndex(int value){
            	HX_STACKFRAME(&_hx_pos_cd239fab779fd691_153_set_selectedIndex)
HXLINE( 154)		{
HXLINE( 154)			int _g = 0;
HXDLIN( 154)			::Array< int > _g1 = this->get_selectedIndexes();
HXDLIN( 154)			while((_g < _g1->length)){
HXLINE( 154)				int i = _g1->__get(_g);
HXDLIN( 154)				_g = (_g + 1);
HXLINE( 155)				this->setItemState(i,0,::wx::widgets::ListState_obj::SELECTED);
            			}
            		}
HXLINE( 157)		this->setItemState(value,::wx::widgets::ListState_obj::SELECTED,::wx::widgets::ListState_obj::SELECTED);
...
::cpp::Pointer<  wxListCtrl > ListCtrl_obj::get_listCtrlRef(){
            	HX_STACKFRAME(&_hx_pos_cd239fab779fd691_167_get_listCtrlRef)
HXDLIN( 167)		return this->_ref->reinterpret();
            	}
...
::hx::Val ListCtrl_obj::__Field(const ::String &inName,::hx::PropertyAccess inCallProp)
{
	...
	case 14:
		...
		break;
	case 15:
		if (HX_FIELD_EQ(inName,"selectedIndexes") ) { if (inCallProp == ::hx::paccAlways) return ::hx::Val( get_selectedIndexes() ); }
	...
	case 19:
		...
		if (HX_FIELD_EQ(inName,"set_selectedIndexes") ) { return ::hx::Val( set_selectedIndexes_dyn() ); }
		break;
	case 21:
...
::hx::Val ListCtrl_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 14:
		...
		break;
	case 15:
		if (HX_FIELD_EQ(inName,"selectedIndexes") ) { if (inCallProp == ::hx::paccAlways) return ::hx::Val( set_selectedIndexes(inValue.Cast< ::Array< int > >()) ); }
		break;
	case 17:
...
static ::String ListCtrl_obj_sMemberFields[] = {
	...
	HX_("set_selectedIndexes",08,ed,92,17),
