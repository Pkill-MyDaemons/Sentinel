...
HX_DEFINE_STACK_FRAME(_hx_pos_895b182e86905dba_70_new,"haxe.ui.components._OptionBox.SelectedBehaviour","new",0x6e1cba43,"haxe.ui.components._OptionBox.SelectedBehaviour.new","haxe/ui/components/OptionBox.hx",70,0x8f34a36f)
HX_LOCAL_STACK_FRAME(_hx_pos_895b182e86905dba_71_validateData,"haxe.ui.components._OptionBox.SelectedBehaviour","validateData",0x78bd979d,"haxe.ui.components._OptionBox.SelectedBehaviour.validateData","haxe/ui/components/OptionBox.hx",71,0x8f34a36f)
namespace haxe{
namespace ui{
...
void SelectedBehaviour_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_895b182e86905dba_70_new)
...
void SelectedBehaviour_obj::validateData(){
            	HX_STACKFRAME(&_hx_pos_895b182e86905dba_71_validateData)
HXLINE(  72)		 ::haxe::ui::components::OptionBox optionbox = ::hx::TCast<  ::haxe::ui::components::OptionBox >::cast(this->_component);
HXLINE(  73)		 ::haxe::ui::components::OptionBoxBuilder _hx_tmp = ::hx::TCast<  ::haxe::ui::components::OptionBoxBuilder >::cast(this->_component->_compositeBuilder);
HXDLIN(  73)		_hx_tmp->setSelection(optionbox,::haxe::ui::util::_Variant::Variant_Impl__obj::toBool(this->_value),null());
            	}
