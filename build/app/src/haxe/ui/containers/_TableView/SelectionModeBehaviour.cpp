...
HX_DEFINE_STACK_FRAME(_hx_pos_089aa371adabd435_906_new,"haxe.ui.containers._TableView.SelectionModeBehaviour","new",0xe2b31930,"haxe.ui.containers._TableView.SelectionModeBehaviour.new","haxe/ui/containers/TableView.hx",906,0x8a42a716)
HX_LOCAL_STACK_FRAME(_hx_pos_089aa371adabd435_907_validateData,"haxe.ui.containers._TableView.SelectionModeBehaviour","validateData",0x1e5c7310,"haxe.ui.containers._TableView.SelectionModeBehaviour.validateData","haxe/ui/containers/TableView.hx",907,0x8a42a716)
namespace haxe{
namespace ui{
...
void SelectionModeBehaviour_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_089aa371adabd435_906_new)
HXDLIN( 906)		super::__construct(component);
            	}
...
void SelectionModeBehaviour_obj::validateData(){
            	HX_STACKFRAME(&_hx_pos_089aa371adabd435_907_validateData)
HXLINE( 908)		 ::haxe::ui::containers::TableView tableView = ::hx::TCast<  ::haxe::ui::containers::TableView >::cast(this->_component);
HXLINE( 909)		::Array< int > selectedIndices = tableView->get_selectedIndices();
HXLINE( 910)		if ((selectedIndices->length == 0)) {
HXLINE( 911)			return;
            		}
HXLINE( 914)		::String selectionMode = ( (::String)(this->_value) );
HXLINE( 915)		::String _hx_switch_0 = selectionMode;
            		if (  (_hx_switch_0==HX_("disabled",7c,41,04,7c)) ){
HXLINE( 917)			tableView->set_selectedIndices(null());
HXDLIN( 917)			goto _hx_goto_1;
            		}
            		if (  (_hx_switch_0==HX_("one-item",9a,d3,eb,3b)) ){
HXLINE( 920)			if ((selectedIndices->length > 1)) {
HXLINE( 921)				tableView->set_selectedIndices(::Array_obj< int >::__new(1)->init(0,selectedIndices->__get(0)));
            			}
HXLINE( 920)			goto _hx_goto_1;
            		}
            		/* default */{
            		}
            		_hx_goto_1:;
