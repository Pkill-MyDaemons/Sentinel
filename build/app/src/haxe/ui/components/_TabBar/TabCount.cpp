...
HX_DEFINE_STACK_FRAME(_hx_pos_97fc531117eb456c_250_new,"haxe.ui.components._TabBar.TabCount","new",0xe2d492a3,"haxe.ui.components._TabBar.TabCount.new","haxe/ui/components/TabBar.hx",250,0xaabf3019)
HX_LOCAL_STACK_FRAME(_hx_pos_97fc531117eb456c_251_get,"haxe.ui.components._TabBar.TabCount","get",0xe2cf42d9,"haxe.ui.components._TabBar.TabCount.get","haxe/ui/components/TabBar.hx",251,0xaabf3019)
namespace haxe{
namespace ui{
...
void TabCount_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_97fc531117eb456c_250_new)
HXDLIN( 250)		super::__construct(component);
            	}
...
bool TabCount_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::haxe::ui::util::VariantType TabCount_obj::get(){
            	HX_STACKFRAME(&_hx_pos_97fc531117eb456c_251_get)
HXLINE( 252)		 ::haxe::ui::components::_TabBar::Builder builder = ::hx::TCast<  ::haxe::ui::components::_TabBar::Builder >::cast(this->_component->_compositeBuilder);
HXLINE( 253)		 ::haxe::ui::containers::HBox _this = builder->_container;
HXDLIN( 253)		::Array< ::Dynamic> _hx_tmp;
HXDLIN( 253)		if (::hx::IsNull( _this->_children )) {
HXLINE( 253)			_hx_tmp = ::Array_obj< ::Dynamic>::__new(0);
            		}
            		else {
HXLINE( 253)			_hx_tmp = _this->_children;
            		}
HXDLIN( 253)		return ::haxe::ui::util::_Variant::Variant_Impl__obj::fromInt(_hx_tmp->length);
            	}
