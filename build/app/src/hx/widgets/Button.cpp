...
HXLINE(  16)				 wxString str = wxString::FromUTF8(label.utf8_str());
...
HXLINE(  19)				 wxButton * _hx_tmp4 = this->get_buttonRef()->ptr;
HXDLIN(  19)				(*(_hx_tmp4)).Create(::hx::widgets::Window_obj::toRaw(parent),id);
            			}
            		}
