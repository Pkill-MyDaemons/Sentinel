...
class HXCPP_CLASS_ATTRIBUTES GaugeStyle_obj : public ::hx::Object
{
	...
	public:
		...
		inline static ::hx::ObjectPtr< GaugeStyle_obj > __new() {
			::hx::ObjectPtr< GaugeStyle_obj > __this = new GaugeStyle_obj();
			__this->__construct();
			return __this;
		}

		inline static ::hx::ObjectPtr< GaugeStyle_obj > __alloc(::hx::Ctx *_hx_ctx) {
		...
		::String __ToString() const { return HX_("GaugeStyle",98,7e,a7,9a); }
