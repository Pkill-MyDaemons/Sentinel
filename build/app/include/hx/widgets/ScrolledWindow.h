...
class HXCPP_CLASS_ATTRIBUTES ScrolledWindow_obj : public  ::hx::widgets::Window_obj
{
	...
	public:
		...
		::String __ToString() const { return HX_("ScrolledWindow",dc,32,ff,b2); }
		...
		::Dynamic setScrollRate_dyn();

		void showScrollbars( cpp::Struct<wxScrollbarVisibility, cpp::EnumHandler> horz, cpp::Struct<wxScrollbarVisibility, cpp::EnumHandler> vert);

		void enableScrolling(bool xScrolling,bool yScrolling);
		::Dynamic enableScrolling_dyn();
