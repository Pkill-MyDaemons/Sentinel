...
class HXCPP_CLASS_ATTRIBUTES Brush_obj : public  ::hx::widgets::GDIObject_obj
{
	...
	public:
		...
		::String __ToString() const { return HX_("Brush",5a,c8,25,4c); }
		...
		::Dynamic set_colour_dyn();
		 ...
		 cpp::Struct<wxBrushStyle, cpp::EnumHandler> get_style();

		 cpp::Struct<wxBrushStyle, cpp::EnumHandler> set_style( cpp::Struct<wxBrushStyle, cpp::EnumHandler> value);
