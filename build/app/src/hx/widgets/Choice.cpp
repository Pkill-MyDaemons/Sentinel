...
HXLINE(  21)		 wxString s = wxString::FromUTF8(string.utf8_str());
...
HXLINE(  38)		 wxString s = wxString::FromUTF8(string.utf8_str());
...
HXLINE(  62)		 wxString s = wxString::FromUTF8(value.utf8_str());
