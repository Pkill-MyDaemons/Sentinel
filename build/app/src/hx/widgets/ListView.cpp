...
{
	outFields->push(HX_("listViewRef",30,9f,bc,53));
	super::__GetFields(outFields);
};

#ifdef HXCPP_SCRIPTABLE
static ::hx::StorageInfo ListView_obj_sMemberStorageInfo[] = {
	{::hx::fsUnknown /* ::cpp::Pointer<  wxListView > */ ,(int)offsetof(ListView_obj,listViewRef),HX_("listViewRef",30,9f,bc,53)},
	{ ::hx::fsUnknown, 0, null()}
};
...
static ::String ListView_obj_sMemberFields[] = {
	HX_("getColumnWidth",5a,a2,47,ed),
	HX_("setColumnWidth",ce,8a,67,0d),
	HX_("listViewRef",30,9f,bc,53),
	HX_("get_listViewRef",c7,56,9e,14),
	::String(null()) };
...
void ListView_obj::__register()
{
	...
	__mClass->mName = HX_("hx.widgets.ListView",40,f1,cf,a8);
