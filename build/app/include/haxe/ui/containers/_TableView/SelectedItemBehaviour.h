...
#define INCLUDED_haxe_ui_containers__TableView_SelectedItemBehaviour
...
HX_DECLARE_CLASS4(haxe,ui,containers,_TableView,SelectedItemBehaviour)
...
class HXCPP_CLASS_ATTRIBUTES SelectedItemBehaviour_obj : public  ::haxe::ui::behaviours::Behaviour_obj
{
	public:
	...
	public:
		enum { _hx_ClassId = 0x01eb9e1f };

		void __construct( ::haxe::ui::core::Component component);
		inline void *operator new(size_t inSize, bool inContainer=true,const char *inName="haxe.ui.containers._TableView.SelectedItemBehaviour")
			{ return ::hx::Object::operator new(inSize,inContainer,inName); }
		inline void *operator new(size_t inSize, int extra)
			{ return ::hx::Object::operator new(inSize+extra,true,"haxe.ui.containers._TableView.SelectedItemBehaviour"); }
...
#endif /* INCLUDED_haxe_ui_containers__TableView_SelectedItemBehaviour */ 
