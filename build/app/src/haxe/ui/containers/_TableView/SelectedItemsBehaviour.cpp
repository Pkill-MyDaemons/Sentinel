...
HX_DEFINE_STACK_FRAME(_hx_pos_7aeeb567798c614f_866_new,"haxe.ui.containers._TableView.SelectedItemsBehaviour","new",0x76b5b19a,"haxe.ui.containers._TableView.SelectedItemsBehaviour.new","haxe/ui/containers/TableView.hx",866,0x8a42a716)
HX_LOCAL_STACK_FRAME(_hx_pos_7aeeb567798c614f_867_get,"haxe.ui.containers._TableView.SelectedItemsBehaviour","get",0x76b061d0,"haxe.ui.containers._TableView.SelectedItemsBehaviour.get","haxe/ui/containers/TableView.hx",867,0x8a42a716)
HX_LOCAL_STACK_FRAME(_hx_pos_7aeeb567798c614f_886_set,"haxe.ui.containers._TableView.SelectedItemsBehaviour","set",0x76b97cdc,"haxe.ui.containers._TableView.SelectedItemsBehaviour.set","haxe/ui/containers/TableView.hx",886,0x8a42a716)
namespace haxe{
namespace ui{
...
void SelectedItemsBehaviour_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_7aeeb567798c614f_866_new)
HXDLIN( 866)		super::__construct(component);
            	}
...
bool SelectedItemsBehaviour_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::haxe::ui::util::VariantType SelectedItemsBehaviour_obj::get(){
            	HX_STACKFRAME(&_hx_pos_7aeeb567798c614f_867_get)
HXLINE( 868)		 ::haxe::ui::containers::TableView tableView = ::hx::TCast<  ::haxe::ui::containers::TableView >::cast(this->_component);
HXLINE( 869)		::Array< int > selectedIndices = tableView->get_selectedIndices();
HXLINE( 870)		bool _hx_tmp;
HXDLIN( 870)		if (::hx::IsNotNull( selectedIndices )) {
HXLINE( 870)			_hx_tmp = (selectedIndices->length > 0);
            		}
            		else {
HXLINE( 870)			_hx_tmp = false;
            		}
HXDLIN( 870)		if (_hx_tmp) {
HXLINE( 871)			::cpp::VirtualArray selectedItems = ::cpp::VirtualArray_obj::__new(0);
HXLINE( 872)			{
HXLINE( 872)				int _g = 0;
HXDLIN( 872)				while((_g < selectedIndices->length)){
HXLINE( 872)					int i = selectedIndices->__get(_g);
HXDLIN( 872)					_g = (_g + 1);
HXLINE( 873)					bool _hx_tmp1;
HXDLIN( 873)					if ((i >= 0)) {
HXLINE( 873)						_hx_tmp1 = (i >= tableView->get_dataSource()->get_size());
            					}
            					else {
...
HXLINE( 876)					 ::Dynamic data = tableView->get_dataSource()->get(i);
HXLINE( 877)					selectedItems->push(data);
            				}
            			}
HXLINE( 880)			return ::haxe::ui::util::_Variant::Variant_Impl__obj::fromArray(selectedItems);
            		}
            		else {
HXLINE( 882)			return ::haxe::ui::util::_Variant::Variant_Impl__obj::fromArray(::cpp::VirtualArray_obj::__new(0));
            		}
...
void SelectedItemsBehaviour_obj::set( ::haxe::ui::util::VariantType value){
            	HX_STACKFRAME(&_hx_pos_7aeeb567798c614f_886_set)
HXLINE( 887)		 ::haxe::ui::containers::TableView tableView = ::hx::TCast<  ::haxe::ui::containers::TableView >::cast(this->_component);
HXLINE( 888)		::cpp::VirtualArray selectedItems = ::haxe::ui::util::_Variant::Variant_Impl__obj::toArray(value);
HXLINE( 889)		bool _hx_tmp;
HXDLIN( 889)		if (::hx::IsNotNull( selectedItems )) {
HXLINE( 889)			_hx_tmp = (selectedItems->get_length() > 0);
            		}
            		else {
HXLINE( 889)			_hx_tmp = false;
            		}
HXDLIN( 889)		if (_hx_tmp) {
HXLINE( 890)			::Array< int > selectedIndices = ::Array_obj< int >::__new(0);
HXLINE( 891)			int index;
HXLINE( 892)			{
HXLINE( 892)				int _g = 0;
HXDLIN( 892)				while((_g < selectedItems->get_length())){
HXLINE( 892)					 ::Dynamic item = selectedItems->__get(_g);
HXDLIN( 892)					_g = (_g + 1);
HXLINE( 893)					index = tableView->get_dataSource()->indexOf(item);
HXDLIN( 893)					if ((index != -1)) {
HXLINE( 894)						selectedIndices->push(index);
            					}
            				}
            			}
HXLINE( 898)			tableView->set_selectedIndices(selectedIndices);
            		}
            		else {
HXLINE( 900)			tableView->set_selectedIndices(::Array_obj< int >::__new(0));
            		}
            	}
