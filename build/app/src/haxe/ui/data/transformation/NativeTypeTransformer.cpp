...
bool NativeTypeTransformer_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x762393ab;
}
...
HXLINE(   9)		if (::Std_obj::isOfType(i,::hx::ClassOf< ::String >())) {
...
HXDLIN(  11)			if (!(::Std_obj::isOfType(i,::hx::ClassOf< int >()))) {
HXLINE(  11)				_hx_tmp1 = ::Std_obj::isOfType(i,::hx::ClassOf< ::Float >());
            			}
            			else {
HXLINE(  11)				_hx_tmp1 = true;
            			}
HXDLIN(  11)			if (!(_hx_tmp1)) {
HXLINE(  11)				_hx_tmp = ::Std_obj::isOfType(i,::hx::ClassOf< bool >());
            			}
            			else {
