...
class HXCPP_CLASS_ATTRIBUTES DirDialogStyle_obj : public ::hx::Object
{
	...
	public:
		...
		inline static ::hx::ObjectPtr< DirDialogStyle_obj > __new() {
			::hx::ObjectPtr< DirDialogStyle_obj > __this = new DirDialogStyle_obj();
			__this->__construct();
			return __this;
		}

		inline static ::hx::ObjectPtr< DirDialogStyle_obj > __alloc(::hx::Ctx *_hx_ctx) {
		...
		::String __ToString() const { return HX_("DirDialogStyle",1c,c3,78,0f); }
