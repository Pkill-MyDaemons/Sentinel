...
HX_DEFINE_STACK_FRAME(_hx_pos_5e285d1fa7882a5e_306_new,"haxe.ui.components._TabBar.ButtonWidth","new",0xcaa41f8f,"haxe.ui.components._TabBar.ButtonWidth.new","haxe/ui/components/TabBar.hx",306,0xaabf3019)
HX_LOCAL_STACK_FRAME(_hx_pos_5e285d1fa7882a5e_307_validateData,"haxe.ui.components._TabBar.ButtonWidth","validateData",0x4abd28d1,"haxe.ui.components._TabBar.ButtonWidth.validateData","haxe/ui/components/TabBar.hx",307,0xaabf3019)
namespace haxe{
namespace ui{
...
void ButtonWidth_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_5e285d1fa7882a5e_306_new)
...
void ButtonWidth_obj::validateData(){
            	HX_STACKFRAME(&_hx_pos_5e285d1fa7882a5e_307_validateData)
HXLINE( 308)		bool _hx_tmp;
HXDLIN( 308)		if (::hx::IsNotNull( this->_value )) {
HXLINE( 308)			_hx_tmp = ::haxe::ui::util::_Variant::Variant_Impl__obj::get_isNull(this->_value);
            		}
            		else {
...
HXLINE( 311)		{
HXLINE( 311)			int _g = 0;
HXDLIN( 311)			::Array< ::Dynamic> _g1 = this->_component->findComponents(null(),::hx::ClassOf< ::haxe::ui::components::Button >(),null());
HXDLIN( 311)			while((_g < _g1->length)){
HXLINE( 311)				 ::haxe::ui::components::Button b = _g1->__get(_g).StaticCast<  ::haxe::ui::components::Button >();
HXDLIN( 311)				_g = (_g + 1);
HXLINE( 312)				b->set_width(::haxe::ui::util::_Variant::Variant_Impl__obj::toFloat(this->_value));
            			}
            		}
            	}
