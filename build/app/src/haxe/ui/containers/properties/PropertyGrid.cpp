...
HX_LOCAL_STACK_FRAME(_hx_pos_19d410d7a2baa776_204_registerComposite,"haxe.ui.containers.properties.PropertyGrid","registerComposite",0xe94b4aa2,"haxe.ui.containers.properties.PropertyGrid.registerComposite","haxe/ui/macros/Macros.hx",204,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_19d410d7a2baa776_550_registerBehaviours,"haxe.ui.containers.properties.PropertyGrid","registerBehaviours",0xbb95109b,"haxe.ui.containers.properties.PropertyGrid.registerBehaviours","haxe/ui/macros/Macros.hx",550,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_19d410d7a2baa776_597_get_popupStyleNames,"haxe.ui.containers.properties.PropertyGrid","get_popupStyleNames",0xe204f638,"haxe.ui.containers.properties.PropertyGrid.get_popupStyleNames","haxe/ui/macros/Macros.hx",597,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_19d410d7a2baa776_630_set_popupStyleNames,"haxe.ui.containers.properties.PropertyGrid","set_popupStyleNames",0x1ea1e944,"haxe.ui.containers.properties.PropertyGrid.set_popupStyleNames","haxe/ui/macros/Macros.hx",630,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_8067355f8c7edd2a_700_cloneComponent,"haxe.ui.containers.properties.PropertyGrid","cloneComponent",0xda2c4962,"haxe.ui.containers.properties.PropertyGrid.cloneComponent","haxe/ui/macros/helpers/ClassBuilder.hx",700,0x8cdaad7b)
HX_LOCAL_STACK_FRAME(_hx_pos_19d410d7a2baa776_521_self,"haxe.ui.containers.properties.PropertyGrid","self",0xaf1d04ce,"haxe.ui.containers.properties.PropertyGrid.self","haxe/ui/macros/Macros.hx",521,0x27866361)
namespace haxe{
namespace ui{
...
void PropertyGrid_obj::registerComposite(){
            	HX_STACKFRAME(&_hx_pos_19d410d7a2baa776_204_registerComposite)
HXLINE( 205)		this->super::registerComposite();
HXLINE( 213)		this->_internalEventsClass = ::hx::ClassOf< ::haxe::ui::containers::properties::_PropertyGrid::Events >();
HXLINE( 217)		this->_compositeBuilderClass = ::hx::ClassOf< ::haxe::ui::containers::properties::_PropertyGrid::Builder >();
            	}


void PropertyGrid_obj::registerBehaviours(){
            	HX_STACKFRAME(&_hx_pos_19d410d7a2baa776_550_registerBehaviours)
HXLINE( 551)		this->super::registerBehaviours();
HXLINE( 667)		this->behaviours->_hx_register(HX_("popupStyleNames",23,e6,6b,96),::hx::ClassOf< ::haxe::ui::behaviours::DefaultBehaviour >(),null());
            	}


::String PropertyGrid_obj::get_popupStyleNames(){
            	HX_STACKFRAME(&_hx_pos_19d410d7a2baa776_597_get_popupStyleNames)
HXLINE( 598)		if (::hx::IsNull( this->behaviours )) {
HXLINE( 599)			return null();
            		}
HXLINE( 601)		return ::haxe::ui::util::_Variant::Variant_Impl__obj::toString(this->behaviours->get(HX_("popupStyleNames",23,e6,6b,96)));
            	}
...
::String PropertyGrid_obj::set_popupStyleNames(::String value){
            	HX_GC_STACKFRAME(&_hx_pos_19d410d7a2baa776_630_set_popupStyleNames)
HXLINE( 631)		{
...
HXLINE( 634)						::haxe::ui::locale::LocaleManager_obj::get_instance()->registerComponent(( ( ::haxe::ui::core::Component)(::hx::ObjectPtr<OBJ_>(this)) ),HX_("popupStyleNames",23,e6,6b,96),null(),value,null());
...
HXDLIN( 643)		_hx_tmp2->set(HX_("popupStyleNames",23,e6,6b,96),::haxe::ui::util::_Variant::Variant_Impl__obj::fromString(value));
HXLINE( 644)		this->dispatch( ::haxe::ui::events::UIEvent_obj::__alloc( HX_CTX ,::haxe::ui::events::UIEvent_obj::PROPERTY_CHANGE,null(),HX_("popupStyleNames",23,e6,6b,96)),null());
...
HX_DEFINE_DYNAMIC_FUNC1(PropertyGrid_obj,set_popupStyleNames,return )
 ...
 ::haxe::ui::backend::ComponentBase PropertyGrid_obj::cloneComponent(){
            	HX_STACKFRAME(&_hx_pos_8067355f8c7edd2a_700_cloneComponent)
HXLINE( 469)		 ::haxe::ui::containers::properties::PropertyGrid c = ( ( ::haxe::ui::containers::properties::PropertyGrid)(this->super::cloneComponent()) );
HXLINE( 484)		{
...
HXLINE( 493)		return c;
 ...
 ::haxe::ui::backend::ComponentBase PropertyGrid_obj::self(){
            	HX_GC_STACKFRAME(&_hx_pos_19d410d7a2baa776_521_self)
HXDLIN( 521)		return  ::haxe::ui::containers::properties::PropertyGrid_obj::__alloc( HX_CTX );
            	}
