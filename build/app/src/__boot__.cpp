...
::hx::widgets::_GraphicsPath::GraphicPathCalls_obj::__register();
...
::wx::widgets::styles::WindowStyle_obj::__register();
::wx::widgets::styles::TreeCtrlStyle_obj::__register();
::wx::widgets::styles::TextCtrlStyle_obj::__register();
::wx::widgets::styles::StyledTextControlStyle_obj::__register();
::wx::widgets::styles::StaticTextStyle_obj::__register();
::wx::widgets::styles::StaticLineStyle_obj::__register();
::wx::widgets::styles::SliderStyle_obj::__register();
::wx::widgets::styles::ScrollBarStyle_obj::__register();
::wx::widgets::styles::RadioButtonStyle_obj::__register();
::wx::widgets::styles::PropertyGridStyles_obj::__register();
::wx::widgets::styles::PropertyGridAttributes_obj::__register();
::wx::widgets::styles::NotebookStyle_obj::__register();
::wx::widgets::styles::MessageDialogStyle_obj::__register();
::wx::widgets::styles::ListCtrlStyle_obj::__register();
::wx::widgets::styles::HyperlinkCtrlStyle_obj::__register();
::wx::widgets::styles::GaugeStyle_obj::__register();
::wx::widgets::styles::FrameStyle_obj::__register();
::wx::widgets::styles::FileDialogStyle_obj::__register();
::wx::widgets::styles::DirDialogStyle_obj::__register();
::wx::widgets::styles::DialogStyle_obj::__register();
::wx::widgets::styles::DataViewCtrlStyle_obj::__register();
::wx::widgets::styles::ComboBoxStyle_obj::__register();
::wx::widgets::styles::CalendarCtrlStyle_obj::__register();
::wx::widgets::styles::ButtonStyle_obj::__register();
::wx::widgets::StandardId_obj::__register();
::wx::widgets::_SizerFlag::SizerFlag_Impl__obj::__register();
::wx::widgets::ProcessFlag_obj::__register();
::wx::widgets::ListState_obj::__register();
::wx::widgets::GLOptions_obj::__register();
::wx::widgets::_FontWeight::FontWeight_Impl__obj::__register();
::wx::widgets::_FontStyle::FontStyle_Impl__obj::__register();
::wx::widgets::_FontFamily::FontFamily_Impl__obj::__register();
::wx::widgets::ExecFlags_obj::__register();
::wx::widgets::Defs_obj::__register();
::wx::widgets::Alignment_obj::__register();
...
::sentinel::app::AlertsView_obj::__register();
::hx::widgets::StockBrushes_obj::__register();
::wx::widgets::StockBrushes_obj::__register();
::hx::widgets::FontEnumerator_obj::__register();
::hx::widgets::DataViewTreeCtrl_obj::__register();
...
::haxe::ui::styles::DirectiveHandler_obj::__register();
::haxe::ui::styles::CssFunctions_obj::__register();
::haxe::ui::styles::CssFilters_obj::__register();
::haxe::ui::locale::LocaleManager_obj::__register();
::haxe::ui::locale::LocaleEvent_obj::__register();
::haxe::ui::locale::Formats_obj::__register();
::haxe::ui::layouts::LayoutFactory_obj::__register();
::haxe::ui::filters::Tint_obj::__register();
::haxe::ui::filters::Saturate_obj::__register();
::haxe::ui::filters::Outline_obj::__register();
::haxe::ui::filters::HueRotate_obj::__register();
::haxe::ui::filters::Grayscale_obj::__register();
::haxe::ui::filters::DropShadow_obj::__register();
::haxe::ui::filters::Contrast_obj::__register();
::haxe::ui::filters::BoxShadow_obj::__register();
::haxe::ui::filters::Blur_obj::__register();
::haxe::ui::events::ValidationEvent_obj::__register();
::haxe::ui::events::ThemeEvent_obj::__register();
::haxe::ui::events::SortEvent_obj::__register();
::haxe::ui::events::ScrollEvent_obj::__register();
::haxe::ui::events::MenuEvent_obj::__register();
::haxe::ui::events::ItemRendererEvent_obj::__register();
::haxe::ui::events::ItemEvent_obj::__register();
::haxe::ui::events::DragEvent_obj::__register();
::haxe::ui::events::AppEvent_obj::__register();
...
::haxe::ui::backend::hxwidgets::creators::MenuItemCreator_obj::__register();
::haxe::ui::backend::hxwidgets::TreeViewIcons_obj::__register();
::haxe::ui::backend::hxwidgets::TableViewIcons_obj::__register();
::haxe::ui::backend::hxwidgets::TabViewIcons_obj::__register();
::haxe::ui::backend::hxwidgets::MenuItemHelper_obj::__register();
::haxe::ui::backend::hxwidgets::ListViewIcons_obj::__register();
::haxe::ui::backend::hxwidgets::EventMapper_obj::__register();
::haxe::ui::events::FocusEvent_obj::__register();
::wx::widgets::EventType_obj::__register();
...
::wx::widgets::styles::LexicalStates_obj::__register();
::wx::widgets::StyledTextCtrlLexer_obj::__register();
::wx::widgets::StyledTextCtrlEventType_obj::__register();
::wx::widgets::MouseState_obj::__register();
::wx::widgets::Entry_obj::__register();
...
::sentinel::app::SentinelApp_obj::__register();
::sentinel::app::ConfigView_obj::__register();
::hx::widgets::WebView_obj::__register();
::hx::widgets::TreeItemId_obj::__register();
::hx::widgets::TreeCtrl_obj::__register();
::hx::widgets::ToggleButton_obj::__register();
::hx::widgets::TimerEvent_obj::__register();
::hx::widgets::Timer_obj::__register();
::hx::widgets::ThreadEvent_obj::__register();
::hx::widgets::TextInputStream_obj::__register();
::hx::widgets::TextDataObject_obj::__register();
::hx::widgets::TaskBarIcon_obj::__register();
::hx::widgets::SystemSettings_obj::__register();
::hx::widgets::SystemOptions_obj::__register();
::hx::widgets::StyledTextCtrl_obj::__register();
::hx::widgets::StringToStringHashMap_obj::__register();
::hx::widgets::StringProperty_obj::__register();
::hx::widgets::StringInputStream_obj::__register();
::hx::widgets::StdDialogButtonSizer_obj::__register();
::hx::widgets::StaticLine_obj::__register();
::hx::widgets::StaticBoxSizer_obj::__register();
::hx::widgets::StaticBox_obj::__register();
::hx::widgets::StandardPaths_obj::__register();
::hx::widgets::SpinCtrlDouble_obj::__register();
::hx::widgets::SpinCtrl_obj::__register();
::hx::widgets::Slider_obj::__register();
::hx::widgets::SizerItem_obj::__register();
::hx::widgets::Size_obj::__register();
::hx::widgets::SingleChoiceDialog_obj::__register();
::hx::widgets::SearchCtrl_obj::__register();
::hx::widgets::TextCtrl_obj::__register();
::hx::widgets::TextEntry_obj::__register();
::hx::widgets::ScrollBar_obj::__register();
::hx::widgets::Rect_obj::__register();
::hx::widgets::RadioButton_obj::__register();
::hx::widgets::PropertyGridEvent_obj::__register();
::hx::widgets::PropertyGrid_obj::__register();
::hx::widgets::PropertyCategory_obj::__register();
::hx::widgets::Process_obj::__register();
::hx::widgets::Point_obj::__register();
::hx::widgets::PlatformInfo_obj::__register();
::hx::widgets::Pen_obj::__register();
::hx::widgets::PasswordEntryDialog_obj::__register();
::hx::widgets::TextEntryDialog_obj::__register();
::hx::widgets::PaintDC_obj::__register();
::hx::widgets::PGChoices_obj::__register();
::hx::widgets::NotifyEvent_obj::__register();
::hx::widgets::Notebook_obj::__register();
::hx::widgets::MultiChoiceDialog_obj::__register();
::hx::widgets::MouseEvent_obj::__register();
::hx::widgets::MouseState_obj::__register();
::hx::widgets::MessageDialog_obj::__register();
::hx::widgets::MenuItem_obj::__register();
::hx::widgets::MenuBar_obj::__register();
::hx::widgets::Menu_obj::__register();
::hx::widgets::MemoryInputStream_obj::__register();
::hx::widgets::Locale_obj::__register();
::hx::widgets::ListItem_obj::__register();
::hx::widgets::IntegerValidator_obj::__register();
::hx::widgets::Validator_obj::__register();
::hx::widgets::IntProperty_obj::__register();
::hx::widgets::InputStream_obj::__register();
::hx::widgets::StreamBase_obj::__register();
::hx::widgets::ImageList_obj::__register();
::hx::widgets::Image_obj::__register();
::hx::widgets::ImageData_obj::__register();
::hx::widgets::IdleEvent_obj::__register();
::hx::widgets::Icon_obj::__register();
::hx::widgets::HyperlinkCtrl_obj::__register();
::hx::widgets::HardBreakWrapper_obj::__register();
::hx::widgets::GridSizer_obj::__register();
::hx::widgets::Grid_obj::__register();
::hx::widgets::ScrolledWindow_obj::__register();
::hx::widgets::GraphicsPath_obj::__register();
::hx::widgets::GraphicsContext_obj::__register();
::hx::widgets::GraphicsObject_obj::__register();
::hx::widgets::Globals_obj::__register();
::hx::widgets::Gauge_obj::__register();
::hx::widgets::GLContext_obj::__register();
::hx::widgets::GLCanvas_obj::__register();
::hx::widgets::GCDC_obj::__register();
::hx::widgets::Frame_obj::__register();
::hx::widgets::FontDialog_obj::__register();
::hx::widgets::Font_obj::__register();
::hx::widgets::FileDialog_obj::__register();
::hx::widgets::EnumProperty_obj::__register();
::hx::widgets::DropFilesEvent_obj::__register();
::hx::widgets::DirDialog_obj::__register();
::hx::widgets::DataViewToggleRenderer_obj::__register();
::hx::widgets::DataViewTextRenderer_obj::__register();
::hx::widgets::DataViewSpinRenderer_obj::__register();
::hx::widgets::DataViewProgressRenderer_obj::__register();
::hx::widgets::DataViewListCtrl_obj::__register();
::hx::widgets::DataViewItem_obj::__register();
::hx::widgets::DataViewEvent_obj::__register();
::hx::widgets::DataViewCustomRenderer_obj::__register();
::hx::widgets::DataViewCtrl_obj::__register();
::hx::widgets::DataViewColumn_obj::__register();
::hx::widgets::SettableHeaderColumn_obj::__register();
::hx::widgets::HeaderColumn_obj::__register();
::hx::widgets::DataViewBitmapRenderer_obj::__register();
::hx::widgets::DataViewRenderer_obj::__register();
::hx::widgets::DataObjectSimple_obj::__register();
::hx::widgets::DataObject_obj::__register();
::hx::widgets::ComboBox_obj::__register();
::hx::widgets::ColourDialog_obj::__register();
::hx::widgets::Dialog_obj::__register();
::hx::widgets::TopLevelWindow_obj::__register();
::hx::widgets::NonOwnedWindow_obj::__register();
::hx::widgets::ColourData_obj::__register();
::hx::widgets::Colour_obj::__register();
::hx::widgets::CloseEvent_obj::__register();
::hx::widgets::Event_obj::__register();
::hx::widgets::Clipboard_obj::__register();
::hx::widgets::ClientDC_obj::__register();
::hx::widgets::WindowDC_obj::__register();
::hx::widgets::ClassInfo_obj::__register();
::hx::widgets::Choice_obj::__register();
::hx::widgets::ItemContainer_obj::__register();
::hx::widgets::ItemContainerImmutable_obj::__register();
::hx::widgets::CheckBox_obj::__register();
::hx::widgets::CalendarCtrl_obj::__register();
::hx::widgets::Button_obj::__register();
::hx::widgets::BufferedPaintDC_obj::__register();
::hx::widgets::BufferedDC_obj::__register();
::hx::widgets::MemoryDC_obj::__register();
::hx::widgets::DC_obj::__register();
::hx::widgets::Brush_obj::__register();
::hx::widgets::BoxSizer_obj::__register();
::hx::widgets::Sizer_obj::__register();
::hx::widgets::BoolProperty_obj::__register();
::hx::widgets::PGProperty_obj::__register();
::hx::widgets::BookCtrlBase_obj::__register();
::hx::widgets::WithImages_obj::__register();
::hx::widgets::BitmapBundle_obj::__register();
::hx::widgets::Bitmap_obj::__register();
::hx::widgets::GDIObject_obj::__register();
::hx::widgets::ArrayString_obj::__register();
::hx::widgets::AppTraits_obj::__register();
::hx::widgets::App_obj::__register();
::hx::widgets::AppConsole_obj::__register();
::hx::widgets::EventFilter_obj::__register();
::hx::widgets::AnyButton_obj::__register();
::haxe::ui::validators::_Validators::ValidatorsIterator_obj::__register();
::haxe::ui::validators::_Validators::ValidatorsImpl_obj::__register();
::haxe::ui::validators::_Validators::Validators_Impl__obj::__register();
...
::haxe::ui::util::RGBF_obj::__register();
::haxe::ui::util::HSV_obj::__register();
::haxe::ui::util::HSL_obj::__register();
...
::haxe::ui::containers::properties::_PropertyGroup::DisabledBehaviour_obj::__register();
...
::haxe::ui::containers::menus::_MenuSeparator::Layout_obj::__register();
::haxe::ui::containers::menus::_MenuSeparator::Builder_obj::__register();
::haxe::ui::containers::menus::MenuSeparator_obj::__register();
::haxe::ui::containers::menus::_MenuOptionBox::Builder_obj::__register();
::haxe::ui::containers::menus::_MenuOptionBox::SelectedOptionBehaviour_obj::__register();
...
::haxe::ui::containers::menus::_MenuItem::Layout_obj::__register();
...
::haxe::ui::containers::menus::_Menu::Layout_obj::__register();
::haxe::ui::layouts::VerticalLayout_obj::__register();
::haxe::ui::containers::menus::_Menu::Builder_obj::__register();
::haxe::ui::containers::menus::_Menu::CurrentItemBehaviour_obj::__register();
::haxe::ui::containers::menus::_Menu::CurrentIndexBehaviour_obj::__register();
::haxe::ui::containers::menus::Menu_obj::__register();
::haxe::ui::containers::dialogs::Dialog_obj::__register();
::haxe::ui::containers::_TreeViewNode::TreeViewNodeBuilder_obj::__register();
::haxe::ui::containers::_TreeViewNode::TreeViewNodeEvents_obj::__register();
::haxe::ui::containers::_TreeViewNode::GetNodesInternal_obj::__register();
::haxe::ui::containers::_TreeViewNode::Expanded_obj::__register();
::haxe::ui::containers::_TreeViewNode::ClearNodes_obj::__register();
::haxe::ui::containers::_TreeViewNode::RemoveNode_obj::__register();
::haxe::ui::containers::_TreeViewNode::AddNode_obj::__register();
::haxe::ui::containers::_TreeView::TreeViewBuilder_obj::__register();
::haxe::ui::containers::_TreeView::TreeViewEvents_obj::__register();
::haxe::ui::containers::_TreeView::GetNodesInternal_obj::__register();
::haxe::ui::containers::_TreeView::SelectedNode_obj::__register();
::haxe::ui::containers::_TreeView::ClearNodes_obj::__register();
::haxe::ui::containers::_TreeView::RemoveNode_obj::__register();
::haxe::ui::containers::_TreeView::AddNode_obj::__register();
::haxe::ui::containers::TreeView_obj::__register();
::haxe::ui::containers::_TableView::RemoveColumn_obj::__register();
::haxe::ui::containers::_TableView::AddColumn_obj::__register();
::haxe::ui::containers::_TableView::ClearTable_obj::__register();
::haxe::ui::containers::_TableView::GetHeader_obj::__register();
...
::haxe::ui::containers::_TabView::ButtonHeight_obj::__register();
::haxe::ui::containers::_TabView::ButtonWidth_obj::__register();
::haxe::ui::containers::_TabView::RemoveAllPages_obj::__register();
::haxe::ui::containers::_TabView::GetPageById_obj::__register();
::haxe::ui::containers::_TabView::GetPage_obj::__register();
...
::haxe::ui::containers::_ScrollView::IsScrollableBehaviour_obj::__register();
::haxe::ui::containers::_ScrollView::IsScrollableVerticallyBehaviour_obj::__register();
::haxe::ui::containers::_ScrollView::IsScrollableHorizontallyBehaviour_obj::__register();
...
::haxe::ui::core::IScroller_obj::__register();
::haxe::ui::containers::IVirtualContainer_obj::__register();
::haxe::ui::containers::_Header::Layout_obj::__register();
::haxe::ui::containers::_Header::Builder_obj::__register();
...
::haxe::ui::containers::_Box::DataSourceBehaviour_obj::__register();
::haxe::ui::containers::_Box::Builder_obj::__register();
...
::haxe::ui::components::_TextField::SelectionEndIndexBehaviour_obj::__register();
::haxe::ui::components::_TextField::SelectionStartIndexBehaviour_obj::__register();
::haxe::ui::components::_TextField::CaretIndexBehaviour_obj::__register();
::haxe::ui::components::_TextField::IconBehaviour_obj::__register();
::haxe::ui::components::_TextField::HtmlTextBehaviour_obj::__register();
...
::haxe::ui::components::_TextArea::IconBehaviour_obj::__register();
...
::haxe::ui::components::_TextArea::HtmlTextBehaviour_obj::__register();
...
::haxe::ui::components::_TabBar::ButtonHeight_obj::__register();
::haxe::ui::components::_TabBar::ButtonWidth_obj::__register();
::haxe::ui::components::_TabBar::GetTab_obj::__register();
...
::haxe::ui::components::TabBarLayout_obj::__register();
...
::haxe::ui::components::_Slider::MajorTicks_obj::__register();
::haxe::ui::components::_Slider::MinorTicks_obj::__register();
::haxe::ui::components::_Slider::CenterBehaviour_obj::__register();
...
::haxe::ui::components::ProgressBuilder_obj::__register();
...
::haxe::ui::components::_OptionBox::ResetGroup_obj::__register();
...
::haxe::ui::components::_NumberStepper::ValueHelper_obj::__register();
::haxe::ui::components::_NumberStepper::ClassicLayout_obj::__register();
::haxe::ui::components::_NumberStepper::StandardLayout_obj::__register();
::haxe::ui::components::_NumberStepper::Events_obj::__register();
::haxe::ui::components::_NumberStepper::Builder_obj::__register();
::haxe::ui::components::_NumberStepper::DecimalSeparatorBehaviour_obj::__register();
...
::haxe::ui::components::_Label::SelectableBehaviour_obj::__register();
...
::haxe::ui::components::_HorizontalRange::Builder_obj::__register();
::haxe::ui::components::RangeBuilder_obj::__register();
...
::haxe::ui::components::_DropDown::ListDropDownHandler_obj::__register();
::haxe::ui::components::DropDownHandler_obj::__register();
::haxe::ui::components::IDropDownHandler_obj::__register();
::haxe::ui::components::_DropDown::DropDownOpenBehaviour_obj::__register();
::haxe::ui::components::_DropDown::SearchFieldBehaviour_obj::__register();
...
::haxe::ui::components::_DropDown::ShowDropDown_obj::__register();
::haxe::ui::components::_DropDown::HideDropDown_obj::__register();
::haxe::ui::components::DropDown_obj::__register();
::haxe::ui::components::Decorator_obj::__register();
::haxe::ui::components::_Column::Events_obj::__register();
...
::haxe::ui::core::ICompositeInteractiveComponent_obj::__register();
...
::haxe::ui::behaviours::DynamicDataBehaviour_obj::__register();
::haxe::ui::behaviours::DynamicBehaviour_obj::__register();
::haxe::ui::behaviours::Behaviours_obj::__register();
::haxe::ui::backend::hxwidgets::size::ZeroSize_obj::__register();
::haxe::ui::backend::hxwidgets::size::WindowSize_obj::__register();
::haxe::ui::backend::hxwidgets::size::NotebookSize_obj::__register();
::haxe::ui::backend::hxwidgets::size::DialogSize_obj::__register();
::haxe::ui::backend::hxwidgets::size::BestSize_obj::__register();
::haxe::ui::layouts::DelegateLayoutSize_obj::__register();
::haxe::ui::backend::hxwidgets::handlers::TextCtrlHandler_obj::__register();
::haxe::ui::backend::hxwidgets::handlers::StaticTextHandler_obj::__register();
::haxe::ui::backend::hxwidgets::handlers::ReflectionHandler_obj::__register();
::haxe::ui::backend::hxwidgets::handlers::LinkHandler_obj::__register();
::haxe::ui::backend::hxwidgets::handlers::FrameHandler_obj::__register();
::haxe::ui::backend::hxwidgets::handlers::ChoiceHandler_obj::__register();
::haxe::ui::backend::hxwidgets::handlers::ButtonHandler_obj::__register();
::haxe::ui::backend::hxwidgets::handlers::NativeHandler_obj::__register();
::haxe::ui::backend::hxwidgets::custom::TreeViewNode_obj::__register();
::haxe::ui::containers::TreeViewNode_obj::__register();
::haxe::ui::containers::VBox_obj::__register();
::haxe::ui::backend::hxwidgets::custom::TransparentStaticText_obj::__register();
::hx::widgets::StaticText_obj::__register();
::haxe::ui::backend::hxwidgets::custom::TransparentStaticBitmap_obj::__register();
::hx::widgets::StaticBitmap_obj::__register();
::haxe::ui::backend::hxwidgets::custom::TransparentPanel_obj::__register();
::haxe::ui::backend::hxwidgets::custom::SkinablePanel_obj::__register();
::hx::widgets::OwnerDrawnPanel_obj::__register();
::hx::widgets::Panel_obj::__register();
::haxe::ui::backend::hxwidgets::custom::SimpleListView_obj::__register();
::hx::widgets::ListView_obj::__register();
::hx::widgets::ListCtrl_obj::__register();
::hx::widgets::Control_obj::__register();
::hx::widgets::Window_obj::__register();
::hx::widgets::EvtHandler_obj::__register();
::hx::widgets::Trackable_obj::__register();
::hx::widgets::Object_obj::__register();
::haxe::ui::backend::hxwidgets::creators::TextCtrlCreator_obj::__register();
::haxe::ui::backend::hxwidgets::creators::StaticBitmapCreator_obj::__register();
::haxe::ui::backend::hxwidgets::creators::RadioButtonCreator_obj::__register();
::haxe::ui::backend::hxwidgets::creators::NullWindowCreator_obj::__register();
::haxe::ui::backend::hxwidgets::creators::MenuCreator_obj::__register();
::haxe::ui::backend::hxwidgets::creators::MenuBarCreator_obj::__register();
::haxe::ui::backend::hxwidgets::creators::FrameCreator_obj::__register();
::haxe::ui::backend::hxwidgets::creators::DialogCreator_obj::__register();
::haxe::ui::backend::hxwidgets::creators::ButtonCreator_obj::__register();
::haxe::ui::backend::hxwidgets::creators::Creator_obj::__register();
::haxe::ui::backend::hxwidgets::builders::TreeViewNodeBuilder_obj::__register();
::haxe::ui::backend::hxwidgets::builders::TreeViewBuilder_obj::__register();
::haxe::ui::backend::hxwidgets::builders::TableViewBuilder_obj::__register();
::haxe::ui::backend::hxwidgets::builders::ScrollViewBuilder_obj::__register();
::haxe::ui::backend::hxwidgets::builders::PropertyGridBuilder_obj::__register();
::haxe::ui::backend::hxwidgets::builders::MenuBuilder_obj::__register();
::haxe::ui::backend::hxwidgets::builders::ImageBuilder_obj::__register();
::haxe::ui::core::CompositeBuilder_obj::__register();
::haxe::ui::backend::hxwidgets::behaviours::TreeViewSelectedNode_obj::__register();
::haxe::ui::backend::hxwidgets::behaviours::TreeViewRemoveNode_obj::__register();
::haxe::ui::backend::hxwidgets::behaviours::TreeViewGetNodesInternal_obj::__register();
::haxe::ui::backend::hxwidgets::behaviours::TreeViewClearNodes_obj::__register();
::haxe::ui::backend::hxwidgets::behaviours::TreeViewAddNode_obj::__register();
::haxe::ui::backend::hxwidgets::behaviours::ToolTipBehaviour_obj::__register();
::haxe::ui::backend::hxwidgets::behaviours::TextCtrlWordWrap_obj::__register();
::haxe::ui::backend::hxwidgets::behaviours::TextCtrlPlaceholder_obj::__register();
::haxe::ui::backend::hxwidgets::behaviours::TextCtrlPassword_obj::__register();
::haxe::ui::backend::hxwidgets::behaviours::TableViewDataSource_obj::__register();
::haxe::ui::backend::hxwidgets::behaviours::SliderTicks_obj::__register();
::haxe::ui::backend::hxwidgets::behaviours::NotebookSelectedPage_obj::__register();
::haxe::ui::backend::hxwidgets::behaviours::NotebookRemovePage_obj::__register();
::haxe::ui::backend::hxwidgets::behaviours::NotebookRemoveAllPages_obj::__register();
::haxe::ui::backend::hxwidgets::behaviours::NotebookPageIndex_obj::__register();
::haxe::ui::backend::hxwidgets::behaviours::NotebookPageCount_obj::__register();
::haxe::ui::backend::hxwidgets::behaviours::NotebookGetPage_obj::__register();
::haxe::ui::backend::hxwidgets::behaviours::MenuItemSelected_obj::__register();
::haxe::ui::backend::hxwidgets::behaviours::MenuItemLabel_obj::__register();
::haxe::ui::backend::hxwidgets::behaviours::MenuItemBitmap_obj::__register();
::haxe::ui::backend::hxwidgets::behaviours::MenuDisable_obj::__register();
::haxe::ui::backend::hxwidgets::behaviours::ListViewSelectedIndex_obj::__register();
::haxe::ui::backend::hxwidgets::behaviours::ListViewDataSource_obj::__register();
::haxe::ui::backend::hxwidgets::behaviours::ImageScaleMode_obj::__register();
::haxe::ui::backend::hxwidgets::behaviours::FrameTextBehaviour_obj::__register();
::haxe::ui::backend::hxwidgets::behaviours::DataViewListCtrlSelectedRow_obj::__register();
::haxe::ui::backend::hxwidgets::behaviours::DataComponentSelectedItem_obj::__register();
::haxe::ui::backend::hxwidgets::behaviours::ControlValue_obj::__register();
::haxe::ui::backend::hxwidgets::behaviours::ControlStep_obj::__register();
::haxe::ui::backend::hxwidgets::behaviours::ControlPulse_obj::__register();
::haxe::ui::backend::hxwidgets::behaviours::ControlMin_obj::__register();
::haxe::ui::backend::hxwidgets::behaviours::ControlMax_obj::__register();
::haxe::ui::backend::hxwidgets::behaviours::ControlMarkupLabel_obj::__register();
::haxe::ui::backend::hxwidgets::behaviours::ControlLabel_obj::__register();
::haxe::ui::backend::hxwidgets::behaviours::ControlBitmap_obj::__register();
::haxe::ui::backend::hxwidgets::behaviours::ChoiceSelectedLabel_obj::__register();
::haxe::ui::backend::hxwidgets::behaviours::ChoiceSelectedIndex_obj::__register();
::haxe::ui::backend::hxwidgets::behaviours::ChoiceDataSource_obj::__register();
::haxe::ui::backend::hxwidgets::behaviours::CalendarCtrlDateBehaviour_obj::__register();
::haxe::ui::backend::hxwidgets::behaviours::HxWidgetsBehaviour_obj::__register();
::haxe::ui::backend::hxwidgets::behaviours::AllowInteraction_obj::__register();
::haxe::ui::backend::hxwidgets::StyleParser_obj::__register();
::haxe::ui::backend::hxwidgets::RadioButtonGroups_obj::__register();
::haxe::ui::backend::hxwidgets::Platform_obj::__register();
::haxe::ui::backend::hxwidgets::IconMap_obj::__register();
::haxe::ui::backend::hxwidgets::EventTypeParser_obj::__register();
::haxe::ui::backend::hxwidgets::ConstructorParams_obj::__register();
...
::haxe::ui::backend::FontData_obj::__register();
...
::haxe::ui::backend::ComponentToolTipRendererBehaviour_obj::__register();
::haxe::ui::backend::ComponentToolTipBehaviour_obj::__register();
::haxe::ui::behaviours::DataBehaviour_obj::__register();
::haxe::ui::behaviours::IValidatingBehaviour_obj::__register();
::haxe::ui::backend::ComponentValueBehaviour_obj::__register();
::haxe::ui::behaviours::ValueBehaviour_obj::__register();
::haxe::ui::backend::ComponentDisabledBehaviour_obj::__register();
::haxe::ui::backend::ComponentTextBehaviour_obj::__register();
...
::hx::widgets::_GraphicsPath::GraphicPathCalls_obj::__boot();
...
::haxe::ui::backend::AppImpl_obj::__boot();
::haxe::ui::events::UIEvent_obj::__boot();
::haxe::ui::events::MouseEvent_obj::__boot();
::haxe::ui::events::KeyboardEvent_obj::__boot();
::haxe::ui::backend::ComponentBase_obj::__boot();
::haxe::ui::backend::ComponentImpl_obj::__boot();
...
::wx::widgets::EventType_obj::__boot();
::haxe::ui::events::FocusEvent_obj::__boot();
::haxe::ui::backend::hxwidgets::EventMapper_obj::__boot();
::haxe::ui::backend::hxwidgets::ListViewIcons_obj::__boot();
::haxe::ui::backend::hxwidgets::MenuItemHelper_obj::__boot();
::haxe::ui::backend::hxwidgets::TabViewIcons_obj::__boot();
::haxe::ui::backend::hxwidgets::TableViewIcons_obj::__boot();
::haxe::ui::backend::hxwidgets::TreeViewIcons_obj::__boot();
::haxe::ui::backend::hxwidgets::creators::MenuItemCreator_obj::__boot();
...
::haxe::ui::containers::menus::MenuEvents_obj::__boot();
::haxe::ui::core::Platform_obj::__boot();
::haxe::ui::data::DataSource_obj::__boot();
::haxe::ui::events::ActionEvent_obj::__boot();
::haxe::ui::events::AnimationEvent_obj::__boot();
::haxe::ui::events::AppEvent_obj::__boot();
::haxe::ui::events::DragEvent_obj::__boot();
::haxe::ui::events::ItemEvent_obj::__boot();
::haxe::ui::events::ItemRendererEvent_obj::__boot();
::haxe::ui::events::MenuEvent_obj::__boot();
::haxe::ui::events::ScrollEvent_obj::__boot();
::haxe::ui::events::SortEvent_obj::__boot();
::haxe::ui::events::ThemeEvent_obj::__boot();
::haxe::ui::events::ValidationEvent_obj::__boot();
::haxe::ui::filters::Blur_obj::__boot();
::haxe::ui::filters::BoxShadow_obj::__boot();
::haxe::ui::filters::Contrast_obj::__boot();
::haxe::ui::filters::DropShadow_obj::__boot();
::haxe::ui::filters::Grayscale_obj::__boot();
::haxe::ui::filters::HueRotate_obj::__boot();
::haxe::ui::filters::Outline_obj::__boot();
::haxe::ui::filters::Saturate_obj::__boot();
::haxe::ui::filters::Tint_obj::__boot();
::haxe::ui::layouts::LayoutFactory_obj::__boot();
::haxe::ui::locale::Formats_obj::__boot();
::haxe::ui::locale::LocaleEvent_obj::__boot();
::haxe::ui::locale::LocaleManager_obj::__boot();
::haxe::ui::styles::CssFilters_obj::__boot();
::haxe::ui::styles::CssFunctions_obj::__boot();
::haxe::ui::styles::DirectiveHandler_obj::__boot();
...
::haxe::ui::util::StringUtil_obj::__boot();
::haxe::ui::util::StyleUtil_obj::__boot();
::hx::widgets::DataViewTreeCtrl_obj::__boot();
::hx::widgets::FontEnumerator_obj::__boot();
::wx::widgets::StockBrushes_obj::__boot();
::hx::widgets::StockBrushes_obj::__boot();
::sentinel::app::AlertsView_obj::__boot();
...
::wx::widgets::Alignment_obj::__boot();
::wx::widgets::Defs_obj::__boot();
::wx::widgets::ExecFlags_obj::__boot();
::wx::widgets::_FontFamily::FontFamily_Impl__obj::__boot();
::wx::widgets::_FontStyle::FontStyle_Impl__obj::__boot();
::wx::widgets::_FontWeight::FontWeight_Impl__obj::__boot();
::wx::widgets::GLOptions_obj::__boot();
::wx::widgets::ListState_obj::__boot();
::wx::widgets::ProcessFlag_obj::__boot();
::wx::widgets::_SizerFlag::SizerFlag_Impl__obj::__boot();
::wx::widgets::StandardId_obj::__boot();
::wx::widgets::styles::ButtonStyle_obj::__boot();
::wx::widgets::styles::CalendarCtrlStyle_obj::__boot();
::wx::widgets::styles::ComboBoxStyle_obj::__boot();
::wx::widgets::styles::DataViewCtrlStyle_obj::__boot();
::wx::widgets::styles::DialogStyle_obj::__boot();
::wx::widgets::styles::DirDialogStyle_obj::__boot();
::wx::widgets::styles::FileDialogStyle_obj::__boot();
::wx::widgets::styles::FrameStyle_obj::__boot();
::wx::widgets::styles::GaugeStyle_obj::__boot();
::wx::widgets::styles::HyperlinkCtrlStyle_obj::__boot();
::wx::widgets::styles::ListCtrlStyle_obj::__boot();
::wx::widgets::styles::MessageDialogStyle_obj::__boot();
::wx::widgets::styles::NotebookStyle_obj::__boot();
::wx::widgets::styles::PropertyGridAttributes_obj::__boot();
::wx::widgets::styles::PropertyGridStyles_obj::__boot();
::wx::widgets::styles::RadioButtonStyle_obj::__boot();
::wx::widgets::styles::ScrollBarStyle_obj::__boot();
::wx::widgets::styles::SliderStyle_obj::__boot();
::wx::widgets::styles::StaticLineStyle_obj::__boot();
::wx::widgets::styles::StaticTextStyle_obj::__boot();
::wx::widgets::styles::StyledTextControlStyle_obj::__boot();
::wx::widgets::styles::TextCtrlStyle_obj::__boot();
::wx::widgets::styles::TreeCtrlStyle_obj::__boot();
::wx::widgets::styles::WindowStyle_obj::__boot();
}
