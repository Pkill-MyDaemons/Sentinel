...
class HXCPP_CLASS_ATTRIBUTES ItemContainerImmutable_obj {
	public:
		...
		static inline void setString( ::Dynamic _hx_,int n,::String string) {
			...
			#endif
			#endif
			(_hx_.mPtr->*( ::hx::interface_cast< ::hx::widgets::ItemContainerImmutable_obj *>(_hx_.mPtr->_hx_getInterface(0x73706cf3)))->_hx_setString)(n,string);
		}
		...
		static inline ::String getString( ::Dynamic _hx_,int n) {
			...
			#endif
			#endif
			return (_hx_.mPtr->*( ::hx::interface_cast< ::hx::widgets::ItemContainerImmutable_obj *>(_hx_.mPtr->_hx_getInterface(0x73706cf3)))->_hx_getString)(n);
		}
};
