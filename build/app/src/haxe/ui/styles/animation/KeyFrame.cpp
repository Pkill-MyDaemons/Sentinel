...
HXLINE(  47)				 ::haxe::ui::events::AnimationEvent event =  ::haxe::ui::events::AnimationEvent_obj::__alloc( HX_CTX ,::haxe::ui::events::AnimationEvent_obj::FRAME);
HXLINE(  48)				event->currentTime = time;
HXLINE(  49)				event->delta = delta;
HXLINE(  50)				event->position = position;
HXLINE(  51)				target->dispatch(event,null());
            			}
            		}
...
HXLINE(  37)		bool hasFrameEvent = target->hasEvent(::haxe::ui::events::AnimationEvent_obj::FRAME,null());
...
static ::hx::StorageInfo KeyFrame_obj_sMemberStorageInfo[] = {
	...
	{::hx::fsString,(int)offsetof(KeyFrame_obj,easingFunction),HX_("easingFunction",e3,d6,ae,0d)},
