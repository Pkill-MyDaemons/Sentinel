...
{
	outFields->push(HX_("panelRef",af,d0,0f,32));
	super::__GetFields(outFields);
};

#ifdef HXCPP_SCRIPTABLE
static ::hx::StorageInfo Panel_obj_sMemberStorageInfo[] = {
	{::hx::fsUnknown /* ::cpp::Pointer<  wxPanel > */ ,(int)offsetof(Panel_obj,panelRef),HX_("panelRef",af,d0,0f,32)},
	{ ::hx::fsUnknown, 0, null()}
};
...
static ::String Panel_obj_sMemberFields[] = {
	HX_("panelRef",af,d0,0f,32),
	HX_("get_panelRef",b8,84,29,e7),
	::String(null()) };
...
void Panel_obj::__register()
{
	...
	__mClass->mName = HX_("hx.widgets.Panel",87,ff,a7,5c);
