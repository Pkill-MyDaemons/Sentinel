...
HX_DEFINE_STACK_FRAME(_hx_pos_7d84d5d166e74123_104_new,"haxe.ui.containers.menus._MenuOptionBox.Builder","new",0x7f4ee25b,"haxe.ui.containers.menus._MenuOptionBox.Builder.new","haxe/ui/containers/menus/MenuOptionBox.hx",104,0x896244ad)
HX_LOCAL_STACK_FRAME(_hx_pos_7d84d5d166e74123_107_create,"haxe.ui.containers.menus._MenuOptionBox.Builder","create",0x2e7d83e1,"haxe.ui.containers.menus._MenuOptionBox.Builder.create","haxe/ui/containers/menus/MenuOptionBox.hx",107,0x896244ad)
HX_LOCAL_STACK_FRAME(_hx_pos_7d84d5d166e74123_123_onOptionboxChange,"haxe.ui.containers.menus._MenuOptionBox.Builder","onOptionboxChange",0xf6fe28a2,"haxe.ui.containers.menus._MenuOptionBox.Builder.onOptionboxChange","haxe/ui/containers/menus/MenuOptionBox.hx",123,0x896244ad)
namespace haxe{
namespace ui{
...
void Builder_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_7d84d5d166e74123_104_new)
HXDLIN( 104)		super::__construct(component);
            	}
...
void Builder_obj::create(){
            	HX_GC_STACKFRAME(&_hx_pos_7d84d5d166e74123_107_create)
HXLINE( 108)		this->_optionbox =  ::haxe::ui::components::OptionBox_obj::__alloc( HX_CTX );
HXLINE( 109)		this->_optionbox->set_styleNames(HX_("menuitem-optionbox",9b,0c,7d,bf));
HXLINE( 110)		this->_optionbox->set_percentWidth(100);
HXLINE( 111)		this->_optionbox->registerEvent(::haxe::ui::events::UIEvent_obj::CHANGE,this->onOptionboxChange_dyn(),null());
HXLINE( 112)		this->_optionbox->set_scriptAccess(false);
HXLINE( 113)		this->_component->addComponent(this->_optionbox);
HXLINE( 115)		 ::haxe::ui::components::Label label =  ::haxe::ui::components::Label_obj::__alloc( HX_CTX );
HXLINE( 116)		label->set_id(HX_("menuitem-shortcut-label",a8,00,78,8b));
HXLINE( 117)		label->set_styleNames(HX_("menuitem-shortcut-label",a8,00,78,8b));
HXLINE( 118)		label->set_scriptAccess(false);
HXLINE( 119)		this->_component->addComponent(label);
            	}


void Builder_obj::onOptionboxChange( ::haxe::ui::events::UIEvent event){
            	HX_STACKFRAME(&_hx_pos_7d84d5d166e74123_123_onOptionboxChange)
HXDLIN( 123)		this->_component->dispatch(event,null());
            	}


HX_DEFINE_DYNAMIC_FUNC1(Builder_obj,onOptionboxChange,(void))
...
::hx::Val Builder_obj::__Field(const ::String &inName,::hx::PropertyAccess inCallProp)
{
	...
	case 10:
		...
		break;
	case 17:
		if (HX_FIELD_EQ(inName,"onOptionboxChange") ) { return ::hx::Val( onOptionboxChange_dyn() ); }
	}
...
static ::String Builder_obj_sMemberFields[] = {
	...
	HX_("onOptionboxChange",67,b5,71,8e),
	::String(null()) };
