...
class HXCPP_CLASS_ATTRIBUTES ScrollView_obj : public  ::haxe::ui::core::InteractiveComponent_obj
{
	...
	public:
		...
		::String get_scrollMouseButton();
		::Dynamic get_scrollMouseButton_dyn();

		::String set_scrollMouseButton(::String value);
		::Dynamic set_scrollMouseButton_dyn();
		...
		bool get_isScrollableHorizontally();
		::Dynamic get_isScrollableHorizontally_dyn();

		bool set_isScrollableHorizontally(bool value);
		::Dynamic set_isScrollableHorizontally_dyn();

		bool get_isScrollableVertically();
		::Dynamic get_isScrollableVertically_dyn();

		bool set_isScrollableVertically(bool value);
		::Dynamic set_isScrollableVertically_dyn();

		bool get_isScrollable();
		::Dynamic get_isScrollable_dyn();

		bool set_isScrollable(bool value);
		::Dynamic set_isScrollable_dyn();
